...
GymList['Pewter City'] = new Gym(
    'Brock',
    'Pewter City',
    [new GymPokemon('Geodude', 693, 12), new GymPokemon('Onix', 1399, 14)],
    BadgeEnums.Boulder,
    250,
...
GymList['Cerulean City'] = new Gym(
    'Misty',
    'Cerulean City',
    [new GymPokemon('Staryu', 4000, 18), new GymPokemon('Starmie', 6800, 21)],
    BadgeEnums.Cascade,
    500,
...
GymList['Vermilion City'] = new Gym(
    'Lt. Surge',
    'Vermilion City',
    [new GymPokemon('Voltorb', 10780, 21), new GymPokemon('Pikachu', 13540, 18), new GymPokemon('Raichu', 15675, 24)],
    BadgeEnums.Thunder,
    1000,
...
GymList['Celadon City'] = new Gym(
    'Erika',
    'Celadon City',
    [new GymPokemon('Victreebel', 38810, 29), new GymPokemon('Tangela', 30340, 24), new GymPokemon('Vileplume', 36400, 29)],
    BadgeEnums.Rainbow,
    1500,
...
GymList['Saffron City'] = new Gym(
    'Sabrina',
    'Saffron City',
    [new GymPokemon('Kadabra', 23040, 38), new GymPokemon('Mr. Mime', 25600, 37), new GymPokemon('Venomoth', 28400, 38), new GymPokemon('Alakazam', 35380, 43)],
    BadgeEnums.Marsh,
    2500,
...
GymList['Fuchsia City'] = new Gym(
    'Koga',
    'Fuchsia City',
    [new GymPokemon('Koffing', 30780, 37), new GymPokemon('Muk', 32460, 39), new GymPokemon('Koffing', 36430, 37), new GymPokemon('Weezing', 37430, 43)],
    BadgeEnums.Soul,
    3500,
    'Humph! You have proven your worth! Here! Take the Soul Badge!',
    [new OneFromManyRequirement([new RouteKillRequirement(10, GameConstants.Region.kanto, 18), new RouteKillRequirement(10, GameConstants.Region.kanto, 15)])],
    () => {
...
GymList['Cinnabar Island'] = new Gym(
    'Blaine',
    'Cinnabar Island',
    [new GymPokemon('Growlithe', 37430, 42), new GymPokemon('Ponyta', 42340, 40), new GymPokemon('Rapidash', 45230, 42), new GymPokemon('Arcanine', 50290, 47)],
    BadgeEnums.Volcano,
    5000,
...
GymList['Viridian City'] = new Gym(
    'Giovanni',
    'Viridian City',
    [new GymPokemon('Rhyhorn', 45230, 45), new GymPokemon('Dugtrio', 47530, 42), new GymPokemon('Nidoqueen', 48740, 44), new GymPokemon('Nidoking', 48350, 45), new GymPokemon('Rhyhorn', 55000, 50)],
    BadgeEnums.Earth,
    6000,
    'Ha! That was a truly intense fight. You have won! As proof, here is the Earth Badge!',
    [new GymBadgeRequirement(BadgeEnums.Thunder), new GymBadgeRequirement(BadgeEnums.Rainbow), new GymBadgeRequirement(BadgeEnums.Marsh), new QuestLineCompletedRequirement("Bill's Errand")],
    () => {
...
GymList['Elite Lorelei'] = new Gym(
    'Lorelei',
    'Elite Lorelei',
    [new GymPokemon('Dewgong', 45330, 52), new GymPokemon('Cloyster', 48300, 51), new GymPokemon('Slowbro', 52000, 52), new GymPokemon('Jynx', 57000, 54), new GymPokemon('Lapras', 60250, 54)],
...
GymList['Elite Bruno'] = new Gym(
    'Bruno',
    'Elite Bruno',
    [new GymPokemon('Onix', 45330, 51), new GymPokemon('Hitmonchan', 48300, 53), new GymPokemon('Hitmonlee', 52000, 53), new GymPokemon('Onix', 57000, 54), new GymPokemon('Machamp', 60250, 56)],
...
GymList['Elite Agatha'] = new Gym(
    'Agatha',
    'Elite Agatha',
    [new GymPokemon('Gengar', 45330, 54), new GymPokemon('Golbat', 48300, 54), new GymPokemon('Haunter', 52000, 53), new GymPokemon('Arbok', 57000, 56), new GymPokemon('Gengar', 60250, 58)],
...
GymList['Violet City'] = new Gym(
    'Falkner',
    'Violet City',
    [new GymPokemon('Pidgey', 108000, 7), new GymPokemon('Pidgeotto', 112000, 9)],
    BadgeEnums.Zephyr,
    500,
...
GymList['Azalea Town'] = new Gym(
    'Bugsy',
    'Azalea Town',
    [new GymPokemon('Metapod', 103000, 14), new GymPokemon('Kakuna', 101500, 14), new GymPokemon('Scyther', 119000, 16)],
    BadgeEnums.Hive,
    1000,
...
GymList['Goldenrod City'] = new Gym(
    'Whitney',
    'Goldenrod City',
    [new GymPokemon('Clefairy', 130000, 18), new GymPokemon('Miltank', 170000, 20)],
    BadgeEnums.Plain,
    1500,
...
GymList['Ecruteak City'] = new Gym(
    'Morty',
    'Ecruteak City',
    [new GymPokemon('Gastly', 127000, 21), new GymPokemon('Haunter', 128000, 21), new GymPokemon('Gengar', 132000, 25), new GymPokemon('Haunter', 130000, 23)],
    BadgeEnums.Fog,
    2500,
...
GymList['Cianwood City'] = new Gym(
    'Chuck',
    'Cianwood City',
    [new GymPokemon('Primeape', 177000, 27), new GymPokemon('Poliwrath', 183000, 30)],
    BadgeEnums.Storm,
    3500,
...
GymList['Olivine City'] = new Gym(
    'Jasmine',
    'Olivine City',
    [new GymPokemon('Magnemite', 177000, 30), new GymPokemon('Magnemite', 178000, 30), new GymPokemon('Steelix', 182000, 35)],
    BadgeEnums.Mineral,
    4000,
...
GymList['Mahogany Town'] = new Gym(
    'Pryce',
    'Mahogany Town',
    [new GymPokemon('Seel', 190000, 27), new GymPokemon('Dewgong', 192500, 29), new GymPokemon('Piloswine', 196000, 31)],
    BadgeEnums.Glacier,
    5000,
...
GymList['Blackthorn City'] = new Gym(
    'Clair',
    'Blackthorn City',
    [new GymPokemon('Dragonair', 205000, 37), new GymPokemon('Dragonair', 205000, 37), new GymPokemon('Dragonair', 218000, 37), new GymPokemon('Kingdra', 220000, 40)],
    BadgeEnums.Rising,
    7500,
...
GymList['Elite Will'] = new Gym(
    'Will',
    'Elite Will',
    [new GymPokemon('Xatu', 245330, 40), new GymPokemon('Exeggutor', 248300, 41), new GymPokemon('Slowbro', 252000, 41), new GymPokemon('Jynx', 257000, 41), new GymPokemon('Xatu', 260250, 42)],
...
GymList['Elite Koga'] = new Gym(
    'Koga2',
    'Elite Koga',
    [new GymPokemon('Ariados', 245330, 40), new GymPokemon('Venomoth', 248300, 41), new GymPokemon('Forretress', 252000, 43), new GymPokemon('Muk', 257000, 42), new GymPokemon('Crobat', 260250, 44)],
...
GymList['Elite Karen'] = new Gym(
    'Karen',
    'Elite Karen',
    [new GymPokemon('Umbreon', 248300, 42), new GymPokemon('Vileplume', 252000, 42), new GymPokemon('Murkrow', 257000, 44), new GymPokemon('Gengar', 260250, 45), new GymPokemon('Houndoom', 266000, 47)],
...
GymList['Rustboro City'] = new Gym(
    'Roxanne',
    'Rustboro City',
    [new GymPokemon('Geodude', 382900, 12), new GymPokemon('Geodude', 382900, 12), new GymPokemon('Nosepass', 410200, 15)],
    BadgeEnums.Stone,
    1000,
...
GymList['Dewford Town'] = new Gym(
    'Brawly',
    'Dewford Town',
    [new GymPokemon('Machop', 424000, 16), new GymPokemon('Meditite', 424000, 16), new GymPokemon('Makuhita', 444000, 19)],
    BadgeEnums.Knuckle,
    2000,
...
GymList['Mauville City'] = new Gym(
    'Wattson',
    'Mauville City',
    [new GymPokemon('Voltorb', 452000, 20), new GymPokemon('Electrike', 448000, 20), new GymPokemon('Magneton', 483000, 22), new GymPokemon('Manectric', 448000, 24)],
    BadgeEnums.Dynamo,
    3000,
...
GymList['Lavaridge Town'] = new Gym(
    'Flannery',
    'Lavaridge Town',
    [new GymPokemon('Numel', 472000, 24), new GymPokemon('Slugma', 472000, 24), new GymPokemon('Camerupt', 492000, 26), new GymPokemon('Torkoal', 524000, 29)],
    BadgeEnums.Heat,
    4000,
...
GymList['Petalburg City'] = new Gym(
    'Norman',
    'Petalburg City',
    [new GymPokemon('Spinda', 490000, 27), new GymPokemon('Vigoroth', 530000, 27), new GymPokemon('Linoone', 560000, 29), new GymPokemon('Slaking', 596000, 31)],
    BadgeEnums.Balance,
    5000,
    "… I… I can't… I can't believe it. I lost to you? But, rules are rules! Here, take this.",
    [new GymBadgeRequirement(BadgeEnums.Knuckle), new GymBadgeRequirement(BadgeEnums.Heat)],
);
GymList['Fortree City'] = new Gym(
    'Winona',
    'Fortree City',
    [new GymPokemon('Swablu', 605000, 29), new GymPokemon('Tropius', 650000, 29), new GymPokemon('Pelipper', 630000, 30), new GymPokemon('Skarmory', 667000, 31), new GymPokemon('Altaria', 669000, 33)],
    BadgeEnums.Feather,
    6000,
...
GymList['Mossdeep City'] = new Gym(
    'Tate & Liza',
    'Mossdeep City',
    [new GymPokemon('Claydol', 702000, 41), new GymPokemon('Xatu', 703000, 41), new GymPokemon('Lunatone', 702000, 42), new GymPokemon('Solrock', 703000, 42)],
    BadgeEnums.Mind,
    8000,
...
GymList['Sootopolis City'] = new Gym(
    'Juan',
    'Sootopolis City',
    [new GymPokemon('Luvdisc', 798000, 41), new GymPokemon('Whiscash', 813000, 41), new GymPokemon('Sealeo', 823400, 43), new GymPokemon('Crawdaunt', 842000, 43), new GymPokemon('Kingdra', 865000, 46)],
    BadgeEnums.Rain,
    10000,
...
GymList['Elite Sidney'] = new Gym(
    ...
    [new GymBadgeRequirement(BadgeEnums.Feather), new TemporaryBattleRequirement('Wally 2')],
);
...
GymList['Elite Glacia'] = new Gym(
    'Glacia',
    'Elite Glacia',
    [new GymPokemon('Sealeo', 1082000, 50), new GymPokemon('Glalie', 1072000, 50), new GymPokemon('Sealeo', 1086000, 52), new GymPokemon('Glalie', 1076000, 52), new GymPokemon('Walrein', 1100000, 53)],
...
GymList['Mikan Island'] = new Gym(
    'Cissy',
    'Mikan Island',
    [new GymPokemon('Seadra', 2307500, 24), new GymPokemon('Blastoise', 2307500, 24)],
...
GymList['Trovita Island'] = new Gym(
    'Rudy',
    'Trovita Island',
    [new GymPokemon('Electabuzz', 1538333, 24), new GymPokemon('Exeggutor', 1538333, 24), new GymPokemon('Starmie', 1538333, 24)],
...
GymList['Kumquat Island'] = new Gym(
    'Luana',
    'Kumquat Island',
    [new GymPokemon('Alakazam', 2307500, 24), new GymPokemon('Marowak', 2307500, 24)],
...
GymList['Supreme Gym Leader Drake'] = new Gym(
    ...
    [new GymBadgeRequirement(BadgeEnums['Coral-Eye']), new GymBadgeRequirement(BadgeEnums.Sea_Ruby), new GymBadgeRequirement(BadgeEnums.Spike_Shell), new GymBadgeRequirement(BadgeEnums.Jade_Star)],
);
...
GymList['Cipher Admin Eldes'] = new Gym(
    ...
    undefined,
    undefined,
    { displayName: 'Challenge Eldes' },
);
//Sinnoh Gyms
GymList['Oreburgh City'] = new Gym(
    'Roark',
    'Oreburgh City',
    [new GymPokemon('Geodude', 1338000, 12), new GymPokemon('Onix', 1342000, 12), new GymPokemon('Cranidos', 1342000, 14)],
    BadgeEnums.Coal,
    250,
...
GymList['Eterna City'] = new Gym(
    'Gardenia',
    'Eterna City',
    [new GymPokemon('Turtwig', 1433000, 20), new GymPokemon('Cherrim (Overcast)', 1437500, 20), new GymPokemon('Roserade', 1439000, 22)],
    BadgeEnums.Forest,
    400,
...
GymList['Hearthome City'] = new Gym(
    'Fantina',
    'Hearthome City',
    [new GymPokemon('Duskull', 1450000, 24), new GymPokemon('Haunter', 1480000, 24), new GymPokemon('Mismagius', 1480000, 26)],
    BadgeEnums.Relic,
    740,
...
GymList['Veilstone City'] = new Gym(
    'Maylene',
    'Veilstone City',
    [new GymPokemon('Meditite', 1537000, 28), new GymPokemon('Machoke', 1538000, 29), new GymPokemon('Lucario', 1540000, 32)],
    BadgeEnums.Cobble,
    1200,
...
GymList['Pastoria City'] = new Gym(
    'Crasher Wake',
    'Pastoria City',
    [new GymPokemon('Gyarados', 1687000, 33), new GymPokemon('Quagsire', 1693000, 34), new GymPokemon('Floatzel', 1693000, 37)],
    BadgeEnums.Fen,
    2500,
...
GymList['Canalave City'] = new Gym(
    'Byron',
    'Canalave City',
    [new GymPokemon('Magneton', 1767000, 37), new GymPokemon('Steelix', 1772000, 38), new GymPokemon('Bastiodon', 1768000, 41)],
    BadgeEnums.Mine,
    4800,
...
GymList['Snowpoint City'] = new Gym(
    'Candice',
    'Snowpoint City',
    [new GymPokemon('Sneasel', 1872500, 40), new GymPokemon('Piloswine', 1876000, 40), new GymPokemon('Abomasnow', 1870000, 42), new GymPokemon('Froslass', 1870000, 44)],
    BadgeEnums.Icicle,
    8000,
...
GymList['Sunyshore City'] = new Gym(
    'Volkner',
    'Sunyshore City',
    [new GymPokemon('Jolteon', 1965000, 46), new GymPokemon('Raichu', 1965000, 46), new GymPokemon('Luxray', 1978000, 48), new GymPokemon('Electivire', 1980000, 50)],
    BadgeEnums.Beacon,
    12000,
...
GymList['Aspertia City'] = new Gym(
    'Cheren',
    'Aspertia City',
    [new GymPokemon('Patrat', 3458300, 12), new GymPokemon('Pidove', 3462000, 12), new GymPokemon('Lillipup', 3464000, 14)],
    BadgeEnums.Basic,
    500,
...
GymList['Virbank City'] = new Gym(
    'Roxie',
    'Virbank City',
    [new GymPokemon('Koffing', 3658300, 17), new GymPokemon('Grimer', 3662000, 17), new GymPokemon('Whirlipede', 3664000, 19)],
    BadgeEnums.Toxic,
    800,
...
GymList['Castelia City'] = new Gym(
    'Burgh',
    'Castelia City',
    [new GymPokemon('Dwebble', 3858300, 24), new GymPokemon('Shelmet', 3862000, 24), new GymPokemon('Karrablast', 3964000, 24), new GymPokemon('Leavanny', 4064000, 26)],
    BadgeEnums.Insect,
    1500,
...
GymList['Nimbasa City'] = new Gym(
    'Elesa',
    'Nimbasa City',
    [new GymPokemon('Emolga', 4258300, 30), new GymPokemon('Flaaffy', 4262000, 30), new GymPokemon('Joltik', 4464000, 30), new GymPokemon('Zebstrika', 4464000, 32)],
    BadgeEnums.Bolt,
    2600,
...
GymList['Driftveil City'] = new Gym(
    'Clay',
    'Driftveil City',
    [new GymPokemon('Krokorok', 4658300, 34), new GymPokemon('Sandslash', 4662000, 34), new GymPokemon('Onix', 4864000, 34), new GymPokemon('Excadrill', 5064000, 36)],
    BadgeEnums.Quake,
    4800,
...
GymList['Mistralton City'] = new Gym(
    'Skyla',
    'Mistralton City',
    [new GymPokemon('Swoobat', 5458300, 40), new GymPokemon('Skarmory', 6062000, 40), new GymPokemon('Sigilyph', 5664000, 40), new GymPokemon('Swanna', 5864000, 42)],
    BadgeEnums.Jet,
    7600,
...
GymList['Opelucid City'] = new Gym(
    'Drayden',
    'Opelucid City',
    [new GymPokemon('Druddigon', 6558300, 50), new GymPokemon('Flygon', 6662000, 50), new GymPokemon('Altaria', 6464000, 50), new GymPokemon('Haxorus', 6964000, 52)],
    BadgeEnums.Legend,
    14000,
...
GymList['Humilau City'] = new Gym(
    'Marlon',
    'Humilau City',
    [new GymPokemon('Wailord', 7458300, 53), new GymPokemon('Mantine', 7262000, 53), new GymPokemon('Carracosta', 7064000, 53), new GymPokemon('Jellicent', 7464000, 55)],
    BadgeEnums.Wave,
    27000,
...
GymList['Santalune City'] = new Gym(
    'Viola',
    'Santalune City',
    [new GymPokemon('Surskit', 13737400, 10), new GymPokemon('Vivillon (Meadow)', 17395730, 12)],
    BadgeEnums.Bug,
    800,
...
GymList['Cyllage City'] = new Gym(
    'Grant',
    'Cyllage City',
    [new GymPokemon('Amaura', 16937530, 25), new GymPokemon('Tyrunt', 19837400, 25)],
    BadgeEnums.Cliff,
    1700,
...
GymList['Shalour City'] = new Gym(
    'Korrina',
    'Shalour City',
    [new GymPokemon('Mienfoo', 21558300, 29), new GymPokemon('Machoke', 22062000, 28), new GymPokemon('Hawlucha', 22362000, 32)],
    BadgeEnums.Rumble,
    3800,
...
GymList['Coumarine City'] = new Gym(
    'Ramos',
    'Coumarine City',
    [new GymPokemon('Jumpluff', 25508300, 30), new GymPokemon('Weepinbell', 27562000, 31), new GymPokemon('Gogoat', 29502000, 34)],
    BadgeEnums.Plant,
    5500,
...
GymList['Lumiose City'] = new Gym(
    'Clemont',
    'Lumiose City',
    [new GymPokemon('Emolga', 30058300, 35), new GymPokemon('Magneton', 31062000, 35), new GymPokemon('Heliolisk', 32062000, 37)],
    BadgeEnums.Voltage,
    9000,
...
GymList['Laverre City'] = new Gym(
    'Valerie',
    'Laverre City',
    [new GymPokemon('Mawile', 33058300, 38), new GymPokemon('Mr. Mime', 36462000, 38), new GymPokemon('Sylveon', 38062000, 42)],
    BadgeEnums.Fairy,
    16000,
...
GymList['Anistar City'] = new Gym(
    'Olympia',
    'Anistar City',
    [new GymPokemon('Sigilyph', 40058300, 44), new GymPokemon('Slowking', 42062000, 45), new GymPokemon('Meowstic', 44462000, 48)],
    BadgeEnums.Psychic,
    30000,
...
GymList['Snowbelle City'] = new Gym(
    'Wulfric',
    'Snowbelle City',
    [new GymPokemon('Abomasnow', 46558300, 56), new GymPokemon('Cryogonal', 47654830, 55), new GymPokemon('Avalugg', 50062000, 59)],
    BadgeEnums.Iceberg,
    52000,
...
GymList['Elite Malva'] = new Gym(
    'Malva',
    'Elite Malva',
    [new GymPokemon('Pyroar', 46492423, 63), new GymPokemon('Torkoal', 46791055, 63), new GymPokemon('Chandelure', 46794200, 63), new GymPokemon('Talonflame', 47223450, 65)],
...
GymList['Elite Siebold'] = new Gym(
    'Siebold',
    'Elite Siebold',
    [new GymPokemon('Clawitzer', 46492423, 63), new GymPokemon('Gyarados', 47094530, 63), new GymPokemon('Starmie', 47094530, 63), new GymPokemon('Barbaracle', 47223450, 65)],
...
GymList['Elite Wikstrom'] = new Gym(
    'Wikstrom',
    'Elite Wikstrom',
    [new GymPokemon('Klefki', 46492423, 63), new GymPokemon('Probopass', 47094530, 63), new GymPokemon('Scizor', 47094530, 63), new GymPokemon('Aegislash (Shield)', 47223450, 65)],
...
GymList['Elite Drasna'] = new Gym(
    'Drasna',
    'Elite Drasna',
    [new GymPokemon('Dragalge', 46492423, 63), new GymPokemon('Druddigon', 47094530, 63), new GymPokemon('Altaria', 47094530, 63), new GymPokemon('Noivern', 47223450, 65)],
...
GymList['Iki Town'] = new Gym(
    'Hala',
    'Iki Town',
    [new GymPokemon('Machop', 62058739, 15), new GymPokemon('Makuhita', 62058739, 15), new GymPokemon('Crabrawler', 63069612, 16)],
...
GymList['Konikoni City'] = new Gym(
    'Olivia',
    'Konikoni City',
    [new GymPokemon('Anorith', 81530244, 27), new GymPokemon('Lileep', 81530244, 27), new GymPokemon('Lycanroc (Midnight)', 83170680, 28)],
...
GymList['Malie City'] = new Gym(
    'Nanu',
    'Malie City',
    [new GymPokemon('Sableye', 101710296, 43), new GymPokemon('Krokorok', 101710296, 43), new GymPokemon('Alolan Persian', 103271750, 44)],
...
GymList.Turffield = new Gym(
    'Milo',
    'Turffield',
    [new GymPokemon('Gossifleur', 110892836, 19), new GymPokemon('Eldegoss', 123214264, 20)],
...
GymList.Hulbury = new Gym(
    'Nessa',
    'Hulbury',
    [new GymPokemon('Goldeen', 119044213, 22), new GymPokemon('Arrokuda', 119044213, 23), new GymPokemon('Gigantamax Drednaw', 122651613, 24)],
...
GymList.Motostoke = new Gym(
    'Kabu',
    'Motostoke',
    [new GymPokemon('Ninetales', 125012841, 25), new GymPokemon('Arcanine', 125012841, 25), new GymPokemon('Gigantamax Centiskorch', 132826144, 27)],
...
GymList['Stow-on-Side1'] = new Gym(
    'Bea',
    'Stow-on-Side1',
    [new GymPokemon('Hitmontop', 131352402, 34), new GymPokemon('Pangoro', 131352402, 34), new GymPokemon("Sirfetch'd", 131352402, 35), new GymPokemon('Gigantamax Machamp', 142075062, 36)],
...
GymList['Stow-on-Side2'] = new Gym(
    'Allister',
    'Stow-on-Side2',
    [new GymPokemon('Galarian Yamask', 131352402, 34), new GymPokemon('Mimikyu', 131352402, 34), new GymPokemon('Cursola', 131352402, 35), new GymPokemon('Gigantamax Gengar', 142075062, 36)],
    ...
    undefined,
    { displayName: "Allister's Stow-on-Side Gym" },
);
GymList.Ballonlea = new Gym(
    'Opal',
    'Ballonlea',
    [new GymPokemon('Galarian Weezing', 135999999, 36), new GymPokemon('Mawile', 135999999, 36), new GymPokemon('Togekiss', 135999999, 37), new GymPokemon('Gigantamax Alcremie', 147097917, 38)],
...
GymList.Circhester1 = new Gym(
    'Gordie',
    'Circhester1',
    [new GymPokemon('Barbaracle', 140246069, 40), new GymPokemon('Shuckle', 140246069, 40), new GymPokemon('Stonjourner', 140246069, 41), new GymPokemon('Gigantamax Coalossal', 151694727, 42)],
    ...
    undefined,
    undefined,
    { displayName: "Gordie's Circhester Gym" },
);
GymList.Circhester2 = new Gym(
    ...
    undefined,
    undefined,
    { displayName: "Melony's Circhester Gym" },
);
GymList.Spikemuth = new Gym(
    'Piers',
    'Spikemuth',
    [new GymPokemon('Scrafty', 145552675, 44), new GymPokemon('Malamar', 145552675, 45), new GymPokemon('Skuntank', 145552675, 45), new GymPokemon('Obstagoon', 157434528, 46)],
...
GymList.Hammerlocke = new Gym(
    'Raihan',
    'Hammerlocke',
    [new GymPokemon('Gigalith', 151276613, 46), new GymPokemon('Flygon', 151276613, 47), new GymPokemon('Sandaconda', 151276613, 46), new GymPokemon('Gigantamax Duraludon', 163625773, 48)],
...
GymList['Elite Dojo Matron Honey'] = new Gym(
    ...
    [new MultiRequirement([new GymBadgeRequirement(BadgeEnums.Elite_ArmorPoison), new GymBadgeRequirement(BadgeEnums.Elite_ArmorPsychic)])],
);
...
GymList['Grandtree Arena'] = new Gym(
    ...
    undefined,
    undefined,
    { displayName: 'Lord Kleavor', imageName: '../pokemon/900.01' },
);
GymList['Brava Arena'] = new Gym(
    ...
    undefined,
    undefined,
    { displayName: 'Lady Lilligant', imageName: '../pokemon/549.02' },
);
GymList['Molten Arena'] = new Gym(
    ...
    undefined,
    undefined,
    { displayName: 'Lord Arcanine', imageName: '../pokemon/59.02' },
);
GymList['Moonview Arena'] = new Gym(
    ...
    undefined,
    undefined,
    { displayName: 'Lord Electrode', imageName: '../pokemon/101.02' },
);
GymList['Icepeak Arena'] = new Gym(
    ...
    undefined,
    undefined,
    { displayName: 'Lord Avalugg', imageName: '../pokemon/713.02' },
);
...
GymList.Cortondo = new Gym(
    'Katy',
    'Cortondo',
    [new GymPokemon('Nymble', 203123316, 14), new GymPokemon('Tarountula', 203123316, 14), new GymPokemon('Teddiursa', 203123316, 15)],
    BadgeEnums.Bug_Gym,
    250000,
    '',
...
GymList.Artazon = new Gym(
    'Brassius',
    'Artazon',
    [new GymPokemon('Petilil', 203123316, 16), new GymPokemon('Smoliv', 203123316, 14), new GymPokemon('Sudowoodo', 203123316, 17)],
...
GymList.Levincia = new Gym(
    'Iono',
    'Levincia',
    [new GymPokemon('Wattrel', 203123316, 23), new GymPokemon('Bellibolt', 203123316, 23), new GymPokemon('Luxio', 203123316, 23), new GymPokemon('Mismagius', 203123316, 24)],
...
GymList.Cascarrafa = new Gym(
    'Kofu',
    'Cascarrafa',
    [new GymPokemon('Veluza', 203123316, 29), new GymPokemon('Wugtrio', 203123316, 29), new GymPokemon('Crabominable', 203123316, 30)],
...
GymList.Medali = new Gym(
    'Larry',
    'Medali',
    [new GymPokemon('Komala', 203123316, 35), new GymPokemon('Dudunsparce (Two-Segment)', 203123316, 35), new GymPokemon('Staraptor', 203123316, 36)],
...
GymList.Montenevera = new Gym(
    'Ryme',
    'Montenevera',
    [new GymPokemon('Banette', 203123316, 41), new GymPokemon('Mimikyu', 203123316, 41), new GymPokemon('Houndstone', 203123316, 41), new GymPokemon('Toxtricity (Low Key)', 203123316, 42)],
...
GymList.Alfornada = new Gym(
    'Tulip',
    'Alfornada',
    [new GymPokemon('Farigiraf', 203123316, 44), new GymPokemon('Gardevoir', 203123316, 44), new GymPokemon('Espathra', 203123316, 44), new GymPokemon('Florges (Red)', 203123316, 45)],
...
GymList['Glaseado Mountain'] = new Gym(
    'Grusha',
    'Glaseado Mountain',
    [new GymPokemon('Frosmoth', 203123316, 47), new GymPokemon('Beartic', 203123316, 47), new GymPokemon('Cetitan', 203123316, 47), new GymPokemon('Altaria', 203123316, 48)],
    BadgeEnums.Ice_Gym,
    250000,
    '',
...
GymList["Segin Squad's Base"] = new Gym(
    'Giacomo',
    "Segin Squad's Base",
    [new GymPokemon('Pawniard', 203123316, 21), new GymPokemon('Segin Starmobile', 203123316, 20)],
    ...
    undefined,
    undefined,
    { displayName: 'Giacomo of Team Star' },
);
GymList["Schedar Squad's Base"] = new Gym(
    'Mela',
    "Schedar Squad's Base",
    [new GymPokemon('Torkoal', 203123316, 27), new GymPokemon('Schedar Starmobile', 203123316, 26)],
    ...
    undefined,
    undefined,
    { displayName: 'Mela of Team Star' },
);
GymList["Navi Squad's Base"] = new Gym(
    'Atticus',
    "Navi Squad's Base",
    [new GymPokemon('Skuntank', 203123316, 32), new GymPokemon('Muk', 203123316, 32), new GymPokemon('Revavroom', 203123316, 33), new GymPokemon('Navi Starmobile', 203123316, 32)],
    ...
    undefined,
    undefined,
    { displayName: 'Atticus of Team Star' },
);
GymList["Ruchbah Squad's Base"] = new Gym(
    'Ortega',
    "Ruchbah Squad's Base",
    [new GymPokemon('Azumarill', 203123316, 50), new GymPokemon('Wigglytuff', 203123316, 50), new GymPokemon('Dachsbun', 203123316, 51), new GymPokemon('Ruchbah Starmobile', 203123316, 50)],
    ...
    undefined,
    undefined,
    { displayName: 'Ortega of Team Star' },
);
...
GymList['Director Clavell'] = new Gym(
    ...
    undefined,
    undefined,
    { displayName: 'Director Clavell', hideUntilUnlocked: true },
);
GymList['Penny of Team Star'] = new Gym(
    ...
    undefined,
    undefined,
    { displayName: 'Penny of Team Star', hideUntilUnlocked: true },
);
...
GymList['Lurking Steel Titan'] = new Gym(
    ...
    undefined,
    undefined,
    { imageName: '../pokemon/968.01' },
);
GymList['Asado Desert'] = new Gym(
    'Quaking Earth Titan',
    'Asado Desert',
    [new GymPokemon('Titan Great Tusk', 203123316, 45), new GymPokemon('Titan Iron Treads', 203123316, 45)],
...
GymList['Casseroya Lake'] = new Gym(
    'False Dragon Titan',
    'Casseroya Lake',
    [new GymPokemon('Titan Dondozo', 203123316, 56), new GymPokemon('Titan Tatsugiri', 203123316, 57)],
...
GymList['Pokémon Trainer Arven'] = new Gym(
    ...
    undefined,
    undefined,
    { displayName: 'Arven', hideUntilUnlocked: true },
);
