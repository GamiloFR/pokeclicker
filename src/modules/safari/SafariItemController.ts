...
import { SafariItemWeighed } from './SafariItem';

class SafariItemController {
    public static list: Record<SafariRegion, Array<SafariItemWeighed>>;
    ...
    public static init() {
        this.list  = {
            ...
            [Region.kanto]: [
                ...
                { item: { id: 'Pinsirite', type: ItemType.item }, weight: 1, requirement: new MultiRequirement([new MaxRegionRequirement(Region.kalos), new ObtainedPokemonRequirement('Pinsir'), new SafariLevelRequirement(10)]) },
            ],
            [Region.johto]: [
            ...
            [Region.kalos]: [
                ...
                { item: { id: 'Exeggcute (Single)', type: ItemType.item }, weight: 0.25, requirement: new MultiRequirement([new SafariLevelRequirement(5), new ObtainedPokemonRequirement('Exeggcute')]) },
                { item: { id: 'Scizorite', type: ItemType.item }, weight: 1, requirement: new MultiRequirement([new MaxRegionRequirement(Region.kalos), new ObtainedPokemonRequirement('Scizor'), new SafariLevelRequirement(15)]) },
            ],
            [Region.alola]: [
...
export default SafariItemController;
