...
import { AchievementOption, AlolaSubRegions, DayOfWeek, GalarSubRegions, HoennSubRegions, JohtoSubRegions, KantoSubRegions, Region, getDungeonIndex } from '../GameConstants';
...
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.kanto, 2), new GymBadgeRequirement(BadgeEnums.Boulder)],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.kanto, 3), new ClearDungeonRequirement(1, getDungeonIndex('Mt. Moon'))],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new TemporaryBattleRequirement('Blue 3'), new GymBadgeRequirement(BadgeEnums.Cascade)],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new TemporaryBattleRequirement('Snorlax route 12'), new RouteKillRequirement(10, Region.kanto, 14)])],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.kanto, 13), new RouteKillRequirement(10, Region.kanto, 15)])],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.kanto, 18), new RouteKillRequirement(10, Region.kanto, 14)])],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new TemporaryBattleRequirement('Snorlax route 16'), new RouteKillRequirement(10, Region.kanto, 17)])],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.kanto, 16), new RouteKillRequirement(10, Region.kanto, 18)])],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.kanto, 17), new RouteKillRequirement(10, Region.kanto, 15)])],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.kanto, 21), new ClearDungeonRequirement(1, getDungeonIndex('Seafoam Islands'))])],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.kanto, 22), new TemporaryBattleRequirement('Blue 6')],
        undefined,
        KantoSubRegions.Kanto,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new ClearDungeonRequirement(1, getDungeonIndex('Altering Cave')), new QuestLineCompletedRequirement("Celio's Errand")],
        undefined,
        KantoSubRegions.Sevii4567,
        true,
        1250000,
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.johto, 35), new TemporaryBattleRequirement('Sudowoodo')])],
        undefined,
        JohtoSubRegions.Johto,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new TemporaryBattleRequirement('Sudowoodo'), new RouteKillRequirement(10, Region.johto, 36)],
        undefined,
        JohtoSubRegions.Johto,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.johto, 39), new GymBadgeRequirement(BadgeEnums.Fog)],
        undefined,
        JohtoSubRegions.Johto,
    ),
);
...
const cuteMeowthReq = new MultiRequirement([
    ...
    new OneFromManyRequirement([
        ...
        new MultiRequirement([new PokemonLevelRequirement('Phanpy', 51, AchievementOption.less), new ClearDungeonRequirement(250, getDungeonIndex("Team Rocket's Hideout"))]),
    ]),
]);
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            headbutt: ['Aipom', 'Heracross'],
            special: [
                new SpecialRoutePokemon(
                    ['Meowth (Phanpy)'],
                    new CustomRequirement(
                        ko.pureComputed(() => cuteMeowthReq.isCompleted()),
                        true,
                        "Have Phanpy newly hatched and at level below 21, or 51 if you cleared the Team Rocket's Hideout 250 times or more.",
                    ),
                ),
            ],
        }),
        [new OneFromManyRequirement([new ClearDungeonRequirement(1, getDungeonIndex('Mt. Mortar')), new GymBadgeRequirement(BadgeEnums.Fog)])],
        undefined,
        JohtoSubRegions.Johto,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.hoenn, 105), new RouteKillRequirement(10, Region.hoenn, 107)])],
        115.2,
        HoennSubRegions.Hoenn,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.hoenn, 106), new RouteKillRequirement(10, Region.hoenn, 108)])],
        115.3,
        HoennSubRegions.Hoenn,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.hoenn, 107), new RouteKillRequirement(10, Region.hoenn, 109)])],
        115.4,
        HoennSubRegions.Hoenn,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [new SpecialRoutePokemon(['Electrike'], new ObtainedPokemonRequirement('Electrike'))],
        }),
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [new SpecialRoutePokemon(['Roselia'], new ObtainedPokemonRequirement('Roselia'))],
        }),
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [new SpecialRoutePokemon(['Electrike'], new ObtainedPokemonRequirement('Electrike')), new SpecialRoutePokemon(['Manectric'], new ObtainedPokemonRequirement('Manectric'))],
        }),
        [new GymBadgeRequirement(BadgeEnums.Balance)],
        undefined,
        HoennSubRegions.Hoenn,
...
Routes.add(
    new RegionRoute(
        ...
        [new ClearDungeonRequirement(1, getDungeonIndex('Weather Institute')), new TemporaryBattleRequirement('Kecleon 1')],
        undefined,
        HoennSubRegions.Hoenn,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.hoenn, 125), new RouteKillRequirement(10, Region.hoenn, 126)])],
        undefined,
        HoennSubRegions.Hoenn,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.sinnoh, 201), new TemporaryBattleRequirement('Barry 1')],
    ),
);
Routes.add(
    new RegionRoute(
...
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.unova, 19), new TemporaryBattleRequirement('Hugh 1')],
        0.2,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new GymBadgeRequirement(BadgeEnums.Toxic), new TemporaryBattleRequirement('Team Plasma Grunt 1'), new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 1)],
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.unova, 4), new TemporaryBattleRequirement('Colress 1'), new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 2)],
        4,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [new TemporaryBattleRequirement('Colress 1'), new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 2)],
    ),
);
Routes.add(
    new RegionRoute(
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [new SpecialRoutePokemon(['Zebstrika'], new ObtainedPokemonRequirement('Zebstrika'))],
        }),
        [new ClearDungeonRequirement(1, getDungeonIndex('Chargestone Cave')), new TemporaryBattleRequirement('Colress 2'), new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 7)],
    ),
);
Routes.add(
    new RegionRoute(
...
Routes.add(
    new RegionRoute(
            ...
            special: [
                new SpecialRoutePokemon(
                    ...
                    new MultiRequirement([
                        new ObtainedPokemonRequirement('Cherrim (Overcast)'),
        ...
        [new RouteKillRequirement(10, Region.unova, 13), new TemporaryBattleRequirement('Zinzolin 1'), new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 10)],
        13.1,
    ),
);
Routes.add(
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            water: ['Buizel', 'Basculin (Red-Striped)', 'Basculin (Blue-Striped)'],
            special: [new SpecialRoutePokemon(['Sawk'], new ObtainedPokemonRequirement('Sawk')), new SpecialRoutePokemon(['Throh'], new ObtainedPokemonRequirement('Throh'))],
        }),
        [new ClearDungeonRequirement(1, getDungeonIndex('Giant Chasm')), new TemporaryBattleRequirement('Ghetsis 2'), new QuestLineCompletedRequirement('Hollow Truth and Ideals')],
    ),
);
Routes.add(
    new RegionRoute(
        ...
        [
            new OneFromManyRequirement([
                ...
                new MultiRequirement([new RouteKillRequirement(10, Region.unova, 9), new GymBadgeRequirement(BadgeEnums.Elite_UnovaChampion)]),
            ]),
        ],
        23.1,
    ),
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.unova, 14), new RouteKillRequirement(10, Region.unova, 16)]), new GymBadgeRequirement(BadgeEnums.Elite_UnovaChampion)],
        23.1,
    ),
);
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [new SpecialRoutePokemon(['Zebstrika'], new ObtainedPokemonRequirement('Zebstrika')), new SpecialRoutePokemon(['Blitzle'], new ObtainedPokemonRequirement('Blitzle'))],
        }),
...
Routes.add(
    new RegionRoute(
        ...
        [new GymBadgeRequirement(BadgeEnums.Cliff), new RouteKillRequirement(10, Region.kalos, 10), new QuestLineStepCompletedRequirement('A Beautiful World', 8)],
    ),
);
Routes.add(
    new RegionRoute(
...
Routes.add(
    new RegionRoute(
        ...
        [new ClearDungeonRequirement(1, getDungeonIndex('Seaward Cave')), new ClearDungeonRequirement(1, getDungeonIndex('Brooklet Hill'))],
        5.2,
        AlolaSubRegions.MelemeleIsland,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.alola, 10), new TemporaryBattleRequirement('Skull 4')],
        10.1,
        AlolaSubRegions.UlaulaIsland,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.alola, 11), new ClearDungeonRequirement(1, getDungeonIndex('Hokulani Observatory'))],
        undefined,
        AlolaSubRegions.UlaulaIsland,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [new SpecialRoutePokemon(['Wimpod'], new ObtainedPokemonRequirement('Wimpod')), new SpecialRoutePokemon(['Meltan'], new QuestLineStepCompletedRequirement("Let's Go, Meltan!", 9))],
        }),
...
Routes.add(
    new RegionRoute(
        ...
        [new RouteKillRequirement(10, Region.galar, 1), new TemporaryBattleRequirement('Mirages')],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Roselia'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Snow, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                new SpecialRoutePokemon(
                    ['Shiftry', 'Ludicolo', 'Oddish', 'Seedot', 'Lotad'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm]),
                ),
                new SpecialRoutePokemon(['Vileplume'], new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast])),
                new SpecialRoutePokemon(
                    ['Bunnelby'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Rain, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm]),
                ),
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                new SpecialRoutePokemon(
                    ['Krabby'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Blizzard, WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(
                    ['Wooper'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
                ...
                new SpecialRoutePokemon(
                    ['Purrloin'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Snow, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(
                    ['Tympole'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(
                    ['Frillish'],
                    new WeatherRequirement([
                ...
                new SpecialRoutePokemon(
                    ['Grapploct'],
                    new MultiRequirement([
                        new ObtainedPokemonRequirement('Grapploct'),
                        new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                    ]),
                ),
            ],
        }),
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Minccino'],
                    new WeatherRequirement([WeatherType.Overcast, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(
                    ['Pancham'],
                    new WeatherRequirement([WeatherType.Overcast, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm]),
                ),
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 8), new RouteKillRequirement(10, Region.galar, 9)])],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Stunky'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm]),
                ),
                ...
                new SpecialRoutePokemon(
                    ['Skuntank'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Stufful'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Harsh_Sunlight, WeatherType.Fog]),
                ),
                ...
                new SpecialRoutePokemon(
                    ['Wingull'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Snow, WeatherType.Harsh_Sunlight, WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(
                    ['Xatu'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ...
                new SpecialRoutePokemon(
                    ['Purrloin'],
                    new WeatherRequirement([WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Fog]),
                ),
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 6), new RouteKillRequirement(10, Region.galar, 7), new RouteKillRequirement(10, Region.galar, 8)])],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Haxorus'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(
                    ['Cramorant'],
                    new WeatherRequirement([
        ...
        [new MultiRequirement([new RouteKillRequirement(10, Region.galar, 6), new RouteKillRequirement(10, Region.galar, 25)])],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Drifloon'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight]),
                ),
                ...
                new SpecialRoutePokemon(
                    ['Gastly', 'Haunter'],
                    new WeatherRequirement([WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Blizzard, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 4), new RouteKillRequirement(10, Region.galar, 5), new RouteKillRequirement(10, Region.galar, 6)])],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new MultiRequirement([new RouteKillRequirement(10, Region.galar, 9), new GymBadgeRequirement(BadgeEnums.Galar_Fire)])],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Beheeyem'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(
                    ['Noivern'],
                    new WeatherRequirement([
                ...
                new SpecialRoutePokemon(
                    ['Toxel'],
                    new MultiRequirement([new ObtainedPokemonRequirement('Toxel'), new WeatherRequirement([WeatherType.Clear, WeatherType.Rain, WeatherType.Thunderstorm])]),
                ),
            ],
        }),
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                new SpecialRoutePokemon(
                    ['Woobat', 'Pumpkaboo (Average)', 'Pumpkaboo (Small)', 'Pumpkaboo (Large)', 'Pumpkaboo (Super Size)', 'Nickit', 'Budew', 'Bellossom'],
                    new WeatherRequirement([WeatherType.Clear]),
                ),
                new SpecialRoutePokemon(
                    ['Gloom'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Harsh_Sunlight, WeatherType.Fog]),
                ),
                ...
                new SpecialRoutePokemon(
                    ['Vileplume'],
                    new WeatherRequirement([WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Sandstorm]),
                ),
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 18), new ClearDungeonRequirement(1, getDungeonIndex('Dusty Bowl'))])],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Galarian Linoone'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Fog]),
                ),
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 18), new RouteKillRequirement(10, Region.galar, 21), new ClearDungeonRequirement(1, getDungeonIndex('Dusty Bowl'))])],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Seaking'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Thunderstorm, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(['Lapras'], new WeatherRequirement([WeatherType.Clear, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Fog])),
                ...
                new SpecialRoutePokemon(
                    ['Garbodor', 'Drapion', 'Galarian Weezing', 'Hitmontop', 'Skuntank', 'Grimmsnarl', 'Pangoro', 'Falinks', 'Espeon'],
                    new WeatherRequirement([WeatherType.Overcast]),
                ),
                ...
                new SpecialRoutePokemon(
                    ['Seismitoad', 'Araquanid', 'Golisopod', 'Cramorant (Gulping)', 'Quagsire', 'Barbaracle', 'Deino', 'Goomy', 'Vaporeon'],
                    new WeatherRequirement([WeatherType.Rain]),
                ),
                ...
                new SpecialRoutePokemon(
                    ['Ninetales', 'Arcanine', 'Durant', 'Heatmor', 'Lampent', 'Flygon', 'Coalossal', 'Sandaconda', 'Turtonator', 'Larvitar', 'Flareon', 'Chandelure'],
                ...
                new SpecialRoutePokemon(
                    ['Dreepy'],
                    new MultiRequirement([new ObtainedPokemonRequirement('Dreepy'), new WeatherRequirement([WeatherType.Overcast, WeatherType.Thunderstorm, WeatherType.Fog])]),
                ),
                new SpecialRoutePokemon(
                    ['Drakloak'],
                    new MultiRequirement([new ObtainedPokemonRequirement('Drakloak'), new WeatherRequirement([WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Fog])]),
                ),
                new SpecialRoutePokemon(['Grapploct'], new ObtainedPokemonRequirement('Grapploct')),
            ],
        }),
        [new MultiRequirement([new RouteKillRequirement(10, Region.galar, 20), new RouteKillRequirement(10, Region.galar, 25)])],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                new SpecialRoutePokemon(
                    ['Espurr'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(
                    ['Inkay'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Fog]),
                ),
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 19), new RouteKillRequirement(10, Region.galar, 20)])],
        undefined,
        GalarSubRegions.SouthGalar,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new MultiRequirement([new TemporaryBattleRequirement('Klara 1'), new TemporaryBattleRequirement('Avery 1')])],
        undefined,
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 34), new RouteKillRequirement(10, Region.galar, 36), new RouteKillRequirement(10, Region.galar, 38)])],
        undefined,
        GalarSubRegions.IsleofArmor,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Pelipper', 'Starmie'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Grapploct'],
                    new MultiRequirement([new ObtainedPokemonRequirement('Grapploct'), new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Harsh_Sunlight, WeatherType.Fog])]),
                ),
                new SpecialRoutePokemon(['Clobbopus'], new ObtainedPokemonRequirement('Clobbopus')),
            ],
            headbutt: ['Skwovet', 'Applin'],
        }),
        [new OneFromManyRequirement([new ClearDungeonRequirement(1, getDungeonIndex('Courageous Cavern')), new RouteKillRequirement(10, Region.galar, 42)])],
        undefined,
        GalarSubRegions.IsleofArmor,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Barraskewda'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Rhyperior'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 38), new ClearDungeonRequirement(1, getDungeonIndex("Brawlers' Cave"))])],
        undefined,
        GalarSubRegions.IsleofArmor,
    ),
);
...
Routes.add(
    new RegionRoute(
        ...
        [new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 42), new RouteKillRequirement(10, Region.galar, 44)])],
        undefined,
        GalarSubRegions.IsleofArmor,
    ),
);
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Piloswine', 'Smoochum', 'Snom', 'Swinub'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Fog]),
                ),
                ...
                new SpecialRoutePokemon(
                    ['Hatenna', 'Impidimp', 'Gothorita', 'Mimikyu', 'Duosion', 'Gothita', 'Solosis', 'Hattrem', 'Grimmsnarl', 'Gothitelle', 'Reuniclus'],
                    new WeatherRequirement([WeatherType.Fog]),
                ),
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Hattrem', 'Gothorita', 'Duosion', 'Mimikyu', 'Hatenna', 'Gothita', 'Solosis', 'Hatterene', 'Gothitelle', 'Reuniclus'],
                    new WeatherRequirement([WeatherType.Fog]),
                ),
                new SpecialRoutePokemon(
                    ['Amaura'],
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Hattrem', 'Morgrem', 'Clefairy', 'Mimikyu', 'Hatenna', 'Grimmsnarl', 'Hatterene', 'Clefable', 'Sylveon', 'Milotic'],
                    new WeatherRequirement([WeatherType.Fog]),
                ),
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                new SpecialRoutePokemon(
                    ['Audino', 'Karrablast', 'Nidoran(M)', 'Nidoran(F)', 'Sinistea'],
                    new WeatherRequirement([
                        WeatherType.Clear,
                        WeatherType.Overcast,
                        WeatherType.Rain,
                ...
                new SpecialRoutePokemon(
                    ['Dragapult'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Overcast, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Harsh_Sunlight]),
                ),
                new SpecialRoutePokemon(
                    ['Polteageist'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Bronzong', 'Bronzor', 'Cufant', 'Feebas', 'Stonjourner'],
                    new WeatherRequirement([
                        WeatherType.Clear,
                        WeatherType.Overcast,
                        WeatherType.Rain,
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Carracosta'],
                    new MultiRequirement([
                        new ObtainedPokemonRequirement('Carracosta'),
                        new WeatherRequirement([WeatherType.Clear, WeatherType.Rain, WeatherType.Thunderstorm, WeatherType.Harsh_Sunlight]),
                    ]),
                ),
            ],
        }),
...
Routes.add(
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                new SpecialRoutePokemon(
                    ['Audino', 'Avalugg', 'Claydol', 'Bergmite', 'Bronzor'],
                    new WeatherRequirement([
                        WeatherType.Clear,
                        WeatherType.Overcast,
                        WeatherType.Rain,
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Coalossal'],
                    new WeatherRequirement([WeatherType.Clear, WeatherType.Thunderstorm, WeatherType.Snow, WeatherType.Blizzard, WeatherType.Harsh_Sunlight, WeatherType.Sandstorm, WeatherType.Fog]),
                ),
        ...
        new RoutePokemon({
            ...
            special: [
                ...
                new SpecialRoutePokemon(
                    ['Aurorus'],
                    new MultiRequirement([
                        new ObtainedPokemonRequirement('Aurorus'),
                        new WeatherRequirement([
                            WeatherType.Clear,
                            WeatherType.Overcast,
                            WeatherType.Rain,
    ...
    new RegionRoute(
        ...
        new RoutePokemon({
            land: [
                ...
                'Bronzor',
                'Tinkatink',
                /*Fixed encounter only:*/ 'Talonflame',
                'Staraptor',
                'Gimmighoul (Chest)',
            ],
        }),
...
const santaJynxReq = new OneFromManyRequirement([
    new MultiRequirement([new ItemOwnedRequirement('Christmas_present', 11, AchievementOption.less), new TemporaryBattleRequirement('Santa Jynx 1')]),
    new MultiRequirement([new ItemOwnedRequirement('Christmas_present', 27, AchievementOption.less), new TemporaryBattleRequirement('Santa Jynx 2')]),
    new MultiRequirement([new ItemOwnedRequirement('Christmas_present', 49, AchievementOption.less), new TemporaryBattleRequirement('Santa Jynx 3')]),
    new MultiRequirement([new ItemOwnedRequirement('Christmas_present', 150, AchievementOption.less), new TemporaryBattleRequirement('Santa Jynx 4')]),
]);
Routes.getRoutesByRegion(Region.kanto).forEach((route) => {
    route.pokemon.special.push(
        new SpecialRoutePokemon(
            ...
            new MultiRequirement([
                ...
                new CustomRequirement(
                    ko.pureComputed(() => santaJynxReq.isCompleted()),
                    true,
