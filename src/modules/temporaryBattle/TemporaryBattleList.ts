...
import { AchievementOption, getDungeonIndex, getGymIndex, getTemporaryBattlesIndex, MegaStoneType, Region, ShadowStatus, SHINY_CHANCE_REWARD, Starter } from '../GameConstants';
...
export function initTemporaryBattleList() {
    //Kanto Temporary Battles
    TemporaryBattleList['Blue 1'] = new TemporaryBattle(
        'Blue 1',
        [
            new GymPokemon('Pidgey', 1040, 9),
            new GymPokemon('Charmander', 1678, 9, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Squirtle', 1678, 9, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Bulbasaur', 1678, 9, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Bulbasaur', 1678, 9, new StarterRequirement(Region.kanto, Starter.Special)),
        ],
        ...
        [
            ...
            new GymBadgeRequirement(BadgeEnums.Boulder, AchievementOption.less),
        ],
        undefined,
        {
    ...
    TemporaryBattleList['Blue 2'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Charmander', 3791, 18, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Squirtle', 3791, 18, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Bulbasaur', 3791, 18, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Bulbasaur', 3791, 18, new StarterRequirement(Region.kanto, Starter.Special)),
        ],
        'Hey! Take it easy! You won already!',
        [new RouteKillRequirement(10, Region.kanto, 4)],
        undefined,
        {
            displayName: 'Rival Blue',
    ...
    TemporaryBattleList['Blue 3'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Charmeleon', 13437, 20, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Wartortle', 13437, 20, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Ivysaur', 13437, 20, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Ivysaur', 13437, 20, new StarterRequirement(Region.kanto, Starter.Special)),
        ],
    ...
    TemporaryBattleList['Blue 4'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Exeggcute', 28878, 23, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Growlithe', 28878, 23, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Gyarados', 28878, 23, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Gyarados', 28878, 23, new StarterRequirement(Region.kanto, Starter.Special)),
            new GymPokemon('Gyarados', 28878, 22, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Exeggcute', 28878, 22, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Growlithe', 28878, 22, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Growlithe', 28878, 22, new StarterRequirement(Region.kanto, Starter.Special)),
            new GymPokemon('Kadabra', 30398, 20),
            new GymPokemon('Charmeleon', 33438, 25, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Wartortle', 33438, 25, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Ivysaur', 33438, 25, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Ivysaur', 33438, 25, new StarterRequirement(Region.kanto, Starter.Special)),
        ],
        'What? You stinker! I took it easy on you, too!',
        [new ClearDungeonRequirement(1, getDungeonIndex('Pokémon Tower'))],
        undefined,
        {
            displayName: 'Rival Blue',
            imageName: 'Blue2',
    ...
    TemporaryBattleList['Snorlax route 12'] = new TemporaryBattle(
        ...
        undefined,
        [
            new RouteKillRequirement(10, Region.kanto, 12),
        ...
        [new TemporaryBattleRequirement('Snorlax route 12'), new ObtainedPokemonRequirement('Snorlax')],
        {
            ...
            hideTrainer: true,
            visibleRequirement: new OneFromManyRequirement([new RouteKillRequirement(10, Region.kanto, 11), new RouteKillRequirement(5, Region.kanto, 12)]),
        },
    );
    TemporaryBattleList['Snorlax route 16'] = new TemporaryBattle(
        ...
        [new TemporaryBattleRequirement('Snorlax route 16'), new ObtainedPokemonRequirement('Snorlax')],
        {
            ...
            isTrainerBattle: false,
            hideTrainer: true,
            visibleRequirement: new RouteKillRequirement(10, Region.kanto, 7),
        },
    );
    TemporaryBattleList['Blue 5'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Exeggcute', 38447, 38, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Growlithe', 38447, 38, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Gyarados', 38447, 38, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Gyarados', 38447, 38, new StarterRequirement(Region.kanto, Starter.Special)),
            new GymPokemon('Gyarados', 38447, 35, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Exeggcute', 38447, 35, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Growlithe', 38447, 35, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Growlithe', 38447, 35, new StarterRequirement(Region.kanto, Starter.Special)),
            new GymPokemon('Alakazam', 41482, 35),
            new GymPokemon('Charizard', 44113, 40, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Blastoise', 44113, 40, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Venusaur', 44113, 40, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Venusaur', 44113, 40, new StarterRequirement(Region.kanto, Starter.Special)),
        ],
    ...
    TemporaryBattleList['Ash Ketchum New Island'] = new TemporaryBattle(
        ...
        [new ClearDungeonRequirement(10, getDungeonIndex('New Island'))],
        undefined,
        {
            displayName: 'Ash Ketchum',
            imageName: 'Ash Ketchum',
            firstTimeRewardFunction: () => {
                App.game.party.gainPokemonByName('Pikachu (Clone)', PokemonFactory.generateShiny(SHINY_CHANCE_REWARD));
            },
        },
    );
    ...
    TemporaryBattleList['Blue 6'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Exeggcute', 82269, 45, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Growlithe', 82269, 45, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Gyarados', 82269, 45, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Gyarados', 82269, 45, new StarterRequirement(Region.kanto, Starter.Special)),
            new GymPokemon('Gyarados', 82269, 45, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Exeggcute', 82269, 45, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Growlithe', 82269, 45, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Growlithe', 82269, 45, new StarterRequirement(Region.kanto, Starter.Special)),
            new GymPokemon('Alakazam', 84840, 47),
            new GymPokemon('Charizard', 92553, 53, new StarterRequirement(Region.kanto, Starter.Grass)),
            new GymPokemon('Blastoise', 92553, 53, new StarterRequirement(Region.kanto, Starter.Fire)),
            new GymPokemon('Venusaur', 92553, 53, new StarterRequirement(Region.kanto, Starter.Water)),
            new GymPokemon('Venusaur', 92553, 53, new StarterRequirement(Region.kanto, Starter.Special)),
        ],
    ...
    TemporaryBattleList['Santa Jynx 1'] = new TemporaryBattle(
        ...
        [
            ...
            new TemporaryBattleRequirement('Santa Jynx 2', 1, AchievementOption.less),
            new TemporaryBattleRequirement('Santa Jynx 3', 1, AchievementOption.less),
            new TemporaryBattleRequirement('Santa Jynx 4', 1, AchievementOption.less),
        ],
        undefined,
        {
    ...
    TemporaryBattleList['Santa Jynx 2'] = new TemporaryBattle(
        ...
        [
            ...
            new TemporaryBattleRequirement('Santa Jynx 1', 1, AchievementOption.less),
            new TemporaryBattleRequirement('Santa Jynx 3', 1, AchievementOption.less),
            new TemporaryBattleRequirement('Santa Jynx 4', 1, AchievementOption.less),
        ],
        undefined,
    ...
    TemporaryBattleList['Silver 1'] = new TemporaryBattle(
        'Silver 1',
        [
            new GymPokemon('Cyndaquil', 176000, 5, new StarterRequirement(Region.johto, Starter.Grass)),
            new GymPokemon('Totodile', 176000, 5, new StarterRequirement(Region.johto, Starter.Fire)),
            new GymPokemon('Chikorita', 176000, 5, new StarterRequirement(Region.johto, Starter.Water)),
        ],
        '...Humph! Are you happy you won?',
        [new RouteKillRequirement(10, Region.johto, 30)],
        undefined,
        {
    ...
    TemporaryBattleList['Silver 2'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Quilava', 237772, 18, new StarterRequirement(Region.johto, Starter.Grass)),
            new GymPokemon('Croconaw', 237772, 18, new StarterRequirement(Region.johto, Starter.Fire)),
            new GymPokemon('Bayleef', 237772, 18, new StarterRequirement(Region.johto, Starter.Water)),
        ],
    ...
    TemporaryBattleList.Sudowoodo = new TemporaryBattle(
        ...
        [new TemporaryBattleRequirement('Sudowoodo'), new ObtainedPokemonRequirement('Sudowoodo')],
        {
            ...
            hideTrainer: true,
            visibleRequirement: new RouteKillRequirement(10, Region.johto, 31),
        },
    );
    TemporaryBattleList['Silver 3'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Quilava', 251262, 22, new StarterRequirement(Region.johto, Starter.Grass)),
            new GymPokemon('Croconaw', 251262, 22, new StarterRequirement(Region.johto, Starter.Fire)),
            new GymPokemon('Bayleef', 251262, 22, new StarterRequirement(Region.johto, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Silver 4'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Quilava', 295109, 34, new StarterRequirement(Region.johto, Starter.Grass)),
            new GymPokemon('Feraligatr', 295109, 32, new StarterRequirement(Region.johto, Starter.Fire)),
            new GymPokemon('Meganium', 295109, 34, new StarterRequirement(Region.johto, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Silver 5'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Typhlosion', 397807, 40, new StarterRequirement(Region.johto, Starter.Grass)),
            new GymPokemon('Feraligatr', 397807, 40, new StarterRequirement(Region.johto, Starter.Fire)),
            new GymPokemon('Meganium', 397807, 40, new StarterRequirement(Region.johto, Starter.Water)),
        ],
        ...
        [new ClearDungeonRequirement(1, getDungeonIndex('Victory Road Johto'))],
        undefined,
        {
            displayName: 'Rival Silver',
    ...
    TemporaryBattleList['Suicune 1'] = new TemporaryBattle(
        ...
        [
            ...
            new RouteKillRequirement(10, Region.johto, 41),
        ],
        undefined,
        {
            displayName: 'Suicune',
    ...
    TemporaryBattleList['Red Gyarados'] = new TemporaryBattle(
        ...
        [
            ...
            new RouteKillRequirement(10, Region.johto, 43),
        ],
        undefined,
        {
    ...
    TemporaryBattleList['Silver 6'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Typhlosion', 581846, 50, new StarterRequirement(Region.johto, Starter.Grass)),
            new GymPokemon('Feraligatr', 581846, 50, new StarterRequirement(Region.johto, Starter.Fire)),
            new GymPokemon('Meganium', 581846, 50, new StarterRequirement(Region.johto, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Silver 7'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Typhlosion', 705124, 60, new StarterRequirement(Region.johto, Starter.Grass)),
            new GymPokemon('Feraligatr', 705124, 60, new StarterRequirement(Region.johto, Starter.Fire)),
            new GymPokemon('Meganium', 705124, 60, new StarterRequirement(Region.johto, Starter.Water)),
        ],
    ...
    TemporaryBattleList.Red = new TemporaryBattle(
        ...
        '...',
        [new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion), new ClearDungeonRequirement(1, getDungeonIndex('Mt. Silver'))],
        undefined,
        {
            rewardFunction: () => {
...
$playername$ got <img src="./assets/images/currency/money.svg" height="24px"/> ${reward.toLocaleString('en-US')} for winning!`),
    ...
    TemporaryBattleList['May 1'] = new TemporaryBattle(
        'May 1',
        [
            new GymPokemon('Torchic', 823400, 5, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Mudkip', 823400, 5, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Treecko', 823400, 5, new StarterRequirement(Region.hoenn, Starter.Water)),
        ],
        'Wow! That\'s great! You\'re pretty good!',
        [new RouteKillRequirement(10, Region.hoenn, 103)],
        undefined,
        {
    ...
    TemporaryBattleList['May 2'] = new TemporaryBattle(
        'May 2',
        [
            new GymPokemon('Lotad', 1124608, 13, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Torkoal', 1124608, 13, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Wingull', 1124608, 13, new StarterRequirement(Region.hoenn, Starter.Water)),
            new GymPokemon('Torchic', 1197952, 15, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Mudkip', 1197952, 15, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Treecko', 1197952, 15, new StarterRequirement(Region.hoenn, Starter.Water)),
        ],
        'Yikes! You\'re better than I expected!',
        [new ClearDungeonRequirement(1, getDungeonIndex('Rusturf Tunnel'))],
        undefined,
        {
            displayName: 'Pokémon Trainer May',
    ...
    TemporaryBattleList['May 3'] = new TemporaryBattle(
        'May 3',
        [
            new GymPokemon('Wingull', 1119525, 18, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Lombre', 1119525, 18, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Wingull', 1119525, 18, new StarterRequirement(Region.hoenn, Starter.Water)),
            new GymPokemon('Lombre', 1119525, 18, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Slugma', 1119525, 18, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Slugma', 1119525, 18, new StarterRequirement(Region.hoenn, Starter.Water)),
            new GymPokemon('Combusken', 1153450, 20, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Marshtomp', 1153450, 20, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Grovyle', 1153450, 20, new StarterRequirement(Region.hoenn, Starter.Water)),
        ],
        'Yikes! You\'re better than I expected!',
        [new RouteKillRequirement(10, Region.hoenn, 110)],
        undefined,
        {
            displayName: 'Pokémon Trainer May',
    ...
    TemporaryBattleList['May 4'] = new TemporaryBattle(
        'May 4',
        [
            new GymPokemon('Pelipper', 1832160, 29, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Lombre', 1832160, 29, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Slugma', 1832160, 29, new StarterRequirement(Region.hoenn, Starter.Water)),
            new GymPokemon('Lombre', 1832160, 29, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Slugma', 1832160, 29, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Lombre', 1832160, 29, new StarterRequirement(Region.hoenn, Starter.Water)),
            new GymPokemon('Combusken', 1887680, 31, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Marshtomp', 1887680, 31, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Grovyle', 1887680, 31, new StarterRequirement(Region.hoenn, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Kecleon 1'] = new TemporaryBattle(
        ...
        [new TemporaryBattleRequirement('Kecleon 1'), new ObtainedPokemonRequirement('Kecleon')],
        {
            ...
            hideTrainer: true,
            visibleRequirement: new RouteKillRequirement(10, Region.hoenn, 119),
        },
    );
    ...
    TemporaryBattleList['May 5'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Pelipper', 2013125, 32, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Ludicolo', 2013125, 32, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Slugma', 2013125, 32, new StarterRequirement(Region.hoenn, Starter.Water)),
            new GymPokemon('Ludicolo', 2013125, 32, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Slugma', 2013125, 32, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Pelipper', 2013125, 32, new StarterRequirement(Region.hoenn, Starter.Water)),
            new GymPokemon('Combusken', 2133912, 34, new StarterRequirement(Region.hoenn, Starter.Grass)),
            new GymPokemon('Marshtomp', 2133912, 34, new StarterRequirement(Region.hoenn, Starter.Fire)),
            new GymPokemon('Grovyle', 2133912, 34, new StarterRequirement(Region.hoenn, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Wally 2'] = new TemporaryBattle(
        ...
        [new ClearDungeonRequirement(1, getDungeonIndex('Victory Road Hoenn'))],
        [new NullRequirement],
        {
            displayName: 'Pokémon Trainer Wally',
            imageName: 'Wally',
    ...
    TemporaryBattleList.Latias = new TemporaryBattle(
        ...
        [new MultiRequirement([new QuestLineStepCompletedRequirement('The Eon Duo', 3), new CustomRequirement(ko.pureComputed(() => App.game.statistics.temporaryBattleDefeated[getTemporaryBattlesIndex('Latios')]()), 1, undefined, AchievementOption.less)])],
        undefined,
        {
            displayName: 'Latias',
            firstTimeRewardFunction: () => {
                App.game.party.gainPokemonByName('Latias', PokemonFactory.generateShiny(SHINY_CHANCE_REWARD));
            },
    ...
    TemporaryBattleList.Latios = new TemporaryBattle(
        ...
        [new MultiRequirement([new QuestLineStepCompletedRequirement('The Eon Duo', 3), new CustomRequirement(ko.pureComputed(() => App.game.statistics.temporaryBattleDefeated[getTemporaryBattlesIndex('Latias')]()), 1, undefined, AchievementOption.less)])],
        undefined,
        {
            displayName: 'Latios',
            firstTimeRewardFunction: () => {
                App.game.party.gainPokemonByName('Latios', PokemonFactory.generateShiny(SHINY_CHANCE_REWARD));
            },
            returnTown: 'Southern Island',
    ...
    TemporaryBattleList['Cipher Peon Naps'] = new TemporaryBattle(
        'Cipher Peon Naps',
        [new GymPokemon('Teddiursa', 110813753, 11, undefined, undefined, ShadowStatus.Shadow)], // Slightly weaker than Calem 1
    ...
    TemporaryBattleList['Miror B. 1'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Lombre', 34444125, 17),
            new GymPokemon('Lombre', 34444125, 17),
            new GymPokemon('Voltorb', 34444125, 19, undefined, undefined, ShadowStatus.Shadow),
        ],
    ...
    TemporaryBattleList.Zook = new TemporaryBattle(
        'Zook',
        [
            new GymPokemon('Zangoose', 35797654, 28, undefined, undefined, ShadowStatus.Shadow),
    ...
    TemporaryBattleList['Miror B. 2'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Lombre', 38797654, 26),
            new GymPokemon('Lombre', 38797654, 26),
            new GymPokemon('Nosepass', 38797654, 25, undefined, undefined, ShadowStatus.Shadow),
    ...
    TemporaryBattleList['Barry 1'] = new TemporaryBattle(
        'Barry 1',
        [
            new GymPokemon('Chimchar', 1689240, 5, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Piplup', 1689240, 5, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Turtwig', 1689240, 5, new StarterRequirement(Region.sinnoh, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Barry 2'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Chimchar', 3074416, 9, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Piplup', 3074416, 9, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Turtwig', 3074416, 9, new StarterRequirement(Region.sinnoh, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Barry 3'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Buizel', 2195053, 23, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Ponyta', 2195053, 23, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Buizel', 2195053, 23, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Roselia', 2195053, 23, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Roselia', 2195053, 23, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Ponyta', 2195053, 23, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Monferno', 2329444, 27, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Prinplup', 2329444, 27, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Grotle', 2329444, 27, new StarterRequirement(Region.sinnoh, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Barry 4'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Buizel', 2440886, 32, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Ponyta', 2440886, 32, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Buizel', 2440886, 32, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Roselia', 2440886, 32, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Roselia', 2440886, 32, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Ponyta', 2440886, 32, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Monferno', 2590328, 36, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Prinplup', 2590328, 36, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Grotle', 2590328, 36, new StarterRequirement(Region.sinnoh, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Barry 5'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Floatzel', 2051478, 35, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Rapidash', 2051478, 35, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Floatzel', 2051478, 35, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Roserade', 2051478, 35, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Roserade', 2051478, 35, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Rapidash', 2051478, 35, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Infernape', 2209284, 38, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Empoleon', 2209284, 38, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Torterra', 2209284, 38, new StarterRequirement(Region.sinnoh, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Barry 6'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Floatzel', 3740930, 47, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Rapidash', 3740930, 47, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Rapidash', 3740930, 47, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Snorlax', 3857834, 49, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Snorlax', 3857834, 49, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Floatzel', 3740930, 47, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Heracross', 3857834, 48),
            new GymPokemon('Roserade', 3740930, 47, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Roserade', 3740930, 47, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Snorlax', 3857834, 49, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Infernape', 4161784, 51, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Empoleon', 4161784, 51, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Torterra', 4161784, 51, new StarterRequirement(Region.sinnoh, Starter.Water)),
        ],
        ...
        [new ClearDungeonRequirement(1, getDungeonIndex('Victory Road Sinnoh'))],
        undefined,
        {
            displayName: 'Pokémon Trainer Barry',
    ...
    TemporaryBattleList['Barry 7'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Floatzel', 9212128, 79, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Roserade', 9212128, 79, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Rapidash', 9212128, 79, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Roserade', 9212128, 79, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Rapidash', 9212128, 79, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Floatzel', 9212128, 79, new StarterRequirement(Region.sinnoh, Starter.Water)),
            new GymPokemon('Heracross', 9498219, 81),
            new GymPokemon('Snorlax', 9498219, 83),
            new GymPokemon('Infernape', 10184837, 85, new StarterRequirement(Region.sinnoh, Starter.Grass)),
            new GymPokemon('Empoleon', 10184837, 85, new StarterRequirement(Region.sinnoh, Starter.Fire)),
            new GymPokemon('Torterra', 10184837, 85, new StarterRequirement(Region.sinnoh, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Manaphy Egg Protectors'] = new TemporaryBattle(
        ...
        undefined,
        {
            ...
            firstTimeRewardFunction: () => {
                App.game.party.gainPokemonByName('Manaphy', PokemonFactory.generateShiny(SHINY_CHANCE_REWARD));
            },
        },
    );
    ...
    TemporaryBattleList['Hugh 1'] = new TemporaryBattle(
        'Hugh 1',
        [
            new GymPokemon('Tepig', 7269010, 5, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Oshawott', 7269010, 5, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Snivy', 7269010, 5, new StarterRequirement(Region.unova, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Hugh 2'] = new TemporaryBattle(
        'Hugh 2',
        [
            new GymPokemon('Tepig', 11630416, 8, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Oshawott', 11630416, 8, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Snivy', 11630416, 8, new StarterRequirement(Region.unova, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Hugh 3'] = new TemporaryBattle(
        'Hugh 3',
        [
            new GymPokemon('Pignite', 13864044, 25, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Dewott', 13864044, 25, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Servine', 13864044, 25, new StarterRequirement(Region.unova, Starter.Water)),
            new GymPokemon('Simipour', 13456278, 25, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Simisage', 13456278, 25, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Tranquill', 13456278, 25),
            new GymPokemon('Simisear', 13456278, 25, new StarterRequirement(Region.unova, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Hugh 4'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Simipour', 16756278, 39, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Simisage', 16756278, 39, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Simisear', 16756278, 39, new StarterRequirement(Region.unova, Starter.Water)),
            new GymPokemon('Emboar', 17264044, 41, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Samurott', 17264044, 41, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Serperior', 17264044, 41, new StarterRequirement(Region.unova, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Hugh 5'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Simipour', 23086313, 55, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Simisage', 23086313, 55, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Simisear', 23086313, 55, new StarterRequirement(Region.unova, Starter.Water)),
            new GymPokemon('Bouffalant', 23557462, 55),
            new GymPokemon('Emboar', 24217071, 57, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Samurott', 24217071, 57, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Serperior', 24217071, 57, new StarterRequirement(Region.unova, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Hugh 6'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Simipour', 30507789, 62, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Simisage', 30507789, 62, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Simisear', 30507789, 62, new StarterRequirement(Region.unova, Starter.Water)),
            new GymPokemon('Bouffalant', 31270484, 62),
            new GymPokemon('Flygon', 30507789, 62),
            new GymPokemon('Eelektross', 30507789, 62),
            new GymPokemon('Emboar', 32605200, 64, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Samurott', 32605200, 64, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Serperior', 32605200, 64, new StarterRequirement(Region.unova, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Hugh 7'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Simipour', 34936339, 65, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Simisage', 34936339, 65, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Simisear', 34936339, 65, new StarterRequirement(Region.unova, Starter.Water)),
            new GymPokemon('Bouffalant', 35809748, 65),
            new GymPokemon('Flygon', 34936339, 65),
            new GymPokemon('Eelektross', 34936339, 65),
            new GymPokemon('Emboar', 37338212, 67, new StarterRequirement(Region.unova, Starter.Grass)),
            new GymPokemon('Samurott', 37338212, 67, new StarterRequirement(Region.unova, Starter.Fire)),
            new GymPokemon('Serperior', 37338212, 67, new StarterRequirement(Region.unova, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Dream Researcher'] = new TemporaryBattle(
        ...
        [new ObtainedPokemonRequirement('Landorus (Therian)'), new ObtainedPokemonRequirement('Audino'), new MaxRegionRequirement(Region.kalos)],
        undefined,
        {
    ...
    TemporaryBattleList['Shauna 1'] = new TemporaryBattle(
        'Shauna 1',
        [
            new GymPokemon('Froakie', 24906504, 5, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Chespin', 24906504, 5, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Fennekin', 24906504, 5, new StarterRequirement(Region.kalos, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Sycamore 1'] = new TemporaryBattle(
        ...
        [new RouteKillRequirement(10, Region.kalos, 4)],
        undefined,
        {
            firstTimeRewardFunction: () => {
    ...
    TemporaryBattleList['Tierno 1'] = new TemporaryBattle(
        ...
        [new RouteKillRequirement(10, Region.kalos, 5)],
        undefined,
        {
    ...
    TemporaryBattleList['Trevor & Tierno'] = new TemporaryBattle(
        ...
        [new RouteKillRequirement(10, Region.kalos, 7)],
        undefined,
        {
    ...
    TemporaryBattleList['Calem 1'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Braixen', 41888812, 30, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Frogadier', 41888812, 30, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Quilladin', 41888812, 30, new StarterRequirement(Region.kalos, Starter.Water)),
        ],
        'Your bonds with your Pokémon are really strong. Although, I don\'t like losing much...',
        [new ClearDungeonRequirement(1, getDungeonIndex('Reflection Cave'))],
        undefined,
        {
    ...
    TemporaryBattleList['Hoopa 6'] = new TemporaryBattle(
        ...
        undefined,
        {
            ...
            firstTimeRewardFunction: () => {
                App.game.party.gainPokemonByName('Hoopa (Unbound)', PokemonFactory.generateShiny(SHINY_CHANCE_REWARD));
            },
        },
    );
    TemporaryBattleList['Calem 2'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Braixen', 54231360, 33, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Frogadier', 54231360, 33, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Quilladin', 54231360, 33, new StarterRequirement(Region.kalos, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Calem 3'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Delphox', 67476604, 37, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Greninja', 67476604, 37, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Chesnaught', 67476604, 37, new StarterRequirement(Region.kalos, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Calem 4'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Jolteon', 61391150, 44, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Flareon', 61391150, 44, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Vaporeon', 61391150, 44, new StarterRequirement(Region.kalos, Starter.Water)),
            new GymPokemon('Delphox', 63846796, 46, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Greninja', 63846796, 46, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Chesnaught', 63846796, 46, new StarterRequirement(Region.kalos, Starter.Water)),
        ],
        'Why am I still playing catch-up to you?!',
        [new RouteKillRequirement(10, Region.kalos, 17)],
        undefined,
        {
            displayName: 'Pokémon Trainer Calem',
            returnTown: 'Anistar City',
    ...
    TemporaryBattleList['Shauna 2'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Greninja', 94497751, 51, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Chesnaught', 94497751, 51, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Delphox', 94497751, 51, new StarterRequirement(Region.kalos, Starter.Water)),
        ],
        'Battles with friends are really, really exciting!',
        [new RouteKillRequirement(10, Region.kalos, 19)],
        undefined,
        {
            displayName: 'Pokémon Trainer Shauna',
    ...
    TemporaryBattleList['Calem 5'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Jolteon', 67294391, 57, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Flareon', 67294391, 57, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Vaporeon', 67294391, 57, new StarterRequirement(Region.kalos, Starter.Water)),
            new GymPokemon('Altaria', 67294391, 58),
            new GymPokemon('Absol', 71149798, 59),
            new GymPokemon('Delphox', 76407173, 61, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Greninja', 76407173, 61, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Chesnaught', 76407173, 61, new StarterRequirement(Region.kalos, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Ash Ketchum Johto'] = new TemporaryBattle(
        ...
        [new TemporaryBattleRequirement('Ash Ketchum Kanto'), new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion), new RouteKillRequirement(10, Region.johto, 48)],
        undefined,
        {
            displayName: 'Ash Ketchum',
            returnTown: 'Cianwood City',
    ...
    TemporaryBattleList['Ash Ketchum Sinnoh'] = new TemporaryBattle(
        ...
        [new TemporaryBattleRequirement('Ash Ketchum Hoenn'), new GymBadgeRequirement(BadgeEnums.Elite_SinnohChampion), new RouteKillRequirement(10, Region.sinnoh, 226)],
        undefined,
        {
            displayName: 'Ash Ketchum',
    ...
    TemporaryBattleList['Ash Ketchum Pinkan'] = new TemporaryBattle(
        ...
        [new TemporaryBattleRequirement('Ash Ketchum Hoenn'), new ClearDungeonRequirement(1, getDungeonIndex('Pinkan Mountain'))],
        undefined,
        {
            displayName: 'Ash Ketchum',
    ...
    TemporaryBattleList['Calem 6'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Jolteon', 99137044, 66, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Flareon', 99137044, 66, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Vaporeon', 99137044, 66, new StarterRequirement(Region.kalos, Starter.Water)),
            new GymPokemon('Altaria', 94468205, 67),
            new GymPokemon('Delphox', 105685546, 70, new StarterRequirement(Region.kalos, Starter.Grass)),
            new GymPokemon('Greninja', 105685546, 70, new StarterRequirement(Region.kalos, Starter.Fire)),
            new GymPokemon('Chesnaught', 105685546, 70, new StarterRequirement(Region.kalos, Starter.Water)),
    ...
    TemporaryBattleList['Marquis Grant'] = new TemporaryBattle(
        ...
        [new GymBadgeRequirement(BadgeEnums.Elite_KalosChampion), new ClearGymRequirement(2000, getGymIndex('Cyllage City')), new ObtainedPokemonRequirement('Tyranitar')],
        undefined,
        {
    ...
    TemporaryBattleList['Unrivaled Red'] = new TemporaryBattle(
        ...
        '... ... ...!',
        [new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 0, AchievementOption.less), new QuestLineStartedRequirement('An Unrivaled Power')])],
        undefined,
        {
    ...
    TemporaryBattleList['Hau 1'] = new TemporaryBattle(
        'Hau 1',
        [
            new GymPokemon('Popplio', 71131094, 5, new StarterRequirement(Region.alola, Starter.Grass)),
            new GymPokemon('Rowlet', 71131094, 5, new StarterRequirement(Region.alola, Starter.Fire)),
            new GymPokemon('Litten', 71131094, 5, new StarterRequirement(Region.alola, Starter.Water)),
        ],
        ...
        [new RouteKillRequirement(10, Region.alola, 1)],
        undefined,
        {
            firstTimeRewardFunction: () => {
    ...
    TemporaryBattleList['Hau 2'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Popplio', 81763320, 7, new StarterRequirement(Region.alola, Starter.Grass)),
            new GymPokemon('Rowlet', 81763320, 7, new StarterRequirement(Region.alola, Starter.Fire)),
            new GymPokemon('Litten', 81763320, 7, new StarterRequirement(Region.alola, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Skull 2'] = new TemporaryBattle(
        ...
        [new MultiRequirement([new TemporaryBattleRequirement('Ilima'), new RouteKillRequirement(10, Region.alola, 2)])],
        undefined,
        {
            displayName: 'Team Skull Grunts A and B',
            returnTown: 'Hau\'oli City',
    ...
    TemporaryBattleList['Hau 3'] = new TemporaryBattle(
        'Hau 3',
        [
            new GymPokemon('Popplio', 111444000, 13, new StarterRequirement(Region.alola, Starter.Grass)),
            new GymPokemon('Rowlet', 111444000, 13, new StarterRequirement(Region.alola, Starter.Fire)),
            new GymPokemon('Litten', 111444000, 13, new StarterRequirement(Region.alola, Starter.Water)),
    ...
    TemporaryBattleList.Dexio = new TemporaryBattle(
        ...
        // Starts Akala story quest if both Sina and Dexio are defeated.
            firstTimeRewardFunction: () => {
                if (App.game.statistics.temporaryBattleDefeated[getTemporaryBattlesIndex('Sina')]() >= 1) {
    ...
    TemporaryBattleList.Sina = new TemporaryBattle(
        ...
        // Starts Akala story quest if both Sina and Dexio are defeated.
            firstTimeRewardFunction: () => {
                if (App.game.statistics.temporaryBattleDefeated[getTemporaryBattlesIndex('Dexio')]() >= 1) {
                    App.game.quests.getQuestLine('Symbiotic Relations').beginQuest(0, undefined, true);
                // TODO: zygarde quest thing
                }
            },
    ...
    TemporaryBattleList['Hau 4'] = new TemporaryBattle(
        'Hau 4',
        [
            new GymPokemon('Brionne', 99628133, 16, new StarterRequirement(Region.alola, Starter.Grass)),
            new GymPokemon('Dartrix', 99628133, 16, new StarterRequirement(Region.alola, Starter.Fire)),
            new GymPokemon('Torracat', 99628133, 16, new StarterRequirement(Region.alola, Starter.Water)),
    ...
    TemporaryBattleList['Skull 3'] = new TemporaryBattle(
        ...
        undefined, // custom quest message
        [
            new RouteKillRequirement(10, Region.alola, 6),
    ...
    TemporaryBattleList['Battle Royal'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Brionne', 143802105, 20, new StarterRequirement(Region.alola, Starter.Grass)),
            new GymPokemon('Dartrix', 143802105, 20, new StarterRequirement(Region.alola, Starter.Fire)),
            new GymPokemon('Torracat', 143802105, 20, new StarterRequirement(Region.alola, Starter.Water)),
        ],
        'The battle is over!',
        [new RouteKillRequirement(10, Region.alola, 6)],
        undefined,
    ...
    TemporaryBattleList['Plumeria 1'] = new TemporaryBattle(
        ...
        [new RouteKillRequirement(10, Region.alola, 21)],
        undefined,
        {
    ...
    TemporaryBattleList['Hau 5'] = new TemporaryBattle(
        'Hau 5',
        [
            new GymPokemon('Brionne', 101997102, 30, new StarterRequirement(Region.alola, Starter.Grass)),
            new GymPokemon('Dartrix', 101997102, 30, new StarterRequirement(Region.alola, Starter.Fire)),
            new GymPokemon('Torracat', 101997102, 30, new StarterRequirement(Region.alola, Starter.Water)),
            new GymPokemon('Flareon', 92508999, 28, new StarterRequirement(Region.alola, Starter.Grass)),
            new GymPokemon('Vaporeon', 92508999, 28, new StarterRequirement(Region.alola, Starter.Fire)),
            new GymPokemon('Leafeon', 92508999, 28, new StarterRequirement(Region.alola, Starter.Water)),
    ...
    TemporaryBattleList['Exeggutor Tree'] = new TemporaryBattle(
        ...
        [new QuestLineStepCompletedRequirement('Emissary of Light', 2, AchievementOption.less)],
        undefined,
        {
            displayName: 'A Tree?',
            isTrainerBattle: false,
    ...
    TemporaryBattleList['Gladion 3'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Silvally (Fire)', 213569655, 55, new StarterRequirement(Region.alola, Starter.Grass)),
            new GymPokemon('Silvally (Water)', 213569655, 55, new StarterRequirement(Region.alola, Starter.Fire)),
            new GymPokemon('Silvally (Grass)', 213569655, 55, new StarterRequirement(Region.alola, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Rainbow Rocket Grunt 1'] = new TemporaryBattle(
        ...
        [
            ...
            new QuestLineStepCompletedRequirement('Defeat Rainbow Rocket', 0, AchievementOption.less ),
        ],
        undefined,
        {
    ...
    TemporaryBattleList['Magikarp Jump Koylee'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White)', 1701000, 20)],
        'Your scales are full of heart!',
        [new RouteKillRequirement(10, Region.alola, 32)],
        undefined,
        {
            displayName: 'Koylee',
    ...
    TemporaryBattleList['Magikarp Jump Karpella'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White, Black)', 4252500, 20)],
        'Wow, you\'re the cream of the \'karp, alright!',
        [new RouteKillRequirement(10, Region.alola, 33)],
        undefined,
        {
    ...
    TemporaryBattleList['Magikarp Jump Karpen'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (White, Orange)', 4488750, 20)],
        ...
        undefined,
        {
            displayName: 'Karpen',
            imageName: 'Jump Champ Green',
            visibleRequirement: new RouteKillRequirement(10, Region.alola, 33),
            firstTimeRewardFunction: () => {
                Notifier.notify({
                    message: 'You were awarded a Magikarp Biscuit!',
                    type: NotificationConstants.NotificationOption.success,
    ...
    TemporaryBattleList['Magikarp Jump Tykarp'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White)', 6804000, 20)],
        'I lost because of my karpal tunnel...',
        [new RouteKillRequirement(10, Region.alola, 34)],
        undefined,
        {
            displayName: 'Tykarp',
    ...
    TemporaryBattleList['Magikarp Jump Karpress'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White, Black)', 7182000, 20)],
        ...
        undefined,
        {
            ...
            imageName: 'Jump Champ Red',
            visibleRequirement: new RouteKillRequirement(10, Region.alola, 34),
            firstTimeRewardFunction: () => {
                Notifier.notify({
                    message: 'You were awarded a Magikarp Biscuit!',
                    type: NotificationConstants.NotificationOption.success,
    ...
    TemporaryBattleList['Magikarp Jump Karami'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White)', 12757500, 20)],
        'Well, it\'s oh-fish-ial! You win!',
        [new RouteKillRequirement(10, Region.alola, 35)],
        undefined,
        {
            displayName: 'Karami',
            imageName: 'Jump Champ Green',
    ...
    TemporaryBattleList['Magikarp Jump Karson'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Skelly', 13466250, 20)],
        ...
        undefined,
        {
            displayName: 'Karson',
            imageName: 'Jump Champ Blue',
            visibleRequirement: new RouteKillRequirement(10, Region.alola, 35),
            firstTimeRewardFunction: () => {
                Notifier.notify({
                    message: 'You were awarded a Magikarp Biscuit!',
                    type: NotificationConstants.NotificationOption.success,
    ...
    TemporaryBattleList['Magikarp Jump Karpress 2'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White)', 17010000, 20)],
        'I\'m fin-ished...',
        [new RouteKillRequirement(10, Region.alola, 36)],
        undefined,
        {
            displayName: 'Karpress',
            imageName: 'Jump Champ Red',
    ...
    TemporaryBattleList['Magikarp Jump Karpen 2'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (White, Orange)', 17955000, 20)],
        ...
        undefined,
        {
            displayName: 'Karpen',
            imageName: 'Jump Champ Green',
            visibleRequirement: new RouteKillRequirement(10, Region.alola, 36),
            firstTimeRewardFunction: () => {
                Notifier.notify({
                    message: 'You were awarded a Magikarp Biscuit!',
                    type: NotificationConstants.NotificationOption.success,
    ...
    TemporaryBattleList['Magikarp Jump Karbuck'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, Gold)', 18333000, 20)],
    ...
    TemporaryBattleList['Magikarp Jump Skyhopper'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White)', 25515000, 20)],
        'I will jump away from this battle!',
        [new RouteKillRequirement(10, Region.alola, 37)],
        undefined,
        {
    ...
    TemporaryBattleList['Magikarp Jump Karpen 3'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Skelly', 26932500, 20)],
        ...
        undefined,
        {
            displayName: 'Karpen',
            imageName: 'Jump Champ Blue',
            visibleRequirement: new RouteKillRequirement(10, Region.alola, 37),
            firstTimeRewardFunction: () => {
                Notifier.notify({
                    message: 'You were awarded a Magikarp Biscuit!',
                    type: NotificationConstants.NotificationOption.success,
    ...
    TemporaryBattleList['Magikarp Jump Karpella 2'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White, Black)', 27499500, 20)],
        'I hate fish puns...',
    ...
    TemporaryBattleList['Magikarp Jump Karbuck 2'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White)', 34020000, 20)],
        'I wish a Pidgeotto would steal me away about now...',
        [new RouteKillRequirement(10, Region.alola, 38)],
        undefined,
        {
            displayName: 'Karbuck',
            imageName: 'Jump Champ Red',
    ...
    TemporaryBattleList['Magikarp Jump Kareign'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (White, Orange)', 35910000, 20)],
        ...
        undefined,
        {
            displayName: 'Kareign',
            imageName: 'Jump Champ Blue',
            visibleRequirement: new RouteKillRequirement(10, Region.alola, 38),
            firstTimeRewardFunction: () => {
                Notifier.notify({
                    message: 'You were awarded a Magikarp Biscuit!',
                    type: NotificationConstants.NotificationOption.success,
    ...
    TemporaryBattleList['Magikarp Jump Koylee 2'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, White, Black)', 36666000, 20)],
    ...
    TemporaryBattleList['Magikarp Jump Karpress 3'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Grey Diamonds', 51030000, 20)],
        'You cheater! I have seen Rowlet giving you money!!!',
        [new RouteKillRequirement(10, Region.alola, 39)],
        undefined,
        {
            displayName: 'Karpress',
            imageName: 'Jump Champ Blue',
    ...
    TemporaryBattleList['Magikarp Jump Karpen 4'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Brown Tiger', 53865000, 20)],
        ...
        undefined,
        {
            displayName: 'Karpen',
            imageName: 'Jump Champ Red',
            visibleRequirement: new RouteKillRequirement(10, Region.alola, 39),
            firstTimeRewardFunction: () => {
                Notifier.notify({
                    message: 'You were awarded a Magikarp Biscuit!',
                    type: NotificationConstants.NotificationOption.success,
    ...
    TemporaryBattleList['Magikarp Jump Karpella 3'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Purple Patches', 54999000, 20)],
    ...
    TemporaryBattleList['Magikarp Jump Skyhopper 2'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Calico (Orange, Gold)', 68040000, 20)],
        'Who wants to place a bait on a rematch?',
        [new RouteKillRequirement(10, Region.alola, 40)],
        undefined,
        {
            displayName: 'Skyhopper',
            imageName: 'Jump Champ Blue',
    ...
    TemporaryBattleList['Magikarp Jump Tykarp 2'] = new TemporaryBattle(
        ...
        [new GymPokemon('Magikarp Black Mask', 71820000, 20)],
        ...
        undefined,
        {
            displayName: 'Tykarp',
            imageName: 'Jump Champ Red',
            visibleRequirement: new RouteKillRequirement(10, Region.alola, 40),
            firstTimeRewardFunction: () => {
                Notifier.notify({
                    message: 'You were awarded a Magikarp Biscuit!',
                    type: NotificationConstants.NotificationOption.success,
    ...
    TemporaryBattleList['Hop 1'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Sobble', 142807378, 5, new StarterRequirement(Region.galar, Starter.Grass)),
            new GymPokemon('Grookey', 142807378, 5, new StarterRequirement(Region.galar, Starter.Fire)),
            new GymPokemon('Scorbunny', 142807378, 5, new StarterRequirement(Region.galar, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Hop 2'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Sobble', 124574239, 8, new StarterRequirement(Region.galar, Starter.Grass)),
            new GymPokemon('Grookey', 124574239, 8, new StarterRequirement(Region.galar, Starter.Fire)),
            new GymPokemon('Scorbunny', 124574239, 8, new StarterRequirement(Region.galar, Starter.Water)),
        ],
        'And I even got my Pokéball throw perfect too!',
        [new RouteKillRequirement(10, Region.galar, 2)],
        undefined,
        {
            displayName: 'Pokémon Trainer Hop',
    ...
    TemporaryBattleList['Hop 3'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Sobble', 143273544, 14, new StarterRequirement(Region.galar, Starter.Grass)),
            new GymPokemon('Grookey', 143273544, 14, new StarterRequirement(Region.galar, Starter.Fire)),
            new GymPokemon('Scorbunny', 143273544, 14, new StarterRequirement(Region.galar, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Bede 1'] = new TemporaryBattle(
        ...
        [new ClearDungeonRequirement(1, getDungeonIndex('Galar Mine'))],
        undefined,
        {
    ...
    TemporaryBattleList['Hop 4'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Drizzile', 203410376, 21, new StarterRequirement(Region.galar, Starter.Grass)),
            new GymPokemon('Thwackey', 203410376, 21, new StarterRequirement(Region.galar, Starter.Fire)),
            new GymPokemon('Raboot', 203410376, 21, new StarterRequirement(Region.galar, Starter.Water)),
        ],
        'We both got ourselves the same Grass Badge, so how come you\'re so much stronger?',
        [new RouteKillRequirement(10, Region.galar, 14)],
        undefined,
        {
            displayName: 'Pokémon Trainer Hop',
    ...
    TemporaryBattleList['Bede 2'] = new TemporaryBattle(
        ...
        [new ClearDungeonRequirement(1, getDungeonIndex('Galar Mine No. 2'))],
        undefined,
        {
            displayName: 'Pokémon Trainer Bede',
            imageName: 'Bede',
    ...
    TemporaryBattleList['Marnie 1'] = new TemporaryBattle(
        ...
        [new RouteKillRequirement(10, Region.galar, 15)],
        undefined,
        {
    ...
    TemporaryBattleList['Hop 5'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Drizzile', 258803803, 33, new StarterRequirement(Region.galar, Starter.Grass)),
            new GymPokemon('Thwackey', 258803803, 33, new StarterRequirement(Region.galar, Starter.Fire)),
            new GymPokemon('Raboot', 258803803, 33, new StarterRequirement(Region.galar, Starter.Water)),
        ],
        'My strategy goes right to pot when I\'ve got all these bad thoughts running through my head...',
        [new RouteKillRequirement(10, Region.galar, 23)],
        undefined,
        {
            displayName: 'Pokémon Trainer Hop',
    ...
    TemporaryBattleList['Hop 6'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Inteleon', 229959263, 37, new StarterRequirement(Region.galar, Starter.Grass)),
            new GymPokemon('Rillaboom', 229959263, 37, new StarterRequirement(Region.galar, Starter.Fire)),
            new GymPokemon('Cinderace', 229959263, 37, new StarterRequirement(Region.galar, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Hop 7'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Inteleon', 237657651, 41, new StarterRequirement(Region.galar, Starter.Grass)),
            new GymPokemon('Rillaboom', 237657651, 41, new StarterRequirement(Region.galar, Starter.Fire)),
            new GymPokemon('Cinderace', 237657651, 41, new StarterRequirement(Region.galar, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Marnie 2'] = new TemporaryBattle(
        ...
        [new RouteKillRequirement(10, Region.galar, 30)],
        undefined,
        {
            displayName: 'Pokémon Trainer Marnie',
            returnTown: 'Circhester',
    ...
    TemporaryBattleList['Hop 8'] = new TemporaryBattle(
        ...
        [
            ...
            new GymPokemon('Inteleon', 410276760, 60, new StarterRequirement(Region.galar, Starter.Grass)),
            new GymPokemon('Rillaboom', 410276760, 60, new StarterRequirement(Region.galar, Starter.Fire)),
            new GymPokemon('Cinderace', 410276760, 60, new StarterRequirement(Region.galar, Starter.Water)),
        ],
    ...
    TemporaryBattleList['Max Raid Venusaur'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 33), new SeededDateSelectNRequirement(0, 30, 10)],
        undefined,
        {
            hideTrainer: true,
    ...
    TemporaryBattleList['Max Raid Blastoise'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 41), new SeededDateSelectNRequirement(2, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Butterfree'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 34), new SeededDateSelectNRequirement(3, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Pikachu'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 48), new SeededDateSelectNRequirement(4, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Meowth'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 54), new SeededDateSelectNRequirement(5, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Gengar'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 11), new SeededDateSelectNRequirement(7, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Kingler'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 5), new SeededDateSelectNRequirement(8, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Lapras'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 51), new SeededDateSelectNRequirement(9, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Snorlax'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 53), new SeededDateSelectNRequirement(11, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Garbodor'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 38), new SeededDateSelectNRequirement(12, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Rillaboom'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 35), new OneFromManyRequirement([new RouteKillRequirement(10, Region.galar, 34), new RouteKillRequirement(10, Region.galar, 40)]), new SeededDateSelectNRequirement(13, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Cinderace'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 40), new SeededDateSelectNRequirement(14, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Inteleon'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 43), new SeededDateSelectNRequirement(15, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Orbeetle'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 21), new SeededDateSelectNRequirement(17, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Drednaw'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 8), new SeededDateSelectNRequirement(18, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Flapple'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 50), new SeededDateSelectNRequirement(20, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Appletun'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 48), new SeededDateSelectNRequirement(21, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Sandaconda'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 39), new SeededDateSelectNRequirement(22, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Toxtricity'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 36), new SeededDateSelectNRequirement(23, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Hatterene'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 50), new SeededDateSelectNRequirement(25, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Grimmsnarl'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 52), new SeededDateSelectNRequirement(26, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Copperajah'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 49), new SeededDateSelectNRequirement(28, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
    ...
    TemporaryBattleList['Max Raid Duraludon'] = new TemporaryBattle(
        ...
        undefined,
        [new QuestLineStepCompletedRequirement('The Lair of Giants', 2), new RouteKillRequirement(10, Region.galar, 7), new SeededDateSelectNRequirement(29, 30, 10)],
        undefined,
        {
            hideTrainer: true,
            displayName: 'Max Raid',
...
export default TemporaryBattleList;
