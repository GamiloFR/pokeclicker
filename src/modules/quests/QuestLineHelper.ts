...
import { TmpBattleFrontierMilestonePokemonType, TmpNPCType } from '../TemporaryScriptTypes';
...
declare const PalletMom1: TmpNPCType;
declare const ViridianCityOldMan2: TmpNPCType;
declare const BillsGrandpa1: TmpNPCType;
declare const BillsGrandpa2: TmpNPCType;
declare const BillsGrandpa3: TmpNPCType;
declare const BillsGrandpa4: TmpNPCType;
declare const BillsGrandpa5: TmpNPCType;
declare const BillsGrandpa6: TmpNPCType;
declare const BillsGrandpa7: TmpNPCType;
declare const OneIslandCelio1: TmpNPCType;
declare const TwoIslandGameCornerOwner1: TmpNPCType;
declare const TwoIslandGameCornerOwner2: TmpNPCType;
declare const OneIslandCelio2: TmpNPCType;
declare const SaffronBreeder: TmpNPCType;
declare const PewterScientist: TmpNPCType;
declare const OlivineLighthouseJasmine1: TmpNPCType;
declare const CianwoodCityPharmacist1: TmpNPCType;
declare const CianwoodCityPharmacist2: TmpNPCType;
declare const OlivineLighthouseMedicineAmphy: TmpNPCType;
declare const OlivineLighthouseJasmine2: TmpNPCType;
declare const EcruteakEusine: TmpNPCType;
declare const EcruteakPokéfan: TmpNPCType;
declare const CianwoodEusine: TmpNPCType;
declare const MahoganyEusine: TmpNPCType;
declare const VermilionEusine: TmpNPCType;
declare const FuchsiaEusine: TmpNPCType;
declare const BillsHouseEusine: TmpNPCType;
declare const Zuki: TmpNPCType;
declare const Naoko: TmpNPCType;
declare const Miki: TmpNPCType;
declare const Sayo: TmpNPCType;
declare const Kuni: TmpNPCType;
declare const KimonoGirlsWhirl: TmpNPCType;
declare const KimonoGirlsEcruteak: TmpNPCType;
declare const PalletCelebiProfOak1: TmpNPCType;
declare const CelebiProfIvy: TmpNPCType;
declare const PalletCelebiProfOak2: TmpNPCType;
declare const AzaleaCelebiKurt2: TmpNPCType;
declare const AzaleaCelebiKurt4: TmpNPCType;
declare const AzaleaCelebiOak1: TmpNPCType;
declare const IlexForestShrine1: TmpNPCType;
declare const AzaleaCelebiOak2: TmpNPCType;
declare const TohjoFallsCelebiTimeDistortion: TmpNPCType;
declare const AzaleaCelebiOak3: TmpNPCType;
declare const IlexForestShrine2: TmpNPCType;
declare const AzaleaCelebiOak5: TmpNPCType;
declare const WeatherBattle1: TmpNPCType;
declare const Wallace1: TmpNPCType;
declare const WeatherBattle2: TmpNPCType;
declare const Wallace2: TmpNPCType;
declare const Television1: TmpNPCType;
declare const Television2: TmpNPCType;
declare const TicketClaim: TmpNPCType;
declare const SouthernIsland1: TmpNPCType;
declare const OneIslandCelio4: TmpNPCType;
declare const SeviiRocketGrunts: TmpNPCType;
declare const SeviiRuby: TmpNPCType;
declare const OneIslandCelio5: TmpNPCType;
declare const SeviiLorelei: TmpNPCType;
declare const SeviiGideon2: TmpNPCType;
declare const OneIslandCelio6: TmpNPCType;
declare const ThemeparkTeamRocket1: TmpNPCType;
declare const ThemeparkTeamRocket4: TmpNPCType;
declare const SCEntrance: TmpNPCType;
declare const SCMazeLeft: TmpNPCType;
declare const SCMazeStraight: TmpNPCType;
declare const SCMazeRight: TmpNPCType;
declare const SCHints: TmpNPCType;
declare const MillenniumFest: TmpNPCType;
declare const Butler1: TmpNPCType;
declare const CocoonHatch: TmpNPCType;
declare const Butler2: TmpNPCType;
declare const Butler3: TmpNPCType;
declare const ExploreStand: TmpNPCType;
declare const Sack: TmpNPCType;
declare const EsCade1: TmpNPCType;
declare const Rui1: TmpNPCType;
declare const Duking1: TmpNPCType;
declare const Doken1: TmpNPCType;
declare const FreePlusle: TmpNPCType;
declare const Rui2: TmpNPCType;
declare const GrandpaEagun1: TmpNPCType;
declare const Rui3: TmpNPCType;
declare const SearchTheStudio: TmpNPCType;
declare const EsCade2: TmpNPCType;
declare const EviceEscape: TmpNPCType;
declare const ManaphyHastings1: TmpNPCType;
declare const ManaphyBoulders: TmpNPCType;
declare const ManaphyGoRockCommander: TmpNPCType;
declare const ManaphyGoRock: TmpNPCType;
declare const ManaphyHastings2: TmpNPCType;
declare const ManaphyHastings3: TmpNPCType;
declare const HappinyWitness1: TmpNPCType;
declare const HappinyWitness2: TmpNPCType;
declare const HappinyWitness3: TmpNPCType;
declare const HappinyWitness4: TmpNPCType;
declare const HappinyWitness5: TmpNPCType;
declare const HappinyWitness6: TmpNPCType;
declare const HappinyWitness7: TmpNPCType;
declare const HappinyWitness8: TmpNPCType;
declare const HappinyWitness9: TmpNPCType;
declare const HappinyBoulders: TmpNPCType;
declare const ManaphyHastings4: TmpNPCType;
declare const FightAreaZero1: TmpNPCType;
declare const CanalaveSinnohMyth: TmpNPCType;
declare const FightAreaZero2: TmpNPCType;
declare const VerityMesprit: TmpNPCType;
declare const ValorAzelf: TmpNPCType;
declare const AcuityUxie: TmpNPCType;
declare const SendoffSpringLakeTrio: TmpNPCType;
declare const SendoffSpringZero1: TmpNPCType;
declare const SendoffSpringZero2: TmpNPCType;
declare const PlasmaGrunt1: TmpNPCType;
declare const PlasmaGrunt2: TmpNPCType;
declare const DriftveilZinzolin: TmpNPCType;
declare const GiantChasmColress: TmpNPCType;
declare const GiantChasmShadowTriad: TmpNPCType;
declare const destinyGem: TmpNPCType;
declare const destinyScientistChasm: TmpNPCType;
declare const destinyScientistBF: TmpNPCType;
declare const destinyDeoxysReunion: TmpNPCType;
declare const OldManSwords: TmpNPCType;
declare const Cobalion1: TmpNPCType;
declare const Terrakion1: TmpNPCType;
declare const Cobalion2: TmpNPCType;
declare const Virizion1: TmpNPCType;
declare const Virizion2: TmpNPCType;
declare const Cobalion3: TmpNPCType;
declare const Cobalion4: TmpNPCType;
declare const Cobalion5: TmpNPCType;
declare const Cobalion6: TmpNPCType;
declare const Cobalion7: TmpNPCType;
declare const Terrakion2: TmpNPCType;
declare const Virizion3: TmpNPCType;
declare const InvestigateP2: TmpNPCType;
declare const AncientBugHunter1: TmpNPCType;
declare const GenesectFight: TmpNPCType;
declare const GateonSailor: TmpNPCType;
declare const Chobin1: TmpNPCType;
declare const Eagun2: TmpNPCType;
declare const Lovrina: TmpNPCType;
declare const Exol: TmpNPCType;
declare const Snattle: TmpNPCType;
declare const Trest: TmpNPCType;
declare const Verich: TmpNPCType;
declare const Chobin2: TmpNPCType;
declare const SearchLibra: TmpNPCType;
declare const ProfKrane: TmpNPCType;
declare const Lysandre1: TmpNPCType;
declare const Calem1: TmpNPCType;
declare const Calem2: TmpNPCType;
declare const FossilScientist: TmpNPCType;
declare const TeamFlareGrunt1: TmpNPCType;
declare const Diantha1: TmpNPCType;
declare const Lysandre2: TmpNPCType;
declare const Lysandre3: TmpNPCType;
declare const PokéBallFactoryDirector: TmpNPCType;
declare const ProfessorSycamore1: TmpNPCType;
declare const KalosTVNews: TmpNPCType;
declare const Lysandre4: TmpNPCType;
declare const AZ1: TmpNPCType;
declare const BlueButton: TmpNPCType;
declare const RedButton: TmpNPCType;
declare const TeamFlareLysandre1: TmpNPCType;
declare const TeamFlareBossLysandre1: TmpNPCType;
declare const Cozmo1: TmpNPCType;
declare const Zinnia1: TmpNPCType;
declare const DeltaMay1: TmpNPCType;
declare const NewsBirch: TmpNPCType;
declare const DeltaMay2: TmpNPCType;
declare const DeltaSteven1: TmpNPCType;
declare const DeltaWally1: TmpNPCType;
declare const Zinnia2: TmpNPCType;
declare const Zinnia3: TmpNPCType;
declare const Cozmo2: TmpNPCType;
declare const Zinnia4: TmpNPCType;
declare const Cozmo3: TmpNPCType;
declare const DraconidElder1: TmpNPCType;
declare const DraconidElder2: TmpNPCType;
declare const Zinnia5: TmpNPCType;
declare const Archie: TmpNPCType;
declare const Maxie: TmpNPCType;
declare const Wallace3: TmpNPCType;
declare const Zinnia6: TmpNPCType;
declare const Zinnia7: TmpNPCType;
declare const Cozmo4: TmpNPCType;
declare const MrStone1: TmpNPCType;
declare const PrimalMural1: TmpNPCType;
declare const PrimalMural2: TmpNPCType;
declare const PrimalSteven: TmpNPCType;
declare const Stern1: TmpNPCType;
declare const Stern2: TmpNPCType;
declare const Stern3: TmpNPCType;
declare const WeatherScan: TmpNPCType;
declare const PrimalArchie: TmpNPCType;
declare const PrimalMaxie: TmpNPCType;
declare const MrStone2: TmpNPCType;
declare const searchForClues: TmpNPCType;
declare const Informant1: TmpNPCType;
declare const Informant2: TmpNPCType;
declare const HowardClifford1: TmpNPCType;
declare const LucyStevens1: TmpNPCType;
declare const Mewtwo1: TmpNPCType;
declare const HowardClifford2: TmpNPCType;
declare const HowardClifford3: TmpNPCType;
declare const Mewtwo2: TmpNPCType;
declare const DetectiveRaichu: TmpNPCType;
declare const ExamineAegislash: TmpNPCType;
declare const ThanksDiancie: TmpNPCType;
declare const Baraz1: TmpNPCType;
declare const Baraz2: TmpNPCType;
declare const Baraz3: TmpNPCType;
declare const Baraz4: TmpNPCType;
declare const UnrivaledBlue: TmpNPCType;
declare const UnrivaledGreen1: TmpNPCType;
declare const UnrivaledGreen2: TmpNPCType;
declare const AnomalyMewtwo1: TmpNPCType;
declare const AnomalyMewtwo2: TmpNPCType;
declare const AnomalyMewtwo3: TmpNPCType;
declare const AnomalyMewtwo4: TmpNPCType;
declare const Lillie1: TmpNPCType;
declare const Lillie2: TmpNPCType;
declare const Lillie3: TmpNPCType;
declare const Lillie4: TmpNPCType;
declare const ProfBurnetAlola1: TmpNPCType;
declare const Lillie5: TmpNPCType;
declare const Lillie6: TmpNPCType;
declare const Gladion1: TmpNPCType;
declare const HapuHope: TmpNPCType;
declare const SunFlute: TmpNPCType;
declare const MoonFlute: TmpNPCType;
declare const Lillie7: TmpNPCType;
declare const Lillie8: TmpNPCType;
declare const SilvallyGladion1: TmpNPCType;
declare const SilvallyHala: TmpNPCType;
declare const SilvallyOlivia: TmpNPCType;
declare const SilvallyNanu: TmpNPCType;
declare const SilvallyMina: TmpNPCType;
declare const SilvallyGladion2: TmpNPCType;
declare const LanaSilvally1: TmpNPCType;
declare const MallowSilvally1: TmpNPCType;
declare const KiaweSilvally1: TmpNPCType;
declare const SophoclesSilvally1: TmpNPCType;
declare const VeteranSilvally1: TmpNPCType;
declare const HapuSilvally1: TmpNPCType;
declare const SilvallyGladion3: TmpNPCType;
declare const GuzmaSilvally: TmpNPCType;
declare const KahiliSilvally: TmpNPCType;
declare const PlumeriaSilvally: TmpNPCType;
declare const AcerolaSilvally: TmpNPCType;
declare const FabaSilvally: TmpNPCType;
declare const MolayneSilvally: TmpNPCType;
declare const RyukiSilvally: TmpNPCType;
declare const SilvallyGladion4: TmpNPCType;
declare const RoadsideMotelLooker1: TmpNPCType;
declare const RoadsideMotelAnabel1: TmpNPCType;
declare const RoadsideMotelLooker2: TmpNPCType;
declare const RoadsideMotelAnabel2: TmpNPCType;
declare const RoadsideMotelAnabel3: TmpNPCType;
declare const RoadsideMotelMina: TmpNPCType;
declare const RoadsideMotelNanu1: TmpNPCType;
declare const RoadsideMotelNanu2: TmpNPCType;
declare const RoadsideMotelAnabel4: TmpNPCType;
declare const RoadsideMotelAnabel5: TmpNPCType;
declare const MayorKarp: TmpNPCType;
declare const DrSplash1: TmpNPCType;
declare const DrSplash2: TmpNPCType;
declare const DrSplash3: TmpNPCType;
declare const DrSplash4: TmpNPCType;
declare const DrSplash5: TmpNPCType;
declare const AncientMural1: TmpNPCType;
declare const AncientMural2: TmpNPCType;
declare const StowonSideSonia: TmpNPCType;
declare const HerosBath: TmpNPCType;
declare const CirchesterHop: TmpNPCType;
declare const CirchesterSonia: TmpNPCType;
declare const RoseBroadcast: TmpNPCType;
declare const WyndonHop: TmpNPCType;
declare const SlumberingHop1: TmpNPCType;
declare const EnergyPlantRose: TmpNPCType;
declare const Leon: TmpNPCType;
declare const SlumberingHop2: TmpNPCType;
declare const SordwardShielbert1: TmpNPCType;
declare const SordwardShielbert2: TmpNPCType;
declare const SordwardShielbert3: TmpNPCType;
declare const SordwardShielbert4: TmpNPCType;
declare const Piers: TmpNPCType;
declare const Mustard1: TmpNPCType;
declare const Mustard2: TmpNPCType;
declare const Mustard3: TmpNPCType;
declare const Mustard4: TmpNPCType;
declare const Klara1: TmpNPCType;
declare const Avery1: TmpNPCType;
declare const Mustard5: TmpNPCType;
declare const Klara2: TmpNPCType;
declare const Avery2: TmpNPCType;
declare const Mustard6: TmpNPCType;
declare const Mustard7: TmpNPCType;
declare const Mustard8: TmpNPCType;
declare const Mustard9: TmpNPCType;
declare const Mustard10: TmpNPCType;
declare const JungleAsh1: TmpNPCType;
declare const JungleKoko1: TmpNPCType;
declare const JungleKoko2: TmpNPCType;
declare const JungleKoko3: TmpNPCType;
declare const JungleKoko4: TmpNPCType;
declare const JungleAsh2: TmpNPCType;
declare const JungleKoko5: TmpNPCType;
declare const JungleAsh3: TmpNPCType;
declare const JungleKoko6: TmpNPCType;
declare const CrownPeony1: TmpNPCType;
declare const Calyrex1: TmpNPCType;
declare const Calyrex2: TmpNPCType;
declare const Calyrex3: TmpNPCType;
declare const Calyrex4: TmpNPCType;
declare const CrownPeony2: TmpNPCType;
declare const BirdPeony1: TmpNPCType;
declare const BirdPeony2: TmpNPCType;
declare const BirdPeony3: TmpNPCType;
declare const BirdPeony4: TmpNPCType;
declare const GolemPeony1: TmpNPCType;
declare const GolemPeony2: TmpNPCType;
declare const GolemPeony3: TmpNPCType;
declare const GolemPeony4: TmpNPCType;
declare const GolemPeony5: TmpNPCType;
declare const GolemPeony6: TmpNPCType;
declare const Peonia1: TmpNPCType;
declare const Peonia2: TmpNPCType;
declare const Peonia3: TmpNPCType;
declare const GigantamaxLeon1: TmpNPCType;
declare const GigantamaxLeon2: TmpNPCType;
declare const Peonia4: TmpNPCType;
declare const ForcesCogita1: TmpNPCType;
declare const ForcesCogita2: TmpNPCType;
declare const ForcesCogita3: TmpNPCType;
declare const EasterEggHunter: TmpNPCType;
