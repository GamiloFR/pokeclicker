...
abstract class Quest {
    public static questObservable = ko.observable<Quest>();

    public index: number;
    public amount: number;
    public pointsReward: number;
    public progress: PureComputed<number>;
    public progressText: PureComputed<string>;
    public inProgress: PureComputed<boolean>;
    public isCompleted: Computed<boolean>;
    public claimed: Observable<boolean>;
    public initial: Observable<any>;
    public notified: boolean;
    public autoComplete: boolean;
    public mainQuest: Quest;
    public autoCompleter: Subscription;
    public inQuestLine: boolean;
    public onLoadCalled: boolean;
    public suspended: boolean;
    public customReward?: () => void;
    public optionalArgs?: QuestOptionalArgument;
    public initialValue?: number;
    public parentQuestLine?: QuestLine;

    protected customDescription?: string;

    private _onLoad?: () => void;
    private _focus: Observable<any>;
    ...
    get description(): string {
        ...
        if (!this.cachedTranslatedDescription) {
            if (!this.parentQuestLine) {
                console.error('Cannot translate, missing parentQuestLine');
                return '';
            }
    ...
    set focus(value: Observable<any>) {
        this._focus = value;
