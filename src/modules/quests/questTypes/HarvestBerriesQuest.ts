...
class HarvestBerriesQuest extends Quest implements QuestInterface {
    ...
    get defaultDescription(): string {
        return `Harvest ${this.amount.toLocaleString('en-US')} ${BerryType[this.berryType]} ${pluralizeString('Berry', this.amount)} at the farm.`;
    }
...
export default HarvestBerriesQuest;
