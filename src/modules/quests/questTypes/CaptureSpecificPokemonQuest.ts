...
class CaptureSpecificPokemonQuest extends Quest implements QuestInterface {
    ...
    constructor(pokemonName: PokemonNameType, capturesNeeded = 1, includeBreeding = false, reward = 0) {
        ...
        this.focus = ko.pureComputed(
            () => App.game.statistics.pokemonCaptured[this.pokemon.id]() - (includeBreeding ? 0 : App.game.statistics.pokemonHatched[this.pokemon.id]()),
...
export default CaptureSpecificPokemonQuest;
