...
function initDungeons() {
            ...
            new DungeonTrainer('Egg Hunter',
                [new GymPokemon('Togepi (Flowering Crown)', 300000, 100)],
                {
                    ...
                    requirement: new MultiRequirement([
                        ...
                        new QuestLineStepCompletedRequirement('Egg Hunt', 0, AchievementOption.less),
                    ]),
                }),
    ...
    DungeonList['Silph Co.'] = new Dungeon('Silph Co.',
        ...
        [
            new DungeonTrainer('Scientist',
                ...
                ], { weight: 1, hide: true, requirement: new QuestLineStepCompletedRequirement('Team Rocket', 2, AchievementOption.less) }, 'Beau', '(male)'),
            new DungeonTrainer('Team Rocket Boss',
                [
    ...
    DungeonList['Cerulean Cave'] = new Dungeon('Cerulean Cave',
        ['Golbat', 'Parasect', 'Psyduck', 'Golduck', 'Primeape', 'Poliwag', 'Machoke', 'Slowpoke', 'Slowbro', 'Magneton', 'Electrode', 'Goldeen', 'Magikarp', 'Ditto'],
        {
            ...
            mythic: [
                { loot: 'LargeRestore' },
                { loot: 'Max Revive', weight: 2 },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(500, getDungeonIndex('Cerulean Cave')) },
            ],
        },
        28735,
        [
    ...
    DungeonList['Pinkan Mountain'] = new Dungeon('Pinkan Mountain',
        ['Pinkan Rattata', 'Pinkan Nidoran(M)', 'Pinkan Nidoran(F)', 'Pinkan Mankey', 'Pinkan Rhyhorn'],
        {
            ...
            rare: [
                { loot: 'Purple Shard' },
                { loot: 'Pink Shard', requirement: new MaxRegionRequirement(Region.kalos) },
            ],
            epic: [
        ...
        [
            ...
            new DungeonBossPokemon('Lapras', 450000, 20, {
                ...
                requirement: new MultiRequirement([
                    ...
                    new DayOfWeekRequirement(DayOfWeek.Friday),
                ]) }),
        ],
        3000, 32);
            ...
            new DungeonTrainer('Egg Hunter',
                [new GymPokemon('Togepi (Flowering Crown)', 900000, 100)],
                {
                    ...
                    requirement: new MultiRequirement([
                        ...
                        new QuestLineStepCompletedRequirement('Egg Hunt', 1, AchievementOption.less),
                    ]),
                }),
            new DungeonBossPokemon('Togepi (Flowering Crown)', 2700000, 23, {
                requirement: new MultiRequirement([
    ...
    DungeonList['Radio Tower'] = new Dungeon('Radio Tower',
        ...
        ],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Lum', requirement: new ClearDungeonRequirement(250, getDungeonIndex('Radio Tower')) },
            ],
        },
        112000,
        [
    ...
    DungeonList['Mt. Silver'] = new Dungeon('Mt. Silver',
        ['Ponyta', 'Doduo', 'Tangela', 'Sneasel', 'Ursaring', 'Donphan', 'Teddiursa', 'Phanpy', 'Quagsire', 'Misdreavus'],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Heart Scale' },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(450, getDungeonIndex('Mt. Silver')) },
            ],
        },
        130500,
            ...
            new DungeonTrainer('Egg Hunter',
                [new GymPokemon('Togepi (Flowering Crown)', 2700000, 100)],
                {
                    ...
                    requirement: new MultiRequirement([
                        ...
                        new QuestLineStepCompletedRequirement('Egg Hunt', 2, AchievementOption.less),
                    ]),
                }),
    ...
    DungeonList['Mt. Chimney Crater'] = new Dungeon('Mt. Chimney Crater',
        ...
        [
            new DungeonTrainer('Magma Leader',
                ...
                ], { weight: 2, hide: true, requirement: new QuestLineCompletedRequirement('The Delta Episode', AchievementOption.less) }, 'Maxie'),
            new DungeonTrainer('Magma Leader',
                [
    ...
    DungeonList['Weather Institute'] = new Dungeon('Weather Institute',
        ...
        [
            new DungeonTrainer('Aqua Admin',
                ...
                ], { weight: 1, hide: true, requirement: new QuestLineStepCompletedRequirement('Primal Reversion', 9, AchievementOption.less) }, 'Shelly', '(shelly)'),
            new DungeonTrainer('Aqua Admin',
                [
    ...
    DungeonList['Magma Hideout'] = new Dungeon('Magma Hideout',
        ...
        [
            new DungeonTrainer('Magma Leader',
                ...
                { weight: 1, hide: true, requirement: new QuestLineCompletedRequirement('The Delta Episode', AchievementOption.less) }, 'Maxie'),
            new DungeonTrainer('Magma Leader',
                [
    ...
    DungeonList['Seafloor Cavern'] = new Dungeon('Seafloor Cavern',
        [
            ...
            new DungeonTrainer('Team Aqua Grunt',
                ...
                { weight: 1, requirement: new QuestLineStepCompletedRequirement('Primal Reversion', 7, AchievementOption.less) }, undefined, '(male)'),
            new DungeonTrainer('Team Aqua Grunt',
            ...
            new DungeonTrainer('Team Aqua Grunt',
                [new GymPokemon('Carvanha', 32000, 36)],
                { weight: 1, requirement: new QuestLineStepCompletedRequirement('Primal Reversion', 7, AchievementOption.less) }, undefined, '(female)'),
            new DungeonTrainer('Team Aqua Grunt',
                [
            ...
            new DungeonTrainer('Aqua Admin',
                ...
                ], { weight: 1, requirement: new QuestLineStepCompletedRequirement('Primal Reversion', 7, AchievementOption.less) }, 'Shelly', '(shelly)'),
            new DungeonTrainer('Team Aqua Grunt',
        ...
        [
            new DungeonTrainer('Aqua Leader',
                ...
                { weight: 1, hide: true, requirement: new QuestLineCompletedRequirement('The Delta Episode', AchievementOption.less) }, 'Archie'),
            new DungeonTrainer('Aqua Leader',
                [
    ...
    DungeonList['Phenac City Battles'] = new Dungeon('Phenac City Battles',
        [
            new DungeonTrainer('Miror B. Peon',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(25, getDungeonIndex('Phenac City Battles'), AchievementOption.less) }, 'Folly', '(folly)'),
            new DungeonTrainer('Team Snagem',
                [
                    new GymPokemon('Corphish', 38000, 25),
                    new GymPokemon('Koffing', 38000, 27),
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('Phenac City Battles'), AchievementOption.less) }, 'Wakin'),
            new DungeonTrainer('Miror B. Peon',
                [
                    new GymPokemon('Whismur', 38000, 26),
                    new GymPokemon('Lotad', 38000, 25),
                ], { weight: 1, requirement: new ClearDungeonRequirement(75, getDungeonIndex('Phenac City Battles'), AchievementOption.less) }, 'Folly', '(folly)'),
            new DungeonTrainer('Mystery Troop Green',
                [
                    new GymPokemon('Grimer', 38000, 26),
                    new GymPokemon('Spoink', 38000, 24),
                    new GymPokemon('Bayleef', 38000, 30, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Verde'),
            new DungeonTrainer('Mystery Troop Red',
                [
                    new GymPokemon('Grimer', 38000, 26),
                    new GymPokemon('Spoink', 38000, 24),
                    new GymPokemon('Quilava', 38000, 30, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Rosso'),
            new DungeonTrainer('Mystery Troop Blue',
                [
                    new GymPokemon('Grimer', 38000, 26),
                    new GymPokemon('Spoink', 38000, 24),
                    new GymPokemon('Croconaw', 38000, 30, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Bluno'),
            new DungeonTrainer('Miror B. Peon',
                [
                    new GymPokemon('Exploud', 38000, 53),
                    new GymPokemon('Ludicolo', 38000, 55),
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Phenac City Battles'), AchievementOption.less) }, 'Folly', '(folly)'),
            new DungeonTrainer('Miror B. Peon',
                [
                    new GymPokemon('Dusclops', 38000, 54),
                    new GymPokemon('Spinarak', 38000, 53),
                    new GymPokemon('Machoke', 38000, 53),
                ], { weight: 1, requirement: new ClearDungeonRequirement(125, getDungeonIndex('Phenac City Battles'), AchievementOption.less) }, 'Trudly', '(trudly)'),
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Pineco', 38000, 20, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(150, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Ertlig', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Duskull', 38000, 21),
                    new GymPokemon('Corphish', 38000, 20),
                    new GymPokemon('Qwilfish', 38000, 21),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(175, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Forgs', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Sudowoodo', 38000, 20),
                    new GymPokemon('Clamperl', 38000, 21),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(200, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Pellim', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Mightyena', 38000, 21),
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(225, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Fenton', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Shuppet', 38000, 21),
                    new GymPokemon('Teddiursa', 38000, 21),
                    new GymPokemon('Corsola', 38000, 21),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(250, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Ezoor', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(275, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Kepen', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Nuzleaf', 38000, 23),
                    new GymPokemon('Torkoal', 38000, 22),
                    new GymPokemon('Swinub', 38000, 22, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(300, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Resix', 'Resix'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Horsea', 38000, 21),
                    new GymPokemon('Goldeen', 38000, 20),
                    new GymPokemon('Beldum', 38000, 19),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(325, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Blusix', 'Blusix'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Noctowl', 38000, 20),
                    new GymPokemon('Vigoroth', 38000, 20),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(350, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Browsix', 'Browsix'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Chinchou', 38000, 20),
                    new GymPokemon('Electrike', 38000, 20),
                    new GymPokemon('Magnemite', 38000, 20),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(375, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Yellosix', 'Yellosix'),
            new DungeonTrainer('Cipher Peon',
                [
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(400, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Purpsix', 'Purpsix'),
            new DungeonTrainer('Cipher Peon',
                [
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(425, getDungeonIndex('Phenac City Battles'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 12)]) }, 'Greesix', 'Greesix'),
        ],
        {
            common: [
                { loot: 'xClick' },
        ...
        [
            new DungeonTrainer('Miror B. Peon',
                [
                    ...
                    new GymPokemon('Makuhita', 870000, 30, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 1 }, 'Trudly', '(trudly)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Kirlia', 23925000, 22),
                    new GymPokemon('Linoone', 23925000, 20),
                    new GymPokemon('Natu', 23925000, 22, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Roselia', 23925000, 22, undefined, undefined, ShadowStatus.Shadow),
    ...
    DungeonList['Pyrite Town Battles'] = new Dungeon('Pyrite Town Battles',
        [
            new DungeonTrainer('Chaser',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(25, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Calda', '(male)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Gulpin', 41000, 27),
                    new GymPokemon('Zubat', 41000, 27),
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Emok', '(female)'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Skitty', 41000, 28),
                    new GymPokemon('Zigzagoon', 41000, 28),
                    new GymPokemon('Misdreavus', 41000, 30, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Vant', '(male)'),
            new DungeonTrainer('Bandana Guy',
                [
                    new GymPokemon('Psyduck', 41000, 29),
                    new GymPokemon('Quagsire', 41000, 30, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Divel'),
            ...
            new DungeonTrainer('Rider',
                [
                    ...
                    new GymPokemon('Noctowl', 41000, 30, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Nover', '(male)'),
            new DungeonTrainer('Street Performer',
                [
                    new GymPokemon('Shroomish', 41000, 29),
                    new GymPokemon('Flaaffy', 41000, 30, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Diogo'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Oddish', 41000, 26),
                    new GymPokemon('Dustox', 41000, 26),
                    new GymPokemon('Skiploom', 41000, 30, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Leba', '(female)'),
            new DungeonTrainer('Bodybuilder',
                [
                    new GymPokemon('Beldum', 41000, 34),
                    new GymPokemon('Aron', 41000, 35),
                ], { weight: 1, requirement: new ClearDungeonRequirement(75, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Hadar', '(male)'),
            new DungeonTrainer('Rogue',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Cail', 'Cail'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Furret', 41000, 35),
                    new GymPokemon('Taillow', 41000, 32),
                    new GymPokemon('Slakoth', 41000, 21),
                ], { weight: 1, requirement: new ClearDungeonRequirement(125, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Calda', '(male)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Gulpin', 41000, 36),
                    new GymPokemon('Golbat', 41000, 36),
                ], { weight: 1, requirement: new ClearDungeonRequirement(150, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Emok', '(female)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Skitty', 41000, 28),
                    new GymPokemon('Zigzagoon', 41000, 28),
                    new GymPokemon('Shuppet', 41000, 29),
                ], { weight: 1, requirement: new ClearDungeonRequirement(175, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Vant', '(male)'),
            new DungeonTrainer('Bandana Guy',
                [
                    new GymPokemon('Psyduck', 41000, 29),
                    new GymPokemon('Horsea', 41000, 30),
                ], { weight: 1, requirement: new ClearDungeonRequirement(200, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Divel'),
            new DungeonTrainer('Roller Boy',
                [
                    new GymPokemon('Igglybuff', 41000, 28),
                    ...
                    new GymPokemon('Azurill', 41000, 27),
                    new GymPokemon('Swablu', 41000, 27),
                ], { weight: 1, requirement: new ClearDungeonRequirement(225, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Lon'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Doduo', 41000, 26),
                    new GymPokemon('Ledyba', 41000, 27),
                    new GymPokemon('Wingull', 41000, 27),
                ], { weight: 1, requirement: new ClearDungeonRequirement(250, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Nover', '(male)'),
            new DungeonTrainer('Street Performer',
                [
                    new GymPokemon('Pichu', 41000, 27),
                    new GymPokemon('Shroomish', 41000, 26),
                ], { weight: 1, requirement: new ClearDungeonRequirement(275, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Diogo'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Sunkern', 41000, 28),
                    new GymPokemon('Oddish', 41000, 26),
                    new GymPokemon('Dustox', 41000, 26),
                ], { weight: 1, requirement: new ClearDungeonRequirement(300, getDungeonIndex('Pyrite Town Battles'), AchievementOption.less) }, 'Leba', '(female)'),
        ],
        {
            common: [
                { loot: 'xAttack' },
    ...
    DungeonList['Pyrite Building'] = new Dungeon('Pyrite Building',
        [
            ...
            new DungeonTrainer('Chaser',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(25, getDungeonIndex('Pyrite Building'), AchievementOption.less) }, 'Kai', '(female)'),
            new DungeonTrainer('Roller Boy',
                [
                    new GymPokemon('Taillow', 45000, 33),
                    new GymPokemon('Hoothoot', 45000, 34),
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('Pyrite Building'), AchievementOption.less) }, 'Pike'),
            new DungeonTrainer('Bandana Guy',
                [
                    new GymPokemon('Larvitar', 45000, 31),
                    new GymPokemon('Barboach', 45000, 32),
                    new GymPokemon('Carvanha', 45000, 32),
                ], { weight: 1, requirement: new ClearDungeonRequirement(75, getDungeonIndex('Pyrite Building'), AchievementOption.less) }, 'Geats'),
            new DungeonTrainer('Bandana Guy',
                [
                    new GymPokemon('Wingull', 45000, 32),
                    new GymPokemon('Wooper', 45000, 33),
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Pyrite Building'), AchievementOption.less) }, 'Loba'),
            new DungeonTrainer('Bodybuilder',
                [
                    new GymPokemon('Electrike', 45000, 31),
                    new GymPokemon('Voltorb', 45000, 31),
                ], { weight: 1, requirement: new ClearDungeonRequirement(125, getDungeonIndex('Pyrite Building'), AchievementOption.less) }, 'Akmen', '(male)'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Doduo', 45000, 32),
                    new GymPokemon('Ledyba', 45000, 32),
                    new GymPokemon('Swablu', 45000, 31),
                ], { weight: 1, requirement: new ClearDungeonRequirement(150, getDungeonIndex('Pyrite Building'), AchievementOption.less) }, 'Raleen', '(female)'),
            new DungeonTrainer('Hunter',
                [
                    new GymPokemon('Spheal', 45000, 31),
                    new GymPokemon('Snorunt', 45000, 32),
                ], { weight: 1, requirement: new ClearDungeonRequirement(175, getDungeonIndex('Pyrite Building'), AchievementOption.less) }, 'Tura', '(male)'),
            new DungeonTrainer('Hunter',
                [
                    new GymPokemon('Horsea', 45000, 31),
                    new GymPokemon('Oddish', 45000, 32),
                    new GymPokemon('Sandshrew', 45000, 32),
                ], { weight: 1, requirement: new ClearDungeonRequirement(200, getDungeonIndex('Pyrite Building'), AchievementOption.less) }, 'Toti', '(female)'),
            new DungeonTrainer('Bodybuilder',
                [
                    new GymPokemon('Cacnea', 45000, 32),
                    new GymPokemon('Tentacool', 45000, 33),
                ], { weight: 1, requirement: new ClearDungeonRequirement(225, getDungeonIndex('Pyrite Building'), AchievementOption.less) }, 'Elidi', '(female)'),
            new DungeonTrainer('Miror B. Peon',
                [
                    new GymPokemon('Remoraid', 45000, 33, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(250, getDungeonIndex('Pyrite Building'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Rett', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Corphish', 45000, 18),
                    new GymPokemon('Electrike', 45000, 17),
                    new GymPokemon('Grimer', 45000, 18),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(275, getDungeonIndex('Pyrite Building'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Mocor', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Kecleon', 45000, 19),
                    new GymPokemon('Surskit', 45000, 21),
                    new GymPokemon('Makuhita', 45000, 18, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(300, getDungeonIndex('Pyrite Building'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Elox', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(325, getDungeonIndex('Pyrite Building'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Rixor', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(350, getDungeonIndex('Pyrite Building'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Dilly', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(375, getDungeonIndex('Pyrite Building'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 10)]) }, 'Edlos', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
        ...
        [
            new DungeonTrainer('Hunter',
                [
                    new GymPokemon('Qwilfish', 950000, 33, undefined, undefined, ShadowStatus.Shadow),
    ...
    DungeonList['Pyrite Cave'] = new Dungeon('Pyrite Cave',
        [
            new DungeonTrainer('Street Performer',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(25, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Simes'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Koffing', 46000, 32),
                    new GymPokemon('Ralts', 46000, 31),
                    new GymPokemon('Shroomish', 46000, 32),
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Maiz', '(male)'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Meditite', 46000, 33, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Hunter',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(75, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Valen', '(male)'),
            new DungeonTrainer('Chaser',
                [
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Rehan', '(female)'),
            new DungeonTrainer('Bandana Guy',
                [
                    new GymPokemon('Lotad', 46000, 32),
                    ...
                    new GymPokemon('Lotad', 46000, 33),
                    new GymPokemon('Lotad', 46000, 33),
                ], { weight: 1, requirement: new ClearDungeonRequirement(125, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Noxy'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Dunsparce', 46000, 33, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Roller Boy',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(150, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Evat'),
            new DungeonTrainer('Hunter',
                [
            ...
            new DungeonTrainer('Rider',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(175, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Derid', '(male)'),
            new DungeonTrainer('Hunter',
                [
                    new GymPokemon('Zigzagoon', 46000, 32),
                    new GymPokemon('Zigzagoon', 46000, 32),
                    new GymPokemon('Linoone', 46000, 33),
                ], { weight: 1, requirement: new ClearDungeonRequirement(200, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Meli', '(female)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Natu', 46000, 33),
                    new GymPokemon('Tentacool', 46000, 32),
                    new GymPokemon('Teddiursa', 46000, 32),
                ], { weight: 1, requirement: new ClearDungeonRequirement(225, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Mela', '(female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Lileep', 46000, 32),
                    new GymPokemon('Spheal', 46000, 34),
                    new GymPokemon('Dustox', 46000, 33),
                ], { weight: 1, requirement: new ClearDungeonRequirement(250, getDungeonIndex('Pyrite Cave'), AchievementOption.less) }, 'Sema', '(female)'),
    ...
    DungeonList['The Under'] = new Dungeon('The Under',
        [
            new DungeonTrainer('Hunter',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('The Under'), AchievementOption.less) }, 'Zada', '(female)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Magikarp', 57000, 36),
                    new GymPokemon('Wailord', 57000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('The Under'), AchievementOption.less) }, 'Gurks', '(male)'),
            new DungeonTrainer('Hunter',
                [
                    new GymPokemon('Skitty', 57000, 35),
                    new GymPokemon('Oddish', 57000, 34),
                ], { weight: 1, requirement: new ClearDungeonRequirement(150, getDungeonIndex('The Under'), AchievementOption.less) }, 'Zada', '(female)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Feebas', 57000, 36),
                    new GymPokemon('Wailord', 57000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(200, getDungeonIndex('The Under'), AchievementOption.less) }, 'Gurks', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Ledian', 57000, 40, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(250, getDungeonIndex('The Under'), AchievementOption.less) }, 'Dagur', '(female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Gloom', 57000, 39),
                    new GymPokemon('Illumise', 57000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(300, getDungeonIndex('The Under'), AchievementOption.less) }, 'Dagur', '(female)'),
            new DungeonTrainer('Hunter',
                [
    ...
    DungeonList['Cipher Lab'] = new Dungeon('Cipher Lab',
        [
            ...
            new DungeonTrainer('Scientist',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('Cipher Lab'), AchievementOption.less) }, 'Odlow', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Magnemite', 62000, 39),
                    new GymPokemon('Magneton', 62000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(75, getDungeonIndex('Cipher Lab'), AchievementOption.less) }, 'Coren', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Chinchou', 62000, 38),
                    new GymPokemon('Magnemite', 62000, 37),
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Cipher Lab'), AchievementOption.less) }, 'Lethco', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Electrode', 62000, 39),
                    new GymPokemon('Magnemite', 62000, 38),
                ], { weight: 1, requirement: new ClearDungeonRequirement(125, getDungeonIndex('Cipher Lab'), AchievementOption.less) }, 'Odlow', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Electrode', 62000, 40),
                    new GymPokemon('Magneton', 62000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(150, getDungeonIndex('Cipher Lab'), AchievementOption.less) }, 'Coren', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Chinchou', 62000, 38),
                    new GymPokemon('Electrike', 62000, 39),
                ], { weight: 1, requirement: new ClearDungeonRequirement(175, getDungeonIndex('Cipher Lab'), AchievementOption.less) }, 'Lethco', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Ariados', 62000, 43, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Lesar', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Linoone', 62000, 38),
                    new GymPokemon('Vigoroth', 62000, 39),
                    new GymPokemon('Granbull', 62000, 43, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Tanie', '(female)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Electrode', 62000, 37),
                    new GymPokemon('Electrode', 62000, 37),
                ], { weight: 1, requirement: new ClearDungeonRequirement(200, getDungeonIndex('Cipher Lab'), AchievementOption.less) }, 'Dubik', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Magneton', 62000, 40),
                    new GymPokemon('Ampharos', 62000, 41),
                ], { weight: 1, requirement: new ClearDungeonRequirement(225, getDungeonIndex('Cipher Lab'), AchievementOption.less) }, 'Kotan', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Electrode', 62000, 42),
                    new GymPokemon('Ampharos', 62000, 41),
                ], { weight: 1, requirement: new ClearDungeonRequirement(250, getDungeonIndex('Cipher Lab'), AchievementOption.less) }, 'Kotan', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Houndour', 62000, 17, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Spheal', 62000, 17, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Baltoy', 62000, 17, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Mareep', 62000, 17, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(275, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Corla', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Doduo', 62000, 13),
                    new GymPokemon('Taillow', 62000, 14),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(300, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Javion', 'XD (female)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Lileep', 62000, 13),
                    new GymPokemon('Anorith', 62000, 13),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(325, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Mesak', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Swinub', 62000, 14),
                    new GymPokemon('Shuppet', 62000, 13),
                    new GymPokemon('Spinarak', 62000, 14, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(350, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Crink', 'XD (male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Spoink', 62000, 16),
                    new GymPokemon('Lotad', 62000, 14),
                    new GymPokemon('Staryu', 62000, 14),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(375, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Morbit', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Natu', 62000, 16),
                    new GymPokemon('Nincada', 62000, 14),
                    new GymPokemon('Wailmer', 62000, 15),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(400, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Meda', 'XD (female)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Swablu', 62000, 17),
                    new GymPokemon('Wynaut', 62000, 16),
                    new GymPokemon('Corsola', 62000, 15),
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(425, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Elrok', '(male)'),
            new DungeonTrainer('Scientist',
                [
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(450, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Coffy', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(475, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Digor', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(500, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Nopia', 'XD (female)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Shroomish', 62000, 15, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Scientist',
                ...
                ], { weight: 1, requirement: new MultiRequirement([new ClearDungeonRequirement(525, getDungeonIndex('Cipher Lab'), AchievementOption.less), new QuestLineStepCompletedRequirement('Gale of Darkness', 6)]) }, 'Tekot', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
    ...
    DungeonList['Realgam Tower Battles'] = new Dungeon('Realgam Tower Battles',
        [
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(25, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Bopen', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Dustox', 70000, 38),
                    new GymPokemon('Seviper', 70000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Bopen', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Delibird', 70000, 45, undefined, undefined, ShadowStatus.Shadow),
                    new GymPokemon('Piloswine', 70000, 42),
                    new GymPokemon('Glalie', 70000, 42),
                ], { weight: 0.5 }, 'Arton', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Sunflora', 70000, 45, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Heracross', 70000, 45, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.5 }, 'Dioge', '(male)'),
            new DungeonTrainer('Mystery Troop Green',
                [
                    new GymPokemon('Muk', 70000, 45),
                    new GymPokemon('Grumpig', 70000, 44),
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Verde'),
            new DungeonTrainer('Mystery Troop Red',
                [
                    new GymPokemon('Muk', 70000, 45),
                    new GymPokemon('Grumpig', 70000, 44),
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Rosso'),
            new DungeonTrainer('Mystery Troop Blue',
                [
                    new GymPokemon('Muk', 70000, 45),
                    new GymPokemon('Grumpig', 70000, 44),
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Bluno'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Shelgon', 70000, 40),
                    new GymPokemon('Vigoroth', 70000, 41),
                ], { weight: 1, requirement: new ClearDungeonRequirement(150, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Rugen', '(male)'),
            new DungeonTrainer('Bandana Guy',
                [
                    new GymPokemon('Hariyama', 70000, 41),
                    new GymPokemon('Lombre', 70000, 42),
                ], { weight: 1, requirement: new ClearDungeonRequirement(175, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Klest'),
            new DungeonTrainer('Bandana Guy',
                [
                    new GymPokemon('Nuzleaf', 70000, 39),
                    new GymPokemon('Graveler', 70000, 42),
                ], { weight: 1, requirement: new ClearDungeonRequirement(200, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Klest'),
            new DungeonTrainer('Hunter',
                [
                    new GymPokemon('Metang', 70000, 39),
                    new GymPokemon('Mawile', 70000, 40),
                    new GymPokemon('Lairon', 70000, 41),
                ], { weight: 1, requirement: new ClearDungeonRequirement(225, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Aline', '(female)'),
            new DungeonTrainer('Street Performer',
                [
                    new GymPokemon('Seadra', 70000, 39),
                    new GymPokemon('Feraligatr', 70000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(250, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Luper'),
            new DungeonTrainer('Street Performer',
                [
                    new GymPokemon('Qwilfish', 70000, 40),
                    new GymPokemon('Octillery', 70000, 39),
                ], { weight: 1, requirement: new ClearDungeonRequirement(275, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Luper'),
            new DungeonTrainer('Bodybuilder',
                [
                    new GymPokemon('Loudred', 70000, 45),
                    new GymPokemon('Wigglytuff', 70000, 43),
                ], { weight: 1, requirement: new ClearDungeonRequirement(300, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Givern', '(male)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Ninetales', 70000, 40),
                    new GymPokemon('Machoke', 70000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(325, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Trus', '(male)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Swellow', 70000, 40),
                    new GymPokemon('Magneton', 70000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(350, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Trus', '(male)'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Quagsire', 70000, 41),
                    new GymPokemon('Donphan', 70000, 40),
                    new GymPokemon('Sandslash', 70000, 40),
                ], { weight: 1, requirement: new ClearDungeonRequirement(375, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Kevel', '(male)'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Swalot', 70000, 40),
                    new GymPokemon('Chimecho', 70000, 41),
                ], { weight: 1, requirement: new ClearDungeonRequirement(400, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Elose', '(female)'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Cradily', 70000, 41),
                    new GymPokemon('Noctowl', 70000, 41),
                ], { weight: 1, requirement: new ClearDungeonRequirement(425, getDungeonIndex('Realgam Tower Battles'), AchievementOption.less) }, 'Elose', '(female)'),
        ],
        {
            common: [
                { loot: 'xAttack' },
        ...
        [
            new DungeonTrainer('Cipher Admin',
                ...
                ], { weight: 1, hide: true, requirement: new QuestLineCompletedRequirement('Shadows in the Desert', AchievementOption.less) }, 'Ein', 'Ein'),
            new DungeonTrainer('Cipher Admin',
                [
                ...
                ], { weight: 1, hide: true, requirement: new QuestLineCompletedRequirement('Shadows in the Desert', AchievementOption.less) }, 'Miror B.', 'Miror B'),
            new DungeonTrainer('Cipher Admin',
                [
                ...
                ], { weight: 1, hide: true, requirement: new QuestLineCompletedRequirement('Shadows in the Desert', AchievementOption.less) }, 'Dakim', 'Dakim'),
            new DungeonTrainer('Cipher Admin',
                [
                ...
                ], { weight: 1, hide: true,  requirement: new QuestLineCompletedRequirement('Shadows in the Desert', AchievementOption.less) }, 'Venus', 'Venus'),
        ...
        [
            new DungeonTrainer('Bodybuilder',
                [
                    ...
                    new GymPokemon('Miltank', 75200, 48, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.5 }, 'Jomas', '(female)'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Mightyena', 75200, 46),
                    new GymPokemon('Sharpedo', 75200, 47),
                    new GymPokemon('Absol', 75200, 48, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.5 }, 'Delan', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Torkoal', 75200, 47),
                    new GymPokemon('Magcargo', 75200, 46),
                    new GymPokemon('Houndoom', 75200, 48, undefined, undefined, ShadowStatus.Shadow),
    ...
    DungeonList['Snagem Hideout'] = new Dungeon('Snagem Hideout',
        [
            new DungeonTrainer('Team Snagem',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(25, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Driton'),
            new DungeonTrainer('Bodybuilder',
                [
                    new GymPokemon('Shelgon', 80200, 54),
                    new GymPokemon('Carvanha', 80200, 51),
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Colas', '(male)'),
            new DungeonTrainer('Bandana Guy',
                [
                    new GymPokemon('Weezing', 80200, 52),
                    new GymPokemon('Swalot', 80200, 51),
                ], { weight: 1, requirement: new ClearDungeonRequirement(75, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Crudo'),
            new DungeonTrainer('Team Snagem',
                [
                    new GymPokemon('Vigoroth', 80200, 52),
                    new GymPokemon('Zangoose', 80200, 53),
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Niver'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Mightyena', 80200, 50),
                    new GymPokemon('Linoone', 80200, 53),
                ], { weight: 1, requirement: new ClearDungeonRequirement(125, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Rions', '(male)'),
            new DungeonTrainer('Team Snagem',
                [
                    new GymPokemon('Swellow', 80200, 54),
                    new GymPokemon('Golbat', 80200, 53),
                ], { weight: 1, requirement: new ClearDungeonRequirement(150, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Fuston'),
            new DungeonTrainer('Team Snagem',
                [
                    new GymPokemon('Seadra', 80200, 55),
                    new GymPokemon('Pelipper', 80200, 53),
                ], { weight: 1, requirement: new ClearDungeonRequirement(175, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Driton'),
            new DungeonTrainer('Bodybuilder',
                [
                    new GymPokemon('Pupitar', 80200, 54),
                    new GymPokemon('Spinda', 80200, 51),
                ], { weight: 1, requirement: new ClearDungeonRequirement(200, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Colas', '(male)'),
            new DungeonTrainer('Bandana Guy',
                [
                    new GymPokemon('Sandslash', 80200, 53),
                    new GymPokemon('Linoone', 80200, 55),
                ], { weight: 1, requirement: new ClearDungeonRequirement(225, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Crudo'),
            new DungeonTrainer('Team Snagem',
                [
                    new GymPokemon('Grovyle', 80200, 52),
                    new GymPokemon('Rhyhorn', 80200, 52),
                ], { weight: 1, requirement: new ClearDungeonRequirement(250, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Niver'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Poochyena', 80200, 54),
                    new GymPokemon('Kadabra', 80200, 53),
                ], { weight: 1, requirement: new ClearDungeonRequirement(275, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Rions', '(male)'),
            new DungeonTrainer('Team Snagem',
                [
                    new GymPokemon('Beautifly', 80200, 53),
                    new GymPokemon('Delibird', 80200, 54),
                ], { weight: 1, requirement: new ClearDungeonRequirement(300, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Fuston'),
            new DungeonTrainer('Mystery Troop Green',
                [
            ...
            new DungeonTrainer('Bodybuilder',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(325, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Lonia', '(female)'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Seviper', 80200, 52),
                    new GymPokemon('Sharpedo', 80200, 50),
                ], { weight: 1, requirement: new ClearDungeonRequirement(350, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Nelis', '(female)'),
            new DungeonTrainer('Hunter',
                [
                    new GymPokemon('Mawile', 80200, 53),
                    new GymPokemon('Donphan', 80200, 51),
                ], { weight: 1, requirement: new ClearDungeonRequirement(375, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Frena', '(female)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Jumpluff', 80200, 53),
                    new GymPokemon('Noctowl', 80200, 52),
                ], { weight: 1, requirement: new ClearDungeonRequirement(400, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Liaks', '(female)'),
            new DungeonTrainer('Bodybuilder',
                [
                    new GymPokemon('Flaaffy', 80200, 55),
                    new GymPokemon('Dunsparce', 80200, 51),
                ], { weight: 1, requirement: new ClearDungeonRequirement(425, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Lonia', '(female)'),
            new DungeonTrainer('Rider',
                [
                    new GymPokemon('Corsola', 80200, 51),
                    new GymPokemon('Loudred', 80200, 54),
                ], { weight: 1, requirement: new ClearDungeonRequirement(450, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Nelis', '(female)'),
            new DungeonTrainer('Hunter',
                [
                    new GymPokemon('Jigglypuff', 80200, 52),
                    new GymPokemon('Shroomish', 80200, 53),
                ], { weight: 1, requirement: new ClearDungeonRequirement(475, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Frena', '(female)'),
            new DungeonTrainer('Chaser',
                [
                    new GymPokemon('Gloom', 80200, 53),
                    new GymPokemon('Golduck', 80200, 53),
                ], { weight: 1, requirement: new ClearDungeonRequirement(500, getDungeonIndex('Snagem Hideout'), AchievementOption.less) }, 'Liaks', '(female)'),
            new DungeonTrainer('Team Snagem',
                [
        ...
        [
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Spearow', 89500, 22, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Grimer', 89500, 23, undefined, undefined, ShadowStatus.Shadow),
    ...
    DungeonList['Gateon Port Battles'] = new Dungeon('Gateon Port Battles',
        [
            new DungeonTrainer('Chaser',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(25, getDungeonIndex('Gateon Port Battles'), AchievementOption.less) }, 'Laken', '(female)'),
            new DungeonTrainer('Sailor',
                [
                    new GymPokemon('Wingull', 6002000, 6),
                    new GymPokemon('Lotad', 6002000, 6),
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('Gateon Port Battles'), AchievementOption.less) }, 'Berk'),
            new DungeonTrainer('Sailor',
                [
                    new GymPokemon('Whismur', 6002000, 6),
                    new GymPokemon('Marill', 6002000, 6),
                ], { weight: 1, requirement: new ClearDungeonRequirement(75, getDungeonIndex('Gateon Port Battles'), AchievementOption.less) }, 'Bost'),
            new DungeonTrainer('Old Man',
                [
                    new GymPokemon('Taillow', 80200, 6),
                    new GymPokemon('Ledyba', 80200, 10, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 0.25 }, 'Cyle'),
            new DungeonTrainer('Bodybuilder',
                [
                    new GymPokemon('Zubat', 80200, 6),
                    new GymPokemon('Poochyena', 80200, 10, undefined, undefined, ShadowStatus.Shadow),
        ...
        [
            new DungeonTrainer('Thug',
                [new GymPokemon('Zangoose', 58000000, 28, undefined, undefined, ShadowStatus.Shadow)], { weight: 1 }, 'Zook'),
            new DungeonTrainer('Cipher Admin',
                [
    ...
    DungeonList['Cipher Key Lair'] = new Dungeon('Cipher Key Lair',
        [
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(25, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Kollo', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Ledian', 6708000, 28),
                    new GymPokemon('Illumise', 6708000, 31),
                ], { weight: 1, requirement: new ClearDungeonRequirement(50, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Grezle', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Clamperl', 6708000, 31),
                    new GymPokemon('Octillery', 6708000, 31),
                ], { weight: 1, requirement: new ClearDungeonRequirement(75, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Kollo', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Minun', 6708000, 30),
                    new GymPokemon('Beautifly', 6708000, 30),
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Grezle', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(125, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Ibsol', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Masquerain', 6708000, 31),
                    new GymPokemon('Bellossom', 6708000, 32),
                ], { weight: 1, requirement: new ClearDungeonRequirement(150, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Jelstin', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Plusle', 6708000, 30),
                    new GymPokemon('Dustox', 6708000, 30),
                ], { weight: 1, requirement: new ClearDungeonRequirement(175, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Ibsol', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Roselia', 6708000, 32),
                    new GymPokemon('Hoppip', 6708000, 32),
                ], { weight: 1, requirement: new ClearDungeonRequirement(200, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Jelstin', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
            ...
            new DungeonTrainer('Cipher Peon',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(225, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Kleto', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Noctowl', 6708000, 30),
                    new GymPokemon('Mightyena', 6708000, 29),
                ], { weight: 1, requirement: new ClearDungeonRequirement(250, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Flipis', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Absol', 6708000, 30),
                    new GymPokemon('Smeargle', 6708000, 31),
                    new GymPokemon('Tentacruel', 6708000, 31),
                ], { weight: 1, requirement: new ClearDungeonRequirement(275, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Kleto', 'XD (female)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Chimecho', 6708000, 31),
                    new GymPokemon('Kecleon', 6708000, 30),
                ], { weight: 1, requirement: new ClearDungeonRequirement(300, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Flipis', 'XD (male)'),
            new DungeonTrainer('Cipher Peon',
                [
            ...
            new DungeonTrainer('Scientist',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(325, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Hospel', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Ariados', 6708000, 30),
                    new GymPokemon('Girafarig', 6708000, 29),
                    new GymPokemon('Granbull', 6708000, 31),
                ], { weight: 1, requirement: new ClearDungeonRequirement(350, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Hospel', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
            ...
            new DungeonTrainer('Cipher',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(375, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Peon Fudler', '(commander)'),
            new DungeonTrainer('Cipher',
                [
                    new GymPokemon('Machoke', 6708000, 31),
                    new GymPokemon('Golem', 6708000, 31),
                    new GymPokemon('Forretress', 6708000, 31),
                ], { weight: 1, requirement: new ClearDungeonRequirement(400, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Peon Fudler', '(commander)'),
            new DungeonTrainer('Cipher',
                [
            ...
            new DungeonTrainer('Scientist',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(425, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Acrod', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Grumpig', 6708000, 34),
                    new GymPokemon('Seadra', 6708000, 34),
                    new GymPokemon('Camerupt', 6708000, 35),
                ], { weight: 1, requirement: new ClearDungeonRequirement(450, getDungeonIndex('Cipher Key Lair'), AchievementOption.less) }, 'Acrod', '(male)'),
            new DungeonTrainer('Cipher Peon',
                [
        ...
        [
            ...
            new DungeonTrainer('Cipher',
                [
                    ...
                    new GymPokemon('Hitmonchan', 7409000, 38, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 1 }, 'Peon Karbon', '(commander)'),
            new DungeonTrainer('Cipher',
                [
                    new GymPokemon('Metang', 7409000, 39),
                    new GymPokemon('Hariyama', 7409000, 39),
                    new GymPokemon('Hitmonlee', 7409000, 38, undefined, undefined, ShadowStatus.Shadow),
                ], { weight: 1 }, 'Peon Petro', '(commander)'),
            new DungeonTrainer('Cipher Peon',
                [
                    new GymPokemon('Magneton', 7409000, 41),
                    new GymPokemon('Lickitung', 7409000, 38, undefined, undefined, ShadowStatus.Shadow),
    ...
    DungeonList['Citadark Isle Dome'] = new Dungeon('Citadark Isle Dome', // Difficulty comperable to Pokéball Factory
        [
            ...
            new DungeonTrainer('Cipher Peon',
                [
                    ...
                    new GymPokemon('Dugtrio', 7409000, 40, undefined, undefined, ShadowStatus.Shadow),
            ...
            new DungeonTrainer('Scientist',
                ...
                ], { weight: 1, requirement: new ClearDungeonRequirement(100, getDungeonIndex('Citadark Isle Dome'), AchievementOption.less) }, 'Loket', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Cradily', 8173950, 44),
                    new GymPokemon('Milotic', 8173950, 44),
                    new GymPokemon('Gyarados', 8173950, 42),
                ], { weight: 1, requirement: new ClearDungeonRequirement(150, getDungeonIndex('Citadark Isle Dome'), AchievementOption.less) }, 'Kaller', '(male)'),
            new DungeonTrainer('Cipher Admin',
                [
            ...
            new DungeonTrainer('Scientist',
                [
                    ...
                    new GymPokemon('Slaking', 8173950, 43),
                ], { weight: 1, requirement: new ClearDungeonRequirement(200, getDungeonIndex('Citadark Isle Dome'), AchievementOption.less) }, 'Loket', '(male)'),
            new DungeonTrainer('Scientist',
                [
                    new GymPokemon('Corsola', 8173950, 44),
                    new GymPokemon('Tentacruel', 8173950, 44),
                    new GymPokemon('Gyarados', 8173950, 42),
                ], { weight: 1, requirement: new ClearDungeonRequirement(250, getDungeonIndex('Citadark Isle Dome'), AchievementOption.less) }, 'Kaller', '(male)'),
        ],
        {
            common: [
                { loot: 'xAttack' },
        ...
        [
            new DungeonTrainer('Grand Master',
                [new GymPokemon('XD001', 83753718, 50, undefined, undefined, ShadowStatus.Shadow)],
    ...
    DungeonList['Mt. Coronet North'] = new Dungeon('Mt. Coronet North',
        ['Clefairy', 'Zubat', 'Machop', 'Geodude', 'Magikarp', 'Noctowl', 'Meditite', 'Barboach', 'Chingling', 'Bronzor', 'Snover'],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(350, getDungeonIndex('Mt. Coronet North')) },
            ],
        },
        1111500,
        [
    ...
    DungeonList['Team Galactic HQ'] = new Dungeon('Team Galactic HQ',
        ...
        ],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(350, getDungeonIndex('Team Galactic HQ')) },
            ],
        },
        1295400,
        [
    ...
    DungeonList['Victory Road Sinnoh'] = new Dungeon('Victory Road Sinnoh',
        ...
        ],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Heart Scale' },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(350, getDungeonIndex('Victory Road Sinnoh')) },
            ],
        },
        1503000,
        [
    ...
    DungeonList['Flower Paradise'] = new Dungeon('Flower Paradise',
        ...
        [
            ...
            new DungeonBossPokemon('Bulbasaur (Rose)', 16000000, 100, {
                hide: true,
                requirement: new MultiRequirement([
                    new ClearDungeonRequirement(10, getDungeonIndex('Flower Paradise')),
    ...
    DungeonList['Seaside Cave'] = new Dungeon('Seaside Cave',
        ...
        ],
        {
            ...
            mythic: [
                { loot: 'Heart Scale' },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(300, getDungeonIndex('Seaside Cave')) },
            ],
        },
        4203000,
        [
        ...
        [
            ...
            new DungeonBossPokemon('Kyurem', 35000000, 100, { requirement: new MultiRequirement([
                ...
                new OneFromManyRequirement([
                    ...
                    new QuestLineStartedRequirement('Swords of Justice', AchievementOption.less),
                ]),
            ]),
            }),
            new DungeonBossPokemon('Genesect (High-Speed Chill)', 62000000, 100, {
    ...
    DungeonList['Dragonspiral Tower'] = new Dungeon('Dragonspiral Tower',
        ['Dratini', 'Dragonair', 'Tranquill', 'Basculin (Red-Striped)', 'Basculin (Blue-Striped)', 'Vanillish', 'Sawsbuck (Spring)', 'Sawsbuck (Summer)', 'Sawsbuck (Autumn)', 'Sawsbuck (Winter)', 'Beartic', 'Mienfoo', 'Mienshao', 'Golett', 'Golurk'],
        {
            ...
            mythic: [
                { loot: 'Heart Scale' },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(300, getDungeonIndex('Dragonspiral Tower')) },
            ],
        },
        5203000,
        [
    ...
    DungeonList['Moor of Icirrus'] = new Dungeon('Moor of Icirrus',
        ...
        ],
        {
            ...
            mythic: [
                { loot: 'Heart Scale' },
                { loot: 'Max Revive' },
                { loot: 'Lum', requirement: new ClearDungeonRequirement(200, getDungeonIndex('Moor of Icirrus')) },
            ],
        },
        5203000,
        [
    ...
    DungeonList['P2 Laboratory'] = new Dungeon('P2 Laboratory',
        ...
        [
            ...
            new DungeonTrainer('Team Plasma',
                ...
                ], { hide: true, weight: 1, requirement: new QuestLineCompletedRequirement('The Legend Awakened', AchievementOption.less) }, 'Colress', '(colress)'),
    ...
    DungeonList['Kalos Power Plant'] = new Dungeon('Kalos Power Plant',
        ...
        [
            ...
            new DungeonBossPokemon('Volcanion', 83945700, 100,
                {
                    requirement: new MultiRequirement([
                        new ClearDungeonRequirement(5, getDungeonIndex('Kalos Power Plant')),
    ...
    DungeonList['Victory Road Kalos'] = new Dungeon('Victory Road Kalos',
        ...
        ],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Heart Scale' },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(250, getDungeonIndex('Victory Road Kalos')) },
            ],
        },
        9003000,
        [
    ...
    DungeonList['Hau\'oli Cemetery'] = new Dungeon('Hau\'oli Cemetery',
        ...
        [
            ...
            new DungeonBossPokemon('Litwick', 28968625, 9, { hide: true, requirement: new DayOfWeekRequirement(DayOfWeek.Saturday) }),
        ],
        800000, 2);
    ...
    DungeonList['Verdant Cavern'] = new Dungeon('Verdant Cavern',
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 5, AchievementOption.less) }, 'of Verdant Cavern'),
        ],
        805000, 2);
    ...
    DungeonList['Ten Carat Hill'] = new Dungeon('Ten Carat Hill',
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new QuestLineCompletedRequirement('Welcome to Paradise, Cousin!', AchievementOption.less) }, 'of Ten Carat Hill'),
        ],
        835000, 3);
    ...
    DungeonList['Brooklet Hill'] = new Dungeon('Brooklet Hill',
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new QuestLineStepCompletedRequirement('Symbiotic Relations', 1, AchievementOption.less) }, 'of Brooklet Hill'),
        ],
        875000, 5);
    ...
    DungeonList['Wela Volcano Park'] = new Dungeon('Wela Volcano Park',
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new QuestLineStepCompletedRequirement('Symbiotic Relations', 4, AchievementOption.less) }, 'of Wela Volcano Park'),
        ],
        900000, 7);
    ...
    DungeonList['Lush Jungle'] = new Dungeon('Lush Jungle',
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new QuestLineStepCompletedRequirement('Symbiotic Relations', 5, AchievementOption.less) }, 'of Lush Jungle'),
        ],
        925000, 8);
    ...
    DungeonList['Malie Garden'] = new Dungeon('Malie Garden',
        ...
        [
            ...
            new DungeonTrainer('Tourist Couple',
                ...
                { weight: 1, hide: true, requirement: new QuestLineStepCompletedRequirement('Child of the Stars', 2, AchievementOption.less) }, 'Landon and Yuriko'),
    ...
    DungeonList['Hokulani Observatory'] = new Dungeon('Hokulani Observatory',
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new QuestLineStepCompletedRequirement('Child of the Stars', 2, AchievementOption.less) }, 'of Hokulani Observatory'),
        ],
        1000000, 22);
    ...
    DungeonList['Thrifty Megamart'] = new Dungeon('Thrifty Megamart',
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new QuestLineStepCompletedRequirement('Child of the Stars', 5, AchievementOption.less) }, 'of Thrifty Megamart'),
    ...
    DungeonList['Aether Foundation'] = new Dungeon('Aether Foundation',
        ...
        ],
        {
            ...
            legendary: [
                { loot: 'Max Revive' },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(200, getDungeonIndex('Aether Foundation')) },
            ],
        },
        15619682,
        [
            new DungeonTrainer('Dulse',
                ...
                { weight: 0.25, hide: true, requirement: new QuestLineStepCompletedRequirement('Child of the Stars', 12, AchievementOption.less) }),
    ...
    DungeonList['Exeggutor Island Hill'] = new Dungeon('Exeggutor Island Hill',
        [
            { pokemon: 'Alolan Exeggutor', options: { weight: 1, hide: true, requirement: new OneFromManyRequirement([new QuestLineStepCompletedRequirement('Emissary of Light', 2, AchievementOption.less), new SpecialEventRequirement('Hoopa Day')]) } },
            { pokemon: 'Alolan Exeggutor', options: { weight: 1, hide: true, requirement: new OneFromManyRequirement([new QuestLineStepCompletedRequirement('Emissary of Light', 2, AchievementOption.less), new SpecialEventRequirement('Hoopa Day')]) } },
        ...
        [
            ...
            new DungeonBossPokemon('Serperior', 78865330, 43, { hide: true, requirement: new MultiRequirement([new DayOfWeekRequirement(DayOfWeek.Thursday), new QuestLineStepCompletedRequirement('Emissary of Light', 2)]) }),
            new DungeonBossPokemon('Chesnaught', 78865330, 45, { hide: true, requirement: new MultiRequirement([new DayOfWeekRequirement(DayOfWeek.Thursday), new QuestLineStepCompletedRequirement('Emissary of Light', 2)]) }),
        ],
        1100000, 24);
    ...
    DungeonList['Vast Poni Canyon'] = new Dungeon('Vast Poni Canyon',
        ...
        ],
        {
            ...
            mythic: [
                { loot: 'Heart Scale' },
                { loot: 'Protein', requirement: new ClearDungeonRequirement(200, getDungeonIndex('Vast Poni Canyon')) },
            ],
        },
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new QuestLineStepCompletedRequirement('Emissary of Light', 5, AchievementOption.less) }, 'of Vast Poni Canyon'),
        ],
    ...
    DungeonList['Mina\'s Houseboat'] = new Dungeon('Mina\'s Houseboat',
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new QuestLineStepCompletedRequirement('Eater of Light', 3, AchievementOption.less) }, 'of Mina\'s Houseboat'),
        ],
        1150000, 25);
        ...
        [
            ...
            new DungeonTrainer('Trial Site',
                ...
                { hide: true, weight: 10, requirement: new MultiRequirement([
                    ...
                    new QuestLineCompletedRequirement('Eater of Light', AchievementOption.less),
                ]) }, 'of Mount Lanakila'),
        ],
        1175000, 26);
    ...
    DungeonList['Energy Plant'] = new Dungeon('Energy Plant',
        ...
        [
            new DungeonTrainer('Macro Cosmos',
                ...
                { hide: true, weight: 3, requirement: new QuestLineStepCompletedRequirement('The Lair of Giants', 36, AchievementOption.less) }, 'Rose', '(rose)'),
            new DungeonTrainer('Macro Cosmos',
                [
                    new GymPokemon('Escavalier', 26704124, 50),
                    new GymPokemon('Ferrothorn', 26704124, 50),
    ...
    DungeonList['Tower of Darkness'] = new Dungeon('Tower of Darkness',
        ...
        [
            new DungeonBossPokemon('Urshifu (Single Strike)', 160924440, 60, {
                requirement: new MultiRequirement([
                    new ClearDungeonRequirement(1, getDungeonIndex('Tower of Darkness')),
    ...
    DungeonList['Tower of Waters'] = new Dungeon('Tower of Waters',
        ...
        [
            new DungeonBossPokemon('Urshifu (Rapid Strike)', 160924440, 60, {
                requirement: new MultiRequirement([
                    new ClearDungeonRequirement(1, getDungeonIndex('Tower of Waters')),
    ...
    DungeonList['Ancient Wayward Cave'] = new Dungeon('Ancient Wayward Cave',
        ['Zubat', 'Golbat', 'Barboach', 'Whiscash', 'Gible'],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Lum', requirement: new ClearDungeonRequirement(100, getDungeonIndex('Ancient Wayward Cave')) },
            ],
        },
        2603000,
    ...
    DungeonList['Ancient Quarry'] = new Dungeon('Ancient Quarry',
        ['Bronzor', 'Goomy', 'Stunky', 'Croagunk', 'Skuntank', 'Toxicroak'],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Lum', requirement: new ClearDungeonRequirement(100, getDungeonIndex('Ancient Quarry')) },
            ],
        },
        2603000,
        [
    ...
    DungeonList['Primeval Grotto'] = new Dungeon('Primeval Grotto',
        ['Bronzor', 'Scyther', 'Gligar', 'Nosepass', 'Gyarados', 'Cherubi', 'Cherrim (Overcast)'],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Lum', requirement: new ClearDungeonRequirement(100, getDungeonIndex('Primeval Grotto')) },
            ],
        },
        2603000,
        [
    ...
    DungeonList['Clamberclaw Cliffs'] = new Dungeon('Clamberclaw Cliffs',
        ['Gligar', 'Geodude', 'Graveler', 'Gastly', 'Haunter', 'Gible', 'Burmy (Sand)', 'Wormadam (Sand)', 'Bronzor'],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Lum', requirement: new ClearDungeonRequirement(100, getDungeonIndex('Clamberclaw Cliffs')) },
            ],
        },
        2603000,
        [
    ...
    DungeonList['Celestica Ruins'] = new Dungeon('Celestica Ruins',
        ['Geodude', 'Graveler', 'Nosepass', 'Gligar', 'Burmy (Sand)', 'Gastly', 'Haunter', 'Bonsly', 'Misdreavus'],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Lum', requirement: new ClearDungeonRequirement(100, getDungeonIndex('Celestica Ruins')) },
            ],
        },
        2603000,
        [
    ...
    DungeonList['Temple of Sinnoh'] = new Dungeon('Temple of Sinnoh',
        ['Bronzong', 'Floatzel', 'Magnezone', 'Lumineon', 'Lucario', 'Bibarel', 'Garchomp'],
        {
            ...
            mythic: [
                { loot: 'Max Revive' },
                { loot: 'Lum', requirement: new ClearDungeonRequirement(100, getDungeonIndex('Temple of Sinnoh')) },
            ],
        },
        1350400,
        [
