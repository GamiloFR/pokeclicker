...
import EvolutionStone from './EvolutionStone';
import FarmHandItem from './FarmHandItem';
import FluteItem from './FluteItem';
import HatcheryHelperItem from './HatcheryHelperItem';
import AttackBonusHeldItem from './heldItem/AttackBonusHeldItem';
...
import HybridAttackBonusHeldItem from './heldItem/HybridAttackBonusHeldItem';
...
import TypeRestrictedExceptionAttackBonusHeldItem from './heldItem/TypeRestrictedExceptionAttackBonusHeldItem';
...
import ZCrystalItem from './ZCrystalItem';
...
function initItems() {
    ...
    ItemList['Silvally (Fighting) 1'] = new PokemonItem('Silvally (Fighting)', undefined, undefined, false, 'Silvally (Fighting)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 3, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Fighting)', true)]) }, 'Silvally (Fighting) 1');
    ...
    ItemList['Silvally (Rock) 1'] = new PokemonItem('Silvally (Rock)', undefined, undefined, false, 'Silvally (Rock)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 3, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Rock)', true)]) }, 'Silvally (Rock) 1');
    ...
    ItemList['Silvally (Dark) 1'] = new PokemonItem('Silvally (Dark)', undefined, undefined, false, 'Silvally (Dark)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 3, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Dark)', true)]) }, 'Silvally (Dark) 1');
    ...
    ItemList['Silvally (Fairy) 1'] = new PokemonItem('Silvally (Fairy)', undefined, undefined, false, 'Silvally (Fairy)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 3, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Fairy)', true)]) }, 'Silvally (Fairy) 1');
    ...
    ItemList['Silvally (Water) 1'] = new PokemonItem('Silvally (Water)', undefined, undefined, false, 'Silvally (Water)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 17, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Water)', true)]) }, 'Silvally (Water) 1');
    ...
    ItemList['Silvally (Grass) 1'] = new PokemonItem('Silvally (Grass)', undefined, undefined, false, 'Silvally (Grass)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 17, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Grass)', true)]) }, 'Silvally (Grass) 1');
    ...
    ItemList['Silvally (Fire) 1'] = new PokemonItem('Silvally (Fire)', undefined, undefined, false, 'Silvally (Fire)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 17, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Fire)', true)]) }, 'Silvally (Fire) 1');
    ...
    ItemList['Silvally (Electric) 1'] = new PokemonItem('Silvally (Electric)', undefined, undefined, false, 'Silvally (Electric)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 17, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Electric)', true)]) }, 'Silvally (Electric) 1');
    ...
    ItemList['Silvally (Ice) 1'] = new PokemonItem('Silvally (Ice)', undefined, undefined, false, 'Silvally (Ice)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 17, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Ice)', true)]) }, 'Silvally (Ice) 1');
    ...
    ItemList['Silvally (Ground) 1'] = new PokemonItem('Silvally (Ground)', undefined, undefined, false, 'Silvally (Ground)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 17, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Ground)', true)]) }, 'Silvally (Ground) 1');
    ...
    ItemList['Silvally (Bug) 1'] = new PokemonItem('Silvally (Bug)', undefined, undefined, false, 'Silvally (Bug)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 33, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Bug)', true)]) }, 'Silvally (Bug) 1');
    ...
    ItemList['Silvally (Flying) 1'] = new PokemonItem('Silvally (Flying)', undefined, undefined, false, 'Silvally (Flying)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 33, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Flying)', true)]) }, 'Silvally (Flying) 1');
    ...
    ItemList['Silvally (Poison) 1'] = new PokemonItem('Silvally (Poison)', undefined, undefined, false, 'Silvally (Poison)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 33, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Poison)', true)]) }, 'Silvally (Poison) 1');
    ...
    ItemList['Silvally (Ghost) 1'] = new PokemonItem('Silvally (Ghost)', undefined, undefined, false, 'Silvally (Ghost)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 33, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Ghost)', true)]) }, 'Silvally (Ghost) 1');
    ...
    ItemList['Silvally (Psychic) 1'] = new PokemonItem('Silvally (Psychic)', undefined, undefined, false, 'Silvally (Psychic)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 33, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Psychic)', true)]) }, 'Silvally (Psychic) 1');
    ...
    ItemList['Silvally (Steel) 1'] = new PokemonItem('Silvally (Steel)', undefined, undefined, false, 'Silvally (Steel)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 33, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Steel)', true)]) }, 'Silvally (Steel) 1');
    ...
    ItemList['Silvally (Dragon) 1'] = new PokemonItem('Silvally (Dragon)', undefined, undefined, false, 'Silvally (Dragon)',
        { maxAmount: 1, visible: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 33, AchievementOption.more), new ObtainedPokemonRequirement('Silvally (Dragon)', true)]) }, 'Silvally (Dragon) 1');
    ...
    ItemList.Wonder_Chest = new ExpGainedBonusHeldItem('Wonder_Chest', 1.25, Region.johto, 10000, Currency.money, undefined, 'Wonder Chest');
    ItemList.Miracle_Chest = new ExpGainedBonusHeldItem('Miracle_Chest', 1.5, Region.sinnoh, 30000, Currency.money, { visible: new MaxRegionRequirement(Region.sinnoh) }, 'Miracle Chest');
    ItemList.Joy_Scent = new ExpGainedBonusHeldItem('Joy_Scent', 1.75, Region.hoenn, 10000, Currency.money, undefined, 'Joy Scent', ' the holding Shadow Pokémon', (p) => p.shadow >= ShadowStatus.Shadow );
    ItemList.Excite_Scent = new ExpGainedBonusHeldItem('Excite_Scent', 2, Region.hoenn, 10000, Currency.money, undefined, 'Excite Scent', 'the holding Shadow Pokémon', (p) => p.shadow >= ShadowStatus.Shadow);
    ItemList.Vivid_Scent = new ExpGainedBonusHeldItem('Vivid_Scent', 2.5, Region.hoenn, 10000, Currency.money, undefined, 'Vivid Scent', 'the holding Shadow Pokémon', (p) => p.shadow >= ShadowStatus.Shadow);
    ItemList.Muscle_Band = new AttackBonusHeldItem('Muscle_Band', 1.05, Region.hoenn, 1000, Currency.battlePoint, undefined, 'Muscle Band');
    // Pokemon specific items
    ItemList.Light_Ball = new PokemonRestrictedAttackBonusHeldItem('Light_Ball', 1.3, Region.johto, 10000, Currency.money, undefined, 'Light Ball', 'Pikachu', (pokemon) => Math.floor(pokemon.id) == 25);
    ItemList.Lucky_Punch = new PokemonRestrictedAttackBonusHeldItem('Lucky_Punch', 1.3, Region.sinnoh, 10000, Currency.money, undefined, 'Lucky Punch', 'Happiny, Chansey or Blissey', (pokemon) => Math.floor(pokemon.id) == 440 ||  Math.floor(pokemon.id) == 113 || Math.floor(pokemon.id) == 242);
    ItemList.Quick_Powder = new PokemonRestrictedAttackBonusHeldItem('Quick_Powder', 1.3, Region.kalos, 10000, Currency.money, undefined, 'Quick Powder', 'Ditto', (pokemon) => Math.floor(pokemon.id) == 132);
    ItemList.Thick_Club = new PokemonRestrictedAttackBonusHeldItem('Thick_Club', 1.3, Region.alola, 10000, Currency.money, undefined, 'Thick Club', 'Cubone or Marowak', (pokemon) => Math.floor(pokemon.id) == 104 ||  Math.floor(pokemon.id) == 105);
    ItemList.Soul_Dew = new PokemonRestrictedAttackBonusHeldItem('Soul_Dew', 1.5, Region.hoenn, 10000, Currency.money, undefined, 'Soul Dew', 'Latias or Latios', (pokemon) => Math.floor(pokemon.id) == 380 ||  Math.floor(pokemon.id) == 381);
    ItemList.Adamant_Orb = new PokemonRestrictedAttackBonusHeldItem('Adamant_Orb', 1.5, Region.sinnoh, 10000, Currency.money, undefined, 'Adamant Orb', 'Dialga', (pokemon) => Math.floor(pokemon.id) == 483);
    ItemList.Lustrous_Orb = new PokemonRestrictedAttackBonusHeldItem('Lustrous_Orb', 1.5, Region.sinnoh, 10000, Currency.money, undefined, 'Lustrous Orb', 'Palkia', (pokemon) => Math.floor(pokemon.id) == 484);
    ItemList.Griseous_Orb = new PokemonRestrictedAttackBonusHeldItem('Griseous_Orb', 1.5, Region.sinnoh, 10000, Currency.money, undefined, 'Griseous Orb', 'Giratina', (pokemon) => Math.floor(pokemon.id) == 487);
    ItemList.Gracidea = new PokemonRestrictedAttackBonusHeldItem('Gracidea', 1.5, Region.sinnoh, 200000, Currency.farmPoint, undefined, 'Gracidea', 'Shaymin', (pokemon) => Math.floor(pokemon.id) == 492);
    ItemList.Burn_Drive = new PokemonRestrictedAttackBonusHeldItem('Burn_Drive', 1.5, Region.unova, 10000, Currency.money, undefined, 'Burn Drive', 'Genesect', (pokemon) => pokemon.id == 649 || pokemon.id == 649.01 || pokemon.id == 649.05 || pokemon.id == 649.06);
    ItemList.Chill_Drive = new PokemonRestrictedAttackBonusHeldItem('Chill_Drive', 1.5, Region.unova, 10000, Currency.money, undefined, 'Chill Drive', 'Genesect', (pokemon) => pokemon.id == 649 || pokemon.id == 649.02 || pokemon.id == 649.05 || pokemon.id == 649.07);
    ItemList.Douse_Drive = new PokemonRestrictedAttackBonusHeldItem('Douse_Drive', 1.5, Region.unova, 10000, Currency.money, undefined, 'Douse Drive', 'Genesect', (pokemon) => pokemon.id == 649 || pokemon.id == 649.03 || pokemon.id == 649.05 || pokemon.id == 649.08);
    ItemList.Shock_Drive = new PokemonRestrictedAttackBonusHeldItem('Shock_Drive', 1.5, Region.unova, 10000, Currency.money, undefined, 'Shock Drive', 'Genesect', (pokemon) => pokemon.id == 649 || pokemon.id == 649.04 || pokemon.id == 649.05 || pokemon.id == 649.09);
    ItemList.Great_Twisted_Spoon = new PokemonRestrictedAttackBonusHeldItem('Great_Twisted_Spoon', 1.5, Region.kalos, 10000, Currency.money, undefined, 'Great Twisted Spoon', 'Mewtwo', (pokemon) => Math.floor(pokemon.id) == 150);
    ItemList.Leek = new PokemonRestrictedAttackBonusHeldItem('Leek', 1.3, Region.galar, 10000, Currency.money, undefined, 'Leek', 'Farfetch\'d or Sirfetch\'d', (pokemon) => Math.floor(pokemon.id) == 83 || Math.floor(pokemon.id) == 865);
    ItemList.Rusted_Sword = new PokemonRestrictedAttackBonusHeldItem('Rusted_Sword', 1.5, Region.galar, 10000, Currency.money, undefined, 'Rusted Sword', 'Zacian', (pokemon) => Math.floor(pokemon.id) == 888);
    ItemList.Rusted_Shield = new PokemonRestrictedAttackBonusHeldItem('Rusted_Shield', 1.5, Region.galar, 10000, Currency.money, undefined, 'Rusted Shield', 'Zamazenta', (pokemon) => Math.floor(pokemon.id) == 889);
    ItemList.Wellspring_Mask = new PokemonRestrictedAttackBonusHeldItem('Wellspring_Mask', 1.5, Region.paldea, 10000, Currency.money, undefined, 'Wellspring Mask', 'Ogerpon', (pokemon) => pokemon.id == 1017 || pokemon.id == 1017.01 || pokemon.id == 1017.04 || pokemon.id == 1017.05);
    ItemList.Hearthflame_Mask = new PokemonRestrictedAttackBonusHeldItem('Hearthflame_Mask', 1.5, Region.paldea, 10000, Currency.money, undefined, 'Hearthflame Mask', 'Ogerpon', (pokemon) => pokemon.id == 1017 || pokemon.id == 1017.02 || pokemon.id == 1017.04 || pokemon.id == 1017.06);
    ItemList.Cornerstone_Mask = new PokemonRestrictedAttackBonusHeldItem('Cornerstone_Mask', 1.5, Region.paldea, 10000, Currency.money, undefined, 'Cornerstone Mask', 'Ogerpon', (pokemon) => pokemon.id == 1017 || pokemon.id == 1017.03 || pokemon.id == 1017.04 || pokemon.id == 1017.07);
    ItemList.Booster_Energy = new PokemonRestrictedAttackBonusHeldItem('Booster_Energy', 1.33, Region.paldea, 10000, Currency.money, undefined, 'Booster Energy', /*16 Pokémon. Probably too many to list.*/'Paradox Pokémon', (pokemon) => [984, 985, 986, 987, 988, 989, 990, 991, 992, 993, 994, 995, 1005, 1006, 1009, 1010, 1020, 1021, 1022, 1023].includes(Math.floor(pokemon.id)));

    // Type specific items
    ItemList.Black_Belt = new TypeRestrictedAttackBonusHeldItem('Black_Belt', 1.2, PokemonType.Fighting, Region.johto, 10000, Currency.money, undefined, 'Black Belt');
    // Exceptions as Squirtle level evolves into Squad Leader Squirtle if it wears Black Glasses
    ItemList.Black_Glasses = new TypeRestrictedExceptionAttackBonusHeldItem('Black_Glasses', 1.2, PokemonType.Dark, Region.johto, { Squirtle: true, 'Squad Leader Squirtle': false }, 10000, Currency.money, undefined, 'Black Glasses');
    ItemList.Charcoal = new TypeRestrictedAttackBonusHeldItem('Charcoal', 1.2, PokemonType.Fire, Region.johto, 10000, Currency.money, undefined, 'Charcoal');
    ItemList.Dragon_Fang = new TypeRestrictedAttackBonusHeldItem('Dragon_Fang', 1.2, PokemonType.Dragon, Region.johto, 10000, Currency.money, undefined, 'Dragon Fang');
    ItemList.Magnet = new TypeRestrictedAttackBonusHeldItem('Magnet', 1.2, PokemonType.Electric, Region.johto, 10000, Currency.money, undefined, 'Magnet');
    ItemList.Metal_Powder = new TypeRestrictedAttackBonusHeldItem('Metal_Powder', 1.2, PokemonType.Steel, Region.johto, 10000, Currency.money, undefined, 'Metal Powder');
    ItemList.Miracle_Seed = new TypeRestrictedAttackBonusHeldItem('Miracle_Seed', 1.2, PokemonType.Grass, Region.johto, 10000, Currency.money, undefined, 'Miracle Seed');
    ItemList.Mystic_Water = new TypeRestrictedAttackBonusHeldItem('Mystic_Water', 1.2, PokemonType.Water, Region.johto, 10000, Currency.money, undefined, 'Mystic Water');
    ItemList.Never_Melt_Ice = new TypeRestrictedAttackBonusHeldItem('Never_Melt_Ice', 1.2, PokemonType.Ice, Region.johto, 10000, Currency.money, undefined, 'Never-Melt Ice');
    ItemList.Fairy_Feather = new TypeRestrictedAttackBonusHeldItem('Fairy_Feather', 1.2, PokemonType.Fairy, Region.johto, 10000, Currency.money, undefined, 'Fairy Feather');
    ItemList.Poison_Barb = new TypeRestrictedAttackBonusHeldItem('Poison_Barb', 1.2, PokemonType.Poison, Region.johto, 10000, Currency.money, undefined, 'Poison Barb');
    ItemList.Rock_Incense = new TypeRestrictedAttackBonusHeldItem('Rock_Incense', 1.2, PokemonType.Rock, Region.johto, 10000, Currency.money, undefined, 'Rock Incense');
    ItemList.Sharp_Beak = new TypeRestrictedAttackBonusHeldItem('Sharp_Beak', 1.2, PokemonType.Flying, Region.johto, 10000, Currency.money, undefined, 'Sharp Beak');
    ItemList.Silk_Scarf = new TypeRestrictedAttackBonusHeldItem('Silk_Scarf', 1.2, PokemonType.Normal, Region.johto, 10000, Currency.money, undefined, 'Silk Scarf');
    ItemList.Silver_Powder = new TypeRestrictedAttackBonusHeldItem('Silver_Powder', 1.2, PokemonType.Bug, Region.johto, 10000, Currency.money, undefined, 'Silver Powder');
    ItemList.Soft_Sand = new TypeRestrictedAttackBonusHeldItem('Soft_Sand', 1.2, PokemonType.Ground, Region.johto, 10000, Currency.money, undefined, 'Soft Sand');
    ItemList.Spell_Tag = new TypeRestrictedAttackBonusHeldItem('Spell_Tag', 1.2, PokemonType.Ghost, Region.johto, 10000, Currency.money, undefined, 'Spell Tag');
    ItemList.Twisted_Spoon = new TypeRestrictedAttackBonusHeldItem('Twisted_Spoon', 1.2, PokemonType.Psychic, Region.johto, 10000, Currency.money, undefined, 'Twisted Spoon');

    ItemList.Agile_Scroll = new HybridAttackBonusHeldItem('Agile_Scroll', 0.5, 2.0, Region.hisui, 10000, Currency.money, undefined, 'Agile Scroll');
    ItemList.Strong_Scroll = new HybridAttackBonusHeldItem('Strong_Scroll', 2.0, 0.5, Region.hisui, 10000, Currency.money, undefined, 'Strong Scroll');

    ItemList.Power_Herb = new AttackBonusHeldItem('Power_Herb', 1.5, Region.alola, undefined, Currency.money, undefined, 'Power Herb', undefined, () => true,
        () => App.game.gameState == GameState.dungeon && DungeonRunner.fightingBoss(), ' against Dungeon Bosses');

    ItemList.Macho_Brace = new EVsGainedBonusHeldItem('Macho_Brace', 1.5, Region.sinnoh, 1500, Currency.questPoint, undefined, 'Macho Brace');
    ItemList.Power_Bracer = new EVsGainedBonusHeldItem('Power_Bracer', 2, Region.alola, 2000, Currency.questPoint, undefined, 'Power Bracer');

    ItemList.Everstone = new HeldItem(
        'Everstone',
        Region.kanto,
        (pokemon) => {
        // level or stone evo
        ...
        undefined,
        'Everstone',
        'Stops the holder from evolving due to level or a stone being used. Also prevents new baby Pokémon from hatching.',
    );

    // Berry Masters
    ItemList.HatcheryHelperJasmine = new HatcheryHelperItem('Jasmine', 10000000, Currency.money);
    ItemList.HatcheryHelperDakota = new HatcheryHelperItem('Dakota', 100000, Currency.dungeonToken);
    ItemList.HatcheryHelperCameron = new HatcheryHelperItem('Cameron', 100000, Currency.farmPoint);
    ItemList.HatcheryHelperCarey  = new HatcheryHelperItem('Carey', 10000, Currency.questPoint);
    ItemList.HatcheryHelperKris   = new HatcheryHelperItem('Kris', 8000, Currency.diamond);
    ItemList.HatcheryHelperNoel   = new HatcheryHelperItem('Noel', 20000, Currency.battlePoint);
    ItemList.HatcheryHelperLeslie   = new HatcheryHelperItem('Leslie', 10000, Currency.money);

    // TODO: Set prices for different kinds of stones
    ItemList.Leaf_stone        = new EvolutionStone(StoneType.Leaf_stone, 2500, undefined, 'Leaf Stone');
    ItemList.Fire_stone        = new EvolutionStone(StoneType.Fire_stone, 2500, undefined, 'Fire Stone');
    ItemList.Water_stone       = new EvolutionStone(StoneType.Water_stone, 2500, undefined, 'Water Stone');
    ItemList.Thunder_stone     = new EvolutionStone(StoneType.Thunder_stone, 2500, undefined, 'Thunder Stone');
    ItemList.Moon_stone        = new EvolutionStone(StoneType.Moon_stone, 2500, undefined, 'Moon Stone');
    ItemList.Linking_cord      = new EvolutionStone(StoneType.Linking_cord, 2500, undefined, 'Linking Cord');
    ItemList.Sun_stone         = new EvolutionStone(StoneType.Sun_stone, 2500, undefined, 'Sun Stone');
    ItemList.Soothe_bell       = new EvolutionStone(StoneType.Soothe_bell, 2500, undefined, 'Soothe Bell');
    ItemList.Metal_coat        = new EvolutionStone(StoneType.Metal_coat, 2500, undefined, 'Metal Coat');
    ItemList.Kings_rock        = new EvolutionStone(StoneType.Kings_rock, 2500, undefined, 'King\'s Rock');
    ItemList.Upgrade           = new EvolutionStone(StoneType.Upgrade, 2500, undefined, 'Upgrade');
    ItemList.Dragon_scale      = new EvolutionStone(StoneType.Dragon_scale, 2500, undefined, 'Dragon Scale');
    ItemList.Prism_scale       = new EvolutionStone(StoneType.Prism_scale, 2500, undefined, 'Prism Scale');
    ItemList.Deepsea_tooth     = new EvolutionStone(StoneType.Deepsea_tooth, 2500, undefined, 'Deep Sea Tooth');
    ItemList.Deepsea_scale     = new EvolutionStone(StoneType.Deepsea_scale, 2500, undefined, 'Deep Sea Scale');
    ItemList.Shiny_stone       = new EvolutionStone(StoneType.Shiny_stone, 2500, undefined, 'Shiny Stone');
    ItemList.Dusk_stone        = new EvolutionStone(StoneType.Dusk_stone, 2500, undefined, 'Dusk Stone');
    ItemList.Dawn_stone        = new EvolutionStone(StoneType.Dawn_stone, 2500, undefined, 'Dawn Stone');
    ItemList.Razor_claw        = new EvolutionStone(StoneType.Razor_claw, 2500, undefined, 'Razor Claw');
    ItemList.Razor_fang        = new EvolutionStone(StoneType.Razor_fang, 2500, undefined, 'Razor Fang');
    ItemList.Electirizer       = new EvolutionStone(StoneType.Electirizer, 2500, undefined, 'Electirizer');
    ItemList.Magmarizer        = new EvolutionStone(StoneType.Magmarizer, 2500, undefined, 'Magmarizer');
    ItemList.Protector         = new EvolutionStone(StoneType.Protector, 2500, undefined, 'Protector');
    ItemList.Dubious_disc      = new EvolutionStone(StoneType.Dubious_disc, 2500, undefined, 'Dubious Disc');
    ItemList.Reaper_cloth      = new EvolutionStone(StoneType.Reaper_cloth, 2500, undefined, 'Reaper Cloth');
    ItemList.Black_DNA         = new EvolutionStone(StoneType.Black_DNA, 2500, undefined, 'Black DNA');
    ItemList.White_DNA         = new EvolutionStone(StoneType.White_DNA, 2500, undefined, 'White DNA');
    ItemList.Sachet            = new EvolutionStone(StoneType.Sachet, 2500, undefined, 'Sachet');
    ItemList.Whipped_dream     = new EvolutionStone(StoneType.Whipped_dream, 2500, undefined, 'Whipped Dream');
    ItemList.Key_stone         = new EvolutionStone(StoneType.Key_stone, 250, Currency.battlePoint, 'Key Stone', Region.kalos, { multiplier: 1.1, multiplierDecrease: false });
    ItemList.Ice_stone         = new EvolutionStone(StoneType.Ice_stone, 2500, undefined, 'Ice Stone');
    ItemList.Solar_light       = new EvolutionStone(StoneType.Solar_light, 2500, undefined, 'Solar Light');
    ItemList.Lunar_light       = new EvolutionStone(StoneType.Lunar_light, 2500, undefined, 'Lunar Light');
    ItemList.Pure_light        = new EvolutionStone(StoneType.Pure_light, 2500, undefined, 'Pure Light');
    ItemList.Crystallized_shadow = new EvolutionStone(StoneType.Crystallized_shadow, 2500, undefined, 'Crystallized Shadow');
    ItemList.Sweet_apple       = new EvolutionStone(StoneType.Sweet_apple, 5000, undefined, 'Sweet Apple');
    ItemList.Tart_apple        = new EvolutionStone(StoneType.Tart_apple, 5000, undefined, 'Tart Apple');
    ItemList.Cracked_pot       = new EvolutionStone(StoneType.Cracked_pot, 5000, undefined, 'Cracked Pot');
    ItemList.Galarica_cuff     = new EvolutionStone(StoneType.Galarica_cuff, 5000, undefined, 'Galarica Cuff');
    ItemList.Galarica_wreath   = new EvolutionStone(StoneType.Galarica_wreath, 5000, undefined, 'Galarica Wreath');
    ItemList.Black_mane_hair   = new EvolutionStone(StoneType.Black_mane_hair, 2500, undefined, 'Black Mane Hair');
    ItemList.White_mane_hair   = new EvolutionStone(StoneType.White_mane_hair, 2500, undefined, 'White Mane Hair');
    ItemList.Black_augurite    = new EvolutionStone(StoneType.Black_augurite, 500, undefined, 'Black Augurite');
    ItemList.Peat_block        = new EvolutionStone(StoneType.Peat_block, 5000, Currency.diamond, 'Peat Block');
    ItemList.Auspicious_armor  = new EvolutionStone(StoneType.Auspicious_armor, 5000, undefined, 'Auspicious Armor');
    ItemList.Malicious_armor   = new EvolutionStone(StoneType.Malicious_armor, 5000, undefined, 'Malicious Armor');
    ItemList.Leaders_crest     = new EvolutionStone(StoneType.Leaders_crest, 5000, undefined, 'Leader\'s Crest');
    ItemList.Gimmighoul_coin   = new EvolutionStone(StoneType.Gimmighoul_coin, 5000, undefined, 'Gimmighoul Coin');
    ItemList.Syrupy_apple      = new EvolutionStone(StoneType.Syrupy_apple, 5000, undefined, 'Syrupy Apple');
    ItemList.Unremarkable_teacup   = new EvolutionStone(StoneType.Unremarkable_teacup, 5000, undefined, 'Unremarkable Teacup');
    ItemList.Metal_alloy       = new EvolutionStone(StoneType.Metal_alloy, 5000, undefined, 'Metal Alloy');

    // Berry Masters
    ItemList.FarmHandBailey   = new FarmHandItem('Bailey', 50000, Currency.farmPoint); // Johto (50k)
    ItemList.FarmHandKerry   = new FarmHandItem('Kerry', 100000, Currency.farmPoint); // Hoenn (100k)
    ItemList.FarmHandRiley   = new FarmHandItem('Riley', 200000, Currency.farmPoint); // Sinnoh (200k)
    //ItemList['FarmHandJessie']   = new FarmHandItem('Jessie', 500000, Currency.farmPoint); // Alola (500k) (not implemented)
    // Battle Frontier
    ItemList.FarmHandJamie   = new FarmHandItem('Jamie', 20000, Currency.battlePoint);

    // Z-Crystal
    zCrystalItemType.forEach((name, type) => {
