...
import { AchievementOption, AlolaSubRegions, GalarSubRegions, HoennSubRegions, JohtoSubRegions, KalosSubRegions, KantoSubRegions, PaldeaSubRegions, Region, SinnohSubRegions, UnovaSubRegions, getDungeonIndex } from '../GameConstants';
...
import AssistantNPC from './AssistantNPC';
import KantoBerryMasterNPC from './KantoBerryMasterNPC';
import NPC from './NPC';
import NPCNameType from './NPCNameType';
import PokemonGiftNPC from './PokemonGiftNPC';
import ProfNPC from './ProfNPC';
import RoamerNPC from './RoamerNPC';

const NPCList: Record<NPCNameType, NPC> = {} as Record<NPCNameType, NPC>;

export function initNPCList() {
    // Kanto NPCs
    NPCList.PalletProfOak = new ProfNPC('Prof. Oak',
        Region.kanto,
        ...
        new OneFromManyRequirement([new QuestLineStartedRequirement('Unfinished Business', AchievementOption.less), new QuestLineCompletedRequirement('Unfinished Business'), new QuestLineStepCompletedRequirement('Unfinished Business', 2)]));

    NPCList.PalletMom1 = new NPC('Mom', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Tutorial Quests', 2), new QuestLineStepCompletedRequirement('Tutorial Quests', 3, AchievementOption.less)]),
    });
    NPCList.PalletMom2 = new NPC('Mom', [
    ...
    NPCList.PalletCelebiProfOak1 = new NPC('Prof. Oak', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Unfinished Business'), new QuestLineStepCompletedRequirement('Unfinished Business', 1, AchievementOption.less)]),
    });
    NPCList.PalletCelebiProfOak2 = new NPC('Prof. Oak', [
        ...
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 1), new QuestLineStepCompletedRequirement('Unfinished Business', 2, AchievementOption.less)]),
    });
    NPCList.ViridianCityOldMan1 = new NPC('Old Man', [
        'Leave me alone. I need my coffee.',
    ], {
        image: 'assets/images/npcs/Old Man.png',
        requirement: new QuestLineStepCompletedRequirement('Tutorial Quests', 4, AchievementOption.less),
    });
    NPCList.ViridianCityOldMan2 = new NPC('Old Man', [
        ...
        image: 'assets/images/npcs/Old Man.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Tutorial Quests', 4), new QuestLineStepCompletedRequirement('Tutorial Quests', 5, AchievementOption.less)]),
    });
    NPCList.ViridianCityOldMan3 = new NPC('Old Man', [
        'You can use the Poké Ball Selector to select which type of Poké Ball to use on specific Pokémon based on caught status.',
        'For example, if you click on the empty ball next to the word "Caught" and assign a Poké Ball, you will then start throwing Poké Balls at Pokémon you\'ve already caught before. This can be very useful if you need Dungeon Tokens.',
        'I\'ll always be here to explain it again if you forget.',
    ], {
    ...
    NPCList.PewterBattleItemRival = new NPC('Battle Item Master', [
    ...
    NPCList.PewterScientist = new NPC('Gem Scientist', [
    ...
    NPCList.Route3ShadySalesman = new NPC('Shady Salesman', [
    ...
    NPCList.CeruleanKantoBerryMaster = new KantoBerryMasterNPC('Berry Master', [
        'Bah! You younglings have no appreciation of the art of Berry farming!',
        'Come back when you are ready to learn!',
    ]);
    NPCList.CeruleanFarmApprentice = new NPC('Farm Apprentice', [
    ...
    NPCList.CeruleanSuperNerd = new NPC('Super Nerd Jovan', [
    ...
    NPCList.BillsGrandpa1 = new NPC('Bill\'s Grandpa', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Bill\'s Grandpa Treasure Hunt'), new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 1, AchievementOption.less)]),
    });

    NPCList.BillsGrandpa2 = new NPC('Bill\'s Grandpa', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 1), new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 3, AchievementOption.less)]),
    });

    NPCList.BillsGrandpa3 = new NPC('Bill\'s Grandpa', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 3), new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 5, AchievementOption.less)]),
    });

    NPCList.BillsGrandpa4 = new NPC('Bill\'s Grandpa', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 5), new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 7, AchievementOption.less)]),
    });

    NPCList.BillsGrandpa5 = new NPC('Bill\'s Grandpa', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 7), new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 9, AchievementOption.less)]),
    });

    NPCList.BillsGrandpa6 = new NPC('Bill\'s Grandpa', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 9), new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 11, AchievementOption.less)]),
    });

    NPCList.BillsGrandpa7 = new NPC('Bill\'s Grandpa', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 11), new QuestLineStepCompletedRequirement('Bill\'s Grandpa Treasure Hunt', 13, AchievementOption.less)]),
    });

    NPCList.BillsGrandpa8 = new NPC('Bill\'s Grandpa', [
    ...
    NPCList.BillsHouseEusine = new NPC('Eusine', [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Eusine\'s Chase', 9), new QuestLineCompletedRequirement('Eusine\'s Chase', AchievementOption.less )]),
    });

    NPCList.VermilionFanClubChairman = new NPC('Fan Club Chairman', [
    ...
    NPCList.VermilionShardApprentice = new NPC('Shard Apprentice', [
    ...
    NPCList.VermilionEusine = new NPC('Eusine', [
    ...
    {
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Eusine\'s Chase', 5), new QuestLineStepCompletedRequirement('Eusine\'s Chase', 7, AchievementOption.less )]),
    });

    NPCList.SquirtleJenny = new NPC('Officer Jenny', [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([new ObtainedPokemonRequirement('Squirtle'), new MaxRegionRequirement(Region.johto)]),
    });

    NPCList.LavenderMrFuji = new NPC('Mr. Fuji', [
    ...
    NPCList.LavenderChanneler = new NPC('Channeler Karina', [
    ...
    NPCList.LavenderShopper = new NPC('Shopper', [
    ...
    NPCList.BigSpender = new NPC('Big Spender', [
    ...
    NPCList.EggHuntErika = new NPC('Erika', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Egg Hunt'), new QuestLineCompletedRequirement('Egg Hunt', AchievementOption.less)]),
    });

    NPCList.SaffronBattleItemRival = new NPC('Battle Item Master', [
    ...
    NPCList.SaffronBreeder = new NPC('Breeder', [
    ...
    NPCList.LaprasGift = new PokemonGiftNPC('Silph Co. Employee', [
    ...
    NPCList.FuchsiaKantoRoamerNPC = new RoamerNPC('Youngster Wendy', [
        'There\'s been some recent sightings of roaming Pokémon on {ROUTE_NAME}!',
    ], Region.kanto, RoamingPokemonList.findGroup(Region.kanto, KantoSubRegions.Kanto));

    NPCList.FuchsiaEusine = new NPC('Eusine', [
    ...
    {
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Eusine\'s Chase', 7), new QuestLineStepCompletedRequirement('Eusine\'s Chase', 9, AchievementOption.less )]),
    });

    NPCList.CinnabarIslandResearcher = new NPC('Researcher', [
    ...
    NPCList.KantoFossilNpc = new NPC('Underground Expert', [
    ...
    NPCList.OneIslandCelio1 = new NPC('Celio', [
        ...
        requirement: new QuestLineStepCompletedRequirement('Bill\'s Errand', 1, AchievementOption.less),
    });
    NPCList.OneIslandCelio2 = new NPC('Celio', [
        ...
        image: 'assets/images/npcs/Celio.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Bill\'s Errand', 5), new QuestLineCompletedRequirement('Bill\'s Errand', AchievementOption.less)]),
    });
    NPCList.OneIslandCelio3 = new NPC('Celio', [
        'You\'ve been a great help. Thanks again. Maybe we\'ll meet again some day...',
    ], {
        image: 'assets/images/npcs/Celio.png',
        requirement: new MultiRequirement([new QuestLineCompletedRequirement('Bill\'s Errand'), new QuestLineStartedRequirement('Celio\'s Errand', AchievementOption.less)]),
    });
    NPCList.OneIslandCelio4 = new NPC('Celio', [
        ...
        image: 'assets/images/npcs/Celio.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Celio\'s Errand'), new QuestLineStepCompletedRequirement('Celio\'s Errand', 1, AchievementOption.less)]),
    });
    NPCList.OneIslandCelio5 = new NPC('Celio', [
        ...
        image: 'assets/images/npcs/Celio.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Celio\'s Errand', 4), new QuestLineStepCompletedRequirement('Celio\'s Errand', 6, AchievementOption.less)]),
    });
    NPCList.OneIslandCelio6 = new NPC('Celio', [
        ...
        image: 'assets/images/npcs/Celio.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Celio\'s Errand', 12), new QuestLineCompletedRequirement('Celio\'s Errand', AchievementOption.less)]),
    });
    NPCList.OneIslandCelio7 = new NPC('Celio', [
    ...
    NPCList.OneIslandYoungster = new NPC('Youngster', [
        'Isn\'t it strange how Mol<b><i>tres</i></b> lives on <b><i>One</i></b> Island?',
    ], {
        image: 'assets/images/npcs/Youngster.png',
        requirement: new ClearDungeonRequirement(1, getDungeonIndex('Mt. Ember Summit')),
    });
    NPCList.TwoIslandGameCornerOwner1 = new NPC('Game Corner Owner', [
        ...
        requirement: new QuestLineStepCompletedRequirement('Bill\'s Errand', 4, AchievementOption.less),
    });
    NPCList.TwoIslandGameCornerOwner2 = new NPC('Game Corner Owner', [
        'My sweet Lostelle! I\'m so glad you\'re all right.',
        'Thank you very much kind stranger. Please take the Meteorite.',
    ],
    { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Bill\'s Errand', 4), new QuestLineCompletedRequirement('Bill\'s Errand', AchievementOption.less )]) });
    NPCList.ThreeIslandBiker1 = new NPC('Biker', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Bill\'s Errand', 3), new GymBadgeRequirement(BadgeEnums.Elite_HoennChampion, AchievementOption.less)]),
    });
    NPCList.ThreeIslandBiker2 = new NPC('Biker', [
        'You know what sucks? The other islands are off limits for some arbitrary reason. There is no explanation. Just can\'t go there.',
        ...
        image: 'assets/images/npcs/Biker Goon.png',
        requirement: new MultiRequirement([new GymBadgeRequirement(BadgeEnums.Elite_HoennChampion), new QuestLineStepCompletedRequirement('Celio\'s Errand', 5, AchievementOption.less)]),
    });
    NPCList.ThreeIslandBiker3 = new NPC('Biker', [
        'You know what sucks? The other islands are off limits for some arbitrary reason. There is no explanation. Just can\'t go there.',
    ...
    NPCList.CelebiProfIvy = new NPC('Prof. Ivy', [
        ...
        requirement: new QuestLineStepCompletedRequirement('Unfinished Business', 2, AchievementOption.less),
    });
    NPCList.SeviiRocketGrunts = new NPC('Team Rocket Grunts', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Celio\'s Errand', 0), new QuestLineStepCompletedRequirement('Celio\'s Errand', 2, AchievementOption.less)]),
    });
    NPCList.SeviiRuby = new NPC('Ruby', [
        '<img src="assets/images/items/quest/Celios_Errand_Ruby.png">',
        '<i>You found a Ruby!</i>',
    ],
    { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Celio\'s Errand', 3), new QuestLineStepCompletedRequirement('Celio\'s Errand', 4, AchievementOption.less )]) });
    NPCList.SeviiLorelei = new NPC('Lorelei', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Celio\'s Errand', 6), new QuestLineStepCompletedRequirement('Celio\'s Errand', 8, AchievementOption.less)]),
    });
    NPCList.SeviiGideon1 = new NPC('Gideon', [
        ...
        requirement: new QuestLineStepCompletedRequirement('Celio\'s Errand', 7, AchievementOption.less),
    });
    NPCList.SeviiGideon2 = new NPC('Gideon', [
        ...
        image: 'assets/images/npcs/Scientist Gideon.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Celio\'s Errand', 7), new QuestLineStepCompletedRequirement('Celio\'s Errand', 9, AchievementOption.less)]),
    });
    NPCList.SixIslandSeviiRoamerNPC = new RoamerNPC('Bug Catcher John', [
    ...
    ], Region.kanto, RoamingPokemonList.findGroup(Region.kanto, KantoSubRegions.Sevii4567), 'assets/images/npcs/Bug Catcher.png', new GymBadgeRequirement(BadgeEnums.Elite_OrangeChampion));
    NPCList.AlteringCaveRuinManiac1 = new NPC('Ruin Maniac', [
        ...
        image: 'assets/images/npcs/Ruin Maniac gen3.png',
        requirement: new QuestLineCompletedRequirement('Celio\'s Errand', AchievementOption.less),
    });
    NPCList.AlteringCaveRuinManiac2 = new NPC('Ruin Maniac', [
    ...
    NPCList.ValenciaProfIvy = new NPC('Prof. Ivy', [
    ...
    NPCList.TanobyProfIvy = new NPC('Prof. Ivy', [
    ...
    NPCList.PinkanOfficerJenny1 = new NPC('Officer Jenny', [
        ...
        image: 'assets/images/npcs/Officer Jenny.png',
        requirement: new GymBadgeRequirement(BadgeEnums.Elite_OrangeChampion, AchievementOption.less),
    });
    NPCList.PinkanOfficerJenny2 = new NPC('Officer Jenny', [
        'Have you seen the Pinkan Berries? That is what makes all the Pokémon on this island turn pink.',
        'Hang on, this island is strictly off limits! Pinkan is a protected Pokémon reserve. How did you get here?',
        'Well I suppose you did deal with that Team Rocket branch on Five Island, so I guess I\'ll let you stay, as thanks.',
        ...
        image: 'assets/images/npcs/Officer Jenny.png',
        requirement: new MultiRequirement([new GymBadgeRequirement(BadgeEnums.Elite_OrangeChampion), new QuestLineStepCompletedRequirement('Team Rocket\'s Pinkan Theme Park', 0, AchievementOption.less)]),
    });
    NPCList.PinkanOfficerJenny3 = new NPC('Officer Jenny', [
    ...
    NPCList.ThemeparkTeamRocket1 = new NPC('Jessie & James', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Team Rocket\'s Pinkan Theme Park'), new QuestLineStepCompletedRequirement('Team Rocket\'s Pinkan Theme Park', 1, AchievementOption.less)]),
        image: 'assets/images/npcs/Pinkan Jessie & James.png',
    });

    NPCList.ThemeparkTeamRocket2 = new NPC('Jessie & James', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Team Rocket\'s Pinkan Theme Park', 1), new QuestLineStepCompletedRequirement('Team Rocket\'s Pinkan Theme Park', 2, AchievementOption.less)]),
        image: 'assets/images/npcs/Pinkan Jessie & James.png',
    });

    NPCList.ThemeparkTeamRocket3 = new NPC('Jessie & James', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Team Rocket\'s Pinkan Theme Park', 2), new QuestLineStepCompletedRequirement('Team Rocket\'s Pinkan Theme Park', 3, AchievementOption.less)]),
        image: 'assets/images/npcs/Pinkan Jessie & James.png',
    });

    NPCList.ThemeparkTeamRocket4 = new NPC('Jessie & James', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Team Rocket\'s Pinkan Theme Park', 3), new QuestLineStepCompletedRequirement('Team Rocket\'s Pinkan Theme Park', 5, AchievementOption.less)]),
        image: 'assets/images/npcs/Pinkan Jessie & James.png',
    });

    NPCList.Informant1 = new NPC('Informant', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Detective Pikachu', 2), new QuestLineStepCompletedRequirement('Detective Pikachu', 4, AchievementOption.less)]),
    });
    NPCList.Informant2 = new NPC('Informant', [
        ...
        image: 'assets/images/npcs/specialNPCs/Mime Interview.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Detective Pikachu', 4), new QuestLineStepCompletedRequirement('Detective Pikachu', 6, AchievementOption.less)]),
    });

    NPCList.Mewtwo1 = new NPC('Mewtwo', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Detective Pikachu', 10), new QuestLineStepCompletedRequirement('Detective Pikachu', 12, AchievementOption.less)]),
    });

    NPCList.Mewtwo2 = new NPC('Mewtwo', [
        ...
        image: 'assets/images/npcs/specialNPCs/Possessed Mewtwo.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Detective Pikachu', 15), new QuestLineStepCompletedRequirement('Detective Pikachu', 17, AchievementOption.less)]),
    });

    NPCList.DetectiveRaichu = new NPC('Detective Raichu', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Detective Pikachu', 16), new QuestLineStepCompletedRequirement('Detective Pikachu', 17, AchievementOption.less)]),
    });

    NPCList.ClientSignpost = new NPC('Welcome Sign', [
    ...
    NPCList.NewIslandJessieAndJames = new RoamerNPC('Jessie & James',
        ...
        Region.kanto, 0, 'assets/images/npcs/Jessie and James.png',
        new ClearDungeonRequirement(1,  getDungeonIndex('New Island')),
    );

    NPCList.NewIslandAsh1 = new NPC('Ash Ketchum',
        ['Mewtwo has created an army of Clones. Please help me fight them, I have to save Pikachu!'],
        {
            ...
            requirement: new ClearDungeonRequirement(1, getDungeonIndex('New Island'), AchievementOption.less),
        },
    );

    NPCList.NewIslandAsh2 = new NPC('Ash Ketchum',
        ['There are still Clones left in Mewtwos army! Help me fight them!'],
        {
            image: 'assets/images/npcs/Ash Ketchum.png',
            requirement: new MultiRequirement([new ClearDungeonRequirement(1,  getDungeonIndex('New Island')), new ClearDungeonRequirement(10, getDungeonIndex('New Island'), AchievementOption.less)]),
        },
    );

    NPCList.BugCatcherPinsir = new NPC('Bug Catcher Michel', [
    ...
    ], { image: 'assets/images/npcs/Bug Catcher.png', requirement: new MaxRegionRequirement(Region.kalos) });

    NPCList.CandyMan = new NPC('The Candy Man', [
        'I sure do love candy. The rarer, the better!',
        'I\'ve got a real <b>SWEET-TOOTH</b>',
    ]);

    NPCList.SpeedyRunner = new NPC('Speedy Runner', [
    ...
    NPCList.UnrivaledBlue = new NPC('Blue', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 2), new QuestLineStepCompletedRequirement('An Unrivaled Power', 4, AchievementOption.less)]),
    });

    NPCList.UnrivaledGreen1 = new NPC('Green', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 4), new QuestLineStepCompletedRequirement('An Unrivaled Power', 6, AchievementOption.less)]),
    });

    NPCList.UnrivaledGreen2 = new NPC('Green', [
        ...
        image: 'assets/images/npcs/Green.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 6), new QuestLineStepCompletedRequirement('An Unrivaled Power', 8, AchievementOption.less)]),
    });

    NPCList.AnomalyMewtwo1 = new NPC('Anomaly Mewtwo', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 7), new QuestLineStepCompletedRequirement('An Unrivaled Power', 9, AchievementOption.less)]),
    });

    NPCList.BillGrandpaChristmas = new NPC('Bill\'s Grandpa', [
    ...
    NPCList.UnownFigure = new NPC('Unown Figure', [
    ...
    // Johto NPCs
    NPCList.CherrygroveMrPokemon = new NPC('Mr. Pokémon', [
    ...
    NPCList.AzaleaElder = new NPC('Elder Li', [
    ...
    NPCList.AzaleaHiker = new NPC('Hiker Daniel', [
    ...
    NPCList.AzaleaCelebiKurt1 = new NPC('Kurt', [
        'Those poor Slowpoke! I\'m not doing anything until those disgusting Rockets are gone!',
    ], {
        image: 'assets/images/npcs/Kurt.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 2), new ClearDungeonRequirement(1, getDungeonIndex('Slowpoke Well'), AchievementOption.less)]),
    });

    NPCList.AzaleaCelebiKurt2 = new NPC('Kurt', [
        ...
        image: 'assets/images/npcs/Kurt.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 2), new QuestLineStepCompletedRequirement('Unfinished Business', 3, AchievementOption.less), new ClearDungeonRequirement(1, getDungeonIndex('Slowpoke Well'))]),
    });

    NPCList.AzaleaCelebiKurt3 = new NPC('Kurt', [
        ...
        image: 'assets/images/npcs/Kurt.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 3), new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion, AchievementOption.less)]),
    });

    NPCList.AzaleaCelebiKurt4 = new NPC('Kurt', [
        ...
        image: 'assets/images/npcs/Kurt.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 3), new QuestLineStepCompletedRequirement('Unfinished Business', 5, AchievementOption.less), new GymBadgeRequirement(BadgeEnums.Elite_JohtoChampion)]),
    });

    NPCList.AzaleaCelebiOak1 = new NPC('Prof. Oak', [
        ...
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 4), new QuestLineStepCompletedRequirement('Unfinished Business', 6, AchievementOption.less)]),
    });

    NPCList.AzaleaCelebiOak2 = new NPC('Prof. Oak', [
        ...
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 7), new QuestLineStepCompletedRequirement('Unfinished Business', 9, AchievementOption.less)]),
    });

    NPCList.AzaleaCelebiOak3 = new NPC('Prof. Oak', [
        ...
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 10), new QuestLineStepCompletedRequirement('Unfinished Business', 12, AchievementOption.less)]),
    });

    NPCList.AzaleaCelebiOak4 = new NPC('Prof. Oak', [
        ...
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 12), new QuestLineStepCompletedRequirement('Unfinished Business', 13, AchievementOption.less)]),
    });

    NPCList.AzaleaCelebiOak5 = new NPC('Prof. Oak', [
        ...
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 13), new QuestLineCompletedRequirement('Unfinished Business', AchievementOption.less)]),
    });

    NPCList.IlexForestShrine1 = new NPC('Investigate the Shrine', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 5), new QuestLineStepCompletedRequirement('Unfinished Business', 7, AchievementOption.less)]),
    });

    NPCList.IlexForestShrine2 = new NPC('Investigate the Shrine', [
        ...
        image: 'assets/images/npcs/other/Ilex Forest.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 11), new QuestLineStepCompletedRequirement('Unfinished Business', 13, AchievementOption.less)]),
    });

    NPCList.IlexForestPichuFan = new NPC('Pichu-Fan', [
    ...
    NPCList.EcruteakBill = new NPC('Bill', [
    ...
    NPCList.OlivineLighthouseJasmine1 = new NPC('Jasmine', [
        ...
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Sick Ampharos', 0), new QuestLineStepCompletedRequirement('The Sick Ampharos', 4, AchievementOption.less)]),
    });

    NPCList.CianwoodCityPharmacist1 = new NPC('Pharmacist', [
        ...
        image: 'assets/images/npcs/Scientist (male).png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Sick Ampharos', 1), new QuestLineStepCompletedRequirement('The Sick Ampharos', 3, AchievementOption.less)]),
    });

    NPCList.CianwoodCityPharmacist2 = new NPC('Pharmacist', [
        'I got it! This ought to do the trick.',
        '<i>You got a \'Secret Potion\'</i>',
    ], {
        image: 'assets/images/npcs/Scientist (male).png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Sick Ampharos', 3), new QuestLineStepCompletedRequirement('The Sick Ampharos', 4, AchievementOption.less)]),
    });

    NPCList.OlivineLighthouseMedicineAmphy = new NPC('Give medicine to Amphy', [
        'Palu! Palulu!',
        '<i>Ampharos seems to feel better.</i>',
    ], {
        image: 'assets/images/pokemon/181.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Sick Ampharos', 4), new QuestLineStepCompletedRequirement('The Sick Ampharos', 5, AchievementOption.less)]),
    });

    NPCList.OlivineLighthouseJasmine2 = new NPC('Jasmine', [
        ' ...Oh, I’m so relieved... This is just so wonderful... Thank you so very, very much.',
        '...I will return to the Gym...',
    ], {
        image: 'assets/images/npcs/Jasmine.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Sick Ampharos', 5), new QuestLineStepCompletedRequirement('The Sick Ampharos', 6, AchievementOption.less)]),
    });

    NPCList.OlivineLighthouseAmphy = new NPC('Amphy', [
        'Palu! Palulu!',
    ], {
        image: 'assets/images/pokemon/181.png',
    ...
    NPCList.EcruteakEusine = new NPC('Eusine', [
        ...
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('The Legendary Beasts'), new QuestLineStepCompletedRequirement('The Legendary Beasts', 2, AchievementOption.less )]),
    });
    NPCList.EcruteakPokéfan = new NPC('Pokéfan Derek', [
    ...
    NPCList.Zuki = new NPC('Kimono Girl Zuki', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Whirl Guardian'), new QuestLineStepCompletedRequirement('Whirl Guardian', 1, AchievementOption.less)]),
    });

    NPCList.Naoko = new NPC('Kimono Girl Naoko', [
        'I seem to have lost my way in the forest. Can you show me the way out?',
    ], {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Whirl Guardian', 1), new QuestLineStepCompletedRequirement('Whirl Guardian', 3, AchievementOption.less)]),
    });

    NPCList.Miki = new NPC('Kimono Girl Miki', [
        ...
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Whirl Guardian', 3), new QuestLineStepCompletedRequirement('Whirl Guardian', 5, AchievementOption.less)]),
    });

    NPCList.Sayo = new NPC('Kimono Girl Sayo', [
        'Excuse me! I\'m stuck out here on the ice, can you give me a quick push?',
    ], {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Whirl Guardian', 4), new QuestLineStepCompletedRequirement('Whirl Guardian', 6, AchievementOption.less)]),
    });

    NPCList.Kuni = new NPC('Kimono Girl Kuni', [
        'I\'m supposed to meet my sisters, but the streets here just aren\'t safe! Can you protect me from Team Rocket?',
    ], {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Whirl Guardian', 6), new QuestLineStepCompletedRequirement('Whirl Guardian', 8, AchievementOption.less)]),
    });

    NPCList.KimonoGirlsWhirl = new NPC('Kimono Girls', [
        'With the power of the Tidal Bell, we call to Lugia! Guardian of the Whirl Islands!',
    ], {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Whirl Guardian', 8), new QuestLineStepCompletedRequirement('Whirl Guardian', 10, AchievementOption.less)]),
    });

    NPCList.KimonoGirlsEcruteak = new NPC('Kimono Girls', [
        ...
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Rainbow Guardian'), new QuestLineStepCompletedRequirement('Rainbow Guardian', 1, AchievementOption.less)]),
    });

    NPCList.OlivineSSAquaCaptain = new NPC('S.S. Aqua Captain', [
    ...
    NPCList.CianwoodPhotographyAide = new NPC('Photography Aide', [
    ...
    NPCList.CianwoodEusine = new NPC('Eusine', [
    ...
    {
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Eusine\'s Chase', 0), new QuestLineStepCompletedRequirement('Eusine\'s Chase', 2, AchievementOption.less )]),
    });

    NPCList.MahoganySouvenirShopAttendant = new NPC('Souvenir Shop Attendant', [
    ...
    NPCList.MahoGanyOfficerJenny = new NPC('Officer Jenny', [
    ...
    NPCList.MahoganyEusine = new NPC('Eusine', [
    ...
    {
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Eusine\'s Chase', 3), new QuestLineStepCompletedRequirement('Eusine\'s Chase', 5, AchievementOption.less )]),
    });

    NPCList.BlackthornJohtoRoamerNPC = new RoamerNPC('Pokéfan Trevor', [
        'On the news, they are getting more reports of roaming Pokémon appearing on {ROUTE_NAME}!',
    ], Region.johto, RoamingPokemonList.findGroup(Region.johto, JohtoSubRegions.Johto), 'assets/images/npcs/Pokéfan (male).png');

    NPCList.RedOldManJohtoNPC = new NPC('Old Man', [
    ...
    NPCList.TohjoFallsCelebiTimeDistortion = new NPC('Investigate the Time Distortion', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Unfinished Business', 8), new QuestLineStepCompletedRequirement('Unfinished Business', 10, AchievementOption.less), new ClearDungeonRequirement(1, getDungeonIndex('Tohjo Falls'))]),
    });

    NPCList.Conductor = new NPC('Conductor', [
    ...
    NPCList.ProfElm = new ProfNPC('Prof. Elm',
        Region.johto,
    ...
    NPCList.searchForClues = new NPC('Search For Clues', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Detective Pikachu'), new QuestLineStepCompletedRequirement('Detective Pikachu', 1, AchievementOption.less)]),
    });

    NPCList.HowardClifford1 = new NPC('Howard Clifford', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Detective Pikachu', 6), new QuestLineStepCompletedRequirement('Detective Pikachu', 8, AchievementOption.less)]),
    });

    NPCList.HowardClifford2 = new NPC('Howard Clifford', [
        ...
        image: 'assets/images/npcs/Howard Clifford.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Detective Pikachu', 11), new QuestLineStepCompletedRequirement('Detective Pikachu', 13, AchievementOption.less)]),
    });

    NPCList.HowardClifford3 = new NPC('Howard Clifford', [
        'UNLIMITED POWER! YOU\'LL NEVER STOP ME!',
    ], {
        image: 'assets/images/npcs/Howard Clifford.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Detective Pikachu', 13), new QuestLineStepCompletedRequirement('Detective Pikachu', 15, AchievementOption.less)]),
    });
    NPCList.ParkAttendant = new NPC('Park Attendant', [
    ...
    NPCList.ParkResearcher = new NPC('Researcher', [
        'Welcome to the National Park!',
    ...
    NPCList.BabyAssistant = new AssistantNPC('Elm\'s Assistant', [
    ...
    // Hoenn NPCs
    NPCList.LittlerootAide = new NPC('Professor Birch\'s Aide', [
    ...
    NPCList.OldaleTrackingScientist = new NPC('Tracking Scientist', [
    ...
    NPCList.HoennFossilNpc = new NPC('Laid-Back Angler', [
    ...
    NPCList.SlateportHoennRoamerNPC = new RoamerNPC('Reporter Gabby', [
        'Our sources indicate that roaming Pokémon are gathering on {ROUTE_NAME}!',
    ], Region.hoenn, RoamingPokemonList.findGroup(Region.hoenn, HoennSubRegions.Hoenn), 'assets/images/npcs/Reporter.png');

    NPCList.SkepticalFisherman = new NPC('Skeptical Fisherman', [
    ...
    NPCList.FallarborProfessorCozmo = new NPC('Prof. Cozmo', [
    ...
    { requirement: new QuestLineStartedRequirement('The Delta Episode', AchievementOption.less),
    });

    NPCList.LavaridgeSootCollector = new NPC('Soot Collector', [
    ...
    NPCList.RoadsideStandShadySalesman = new NPC('Shady Salesman', [
        'Have I got a deal just for you!',
    ...
    NPCList.FortreeWeatherman = new NPC('Weatherman', [
    ...
    NPCList.FortreeRanger = new NPC('Pokémon Ranger Catherine', [
    ...
    NPCList.WindChimeShopShadySalesman = new NPC('Shady Salesman', [
    ...
    NPCList.Steven1 = new NPC('Steven', [
    ...
    { requirement: new TemporaryBattleRequirement('Kecleon 3', 1, AchievementOption.less),
    });

    NPCList.Steven2 = new NPC('Steven', [
    ...
    NPCList.MossdeepAstronomer = new NPC('Astronomer', [
    ...
    NPCList.PacifidlogDiver = new NPC('Diver', [
    ...
    NPCList.Wallace1 = new NPC('Gym Leader Wallace', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Weather Trio', 1), new QuestLineStepCompletedRequirement('The Weather Trio', 3, AchievementOption.less)]),
    });

    NPCList.Wallace2 = new NPC('Gym Leader Wallace', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Weather Trio', 4), new QuestLineStepCompletedRequirement('The Weather Trio', 6, AchievementOption.less)]),
    });

    NPCList.WeatherBattle1 = new NPC('The Super-Ancient Pokémon Clash', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('The Weather Trio'), new QuestLineStepCompletedRequirement('The Weather Trio', 1, AchievementOption.less)]),
    });

    NPCList.WeatherBattle2 = new NPC('The Super-Ancient Pokémon Clash', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Weather Trio', 3), new QuestLineStepCompletedRequirement('The Weather Trio', 5, AchievementOption.less)]),
    });

    NPCList.MillenniumFest = new NPC('The Millennium Festival', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Wish Maker'), new QuestLineStepCompletedRequirement('Wish Maker', 1, AchievementOption.less)]),
    });

    NPCList.Butler1 = new NPC('Butler', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Wish Maker', 1), new QuestLineStepCompletedRequirement('Wish Maker', 3, AchievementOption.less)]),
    });

    NPCList.CocoonHatch = new NPC('Examine the Crystalline Cocoon', [
        '<i>The cocoon shifts, shimmers, and hatches to reveal Jirachi!</i>',
    ], { image: 'assets/images/npcs/other/Cocoon.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Wish Maker', 4), new QuestLineStepCompletedRequirement('Wish Maker', 6, AchievementOption.less)]),
    });

    NPCList.Butler2 = new NPC('Butler', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('A Meta Discovery'), new QuestLineStepCompletedRequirement('A Meta Discovery', 1, AchievementOption.less)]),
    });

    NPCList.Butler3 = new NPC('Butler', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Meta Discovery', 2), new QuestLineCompletedRequirement('A Meta Discovery', AchievementOption.less)]),
    });

    NPCList.ProfBirch = new ProfNPC('Prof. Birch',
        Region.hoenn,
    ...
    NPCList.CoolTrainerDillan = new NPC('Cool Trainer Dillan', [
    ...
    NPCList.EasterEggHunter = new NPC('Egg Hunter', [
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Egg Hunt', 2, AchievementOption.more),
            new OneFromManyRequirement([
                new QuestLineCompletedRequirement('Egg Hunt', AchievementOption.less),
                new SpecialEventRequirement('Easter'),
            ]),
        ]),
    });

    NPCList.SCEntrance = new NPC('Strange Markings', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 0), new QuestLineStepCompletedRequirement('The Three Golems', 1, AchievementOption.less)]),
    });

    NPCList.MazeHintLeft = new NPC('Room Engraving', [
        '<i>These strange markings seem to spell something out. The nearby Braille Enthusiast may know more.</i>',
    ], { image: 'assets/images/npcs/other/LeftBraille.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 1), new QuestLineStepCompletedRequirement('The Three Golems', 3, AchievementOption.less)]),
    });

    NPCList.SCMazeLeft = new NPC('Go Left', [
        '<i>You turn left and proceed to the next room.</i>',
    ],  { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 1), new QuestLineStepCompletedRequirement('The Three Golems', 3, AchievementOption.less)]),
    });

    NPCList.SCMazeLeftWrong = new NPC('Go Left', [
        '<i>You turn left, but it is a dead end.</i>',
    ],  { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 3), new QuestLineStepCompletedRequirement('The Three Golems', 6, AchievementOption.less)]),
    });

    NPCList.MazeHintRight = new NPC('Room Engraving', [
        '<i>These strange markings seem to spell something out. The nearby Braille Enthusiast may know more.</i>',
    ], { image: 'assets/images/npcs/other/RightBraille.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 5), new QuestLineStepCompletedRequirement('The Three Golems', 6, AchievementOption.less)]),
    });

    NPCList.SCMazeRight = new NPC('Go Right', [
        '<i>You turn right and proceed to the next room.</i>',
    ],  { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 5), new QuestLineStepCompletedRequirement('The Three Golems', 6, AchievementOption.less)]),
    });

    NPCList.SCMazeRightWrong = new NPC('Go Right', [
        '<i>You turn right, but it is a dead end.</i>',
    ],  { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 1), new QuestLineStepCompletedRequirement('The Three Golems', 5, AchievementOption.less)]),
    });

    NPCList.MazeHintStraight = new NPC('Room Engraving', [
        '<i>These strange markings seem to spell something out. The nearby Braille Enthusiast may know more.</i>',
    ], { image: 'assets/images/npcs/other/StraightBraille.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 3), new QuestLineStepCompletedRequirement('The Three Golems', 5, AchievementOption.less)]),
    });

    NPCList.SCMazeStraight = new NPC('Go Straight', [
        '<i>You go straight and proceed to the next room.</i>',
    ],  { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 3), new QuestLineStepCompletedRequirement('The Three Golems', 5, AchievementOption.less)]),
    });

    NPCList.SCMazeStraightWrong = new NPC('Go Straight', [
        '<i>You go straight, but it is a dead end.</i>',
    ],  { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 1), new QuestLineStepCompletedRequirement('The Three Golems', 3, AchievementOption.less)]),
    });

    NPCList.SCHints = new NPC('Hidden Message', [
        '<i>These strange markings seem to spell something out. The nearby Braille Enthusiast may know more.</i>',
    ], { image: 'assets/images/npcs/other/Regi Hints.png',
        requirement: new QuestLineStepCompletedRequirement('The Three Golems', 6),
    });

    NPCList.BrailleEnthusiast1 = new NPC('Braille Enthusiast', [
    ...
    NPCList.BrailleEnthusiast2 = new NPC('Braille Enthusiast', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Three Golems', 1), new QuestLineStepCompletedRequirement('The Three Golems', 6, AchievementOption.less)]),
    });

    NPCList.BrailleEnthusiast3 = new NPC('Braille Enthusiast', [
    ...
    NPCList.Television1 = new NPC('Watch Television', [
    ...
    ],  { requirement: new MultiRequirement([new QuestLineStartedRequirement('The Eon Duo'), new QuestLineStepCompletedRequirement('The Eon Duo', 1, AchievementOption.less)]),
    });

    NPCList.Television2 = new NPC('Watch More Television', [
    ...
    ],  { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Eon Duo', 0), new QuestLineStepCompletedRequirement('The Eon Duo', 2, AchievementOption.less)]),
    });

    NPCList.TicketClaim = new NPC('Contest Attendant', [
        ...
        'EON-TICKET',
    ],  { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Eon Duo', 1), new QuestLineStepCompletedRequirement('The Eon Duo', 3, AchievementOption.less)]),
    });

    NPCList.SurferDave = new NPC('Surfer Dave', [
        'What\'s up? I got here using my Eon Ticket, what about you?'],
    );

    NPCList.SeaMauvilleRocket1 = new NPC('Rocket Grunt', [
        ...
        requirement: new TemporaryBattleRequirement('Delta Giovanni', 1, AchievementOption.less),
    });

    NPCList.SeaMauvilleRocket2 = new NPC('Rocket Grunt', [
    ...
    NPCList.SouthernIsland1 = new NPC('Explore the Southern Island', [
    ...
    ],  { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Eon Duo', 2), new QuestLineStepCompletedRequirement('The Eon Duo', 3, AchievementOption.less)]),
    });

    NPCList.Cozmo1 = new NPC('Dr. Cozmo', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('The Delta Episode'), new QuestLineStepCompletedRequirement('The Delta Episode', 1, AchievementOption.less)]),
    });

    NPCList.Zinnia1 = new NPC('Mysterious Figure', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 0), new QuestLineStepCompletedRequirement('The Delta Episode', 2, AchievementOption.less)]),
    });

    NPCList.DeltaMay1 = new NPC('May', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 1), new QuestLineStepCompletedRequirement('The Delta Episode', 3, AchievementOption.less)]),
    });

    NPCList.NewsBirch = new NPC('Discuss the news with Professor Birch', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 2), new QuestLineStepCompletedRequirement('The Delta Episode', 4, AchievementOption.less)]),
    });

    NPCList.DeltaMay2 = new NPC('May', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 3), new QuestLineStepCompletedRequirement('The Delta Episode', 5, AchievementOption.less)]),
    });

    NPCList.DeltaSteven1 = new NPC('Ringing Holo Caster', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 5), new QuestLineStepCompletedRequirement('The Delta Episode', 7, AchievementOption.less)]),
    });

    NPCList.DeltaWally1 = new NPC('Wally', [
    ...
    NPCList.Zinnia2 = new NPC('Zinnia', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 7), new QuestLineStepCompletedRequirement('The Delta Episode', 9, AchievementOption.less)]),
    });

    NPCList.Zinnia3 = new NPC('Zinnia', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 9), new QuestLineStepCompletedRequirement('The Delta Episode', 11, AchievementOption.less)]),
    });

    NPCList.Cozmo2 = new NPC('Dr. Cozmo', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 10), new QuestLineStepCompletedRequirement('The Delta Episode', 12, AchievementOption.less)]),
    });

    NPCList.Zinnia4 = new NPC('Zinnia', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 11), new QuestLineStepCompletedRequirement('The Delta Episode', 13, AchievementOption.less)]),
    });

    NPCList.Cozmo3 = new NPC('Dr. Cozmo', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 12), new QuestLineStepCompletedRequirement('The Delta Episode', 14, AchievementOption.less)]),
    });

    NPCList.DraconidElder1 = new NPC('Draconid Elder', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 14), new QuestLineStepCompletedRequirement('The Delta Episode', 16, AchievementOption.less)]),
    });

    NPCList.DraconidElder2 = new NPC('Draconid Elder', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 16), new QuestLineStepCompletedRequirement('The Delta Episode', 18, AchievementOption.less)]),
    });

    NPCList.DraconidElder3 = new NPC('Draconid Elder', [
    ...
    NPCList.Zinnia5 = new NPC('Zinnia', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 19), new QuestLineStepCompletedRequirement('The Delta Episode', 21, AchievementOption.less)]),
    });

    NPCList.Archie = new NPC('Archie', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 21), new QuestLineStepCompletedRequirement('The Delta Episode', 23, AchievementOption.less)]),
    });

    NPCList.Maxie = new NPC('Maxie', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 23), new QuestLineStepCompletedRequirement('The Delta Episode', 25, AchievementOption.less)]),
    });

    NPCList.Wallace3 = new NPC('Gym Leader Wallace', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 24), new QuestLineStepCompletedRequirement('The Delta Episode', 26, AchievementOption.less)]),
    });

    NPCList.Zinnia6 = new NPC('Zinnia', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 28), new QuestLineStepCompletedRequirement('The Delta Episode', 30, AchievementOption.less)]),
    });

    NPCList.Zinnia7 = new NPC('Zinnia', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Delta Episode', 30), new QuestLineStepCompletedRequirement('The Delta Episode', 32, AchievementOption.less)]),
    });

    NPCList.Cozmo4 = new NPC('Dr. Cozmo', [
    ...
    NPCList.ShoalFisherman1 = new NPC('Shoal Fisherman', [
        'Hi! I\'m collecting shells while I fish. There\'s a lot of neat stuff lying around here.',
    ], {
        image: 'assets/images/npcs/Fisherman.png',
        requirement: new TemporaryBattleRequirement('Shoal Fisherman', 1, AchievementOption.less),
    });

    NPCList.ShoalFisherman2 = new NPC('Shoal Fisherman', [
    ...
    NPCList.GraniteCamper1 = new NPC('Camper', [
        ...
        requirement: new TemporaryBattleRequirement('Delta Brock', 1, AchievementOption.less),
    });

    NPCList.GraniteCamper2 = new NPC('Camper', [
    ...
    NPCList.IcyBoulder = new NPC('Icy Boulder', [
        '<i>A large, icy boulder sits in the corner of the cave. Maybe you can move it when you\'re stronger?</i>',
    ], {
        requirement: new TemporaryBattleRequirement('Icy Boulder', 1, AchievementOption.less),
    });

    NPCList.DeltaSteven2 = new NPC('Steven', [
        'You\'re a rather impressive trainer $playername$, but there\'s no way you can beat me. Come back when you\'re stronger.',
    ], {
        image: 'assets/images/npcs/Steven.png',
        requirement: new TemporaryBattleRequirement('Delta Steven', 1, AchievementOption.less),
    });

    NPCList.DeltaSteven3 = new NPC('Steven', [
    ...
    NPCList.HoennStoneSalesman1 = new NPC('Stone Salesman', [
        'I\'m hunting for rare stones! If I find any extras, I\'ll sell you some!',
    ], {
        requirement: new TemporaryBattleRequirement('Hoenn Stone Salesman', 1, AchievementOption.less),
    });

    NPCList.HoennStoneSalesman2 = new NPC('Stone Salesman', [
    ...
    NPCList.MrStone1 = new NPC('Mr. Stone', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Primal Reversion'), new QuestLineStepCompletedRequirement('Primal Reversion', 1, AchievementOption.less)]),
    });

    NPCList.PrimalMural1 = new NPC('Groudon Mural', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Primal Reversion', 1), new QuestLineStepCompletedRequirement('Primal Reversion', 3, AchievementOption.less)]),
    });

    NPCList.PrimalMural2 = new NPC('Kyogre Mural', [
    ...
    NPCList.PrimalSteven = new NPC('Steven', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Primal Reversion', 2), new QuestLineStepCompletedRequirement('Primal Reversion', 4, AchievementOption.less)]),
    });

    NPCList.Stern1 = new NPC('Captain Stern', [
        ...
        requirement: new MultiRequirement([new WeatherRequirement([WeatherType.Thunderstorm]), new QuestLineStepCompletedRequirement('Primal Reversion', 3), new QuestLineStepCompletedRequirement('Primal Reversion', 5, AchievementOption.less)]),
    });

    NPCList.SternSubstitute = new NPC('Deck Swabber', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Primal Reversion', 3), new QuestLineStepCompletedRequirement('Primal Reversion', 5, AchievementOption.less)]),
    });

    NPCList.Stern2 = new NPC('Captain Stern', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Primal Reversion', 5), new QuestLineStepCompletedRequirement('Primal Reversion', 7, AchievementOption.less)]),
    });

    NPCList.Stern3 = new NPC('Captain Stern', [
        'Thanks for getting all the supplies together, $playername$!',
        'We\'re ready to set sail to the Seafloor Cavern!',
    ], { image: 'assets/images/npcs/Sailor.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Primal Reversion', 7), new QuestLineStepCompletedRequirement('Primal Reversion', 9, AchievementOption.less)]),
    });

    NPCList.WeatherScan = new NPC('Scan for unusual weather', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Primal Reversion', 11), new QuestLineStepCompletedRequirement('Primal Reversion', 13, AchievementOption.less)]),
    });

    NPCList.PrimalArchie = new NPC('Archie', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Primal Reversion', 13), new QuestLineStepCompletedRequirement('Primal Reversion', 15, AchievementOption.less)]),
    });

    NPCList.PrimalMaxie = new NPC('Maxie', [
    ...
    NPCList.MrStone2 = new NPC('Mr. Stone', [
    ...
    NPCList.ZinniaOrigin = new NPC('Zinnia', [
    ...
    NPCList.ExploreStand = new NPC('Explore the Outskirt Stand', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Shadows in the Desert'), new QuestLineStepCompletedRequirement('Shadows in the Desert', 1, AchievementOption.less)]),
    });
    NPCList.Willie = new NPC('Willie', [
    ...
    NPCList.Sack = new NPC('Check the sack', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 2), new QuestLineStepCompletedRequirement('Shadows in the Desert', 4, AchievementOption.less)]),
    });
    NPCList.EsCade1 = new NPC('Mayor Es Cade', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 4), new QuestLineStepCompletedRequirement('Shadows in the Desert', 6, AchievementOption.less)]),
    });
    NPCList.Rui1 = new NPC('Rui', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 5), new QuestLineStepCompletedRequirement('Shadows in the Desert', 7, AchievementOption.less)]),
    });
    NPCList.Duking1 = new NPC('Duking', [
        '<i>Grr...</i>.',
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 7), new QuestLineStepCompletedRequirement('Shadows in the Desert', 9, AchievementOption.less)]),
    });
    NPCList.Doken1 = new NPC('Doken', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 10), new QuestLineStepCompletedRequirement('Shadows in the Desert', 12, AchievementOption.less)]),
    });
    NPCList.FreePlusle = new NPC('Free Duking\'s Plusle', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 12), new QuestLineStepCompletedRequirement('Shadows in the Desert', 14, AchievementOption.less)]),
    });
    NPCList.Rui2 = new NPC('Rui', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 13), new QuestLineStepCompletedRequirement('Shadows in the Desert', 15, AchievementOption.less)]),
    });
    NPCList.GrandpaEagun1 = new NPC('Grandpa Eagun', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 16), new QuestLineStepCompletedRequirement('Shadows in the Desert', 18, AchievementOption.less)]),
    });
    NPCList.Rui3 = new NPC('Rui', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 18), new QuestLineStepCompletedRequirement('Shadows in the Desert', 20, AchievementOption.less)]),
    });
    NPCList.SearchTheStudio = new NPC('Search The Studio', [
    ...
    { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 20), new QuestLineStepCompletedRequirement('Shadows in the Desert', 22, AchievementOption.less)]) },
    );
    NPCList.EsCade2 = new NPC('Mayor Es Cade', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 23), new QuestLineStepCompletedRequirement('Shadows in the Desert', 25, AchievementOption.less)]),
    });
    NPCList.EviceEscape = new NPC('Watch Evice Escape', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Shadows in the Desert', 25), new QuestLineCompletedRequirement('Shadows in the Desert', AchievementOption.less)]),
    });
    NPCList.PhenacRoller = new NPC('Cool Dude', [
    ...
    NPCList.OrreRoamerNPC = new RoamerNPC('Fateen\'s Fortune Telling', [
        'I sense the presence of rare Pokémon at the {ROUTE_NAME}! Hurry, before the fates intervene!',
    ], Region.hoenn, RoamingPokemonList.findGroup(Region.hoenn, HoennSubRegions.Orre), 'assets/images/npcs/Psychic (female).png');
    NPCList.AgateAthlete = new NPC('Jogger', [
    ...
    NPCList.RelicSage = new NPC('Relic Stone Sage', [
    ...
    NPCList.GateonSailor = new NPC('Sailor', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Gale of Darkness'), new QuestLineStepCompletedRequirement('Gale of Darkness', 1, AchievementOption.less)]),
    });
    NPCList.Chobin1 = new NPC('Chobin', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 3), new QuestLineStepCompletedRequirement('Gale of Darkness', 5, AchievementOption.less)]),
    });
    NPCList.Eagun2 = new NPC('Grandpa Eagun', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 4), new QuestLineStepCompletedRequirement('Gale of Darkness', 6, AchievementOption.less)]),
    });
    NPCList.Lovrina = new NPC('Cipher Admin Lovrina', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 7), new QuestLineStepCompletedRequirement('Gale of Darkness', 9, AchievementOption.less)]),
    });
    NPCList.Exol = new NPC('Cipher Commander Exol', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 11), new QuestLineStepCompletedRequirement('Gale of Darkness', 13, AchievementOption.less)]),
    });
    NPCList.Snattle = new NPC('Cipher Admin Snattle', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 14), new QuestLineStepCompletedRequirement('Gale of Darkness', 16, AchievementOption.less)]),
    });
    NPCList.Trest = new NPC('Mayor Trest', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 15), new QuestLineStepCompletedRequirement('Gale of Darkness', 17, AchievementOption.less)]),
    });
    NPCList.Verich = new NPC('Mr. Verich', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 16), new QuestLineStepCompletedRequirement('Gale of Darkness', 18, AchievementOption.less)]),
    });
    NPCList.Chobin2 = new NPC('Chobin', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 18), new QuestLineStepCompletedRequirement('Gale of Darkness', 20, AchievementOption.less)]),
    });
    NPCList.SearchLibra = new NPC('Search the S. S. Libra', [
    ...
    ], { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 20), new QuestLineStepCompletedRequirement('Gale of Darkness', 22, AchievementOption.less)]),
    });
    NPCList.ProfKrane = new NPC('Professor Krane', [
    ...
    ], { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Gale of Darkness', 25), new QuestLineStepCompletedRequirement('Gale of Darkness', 27, AchievementOption.less)]),
    });
    NPCList.DrKaminko = new NPC('Dr. Kaminko', [
        'Leave me alone! I\'m WORKING!'],
    );
    NPCList.OrreColosseumSpectator = new NPC('Colosseum Spectator', [
    ...
    NPCList.destinyGem = new NPC('Green Pulsing Gemstone', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Destiny Deoxys', 0), new QuestLineStepCompletedRequirement('Destiny Deoxys', 2, AchievementOption.less)]),
    });

    NPCList.destinyScientistChasm = new NPC('Professor Lund', [
        ...
        image: 'assets/images/npcs/Scientist (male).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Destiny Deoxys', 2), new QuestLineStepCompletedRequirement('Destiny Deoxys', 4, AchievementOption.less)]),
    });

    NPCList.destinyScientistBF = new NPC('Professor Lund', [
        ...
        image: 'assets/images/npcs/Scientist (male).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Destiny Deoxys', 5), new QuestLineStepCompletedRequirement('Destiny Deoxys', 7, AchievementOption.less)]),
    });

    NPCList.destinyDeoxysReunion = new PokemonGiftNPC('Green and Purple Gem Deoxys', [
    ...
    NPCList.MossRock = new NPC('Moss Rock', [
        'The rock is covered in moss. It feels pleasantly cool.',
    ], {
        image: 'assets/images/npcs/other/Moss Rock.png',
        requirement: new MaxRegionRequirement(Region.sinnoh),
    });

    NPCList.IceRock = new NPC('Ice Rock', [
    ...
    // Sinnoh NPCs
    NPCList.TwinleafContestChampion = new NPC('Contest Champion', [
    ...
    NPCList.SandgemBeachcomber = new NPC('Beachcomber', [
    ...
    NPCList.SinnohFossilNpc = new NPC('Gossiper', [
    ...
    NPCList.SinnohBerryMasterAssistant = new NPC('Berry Master Assistant', [
        'I have so many Gracidea right now, so i\'ll sell you one.',
        'If you give it to your Shaymin, it can change form!',
    ]);

    NPCList.OreburghConstructionWorker = new NPC('Construction Worker', [
    ...
    NPCList.HearthomeContestFan = new NPC('Contest Fan', [
    ...
    NPCList.CelesticGrandma = new NPC('Cynthia\'s Grandmother', [
    ...
    NPCList.PalParkWarden = new NPC('Pal Park Warden', [
    ...
    NPCList.PalParkBurglar = new NPC('Burglar', [
    ...
    NPCList.CanalaveSinnohMyth = new NPC('Sinnoh\'s Myth', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Zero\'s Ambition', 0), new QuestLineStepCompletedRequirement('Zero\'s Ambition', 2, AchievementOption.less)]) });

    NPCList.VerityMesprit = new NPC('Mesprit', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Zero\'s Ambition', 2), new QuestLineStepCompletedRequirement('Zero\'s Ambition', 4, AchievementOption.less)]) });

    NPCList.ValorAzelf = new NPC('Azelf', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Zero\'s Ambition', 4), new QuestLineStepCompletedRequirement('Zero\'s Ambition', 6, AchievementOption.less)]) });

    NPCList.SnowpointYoungGirl = new NPC('Young Girl', [
        'Someone told me that training an Eevee on Route 217 will make it evolve.',
        'They must be lying, how can that be true?!',
    ]);

    NPCList.MindyFriend = new NPC('Mindy\'s Friend', [
    ...
    NPCList.AcuityUxie = new NPC('Uxie', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Zero\'s Ambition', 6), new QuestLineStepCompletedRequirement('Zero\'s Ambition', 8, AchievementOption.less)]) });

    NPCList.SunyshoreRibbonerJulia = new NPC('Ribboner Julia', [
    ...
    NPCList.FightAreaAceTrainer = new NPC('Ace Trainer Quinn', [
    ...
    NPCList.FightAreaZero1 = new NPC('Zero', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Zero\'s Ambition'), new QuestLineStepCompletedRequirement('Zero\'s Ambition', 1, AchievementOption.less)]),
    });

    NPCList.FightAreaZero2 = new NPC('Zero', [
        ...
        image: 'assets/images/npcs/Zero.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Zero\'s Ambition', 1), new QuestLineStepCompletedRequirement('Zero\'s Ambition', 2, AchievementOption.less)]),
    });

    NPCList.SurvivalAreaSinnohRoamerNPC = new RoamerNPC('Hiker Kevin', [
        'I spotted a bunch of roaming Pokémon on {ROUTE_NAME}!',
    ], Region.sinnoh, RoamingPokemonList.findGroup(Region.sinnoh, SinnohSubRegions.Sinnoh), 'assets/images/npcs/Hiker.png');

    NPCList.SendoffSpringLakeTrio = new NPC('Lake Trio', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Zero\'s Ambition', 9), new QuestLineStepCompletedRequirement('Zero\'s Ambition', 11, AchievementOption.less)]) });

    NPCList.SendoffSpringZero1 = new NPC('Zero', [
        ...
        image: 'assets/images/npcs/Zero.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Zero\'s Ambition', 11), new QuestLineStepCompletedRequirement('Zero\'s Ambition', 12, AchievementOption.less)]),
    });

    NPCList.SendoffSpringZero2 = new NPC('Zero', [
    ...
    NPCList.ProfRowan = new ProfNPC('Prof. Rowan',
        Region.sinnoh,
    ...
    NPCList.LucyStevens1 = new NPC('Lucy Stevens', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Detective Pikachu', 7), new QuestLineStepCompletedRequirement('Detective Pikachu', 9, AchievementOption.less)]),
    });

    NPCList.ManaphyHastings1 = new NPC('Professor Hastings', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Recover the Precious Egg!'), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 2, AchievementOption.less)]),
    });

    NPCList.ManaphyHastings2 = new NPC('Professor Hastings', [
        ...
        image: 'assets/images/npcs/Professor Hastings.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 10), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 11, AchievementOption.less)]),
    });

    NPCList.ManaphyHastings3 = new NPC('Professor Hastings', [
        ...
        image: 'assets/images/npcs/Professor Hastings.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 11), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 25, AchievementOption.less)]),
    });

    NPCList.ManaphyHastings4 = new NPC('Professor Hastings', [
        ...
        image: 'assets/images/npcs/Professor Hastings.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 25), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 26, AchievementOption.less)]),
    });

    NPCList.ManaphyBoulders = new NPC('Strange Boulders', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 0), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 2, AchievementOption.less)]),
    });

    NPCList.ManaphyGoRockCommander = new NPC('Go-Rock Commander', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 3), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 5, AchievementOption.less)]),
    });

    NPCList.ManaphyGoRock = new NPC('Go-Rock Grunt', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 6), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 8, AchievementOption.less)]),
    });

    NPCList.HappinyWitness1 = new NPC('Black Belt', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 12), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 14, AchievementOption.less)]),
    });

    NPCList.HappinyWitness2 = new NPC('Lady', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 13), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 15, AchievementOption.less)]),
    });

    NPCList.HappinyWitness3 = new NPC('Cyclist', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 14), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 16, AchievementOption.less)]),
    });

    NPCList.HappinyWitness4 = new NPC('Waitress', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 15), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 17, AchievementOption.less)]),
    });

    NPCList.HappinyWitness5 = new NPC('Pokémon Ranger', [
        ...
        image: 'assets/images/npcs/Pokemon Ranger (female).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 16), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 18, AchievementOption.less)]),
    });

    NPCList.HappinyWitness6 = new NPC('Murph', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 17), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 19, AchievementOption.less)]),
    });

    NPCList.HappinyWitness7 = new NPC('Cyclist', [
        ...
        image: 'assets/images/npcs/Cyclist (female).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 18), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 20, AchievementOption.less)]),
    });

    NPCList.HappinyWitness8 = new NPC('Bug Catcher', [
        ...
        image: 'assets/images/npcs/Bug Catcher.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 19), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 21, AchievementOption.less)]),
    });

    NPCList.HappinyWitness9 = new NPC('Go-Rock Pincher', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 20), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 22, AchievementOption.less)]),
    });

    NPCList.HappinyBoulders = new NPC('Strange Boulders', [
        ...
        image: 'assets/images/npcs/specialNPCs/Strange Boulders.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 22), new QuestLineStepCompletedRequirement('Recover the Precious Egg!', 24, AchievementOption.less)]),
    });
    NPCList.SnoverBreeder = new NPC('Snover Breeder', [
    ...
    NPCList.GrotleAcornParty = new NPC('Grotle and Friends', [
    ...
    NPCList.EvolutionAssistant = new AssistantNPC('Prof. Rowan\'s Assistant', [
    ...
    // Unova NPCs
    NPCList.ExcitedChild = new NPC('Excited Child', [
    ...
    NPCList.CasteliaMusician = new NPC('Musician', [
    ...
    NPCList.PlasmaGrunt1 = new NPC('Team Plasma Grunt', [
    ...
    NPCList.RelicCastleRuinmaniac = new NPC('Ruin Maniac', [
    ...
    NPCList.NimbasaExplorer = new NPC('Explorer', [
    ...
    NPCList.PlasmaGrunt2 = new NPC('Team Plasma Grunt', [
        ...
        image: 'assets/images/npcs/Team Plasma Grunt (male).png',
        requirement: new OneFromManyRequirement([new TemporaryBattleRequirement('Team Plasma Grunt 4', 1, AchievementOption.less), new TemporaryBattleRequirement('Team Plasma Grunt 5', 1, AchievementOption.less), new TemporaryBattleRequirement('Team Plasma Grunts 1', 1, AchievementOption.less), new TemporaryBattleRequirement('Team Plasma Grunts 2', 1, AchievementOption.less)]),
    });

    NPCList.DriftveilZinzolin = new NPC('Zinzolin', [
        'YOU!',
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 6), new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 7, AchievementOption.less)]),
    });

    NPCList.PlasmaGrunt3 = new NPC('Team Plasma Grunt', [
    ...
    NPCList.GiantChasmColress = new NPC('Colress', [
        ...
        requirement: new MultiRequirement([new ClearDungeonRequirement(1, getDungeonIndex('Giant Chasm')), new TemporaryBattleRequirement('Plasma Shadow 1'), new TemporaryBattleRequirement('Colress 3', 1, AchievementOption.less)]),
    });

    NPCList.GiantChasmShadowTriad = new NPC('Shadow Triad', [
        ...
        requirement: new MultiRequirement([new TemporaryBattleRequirement('Colress 3'), new TemporaryBattleRequirement('Ghetsis 1', 1, AchievementOption.less)]),
    });

    NPCList.IcirrusFanClubChairman = new NPC('Fan Club Chairman', [
    ...
    NPCList.P2LaboratoryColress = new NPC('Colress', [
        ...
        image: 'assets/images/npcs/Team Plasma (colress).png',
        requirement: new ClearDungeonRequirement(1, getDungeonIndex('P2 Laboratory'), AchievementOption.less),
    });

    NPCList.UnovaRoamerNPC = new RoamerNPC('Professor Juniper\'s Aide', [
        'Our research indicates a higher concentration of roaming Pokémon on {ROUTE_NAME}!',
    ], Region.unova, RoamingPokemonList.findGroup(Region.unova, UnovaSubRegions.Unova));

    NPCList.ProfJuniper = new ProfNPC('Prof. Juniper',
        Region.unova,
    ...
    NPCList.ProfBurnet = new NPC('Professor Burnet', [
    ...
    NPCList.DreamResearcher1 = new NPC('Dream Researcher', [
        ...
        image: 'assets/images/npcs/Scientist (female).png',
        requirement: new TemporaryBattleRequirement('Dream Researcher', 1, AchievementOption.less),
    });

    NPCList.DreamResearcher2 = new NPC('Dream Researcher', [
    ...
    NPCList.VitaminRefundCode = new NPC('Pokémon Breeder', [
    ...
    NPCList.UnovaFossilNpc = new NPC('Friendly Waitress', [
    ...
    NPCList.OldManSwords = new NPC('Old Man', [
        ...
        image: 'assets/images/npcs/Old Man.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Swords of Justice'), new QuestLineStepCompletedRequirement('Swords of Justice', 1, AchievementOption.less)]),
    });
    NPCList.Cobalion1 = new NPC('Cobalion', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 1, AchievementOption.more), new QuestLineStepCompletedRequirement('Swords of Justice', 3, AchievementOption.less)]),
    });
    NPCList.Terrakion1 = new NPC('Terrakion', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 3, AchievementOption.more), new QuestLineStepCompletedRequirement('Swords of Justice', 5, AchievementOption.less)]),
    });
    NPCList.Cobalion2 = new NPC('Cobalion', [
        ...
        image: 'assets/images/pokemon/638.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 5, AchievementOption.more), new QuestLineStepCompletedRequirement('Swords of Justice', 7, AchievementOption.less)]),
    });
    NPCList.Virizion1 = new NPC('Virizion', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 7, AchievementOption.more), new QuestLineStepCompletedRequirement('Swords of Justice', 9, AchievementOption.less)]),
    });
    NPCList.Virizion2 = new NPC('Virizion', [
        ...
        image: 'assets/images/pokemon/640.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 9, AchievementOption.more), new QuestLineStepCompletedRequirement('Swords of Justice', 10, AchievementOption.less)]),
    });
    NPCList.Cobalion3 = new NPC('Cobalion', [
        ...
        image: 'assets/images/pokemon/638.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 10, AchievementOption.more), new QuestLineStepCompletedRequirement('Swords of Justice', 12, AchievementOption.less)]),
    });
    NPCList.Cobalion4 = new NPC('Cobalion', [
        ...
        image: 'assets/images/pokemon/638.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 13, AchievementOption.more), new QuestLineStepCompletedRequirement('Swords of Justice', 15, AchievementOption.less)]),
    });
    NPCList.Cobalion5 = new NPC('Cobalion', [
        ...
        image: 'assets/images/pokemon/638.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 15, AchievementOption.more), new QuestLineStepCompletedRequirement('Swords of Justice', 17, AchievementOption.less)]),
    });
    NPCList.Cobalion6 = new NPC('Cobalion', [
        '$playername$... Don\'t worry about us... We\'ll be fine... Defeat Kyurem once and for all so we can live in peace.',
    ], {
        image: 'assets/images/pokemon/638.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 18, AchievementOption.more), new QuestLineStepCompletedRequirement('Swords of Justice', 20, AchievementOption.less)]),
    });
    NPCList.Cobalion7 = new NPC('Cobalion', [
        ...
        image: 'assets/images/pokemon/638.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Swords of Justice', 20, AchievementOption.more), new QuestLineCompletedRequirement('Swords of Justice', AchievementOption.less)]),
    });
    NPCList.Terrakion2 = new NPC('Terrakion', [
    ...
    NPCList.Virizion3 = new NPC('Virizion', [
    ...
    // Genesect Quest Npcs
    NPCList.InvestigateP2 = new NPC('Investigate the P2 Laboratory', [
        '<i>A bright red Pokémon flies past you at a high speed, heading west.</i>',
    ], {
        image: 'assets/images/shinypokemon/649.05.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('The Legend Awakened'), new QuestLineStepCompletedRequirement('The Legend Awakened', 1, AchievementOption.less)]),
    });

    NPCList.AncientBugHunter1 = new NPC('Ancient Bug Hunter', [
        ...
        image: 'assets/images/npcs/Super Nerd.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Legend Awakened', 2), new QuestLineStepCompletedRequirement('The Legend Awakened', 4, AchievementOption.less)]),
    });

    NPCList.GenesectFight = new NPC('Witness the battle', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Legend Awakened', 4), new QuestLineStepCompletedRequirement('The Legend Awakened', 6, AchievementOption.less)]),
    });

    NPCList.AncientBugHunter2 = new NPC('Ancient Bug Hunter', [
    ...
    NPCList.AncientBugHunter3 = new NPC('Ancient Bug Hunter', [
    ...
    // Kalos NPCs
    NPCList.LumioseEngineer = new NPC('Engineer', [
    ...
    NPCList.LumioseDexio = new NPC('Dexio', [
    ...
    NPCList.Lysandre1 = new NPC('Lysandre', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('A Beautiful World'), new QuestLineStepCompletedRequirement('A Beautiful World', 1, AchievementOption.less)]),
    });

    NPCList.Calem1 = new NPC('Calem', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 0), new QuestLineStepCompletedRequirement('A Beautiful World', 2, AchievementOption.less)]),
    });

    NPCList.CamphrierFlabébéEnthusiast = new NPC('Flabébé Enthusiast', [
    ...
    NPCList.Calem2 = new NPC('Calem', [
        ...
        image: 'assets/images/npcs/Calem.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 1), new QuestLineStepCompletedRequirement('A Beautiful World', 3, AchievementOption.less)]),
    });

    NPCList.KalosFossilNpc1 = new NPC('Honeymooner Gal', [
    ...
    NPCList.KalosFossilNpc2 = new NPC('Honeymooner Guy', [
    ...
    NPCList.KalosFossilNpc3 = new NPC('Honeymooner Couple', [
    ...
    NPCList.FossilScientist = new NPC('Fossil Scientist', [
        ...
        image: 'assets/images/npcs/Scientist (male).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 4), new QuestLineStepCompletedRequirement('A Beautiful World', 6, AchievementOption.less)]),
    });

    NPCList.CyllageStoneCollector = new NPC('Vivid Stone Collector', [
    ...
    NPCList.TeamFlareGrunt1 = new NPC('Team Flare Grunt', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 6), new QuestLineStepCompletedRequirement('A Beautiful World', 8, AchievementOption.less)]),
    });

    NPCList.NotAsh = new NPC('Not Ash', [
    ...
    NPCList.SharlourKorrina = new NPC('Korrina', [
    ...
    NPCList.CoumarineBirdwatcher = new NPC('Birdwatcher', [
    ...
    NPCList.CoumarineElectricTrainer = new NPC('Electric Trainer', [
    ...
    NPCList.Diantha1 = new NPC('Diantha', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 8), new QuestLineStepCompletedRequirement('A Beautiful World', 10, AchievementOption.less)]),
    });

    NPCList.Lysandre2 = new NPC('Lysandre', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 9), new QuestLineStepCompletedRequirement('A Beautiful World', 11, AchievementOption.less)]),
    });

    NPCList.Lysandre3 = new NPC('Lysandre', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 12), new QuestLineStepCompletedRequirement('A Beautiful World', 14, AchievementOption.less)]),
    });

    NPCList.SantaluneSageChen = new NPC('Sage Chen', [
    ...
    NPCList.LaverreFurisodeGirlKatherine = new NPC('Furisode Girl Katherine', [
    ...
    NPCList.LaverreGengariteAster1 = new NPC('Hex Maniac Aster', [
        ...
        requirement: new OneFromManyRequirement([
            new StatisticRequirement(['pokemonEncountered', PokemonHelper.getPokemonByName('Gastly').id], 666, undefined, AchievementOption.less),
            new StatisticRequirement(['pokemonEncountered', PokemonHelper.getPokemonByName('Haunter').id], 444, undefined, AchievementOption.less),
            new StatisticRequirement(['pokemonEncountered', PokemonHelper.getPokemonByName('Gengar').id], 13, undefined, AchievementOption.less),
            new ObtainedPokemonRequirement('Gengar', true)]),
    });

    NPCList.LaverreGengariteAster2 = new NPC('Hex Maniac Aster', [
    ...
    NPCList.LaverreMedichamite = new NPC('Black Belt', [
    ...
    NPCList.PokéBallFactoryDirector = new NPC('Poké Ball Factory Director', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 14), new QuestLineStepCompletedRequirement('A Beautiful World', 16, AchievementOption.less)]),
    });

    NPCList.DendemilleDogLover = new NPC('Dubious Dog-loving Duke', [
    ...
    NPCList.DendemilleWolfLover = new NPC('Worrisome Wolf-loving Woman', [
    ...
    NPCList.ProfessorSycamore1 = new NPC('Prof. Sycamore', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 15), new QuestLineStepCompletedRequirement('A Beautiful World', 17, AchievementOption.less)]),
    });

    NPCList.AnistarKalosRoamerNPC = new RoamerNPC('Hex Maniac Melanie', [
        'The spirits tell me roaming Pokémon have been spotted on {ROUTE_NAME}!',
    ], Region.kalos, RoamingPokemonList.findGroup(Region.kalos, KalosSubRegions.Kalos), 'assets/images/npcs/Hex Maniac.png');

    NPCList.KalosTVNews = new NPC('Kalos TV News', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 18), new QuestLineStepCompletedRequirement('A Beautiful World', 20, AchievementOption.less)]),
    });

    NPCList.Lysandre4 = new NPC('Lysandre', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 19), new QuestLineStepCompletedRequirement('A Beautiful World', 21, AchievementOption.less)]),
    });

    NPCList.AZ1 = new NPC('AZ', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 21), new QuestLineStepCompletedRequirement('A Beautiful World', 23, AchievementOption.less)]),
    });

    NPCList.BlueButton = new NPC('Blue Button', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 23), new QuestLineStepCompletedRequirement('A Beautiful World', 24, AchievementOption.less)]),
    });

    NPCList.RedButton = new NPC('Red Button', [
    ...
    NPCList.TeamFlareLysandre1 = new NPC('Team Flare Lysandre', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 29), new QuestLineStepCompletedRequirement('A Beautiful World', 31, AchievementOption.less)]),
    });

    NPCList.TeamFlareBossLysandre1 = new NPC('Team Flare Boss Lysandre', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('A Beautiful World', 31), new QuestLineStepCompletedRequirement('A Beautiful World', 33, AchievementOption.less)]),
    });

    NPCList.EternalFloetteGift = new PokemonGiftNPC('AZ', [
    ...
    NPCList.CouriwayOldGentlemanHarold = new NPC('Old Gentleman Harold', [
        ...
        requirement: new TemporaryBattleRequirement('Team Flare Boss Lysandre 2', 1, AchievementOption.less),
    });

    NPCList.KiloudeConfusedHiker = new NPC('Confused Hiker', [
    ...
    NPCList.ProfSycamore = new ProfNPC('Prof. Sycamore',
        Region.kalos,
    ...
    NPCList.ExamineAegislash = new PokemonGiftNPC('Millis and Argus Steels\' Aeglislash', [
        '<i>Aegislash wants to join you on your adventure.</i>',
    ], 'Aegislash (Blade)', 'assets/images/pokemon/681.01.png', { requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Princess Diancie', 4, AchievementOption.more), new ObtainedPokemonRequirement('Aegislash (Blade)', true)]) });

    NPCList.ThanksDiancie = new NPC('Princess Diancie', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Princess Diancie', 6), new QuestLineStepCompletedRequirement('Princess Diancie', 8, AchievementOption.less)]),
    });

    NPCList.KalosStoneSalesman1 = new NPC('Stone Salesman', [
        'I\'m hunting for rare stones! If I find any extras, I\'ll sell you some!',
    ], {
        requirement: new TemporaryBattleRequirement('Kalos Stone Salesman', 1, AchievementOption.less),
    });

    NPCList.KalosStoneSalesman2 = new NPC('Stone Salesman', [
    ...
    NPCList.Baraz1 = new NPC('Baraz', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Clash of Ages', 0), new QuestLineStepCompletedRequirement('Clash of Ages', 2, AchievementOption.less)]),
    });

    NPCList.Baraz2 = new NPC('Baraz', [
        '$playername$! No luck?',
        'Maybe beating the Pokémon isn\'t enough. Try catching some of these Psychic Pokémon.',
    ], {
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Clash of Ages', 2), new QuestLineStepCompletedRequirement('Clash of Ages', 3, AchievementOption.less)]),
    });

    NPCList.Baraz3 = new NPC('Baraz', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Clash of Ages', 4), new QuestLineStepCompletedRequirement('Clash of Ages', 6, AchievementOption.less)]),
    });

    NPCList.Baraz4 = new NPC('Baraz', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Clash of Ages', 6), new QuestLineStepCompletedRequirement('Clash of Ages', 8, AchievementOption.less)]),
    });

    NPCList.VivillonPhotobook = new NPC('Vivillon Photobook', [
    ...
    NPCList.FriendlyAttendant = new NPC('Friendly Attendant', [
    ...
    NPCList.BugCatcherScizor = new NPC('Bug Catcher Elliot', [
    ...
    NPCList.AnomalyMewtwo2 = new NPC('Anomaly Mewtwo', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 13), new QuestLineStepCompletedRequirement('An Unrivaled Power', 15, AchievementOption.less)]),
    });

    NPCList.AnomalyMewtwo3 = new NPC('Anomaly Mewtwo', [
        ...
        image: 'assets/images/pokemon/150.02.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 15), new QuestLineStepCompletedRequirement('An Unrivaled Power', 17, AchievementOption.less)]),
    });

    NPCList.AnomalyMewtwo4 = new NPC('Anomaly Mewtwo', [
        ...
        image: 'assets/images/pokemon/150.02.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('An Unrivaled Power', 17), new QuestLineCompletedRequirement('An Unrivaled Power', AchievementOption.less)]),
    });

    // Alola NPCs
    NPCList.IkiOutskirtsMom = new NPC('Scratch Cat Girl', [
    ...
    NPCList.TrainerSchoolTeacher = new NPC('Teacher Emily', [
    ...
    NPCList.IkiKahuna = new NPC('Kahuna Hala', [
        'Welcome to Alola!',
        ...
        requirement: new OneFromManyRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 1, AchievementOption.less), new QuestLineStepCompletedRequirement('Typing some Memories', 3, AchievementOption.more)]),
    });
    NPCList.VerdantCavernIlima = new NPC('Captain Ilima', [
    ...
    NPCList.LagunaKahuna = new NPC('Kahuna Hala', [
    ...
    NPCList.HeaheaCafeOwner = new NPC('Café Owner', [
    ...
    NPCList.HeaheaGentleman = new NPC('Gentleman', [
    ...
    NPCList.ProfBurnetAlola2 = new NPC('Professor Burnet', [
    ...
    NPCList.PikachuValleyPikachuGeneric = new NPC('Pikachu', [
        'Pikachu!',
        '<i>The Pikachu looks happy playing with all its friends!</i>',
    ], {
        image: 'assets/images/pokemon/25.png',
    });
    NPCList.PikachuValleyAlolaCap = new NPC('Pikachu', [
        'Pi-Pikachu!',
        ...
        requirement: new GymBadgeRequirement(BadgeEnums.Champion_Stamp, AchievementOption.less),
    });
    NPCList.PikachuValleyPikachuWorldCap = new NPC('Pikachu', [
        'Pii-kachu!',
        '<i>The Pikachu is staring at you intently! Is it waiting for you to become stronger?</i>',
    ], {
        image: 'assets/images/pokemon/25.07.png',
        requirement: new MultiRequirement([new MaxRegionRequirement(Region.galar), new GymBadgeRequirement(BadgeEnums.Elite_GalarChampion, AchievementOption.less)]),
    });
    NPCList.PaniolaTownActor = new NPC('Actor Meredith', [
    ...
    NPCList.RoyalAvenueSpectator = new NPC('Spectator', [
    ...
    NPCList.KonikoniKahuna = new NPC('Kahuna Olivia', [
    ...
    NPCList.MalieKahuna = new NPC('Kahuna Nanu', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Child of the Stars', 7), new OneFromManyRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 1, AchievementOption.less), new QuestLineStepCompletedRequirement('Typing some Memories', 3, AchievementOption.more)])]),
    });
    NPCList.TapuWorker = new NPC('Worker Ovid', [
    ...
    NPCList.PoTownNanu = new NPC('Officer Nanu', [
        'A trial-goer, huh? Figures. Look, I\'m not gonna fight someone who is taking on Team Skull. So...go. Just go.',
    ], {
        image: 'assets/images/npcs/Nanu.png',
        requirement: new QuestLineStepCompletedRequirement('Child of the Stars', 6, AchievementOption.less),
    });
    NPCList.PoTownHomeowner = new NPC('Office Worker Royce', [
    ...
    NPCList.YungoosAetherHouse = new NPC('Yungoos', [
        'Grrrssssss',
    ], {
        image: 'assets/images/pokemon/734.png',
        requirement: new OneFromManyRequirement([new QuestLineStepCompletedRequirement('Child of the Stars', 5, AchievementOption.less), new QuestLineStepCompletedRequirement('Child of the Stars', 6)]),
    });
    NPCList.SeafolkCaptain = new NPC('Mina', [
        ...
        requirement: new QuestLineStepCompletedRequirement('Eater of Light', 0, AchievementOption.less),
    });
    NPCList.SeafolkCaptainMina = new NPC('Captain Mina', [
        ...
        image: 'assets/images/npcs/Mina.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Eater of Light', 0), new OneFromManyRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 1, AchievementOption.less), new QuestLineStepCompletedRequirement('Typing some Memories', 3, AchievementOption.more)])]),
    });
    NPCList.LanakilaColress = new NPC('Colress', [
    ...
    NPCList.ReconSquadAltar = new NPC('Ultra Recon Squad', [
    ...
    NPCList.AetherParadiseAlolaRoamerNPC = new RoamerNPC('Assistant Branch Chief Wicke', [
        'Some very rare Pokémon have been sighted on {ROUTE_NAME}. I hope we can learn more about them.',
    ], Region.alola, RoamingPokemonList.findGroup(Region.alola, AlolaSubRegions.AkalaIsland), 'assets/images/npcs/Assistant Branch Chief Wicke.png');

    NPCList.ProfKukui = new ProfNPC('Prof. Kukui',
        Region.alola,
    ...
    // Alola Story NPCs
    NPCList.Lillie1 = new NPC('Mysterious Girl', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 0), new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 1, AchievementOption.less)]),
    });
    NPCList.Lillie2 = new NPC('Return Nebby to Lillie', [
        ...
        image: 'assets/images/npcs/specialNPCs/Lillie (nebby).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 8), new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 9, AchievementOption.less)]),
    });
    NPCList.Lillie3 = new NPC('Lillie', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 9), new QuestLineCompletedRequirement('Welcome to Paradise, Cousin!', AchievementOption.less)]),
    });
    NPCList.Lillie4 = new NPC('Meet with Lillie', [
        ...
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Symbiotic Relations'), new QuestLineStepCompletedRequirement('Symbiotic Relations', 0, AchievementOption.less)]),
    });
    NPCList.ProfBurnetAlola1 = new NPC('Talk to Professor Burnet', [
        ...
        image: 'assets/images/npcs/Professor Burnet (gen7).png',
        requirement: new MultiRequirement([new ClearDungeonRequirement(1, getDungeonIndex('Lush Jungle')), new QuestLineStepCompletedRequirement('Symbiotic Relations', 5), new QuestLineStepCompletedRequirement('Symbiotic Relations', 6, AchievementOption.less)]),
    });
    NPCList.Lillie5 = new NPC('Talk to Lillie', [
        ...
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Child of the Stars'), new  QuestLineStepCompletedRequirement('Child of the Stars', 0, AchievementOption.less)]),
    });
    NPCList.Lillie6 = new NPC('Lillie', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Child of the Stars', 12), new  QuestLineStepCompletedRequirement('Child of the Stars', 13, AchievementOption.less)]),
    });
    NPCList.Gladion1 = new NPC('Gladion', [
    ...
    NPCList.HapuHope = new NPC('Hapu', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Emissary of Light', 0), new  QuestLineStepCompletedRequirement('Emissary of Light', 3, AchievementOption.less)]),
    });
    NPCList.SunFlute = new NPC('Play the Sun Flute', [
        'Oh my goodness, Nebby! To think you would be the emissary of the sun, Solgaleo!',
        '<img src="assets/images/pokemon/791.png">',
    ], {
        saveKey: 'SunFlute',
        image: 'assets/images/npcs/Lillie (z powered).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Emissary of Light', 5), new QuestLineStepCompletedRequirement('Emissary of Light', 6, AchievementOption.less), new OneFromManyRequirement([new DayCyclePartRequirement([1]), new DayCyclePartRequirement([2])])]),
    });
    NPCList.MoonFlute = new NPC('Play the Moon Flute', [
        'Oh my goodness, Nebby! To think you would be the emissary of the moon, Lunala!',
        '<img src="assets/images/pokemon/792.png">',
    ], {
        saveKey: 'MoonFlute',
        image: 'assets/images/npcs/Lillie (z powered).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Emissary of Light', 5), new QuestLineStepCompletedRequirement('Emissary of Light', 6, AchievementOption.less), new OneFromManyRequirement([new DayCyclePartRequirement([0]), new DayCyclePartRequirement([3])])]),
    });
    NPCList.Lillie7 = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/Lillie (z powered).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Emissary of Light', 7), new  QuestLineCompletedRequirement('Emissary of Light', AchievementOption.less)]),
    });
    NPCList.Lillie8 = new NPC('Talk to Lillie', [
        ...
        image: 'assets/images/npcs/Lillie (z powered).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Eater of Light', 0), new QuestLineStepCompletedRequirement('Eater of Light', 2, AchievementOption.less)]),
    });
    NPCList.LillieSun = new NPC('Lillie', [
    ...
    NPCList.LillieMoon = new NPC('Lillie', [
        'At first I\'d taken Nebby with me, but I didn\'t have the courage to protect it myself. But I\'m not that person anymore!',
    ...
    // Optional Story NPCs
    // Lillies
    NPCList.LillieMahaloTrail1 = new NPC('Mysterious Girl', [
        'H-help... Save Nebby!',
    ], {
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Welcome to Paradise, Cousin!'), new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 0, AchievementOption.less)]),
    });
    NPCList.LillieMahaloTrail2 = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 1), new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 2, AchievementOption.less)]),
    });
    NPCList.LillieMelemeleMeadow1 = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 5), new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 8, AchievementOption.less)]),
    });
    NPCList.LillieMelemeleMeadow2 = new NPC('Lillie', [
        'Hello, $playername$. Are you done with your battle against Hau on Route 3? We should all head back to Iki Town, now.',
    ], {
        image: 'assets/images/npcs/specialNPCs/Lillie (nebby).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 9), new QuestLineStepCompletedRequirement('Welcome to Paradise, Cousin!', 10, AchievementOption.less)]),
    });
    NPCList.LillieHeahea = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/specialNPCs/Lillie (nebby).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Symbiotic Relations', 0), new QuestLineStepCompletedRequirement('Symbiotic Relations', 7, AchievementOption.less)]),
    });
    NPCList.LillieRuinsOfLife = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/specialNPCs/Lillie (nebby).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Symbiotic Relations', 7), new QuestLineStepCompletedRequirement('Symbiotic Relations', 8, AchievementOption.less)]),
    });
    NPCList.LillieMalie = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Child of the Stars', 0), new  QuestLineStepCompletedRequirement('Child of the Stars', 3, AchievementOption.less)]),
    });
    NPCList.LillieAetherHouse = new NPC('Lillie', [
        'Pokémon being abducted like that... Maybe even hurt... I just can\'t stand the idea! $playername$! Please...help them!',
    ], {
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Child of the Stars', 5), new QuestLineStepCompletedRequirement('Child of the Stars', 6, AchievementOption.less)]),
    });
    NPCList.LillieSeafolkVillage = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/Lillie (z powered).png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Emissary of Light'), new QuestLineStepCompletedRequirement('Emissary of Light', 1, AchievementOption.less)]),
    });
    NPCList.LillieExeggutorIsland = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/Lillie (z powered).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Emissary of Light', 1), new QuestLineStepCompletedRequirement('Emissary of Light', 5, AchievementOption.less)]),
    });
    NPCList.LillieAltar1 = new NPC('Prepare with Lillie', [
        ...
        image: 'assets/images/npcs/Lillie (z powered).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Emissary of Light', 6), new QuestLineStepCompletedRequirement('Emissary of Light', 7, AchievementOption.less)]),
    });
    NPCList.LillieAltar2 = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/Lillie (z powered).png',
        requirement: new MultiRequirement([new QuestLineCompletedRequirement('Emissary of Light'), new  QuestLineStepCompletedRequirement('Eater of Light', 0, AchievementOption.less)]),
    });
    // Other story characters
    NPCList.HauAether = new NPC('Hau', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Child of the Stars', 8), new  QuestLineStepCompletedRequirement('Child of the Stars', 12, AchievementOption.less)]),
    });
    NPCList.GladionAether = new NPC('Gladion', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Child of the Stars', 9), new  QuestLineStepCompletedRequirement('Child of the Stars', 12, AchievementOption.less)]),
    });
    NPCList.LillieAether = new NPC('Lillie', [
        ...
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Child of the Stars', 10), new  QuestLineStepCompletedRequirement('Child of the Stars', 12, AchievementOption.less)]),
    });
    NPCList.HapuMalie = new NPC('Hapu', [
        ...
        image: 'assets/images/npcs/Hapu.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Child of the Stars'), new  QuestLineStepCompletedRequirement('Child of the Stars', 3, AchievementOption.less)]),
    });
    NPCList.HapuCanyon = new NPC('Hapu', [
        ...
        image: 'assets/images/npcs/Hapu.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Emissary of Light', 4), new  QuestLineCompletedRequirement('Emissary of Light', AchievementOption.less)]),
    });
    NPCList.HapuAltar = new NPC('Hapu', [
    ...
    NPCList.PhycoAltar = new NPC('Captain Phyco', [
    ...
    // Rotom-Dex
    NPCList.RotomDexSun = new NPC('Rotom Dex', [
    ...
    NPCList.RotomDexMoon = new NPC('Rotom Dex', [
    ...
    NPCList.RotomDexPreChamp = new NPC('Rotom Dex', [
        'Zzzzt!!! You\'ve almost made it, kiddo! Championship is on the horizzzon! I\'m rootin\' for ya!',
    ], {
        image: 'assets/images/npcs/specialNPCs/Rotom-Dex.png',
        requirement: new MultiRequirement([new QuestLineCompletedRequirement('Eater of Light'), new GymBadgeRequirement(BadgeEnums.Champion_Stamp, AchievementOption.less)]),
    });
    NPCList.RotomDexChamp = new NPC('Rotom Dex', [
    ...
    // Silvally Types NPC
    NPCList.SilvallyGladion1 = new NPC('Gladion', [
        ...
        image: 'assets/images/npcs/Gladion.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 2, AchievementOption.less), new QuestLineStartedRequirement('Typing some Memories', AchievementOption.more)]),
    });
    NPCList.SilvallyHala = new NPC('Kahuna Hala', [
        ...
        image: 'assets/images/npcs/Hala.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 1, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 2, AchievementOption.less)]),
    });
    NPCList.SilvallyOlivia = new NPC('Kahuna Olivia', [
    ...
    NPCList.SilvallyNanu = new NPC('Kahuna Nanu', [
    ...
    NPCList.SilvallyMina = new NPC('Captain Mina', [
    ...
    NPCList.SilvallyGladion2 = new NPC('Gladion', [
        ...
        image: 'assets/images/npcs/Gladion.png',
        requirement: new  MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 2, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 16, AchievementOption.less)]),
    });
    NPCList.SilvallyGladion2Hints = new NPC('Ask Gladion for help', [
        ...
        image: 'assets/images/npcs/Gladion.png',
        requirement: new  MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 3, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 16, AchievementOption.less)]),
    });
    NPCList.LanaSilvally1 = new NPC('Captain Lana', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 4, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 6, AchievementOption.less)]),
    });
    NPCList.MallowSilvally1 = new NPC('Captain Mallow', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 6, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 8, AchievementOption.less)]),
    });
    NPCList.KiaweSilvally1 = new NPC('Captain Kiawe', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 8, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 10, AchievementOption.less)]),
    });
    NPCList.SophoclesSilvally1 = new NPC('Captain Sophocles', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 10, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 12, AchievementOption.less)]),
    });
    NPCList.VeteranSilvally1 = new NPC('Veteran Aristo', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 12, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 14, AchievementOption.less)]),
    });
    NPCList.HapuSilvally1 = new NPC('Kahuna Hapu', [
        ...
        image: 'assets/images/npcs/Hapu.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 14, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 16, AchievementOption.less)]),
    });
    NPCList.SilvallyGladion3 = new NPC('Gladion', [
        ...
        image: 'assets/images/npcs/Gladion.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 16, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 32, AchievementOption.less)]),
    });
    NPCList.SilvallyGladion3Hints = new NPC('Ask Gladion for help', [
        ...
        image: 'assets/images/npcs/Gladion.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 17, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 32, AchievementOption.less)]),
    });
    NPCList.GuzmaSilvally = new NPC('Guzma', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 18, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 20, AchievementOption.less)]),
    });
    NPCList.KahiliSilvally = new NPC('Kahili', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 20, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 22, AchievementOption.less)]),
    });
    NPCList.PlumeriaSilvally = new NPC('Plumeria', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 22, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 24, AchievementOption.less)]),
    });
    NPCList.AcerolaSilvally = new NPC('Captain Acerola', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 24, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 26, AchievementOption.less)]),
    });
    NPCList.FabaSilvally = new NPC('Aether Branch Chief Faba', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 26, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 28, AchievementOption.less)]),
    });
    NPCList.MolayneSilvally = new NPC('Molayne', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 28, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 30, AchievementOption.less)]),
    });
    NPCList.RyukiSilvally = new NPC('Ryuki', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 30, AchievementOption.more), new QuestLineStepCompletedRequirement('Typing some Memories', 32, AchievementOption.less)]),
    });
    NPCList.SilvallyGladion4 = new NPC('Gladion', [
        ...
        image:'assets/images/npcs/Gladion.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Typing some Memories', 32, AchievementOption.more), new QuestLineCompletedRequirement('Typing some Memories', AchievementOption.less)]),
    });
    // Ultra Beasts NPCs
    NPCList.RoadsideMotelLooker1 = new NPC('Looker', [
        ...
        requirement: new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 1, AchievementOption.less),
    });
    NPCList.RoadsideMotelAnabel1 = new NPC('Anabel', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 1, AchievementOption.more), new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 4, AchievementOption.less)]),
    });
    NPCList.RoadsideMotelLooker2 = new NPC('Looker', [
    ...
    NPCList.RoadsideMotelAnabel2 = new NPC('Anabel', [
        ...
        image: 'assets/images/npcs/Anabel.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 4, AchievementOption.more), new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 6, AchievementOption.less)]),
    });
    NPCList.RoadsideMotelAnabel3 = new NPC('Anabel', [
        ...
        image: 'assets/images/npcs/Anabel.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 6, AchievementOption.more), new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 8, AchievementOption.less)]),
    });
    NPCList.RoadsideMotelMina = new NPC('Captain Mina', [
        ...
        image: 'assets/images/npcs/Mina.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 8, AchievementOption.more), new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 10, AchievementOption.less)]),
    });
    NPCList.RoadsideMotelNanu1 = new NPC('Kahuna Nanu', [
        '...',
        ...
        image: 'assets/images/npcs/Nanu.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 10, AchievementOption.more), new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 12, AchievementOption.less)]),
    });
    NPCList.RoadsideMotelNanu2 = new NPC('Kahuna Nanu', [
        '...',
        'Good job on rounding up those creatures, kid.',
        'Now, how about one more battle? I insist.',
    ], {
        image: 'assets/images/npcs/Nanu.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 12, AchievementOption.more), new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 14, AchievementOption.less)]),
    });
    NPCList.RoadsideMotelAnabel4 = new NPC('Anabel', [
        ...
        image: 'assets/images/npcs/Anabel.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 14, AchievementOption.more), new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 16, AchievementOption.less)]),
    });
    NPCList.RoadsideMotelAnabel5 = new NPC('Anabel', [
        ...
        image: 'assets/images/npcs/Anabel.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 16, AchievementOption.more), new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 18, AchievementOption.less)]),
    });
    NPCList.NecrozmaLooker = new NPC('Looker', [
    ...
    NPCList.BattleTreeRed = new NPC('Red', [
        '...',
    ], { image: 'assets/images/npcs/Red-masters.png' });
    NPCList.BattleTreeBlue = new NPC('Blue', [
    ...
    // Magikarp Jump NPCs
    NPCList.MayorKarp = new NPC('Mayor Karp', [
    ...
    NPCList.MagikarpJumpRoamerNPC = new RoamerNPC('Roddy Tackle', [
        'There are some singularly stunning individuals down at {ROUTE_NAME}! Some Magikarp with real personality!',
    ], Region.alola, RoamingPokemonList.findGroup(Region.alola, AlolaSubRegions.MagikarpJump), 'assets/images/npcs/Roddy Tackle.png', new OneFromManyRequirement([new ObtainedPokemonRequirement('Magikarp'), new ObtainedPokemonRequirement('Magikarp (Feebas)')]));
    NPCList.HoppyManOfMystery = new NPC('Man of Mystery', [
    ...
    NPCList.DrSplash1 = new NPC('Dr. Splash', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Dr. Splash\'s Research Project'), new QuestLineStepCompletedRequirement('Dr. Splash\'s Research Project', 1, AchievementOption.less)]),
    });

    NPCList.DrSplash2 = new NPC('Dr. Splash', [
        ...
        image: 'assets/images/npcs/Dr Splash.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Dr. Splash\'s Research Project', 1), new QuestLineStepCompletedRequirement('Dr. Splash\'s Research Project', 3, AchievementOption.less)]),
    });

    NPCList.DrSplash3 = new NPC('Dr. Splash', [
        ...
        image: 'assets/images/npcs/Dr Splash.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Dr. Splash\'s Research Project', 3), new QuestLineStepCompletedRequirement('Dr. Splash\'s Research Project', 5, AchievementOption.less)]),
    });

    NPCList.DrSplash4 = new NPC('Dr. Splash', [
        ...
        image: 'assets/images/npcs/Dr Splash.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Dr. Splash\'s Research Project', 5), new QuestLineStepCompletedRequirement('Dr. Splash\'s Research Project', 7, AchievementOption.less)]),
    });

    NPCList.DrSplash5 = new NPC('Dr. Splash', [
    ...
    NPCList.MagikarpEyeShadySalesman = new NPC('Shady Salesman', [
    ...
    NPCList.FishPolice = new NPC('The Fish Police', [
    ...
    // Galar NPCs
    NPCList.PostwickMum = new NPC('Mum', [
    ...
    NPCList.WedgehurstRailStaff = new NPC('Rail Staff', [
    ...
    NPCList.AssistantHenry = new NPC('Assistant Henry', [
    ...
    NPCList.BattleCafeMaster = new NPC('Battle Café Master', [
    ...
    NPCList.MotostokeArtist = new NPC('Artist Duncan', [
    ...
    NPCList.TurffieldCook = new NPC('Cook Stuart', [
    ...
    NPCList.Meteorologist = new NPC('Meteorologist', [
    ...
    NPCList.HammerlockeHiker = new NPC('Hiker Donald', [
    ...
    NPCList.WyndonBattleCafeRichard = new NPC('Richard', [
    ...
    NPCList.AncientMural1 = new NPC('Ancient Mural', [
        ...
        requirement: new QuestLineStepCompletedRequirement('The Darkest Day', 1, AchievementOption.less),
    });

    NPCList.AncientMural2 = new NPC('Ancient Mural Ruins', [
    ...
    NPCList.StowonSideSonia = new NPC('Sonia', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Darkest Day', 1), new QuestLineStepCompletedRequirement('The Darkest Day', 3, AchievementOption.less)]),
    });

    NPCList.Archaeologist = new NPC('Archaeologist', [
    ...
    NPCList.HerosBath = new NPC('Hero’s Bath', [
    ...
    NPCList.CirchesterHop = new NPC('Hop', [
        ...
        requirement: new MultiRequirement([new TemporaryBattleRequirement('Hop 7'), new QuestLineStepCompletedRequirement('The Darkest Day', 6, AchievementOption.less)]),
    });

    NPCList.CirchesterSonia = new NPC('Sonia', [
    ...
    NPCList.CirchesterGuitarist = new NPC('Guitarist Justin', [
    ...
    NPCList.TeamYellGrunts = new NPC('Team Yell Grunts', [
    ...
    NPCList.RoseBroadcast = new NPC('Broadcast of Chairman Rose', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Darkest Day', 10), new QuestLineStepCompletedRequirement('The Darkest Day', 12, AchievementOption.less)]),
    });

    NPCList.WyndonHop = new NPC('Hop', [
        ...
        image: 'assets/images/npcs/Hop.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Darkest Day', 11), new QuestLineStepCompletedRequirement('The Darkest Day', 13, AchievementOption.less)]),
    });

    NPCList.SlumberingHop1 = new NPC('Hop', [
        ...
        image: 'assets/images/npcs/Hop.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Darkest Day', 13), new QuestLineStepCompletedRequirement('The Darkest Day', 15, AchievementOption.less)]),
    });

    NPCList.EnergyPlantRose = new NPC('Chairman Rose', [
        ...
        image: 'assets/images/npcs/Macro Cosmos (rose).png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Darkest Day', 15), new QuestLineStepCompletedRequirement('The Darkest Day', 17, AchievementOption.less)]),
    });

    NPCList.EternatusCatch = new PokemonGiftNPC('Catch Eternatus', [
    ...
    NPCList.Leon = new NPC('Leon', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Darkest Day', 18), new GymBadgeRequirement(BadgeEnums.Elite_GalarChampion, AchievementOption.less)]),
    });

    NPCList.SlumberingHop2 = new NPC('Hop', [
        ...
        image: 'assets/images/npcs/Hop.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Sword and Shield'), new QuestLineStepCompletedRequirement('Sword and Shield', 1, AchievementOption.less)]),
    });

    NPCList.SordwardShielbert1 = new NPC('Sordward & Shielbert', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Sword and Shield', 1), new QuestLineStepCompletedRequirement('Sword and Shield', 3, AchievementOption.less)]),
    });

    NPCList.SordwardShielbert2 = new NPC('Sordward & Shielbert', [
        ...
        image: 'assets/images/npcs/Sordward & Shielbert.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Sword and Shield', 6), new QuestLineStepCompletedRequirement('Sword and Shield', 8, AchievementOption.less)]),
    });

    NPCList.SordwardShielbert3 = new NPC('Sordward & Shielbert', [
        ...
        image: 'assets/images/npcs/Sordward & Shielbert.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Sword and Shield', 13), new QuestLineStepCompletedRequirement('Sword and Shield', 15, AchievementOption.less)]),
    });

    NPCList.SordwardShielbert4 = new NPC('Sordward & Shielbert', [
        ...
        image: 'assets/images/npcs/Sordward & Shielbert.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Sword and Shield', 15), new QuestLineStepCompletedRequirement('Sword and Shield', 17, AchievementOption.less)]),
    });

    NPCList.Piers = new NPC('Piers', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Sword and Shield', 17), new QuestLineStepCompletedRequirement('Sword and Shield', 19, AchievementOption.less)]),
    });

    NPCList.EnergyPlantHop = new NPC('Hop', [
    ...
    NPCList.SouthGalarRoamerNPC = new RoamerNPC('Professor Sonia', [
        'I’ve heard there’s been sightings of a never-before-seen, super strong Pokémon on {ROUTE_NAME}! You should go check it out!',
    ], Region.galar, RoamingPokemonList.findGroup(Region.galar, GalarSubRegions.SouthGalar), 'assets/images/npcs/Professor Sonia.png');

    // Isle of Armor NPCs
    NPCList.IsleofArmorRoamerNPC = new RoamerNPC('Master Dojo Student', [
        'One of the other students said they saw a rare Pokémon on {ROUTE_NAME}. Might be worth having a look.',
    ], Region.galar, RoamingPokemonList.findGroup(Region.galar, GalarSubRegions.IsleofArmor), 'assets/images/npcs/Master Dojo.png');

    NPCList.Mustard1 = new NPC('Mustard', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('The Dojo\'s Armor'), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 1, AchievementOption.less )]),
    });
    NPCList.Mustard2 = new NPC('Mustard', [
        ...
        image: 'assets/images/npcs/Mustard.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 1), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 3, AchievementOption.less )]),
    });
    NPCList.Mustard3 = new NPC('Mustard', [
        ...
        image: 'assets/images/npcs/Mustard.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 3), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 4, AchievementOption.less )]),
    });
    NPCList.Mustard4 = new NPC('Mustard', [
        ...
        image: 'assets/images/npcs/Mustard.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 4), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 7, AchievementOption.less )]),
    });
    NPCList.Klara1 = new NPC('Klara', [
        ...
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 5), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 7, AchievementOption.less )]),
    });
    NPCList.Avery1 = new NPC('Avery', [
    ...
    NPCList.Mustard5 = new NPC('Mustard', [
        ...
        image: 'assets/images/npcs/Mustard.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 7), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 10, AchievementOption.less )]),
    });
    NPCList.Klara2 = new NPC('Klara', [
        'You are here.',
        ...
        image: 'assets/images/npcs/Klara.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 8), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 10, AchievementOption.less )]),
    });
    NPCList.Avery2 = new NPC('Avery', [
    ...
    NPCList.Mustard6 = new NPC('Mustard', [
        ...
        image: 'assets/images/npcs/Mustard.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 10), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 12, AchievementOption.less )]),
    });
    NPCList.Mustard7 = new NPC('Mustard', [
        ...
        image: 'assets/images/npcs/Mustard.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 12), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 14, AchievementOption.less )]),
    });
    NPCList.Mustard8 = new NPC('Mustard', [
        ...
        image: 'assets/images/npcs/Mustard.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 14), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 16, AchievementOption.less )]),
    });
    NPCList.Mustard9 = new NPC('Mustard', [
        ...
        image: 'assets/images/npcs/Mustard.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 16), new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 18, AchievementOption.less )]),
    });
    NPCList.Mustard10 = new NPC('Mustard', [
        ...
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 18), new QuestLineCompletedRequirement('The Dojo\'s Armor', AchievementOption.less )]),
    });

    NPCList.JungleAsh1 = new NPC('Ash Ketchum', [
        ...
        image: 'assets/images/npcs/Ash Ketchum.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Secrets of the Jungle'), new QuestLineStepCompletedRequirement('Secrets of the Jungle', 1, AchievementOption.less )]),
    });
    NPCList.JungleKoko1 = new NPC('Koko', [
        ...
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('Secrets of the Jungle', 0), new QuestLineStepCompletedRequirement('Secrets of the Jungle', 2, AchievementOption.less )]),
    });
    NPCList.JungleKoko2 = new NPC('Koko', [
        ...
        image: 'assets/images/npcs/Koko.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('Secrets of the Jungle', 2), new QuestLineStepCompletedRequirement('Secrets of the Jungle', 4, AchievementOption.less )]),
    });
    NPCList.JungleKoko3 = new NPC('Koko', [
        ...
        image: 'assets/images/npcs/Koko.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('Secrets of the Jungle', 4), new QuestLineStepCompletedRequirement('Secrets of the Jungle', 6, AchievementOption.less )]),
    });
    NPCList.JungleKoko4 = new NPC('Koko', [
        ...
        image: 'assets/images/npcs/Koko.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('Secrets of the Jungle', 6), new QuestLineStepCompletedRequirement('Secrets of the Jungle', 9, AchievementOption.less )]),
    });
    NPCList.JungleAsh2 = new NPC('Ash Ketchum', [
        ...
        image: 'assets/images/npcs/Ash Ketchum.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('Secrets of the Jungle', 7), new QuestLineStepCompletedRequirement('Secrets of the Jungle', 9, AchievementOption.less )]),
    });
    NPCList.JungleKoko5 = new NPC('Koko', [
        ...
        image: 'assets/images/npcs/Koko.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('Secrets of the Jungle', 9), new QuestLineStepCompletedRequirement('Secrets of the Jungle', 11, AchievementOption.less )]),
    });
    NPCList.JungleAsh3 = new NPC('Ash Ketchum', [
        ...
        image: 'assets/images/npcs/Ash Ketchum.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('Secrets of the Jungle', 11), new QuestLineStepCompletedRequirement('Secrets of the Jungle', 13, AchievementOption.less )]),
    });
    NPCList.JungleKoko6 = new NPC('Koko', [
        ...
        image: 'assets/images/npcs/Koko.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('Secrets of the Jungle', 13), new QuestLineCompletedRequirement('Secrets of the Jungle', AchievementOption.less )]),
    });
    NPCList.CrownShrineExplorer = new NPC('Explorer', [
    ...
    // Crown Tundra NPCs
    NPCList.CrownTundraRoamerNPC = new RoamerNPC('Freezington Mayor', [
        'If my eyes didn\'t deceive me, I saw a rare Pokémon at {ROUTE_NAME}. Go and see if you can find it if you\'re interested.',
    ], Region.galar, RoamingPokemonList.findGroup(Region.galar, GalarSubRegions.CrownTundra));

    NPCList.GalarFossilHiker = new NPC('Spelunker', [
    ...
    NPCList.CrownPeony1 = new NPC('Peony', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('The Crown of Galar'), new QuestLineStepCompletedRequirement('The Crown of Galar', 1, AchievementOption.less )]),
    });
    NPCList.Calyrex1 = new NPC('Calyrex', [
        ...
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Crown of Galar', 1), new QuestLineStepCompletedRequirement('The Crown of Galar', 3, AchievementOption.less )]),
    });

    NPCList.Calyrex2 = new NPC('Calyrex', [
        ...
        image: 'assets/images/npcs/specialNPCs/Possessed Peony.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Crown of Galar', 3), new QuestLineStepCompletedRequirement('The Crown of Galar', 5, AchievementOption.less )]),
    });

    NPCList.Calyrex3 = new NPC('Calyrex', [
        ...
        image: 'assets/images/npcs/specialNPCs/Possessed Peony.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Crown of Galar', 5), new QuestLineStepCompletedRequirement('The Crown of Galar', 7, AchievementOption.less )]),
    });

    NPCList.Calyrex4 = new NPC('Calyrex', [
        ...
        image: 'assets/images/npcs/specialNPCs/Possessed Peony.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Crown of Galar', 7), new QuestLineStepCompletedRequirement('The Crown of Galar', 9, AchievementOption.less )]),
    });
    NPCList.Calyrex5 = new NPC('Calyrex', [
    ...
    NPCList.CrownPeony2 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Crown of Galar', 9), new QuestLineCompletedRequirement('The Crown of Galar', AchievementOption.less)]),
    });
    NPCList.BirdPeony1 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('The Birds of the Dyna Tree'), new QuestLineStepCompletedRequirement('The Birds of the Dyna Tree', 2, AchievementOption.less )]),
    });
    NPCList.BirdPeony2 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Birds of the Dyna Tree', 2), new QuestLineStepCompletedRequirement('The Birds of the Dyna Tree', 4, AchievementOption.less )]),
    });
    NPCList.BirdPeony3 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Birds of the Dyna Tree', 4), new QuestLineStepCompletedRequirement('The Birds of the Dyna Tree', 6, AchievementOption.less )]),
    });
    NPCList.BirdPeony4 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Birds of the Dyna Tree', 6), new QuestLineCompletedRequirement('The Birds of the Dyna Tree', AchievementOption.less)]),
    });
    NPCList.GolemPeony1 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement: new MultiRequirement([new QuestLineStartedRequirement('The Ancient Golems'), new QuestLineStepCompletedRequirement('The Ancient Golems', 1, AchievementOption.less )]),
    });
    NPCList.GolemPeony2 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Ancient Golems', 1), new QuestLineStepCompletedRequirement('The Ancient Golems', 3, AchievementOption.less )]),
    });
    NPCList.GolemPeony3 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Ancient Golems', 3), new QuestLineStepCompletedRequirement('The Ancient Golems', 5, AchievementOption.less )]),
    });
    NPCList.GolemPeony4 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Ancient Golems', 5), new QuestLineStepCompletedRequirement('The Ancient Golems', 7, AchievementOption.less )]),
    });
    NPCList.GolemPeony5 = new NPC('Peony', [
        ...
        image: 'assets/images/npcs/Peony.png',
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('The Ancient Golems', 7), new QuestLineStepCompletedRequirement('The Ancient Golems', 9, AchievementOption.less)]),
    });
    NPCList.GolemPeony6 = new NPC('Peony', [
        'You caught Regieleki and Regidrago from the legends? Well that\'s that then! Smashin\'! I\'ll mark this expedition done!',
    ], {
        image: 'assets/images/npcs/Peony.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Ancient Golems', 9), new QuestLineCompletedRequirement('The Ancient Golems', AchievementOption.less )]),
    });
    NPCList.PeonyComplete = new NPC('Peony', [
    ...
    NPCList.Peonia1 = new NPC('Peonia', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('The Lair of Giants'), new QuestLineStepCompletedRequirement('The Lair of Giants', 1, AchievementOption.less )]),
    });
    NPCList.Peonia2 = new NPC('Peonia', [
        ...
        image: 'assets/images/npcs/Peonia.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Lair of Giants', 1), new QuestLineStepCompletedRequirement('The Lair of Giants', 32, AchievementOption.less )]),
    });
    NPCList.Peonia3 = new NPC('Peonia', [
        ...
        image: 'assets/images/npcs/Peonia.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Lair of Giants', 32), new QuestLineStepCompletedRequirement('The Lair of Giants', 34, AchievementOption.less )]),
    });
    NPCList.GigantamaxLeon1 = new NPC('Leon', [
        ...
        image: 'assets/images/npcs/Leon.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Lair of Giants', 33), new QuestLineStepCompletedRequirement('The Lair of Giants', 35, AchievementOption.less )]),
    });
    NPCList.GigantamaxLeon2 = new NPC('Leon', [
        ...
        image: 'assets/images/npcs/Leon.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Lair of Giants', 35), new QuestLineStepCompletedRequirement('The Lair of Giants', 37, AchievementOption.less )]),
    });
    NPCList.Peonia4 = new NPC('Peonia', [
        ...
        image: 'assets/images/npcs/Peonia.png',
        requirement:  new MultiRequirement([new QuestLineStepCompletedRequirement('The Lair of Giants', 36), new QuestLineCompletedRequirement('The Lair of Giants', AchievementOption.less )]),
    });
    NPCList.MaxLairScientist = new NPC('Scientist', [
    ...
    NPCList.ProfMagnolia = new ProfNPC('Prof. Magnolia',
        Region.galar,
    ...
    const magearnaGiftReq = new MultiRequirement([
        new CaughtUniqueShinyPokemonsByRegionRequirement(Region.kanto),
        new CaughtUniqueShinyPokemonsByRegionRequirement(Region.johto),
        new CaughtUniqueShinyPokemonsByRegionRequirement(Region.hoenn),
        new CaughtUniqueShinyPokemonsByRegionRequirement(Region.sinnoh),
        new CaughtUniqueShinyPokemonsByRegionRequirement(Region.unova),
        new CaughtUniqueShinyPokemonsByRegionRequirement(Region.kalos),
        new CaughtUniqueShinyPokemonsByRegionRequirement(Region.alola),
        new CaughtUniqueShinyPokemonsByRegionRequirement(Region.galar),
    ]);
    NPCList.MagearnaMysteryGift = new PokemonGiftNPC('Mystery Gift', [
    ...
    // Hisui NPCs
    NPCList.ForcesCogita1 = new NPC('Cogita', [
        ...
        requirement: new MultiRequirement([new QuestLineStartedRequirement('Incarnate Forces of Hisui'), new QuestLineStepCompletedRequirement('Incarnate Forces of Hisui', 1, AchievementOption.less)]),
    });
    NPCList.ForcesCogita2 = new NPC('Cogita', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Incarnate Forces of Hisui', 1), new QuestLineStepCompletedRequirement('Incarnate Forces of Hisui', 3, AchievementOption.less)]),
    });
    NPCList.ForcesCogita3 = new NPC('Cogita', [
        ...
        requirement: new MultiRequirement([new QuestLineStepCompletedRequirement('Incarnate Forces of Hisui', 4), new QuestLineCompletedRequirement('Incarnate Forces of Hisui', AchievementOption.less)]),
    });

    // Paldea NPCs
    NPCList.PaldeaRoamerNPC = new RoamerNPC('Student Emily', [
        'Hey, hey, did you hear? A group of students saw some super rare Pokémon on {ROUTE_NAME}!',
    ], Region.paldea, RoamingPokemonList.findGroup(Region.paldea, PaldeaSubRegions.Paldea));
}
