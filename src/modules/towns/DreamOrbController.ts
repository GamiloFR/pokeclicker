...
class DreamOrbController implements Saveable {
    ...
    public selectedOrb: Observable<DreamOrb>;
    public opening: Observable<boolean>;
    public item: Observable<DreamOrbLoot>;
...
export class DreamOrbTownContent extends TownContent {
    constructor() {
        super([new ObtainedPokemonRequirement('Tornadus'), new ObtainedPokemonRequirement('Thundurus'), new ObtainedPokemonRequirement('Landorus')]);
    }
