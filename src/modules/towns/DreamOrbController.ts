...
class DreamOrb {
    ...
    constructor(public color: string, public requirement: Requirement | undefined, public items: DreamOrbLoot[]) {
    }
}
...
class DreamOrbController implements Saveable {
    ...
    public selectedOrb = ko.observable(this.orbs[0]);
    public opening = ko.observable(false);
    public item = ko.observable<DreamOrbLoot>();
    ...
    fromJSON(json: Record<string, any>): void {
        json?.orbs?.forEach((o: any) => this.orbs.find((o2) => o2.color == o.color)?.amount(o.amount));
    }
}

export class DreamOrbTownContent extends TownContent {
    constructor() {
        super([
...
export default DreamOrbController;
