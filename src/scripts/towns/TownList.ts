...
/// <reference path="../../declarations/towns/Town.d.ts"/>
    ...
    new Shop([
        new PokeballItem(
            ...
            GameConstants.Currency.money,
            {
                ...
                saveName: `${GameConstants.Pokeball[GameConstants.Pokeball.Masterball]}|${GameConstants.Currency[GameConstants.Currency.money]}`,
            },
            'Master Ball'
        ),
        new PokeballItem(
            ...
            GameConstants.Currency.dungeonToken,
            {
                multiplier: 1.35,
                multiplierDecrease: false,
                saveName: `${GameConstants.Pokeball[GameConstants.Pokeball.Masterball]}|${GameConstants.Currency[GameConstants.Currency.dungeonToken]}`,
            },
            'Master Ball'
        ),
        new PokeballItem(
            ...
            GameConstants.Currency.questPoint,
            {
                multiplier: 1.35,
                multiplierDecrease: false,
                saveName: `${GameConstants.Pokeball[GameConstants.Pokeball.Masterball]}|${GameConstants.Currency[GameConstants.Currency.questPoint]}`,
            },
            'Master Ball'
        ),
        new PokeballItem(
            ...
            GameConstants.Currency.farmPoint,
            {
                multiplier: 1.35,
                multiplierDecrease: false,
                saveName: `${GameConstants.Pokeball[GameConstants.Pokeball.Masterball]}|${GameConstants.Currency[GameConstants.Currency.farmPoint]}`,
            },
            'Master Ball'
        ),
        new PokeballItem(
            ...
            GameConstants.Currency.diamond,
            {
                multiplier: 1.35,
                multiplierDecrease: false,
                saveName: `${GameConstants.Pokeball[GameConstants.Pokeball.Masterball]}|${GameConstants.Currency[GameConstants.Currency.diamond]}`,
            },
            'Master Ball'
        ),
        ItemList.Protein,
...
const Route3Shop = new Shop([ItemList.Magikarp], 'Shady Deal');
...
const ClientIslandShop = new Shop([ItemList['Charity Chansey']], 'Gift Shop');
...
const PinkanBerryMaster = new BerryMasterShop(
    ...
    'Officer Jenny\'s Pinkan Trade Shop',
    [new QuestLineCompletedRequirement('Team Rocket\'s Pinkan Theme Park')]
);

// Kanto NPCs

const PalletProfOak = new ProfNPC(
    'Prof. Oak',
    ...
    new OneFromManyRequirement([
        new QuestLineStartedRequirement(
            'Unfinished Business',
            GameConstants.AchievementOption.less
        ),
        new QuestLineCompletedRequirement('Unfinished Business'),
        new QuestLineStepCompletedRequirement('Unfinished Business', 2),
    ])
);

const PalletMom1 = new NPC(
    'Mom',
    [
    ...
    ],
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Tutorial Quests', 2),
            new QuestLineStepCompletedRequirement(
                'Tutorial Quests',
                3,
                GameConstants.AchievementOption.less
            ),
...
const PalletMom2 = new NPC(
    ...
    {
        requirement: new QuestLineStepCompletedRequirement(
            'Tutorial Quests',
            3
        ),
    }
);
const PalletCelebiProfOak1 = new NPC(
    'Prof. Oak',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Unfinished Business'),
            new QuestLineStepCompletedRequirement(
                'Unfinished Business',
                1,
                GameConstants.AchievementOption.less
...
const PalletCelebiProfOak2 = new NPC(
    'Prof. Oak',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Unfinished Business', 1),
            new QuestLineStepCompletedRequirement(
                'Unfinished Business',
                2,
                GameConstants.AchievementOption.less
...
const ViridianCityOldMan1 = new NPC(
    'Old Man',
...
const ViridianCityOldMan2 = new NPC(
    'Old Man',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Old Man.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Tutorial Quests', 4),
            new QuestLineStepCompletedRequirement(
                'Tutorial Quests',
                5,
                GameConstants.AchievementOption.less
...
const ViridianCityOldMan3 = new NPC(
    'Old Man',
    [
        'You can use the Poké Ball Selector to select which type of Poké Ball to use on specific Pokémon based on caught status.',
        'For example, if you click on the empty ball next to the word "Caught" and assign a Poké Ball, you will then start throwing Poké Balls at Pokémon you\'ve already caught before. This can be very useful if you need Dungeon Tokens.',
...
const Route3ShadySalesman = new NPC(
    'Shady Salesman',
    [
...
const CeruleanFarmApprentice = new NPC(
    'Farm Apprentice',
    [
...
const CeruleanSuperNerd = new NPC(
    'Super Nerd Jovan',
    [
...
const BillsGrandpa1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Bill\'s Grandpa Treasure Hunt'),
            new QuestLineStepCompletedRequirement(
...
const BillsHouseEusine = new NPC(
    'Eusine',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Eusine\'s Chase', 9),
            new QuestLineCompletedRequirement(
                'Eusine\'s Chase',
                GameConstants.AchievementOption.less
            ),
        ]),
...
const VermilionFanClubChairman = new NPC(
    'Fan Club Chairman',
    [
...
const VermilionEusine = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Eusine\'s Chase', 5),
            new QuestLineStepCompletedRequirement(
                'Eusine\'s Chase',
                7,
                GameConstants.AchievementOption.less
...
const SquirtleJenny = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new ObtainedPokemonRequirement('Squirtle'),
            new MaxRegionRequirement(GameConstants.Region.johto),
        ]),
    }
);

const LavenderMrFuji = new NPC(
    'Mr. Fuji',
    [
...
const LavenderChanneler = new NPC(
    'Channeler Karina',
    [
...
const LaprasGift = new PokemonGiftNPC(
    'Silph Co. Employee',
    [
...
const FuchsiaEusine = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Eusine\'s Chase', 7),
            new QuestLineStepCompletedRequirement(
                'Eusine\'s Chase',
                9,
                GameConstants.AchievementOption.less
...
const CinnabarIslandResearcher = new NPC(
    'Researcher',
    [
...
const OneIslandCelio2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Celio.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Bill\'s Errand', 5),
            new QuestLineCompletedRequirement(
                'Bill\'s Errand',
                GameConstants.AchievementOption.less
            ),
...
const OneIslandCelio4 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Celio.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Celio\'s Errand'),
            new QuestLineStepCompletedRequirement(
                'Celio\'s Errand',
                1,
                GameConstants.AchievementOption.less
...
const OneIslandCelio5 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Celio.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Celio\'s Errand', 4),
            new QuestLineStepCompletedRequirement(
                'Celio\'s Errand',
                6,
                GameConstants.AchievementOption.less
...
const OneIslandCelio6 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Celio.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Celio\'s Errand', 12),
            new QuestLineCompletedRequirement(
                'Celio\'s Errand',
                GameConstants.AchievementOption.less
            ),
...
const OneIslandYoungster = new NPC(
    'Youngster',
    [
    ...
    ],
    {
        ...
        requirement: new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Mt. Ember Summit')
        ),
    }
);
const TwoIslandGameCornerOwner1 = new NPC(
    'Game Corner Owner',
    [
...
const TwoIslandGameCornerOwner2 = new NPC(
    'Game Corner Owner',
    [
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Bill\'s Errand', 4),
            new QuestLineCompletedRequirement(
                'Bill\'s Errand',
                GameConstants.AchievementOption.less
            ),
...
const ThreeIslandBiker1 = new NPC(
    'Biker',
    [
...
const ThreeIslandBiker2 = new NPC(
    'Biker',
    [
        'You know what sucks? The other islands are off limits for some arbitrary reason. There is no explanation. Just can\'t go there.',
...
const ThreeIslandBiker3 = new NPC(
    'Biker',
    [
        'You know what sucks? The other islands are off limits for some arbitrary reason. There is no explanation. Just can\'t go there.',
...
const SeviiRocketGrunts = new NPC(
    'Team Rocket Grunts',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Celio\'s Errand', 0),
            new QuestLineStepCompletedRequirement(
                'Celio\'s Errand',
                2,
                GameConstants.AchievementOption.less
...
const SeviiRuby = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Celio\'s Errand', 3),
            new QuestLineStepCompletedRequirement(
                'Celio\'s Errand',
                4,
                GameConstants.AchievementOption.less
...
const SeviiLorelei = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Celio\'s Errand', 6),
            new QuestLineStepCompletedRequirement(
                'Celio\'s Errand',
                8,
                GameConstants.AchievementOption.less
...
const SeviiGideon2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Scientist Gideon.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Celio\'s Errand', 7),
            new QuestLineStepCompletedRequirement(
                'Celio\'s Errand',
                9,
                GameConstants.AchievementOption.less
...
const SixIslandSeviiRoamerNPC = new RoamerNPC(
    'Bug Catcher John',
    [
    ...
    'assets/images/npcs/Bug Catcher.png',
    new GymBadgeRequirement(BadgeEnums.Elite_OrangeChampion)
);
const AlteringCaveRuinManiac1 = new NPC(
    'Ruin Maniac',
    [
    ...
    {
        image: 'assets/images/npcs/Ruin Maniac gen3.png',
        requirement: new QuestLineCompletedRequirement(
            'Celio\'s Errand',
            GameConstants.AchievementOption.less
        ),
    }
);
const AlteringCaveRuinManiac2 = new NPC(
    'Ruin Maniac',
    [
...
const PinkanOfficerJenny1 = new NPC(
    'Officer Jenny',
    [
    ...
    {
        image: 'assets/images/npcs/Officer Jenny.png',
        requirement: new GymBadgeRequirement(
            BadgeEnums.Elite_OrangeChampion,
            GameConstants.AchievementOption.less
        ),
    }
);
const PinkanOfficerJenny2 = new NPC(
    'Officer Jenny',
    [
        'Have you seen the Pinkan Berries? That is what makes all the Pokémon on this island turn pink.',
        'Hang on, this island is strictly off limits! Pinkan is a protected Pokémon reserve. How did you get here?',
...
const PinkanOfficerJenny3 = new NPC(
    'Officer Jenny',
    [
...
const ThemeparkTeamRocket1 = new NPC(
    'Jessie & James',
    [
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Team Rocket\'s Pinkan Theme Park'),
            new QuestLineStepCompletedRequirement(
                'Team Rocket\'s Pinkan Theme Park',
                1,
                GameConstants.AchievementOption.less
...
const ThemeparkTeamRocket2 = new NPC(
    'Jessie & James',
    [
...
const ThemeparkTeamRocket3 = new NPC(
    'Jessie & James',
    [
...
const ThemeparkTeamRocket4 = new NPC(
    'Jessie & James',
    [
...
const Informant1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Detective Pikachu', 2),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                4,
                GameConstants.AchievementOption.less
...
const Informant2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/specialNPCs/Mime Interview.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Detective Pikachu', 4),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                6,
                GameConstants.AchievementOption.less
...
const Mewtwo1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Detective Pikachu', 10),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                12,
                GameConstants.AchievementOption.less
...
const Mewtwo2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/specialNPCs/Possessed Mewtwo.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Detective Pikachu', 15),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                17,
                GameConstants.AchievementOption.less
...
const DetectiveRaichu = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Detective Pikachu', 16),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                17,
                GameConstants.AchievementOption.less
...
const NewIslandJessieAndJames = new RoamerNPC(
    'Jessie & James',
    [
...
const NewIslandAsh1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('New Island'),
            GameConstants.AchievementOption.less
        ),
    }
);

const NewIslandAsh2 = new NPC(
    'Ash Ketchum',
...
const BugCatcherPinsir = new NPC(
    'Bug Catcher Michel',
    [
    ...
    {
        image: 'assets/images/npcs/Bug Catcher.png',
        requirement: new MaxRegionRequirement(GameConstants.Region.kalos),
    }
);
...
const UnrivaledBlue = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('An Unrivaled Power', 2),
            new QuestLineStepCompletedRequirement(
                'An Unrivaled Power',
                4,
                GameConstants.AchievementOption.less
...
const UnrivaledGreen1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('An Unrivaled Power', 4),
            new QuestLineStepCompletedRequirement(
                'An Unrivaled Power',
                6,
                GameConstants.AchievementOption.less
...
const BillGrandpaChristmas = new NPC(
    'Bill\'s Grandpa',
    ['Did you find all of the Santa Jynx?', 'I hope they don\'t come back!'],
    {
        image: 'assets/images/npcs/Bill\'s Grandpa without Eevee.png',
...
TownList['Pewter City'] = new Town(
    ...
    [PewterCityShop],
    {
        requirements: [
            ...
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Viridian Forest')
            ),
        ],
...
TownList['Lavender Town'] = new Town(
    ...
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Rock Tunnel')
            ),
        ],
    ...
    ],
    {
        requirements: [
            new OneFromManyRequirement([
                ...
                new ClearDungeonRequirement(
                    1,
                    GameConstants.getDungeonIndex('Rocket Game Corner')
                ),
            ]),
        ],
...
TownList['Fuchsia City'] = new Town(
    ...
    [
        FuchsiaCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Fuchsia City']),
    ],
    {
        requirements: [
            new OneFromManyRequirement([
...
TownList['Indigo Plateau Kanto'] = new Town(
    ...
    GameConstants.KantoSubRegions.Kanto,
    [
        GymList['Elite Lorelei'],
        GymList['Elite Bruno'],
        GymList['Elite Agatha'],
        GymList['Elite Lance'],
        GymList['Champion Blue'],
        pokeLeagueShop(),
        TemporaryBattleList['Unrivaled Red'],
    ],
    {
        requirements: [
            ...
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Victory Road')
            ),
        ],
        npcs: [SpeedyRunner],
    }
...
TownList['Mt. Ember'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Sevii Rocket Grunt 2'],
    ],
    {
        requirements: [
...
TownList['Three Island'] = new Town(
    ...
    [
        ThreeIslandShop,
        TemporaryBattleList['Biker Goon 1'],
        TemporaryBattleList['Biker Goon 2'],
        TemporaryBattleList['Biker Goon 3'],
        TemporaryBattleList['Cue Ball Paxton'],
    ],
    {
        requirements: [
...
TownList['Rocket Warehouse'] = new Town(
    ...
    GameConstants.KantoSubRegions.Sevii4567,
    [
        TemporaryBattleList['Sevii Rocket Grunt 3'],
        TemporaryBattleList['Sevii Rocket Grunt 4'],
        TemporaryBattleList['Sevii Rocket Grunt 5'],
        TemporaryBattleList['Sevii Rocket Ariana'],
        TemporaryBattleList['Sevii Rocket Archer'],
        TemporaryBattleList['Scientist Gideon'],
    ],
    {
        requirements: [
...
TownList['Dotted Hole'] = new Town(
    ...
    {
        requirements: [
            new RouteKillRequirement(10, GameConstants.Region.kanto, 37),
        ],
...
TownList['Mikan Island'] = new Town(
    ...
    [MikanIslandShop],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Tanoby Ruins')
            ),
        ],
    }
);
TownList['Navel Island'] = new Town(
    ...
    [NavelIslandShop],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Lost Cave')
            ),
        ],
    }
);
...
TownList['Kumquat Island'] = new Town(
    ...
    [KumquatIslandShop],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Icefall Cave')
            ),
        ],
    }
);
TownList['Pummelo Island'] = new Town(
    ...
    [
        ...
        pokeLeagueShop(),
        new BulletinBoard(GameConstants.BulletinBoards.Sevii4567),
    ],
    {
        requirements: [
...
TownList['Valencia Pokémon Center'] = new Town(
    ...
    {
        requirements: [
            new RouteKillRequirement(10, GameConstants.Region.kanto, 40),
        ],
...
TownList['Pinkan Pokémon Reserve'] = new Town(
    ...
    [
        ...
        PinkanBerryMaster,
        TemporaryBattleList['Pinkan Jessie & James'],
        TemporaryBattleList['Pinkan Officer Jenny'],
    ],
    {
        requirements: [
...
const JohtoBerryMaster = new BerryMasterShop(
    GameConstants.BerryTraderLocations['Goldenrod City'],
    [
...
const CherrygroveMrPokemon = new NPC(
    'Mr. Pokémon',
    [
...
const AzaleaCelebiKurt1 = new NPC(
    'Kurt',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            ...
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Slowpoke Well'),
                GameConstants.AchievementOption.less
            ),
        ]),
    }
...
const AzaleaCelebiKurt2 = new NPC(
    'Kurt',
    [
...
const AzaleaCelebiKurt3 = new NPC(
    'Kurt',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Kurt.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Unfinished Business', 3),
            new GymBadgeRequirement(
...
const AzaleaCelebiKurt4 = new NPC(
    'Kurt',
    [
...
const AzaleaCelebiOak1 = new NPC(
    'Prof. Oak',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Unfinished Business', 4),
            new QuestLineStepCompletedRequirement(
                'Unfinished Business',
                6,
                GameConstants.AchievementOption.less
...
const AzaleaCelebiOak2 = new NPC(
    'Prof. Oak',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Unfinished Business', 7),
            new QuestLineStepCompletedRequirement(
                'Unfinished Business',
                9,
                GameConstants.AchievementOption.less
...
const AzaleaCelebiOak3 = new NPC(
    'Prof. Oak',
    [
...
const AzaleaCelebiOak4 = new NPC(
    'Prof. Oak',
    [
...
const AzaleaCelebiOak5 = new NPC(
    'Prof. Oak',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Professor Oak.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Unfinished Business', 13),
            new QuestLineCompletedRequirement(
                'Unfinished Business',
                GameConstants.AchievementOption.less
            ),
...
const IlexForestShrine1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Unfinished Business', 5),
            new QuestLineStepCompletedRequirement(
                'Unfinished Business',
                7,
                GameConstants.AchievementOption.less
...
const IlexForestShrine2 = new NPC(
    'Investigate the Shrine',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/other/Ilex Forest.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Unfinished Business', 11),
            new QuestLineStepCompletedRequirement(
                'Unfinished Business',
                13,
                GameConstants.AchievementOption.less
...
const IlexForestPichuFan = new NPC(
    'Pichu-Fan',
    [
...
const OlivineLighthouseJasmine1 = new NPC(
    'Jasmine',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Sick Ampharos', 0),
            new QuestLineStepCompletedRequirement(
                'The Sick Ampharos',
                4,
                GameConstants.AchievementOption.less
...
const CianwoodCityPharmacist1 = new NPC(
    'Pharmacist',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Scientist (male).png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Sick Ampharos', 1),
            new QuestLineStepCompletedRequirement(
                'The Sick Ampharos',
                3,
                GameConstants.AchievementOption.less
...
const CianwoodCityPharmacist2 = new NPC(
    'Pharmacist',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Scientist (male).png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Sick Ampharos', 3),
            new QuestLineStepCompletedRequirement(
                'The Sick Ampharos',
                4,
                GameConstants.AchievementOption.less
...
const OlivineLighthouseMedicineAmphy = new NPC(
    'Give medicine to Amphy',
    ['Palu! Palulu!', '<i>Ampharos seems to feel better.</i>'],
    {
        image: 'assets/images/pokemon/181.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Sick Ampharos', 4),
            new QuestLineStepCompletedRequirement(
                'The Sick Ampharos',
                5,
                GameConstants.AchievementOption.less
...
const OlivineLighthouseJasmine2 = new NPC(
    'Jasmine',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Jasmine.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Sick Ampharos', 5),
            new QuestLineStepCompletedRequirement(
                'The Sick Ampharos',
                6,
                GameConstants.AchievementOption.less
...
const OlivineLighthouseAmphy = new NPC('Amphy', ['Palu! Palulu!'], {
    image: 'assets/images/pokemon/181.png',
    requirement: new QuestLineCompletedRequirement('The Sick Ampharos'),
});

const EcruteakEusine = new NPC(
    'Eusine',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('The Legendary Beasts'),
            new QuestLineStepCompletedRequirement(
...
const Zuki = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Whirl Guardian'),
            new QuestLineStepCompletedRequirement(
                'Whirl Guardian',
                1,
                GameConstants.AchievementOption.less
...
const Naoko = new NPC(
    ...
    ['I seem to have lost my way in the forest. Can you show me the way out?'],
    {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Whirl Guardian', 1),
            new QuestLineStepCompletedRequirement(
                'Whirl Guardian',
                3,
                GameConstants.AchievementOption.less
...
const Miki = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Whirl Guardian', 3),
            new QuestLineStepCompletedRequirement(
                'Whirl Guardian',
                5,
                GameConstants.AchievementOption.less
...
const Sayo = new NPC(
    ...
    ['Excuse me! I\'m stuck out here on the ice, can you give me a quick push?'],
    {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Whirl Guardian', 4),
            new QuestLineStepCompletedRequirement(
                'Whirl Guardian',
                6,
                GameConstants.AchievementOption.less
...
const Kuni = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Whirl Guardian', 6),
            new QuestLineStepCompletedRequirement(
                'Whirl Guardian',
                8,
                GameConstants.AchievementOption.less
...
const KimonoGirlsWhirl = new NPC(
    'Kimono Girls',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Whirl Guardian', 8),
            new QuestLineStepCompletedRequirement(
                'Whirl Guardian',
                10,
                GameConstants.AchievementOption.less
...
const KimonoGirlsEcruteak = new NPC(
    'Kimono Girls',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Kimono Girl.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Rainbow Guardian'),
            new QuestLineStepCompletedRequirement(
                'Rainbow Guardian',
                1,
                GameConstants.AchievementOption.less
...
const OlivineSSAquaCaptain = new NPC(
    'S.S. Aqua Captain',
    [
...
const CianwoodEusine = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Eusine\'s Chase', 0),
            new QuestLineStepCompletedRequirement(
                'Eusine\'s Chase',
                2,
                GameConstants.AchievementOption.less
...
const MahoGanyOfficerJenny = new NPC(
    'Officer Jenny',
    [
...
const MahoganyEusine = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Eusine.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Eusine\'s Chase', 3),
            new QuestLineStepCompletedRequirement(
                'Eusine\'s Chase',
                5,
                GameConstants.AchievementOption.less
...
const BlackthornJohtoRoamerNPC = new RoamerNPC(
    'Pokéfan Trevor',
    [
    ...
    'assets/images/npcs/Pokéfan (male).png'
);

const RedOldManJohtoNPC = new NPC(
    'Old Man',
    [
...
const TohjoFallsCelebiTimeDistortion = new NPC(
    'Investigate the Time Distortion',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Unfinished Business', 8),
            new QuestLineStepCompletedRequirement(
                'Unfinished Business',
                10,
                GameConstants.AchievementOption.less
            ...
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Tohjo Falls')
            ),
        ]),
    }
);

const Conductor = new NPC(
    'Conductor',
    [
...
const searchForClues = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Detective Pikachu'),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                1,
                GameConstants.AchievementOption.less
...
const HowardClifford1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Detective Pikachu', 6),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                8,
                GameConstants.AchievementOption.less
...
const HowardClifford2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Howard Clifford.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Detective Pikachu', 11),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                13,
                GameConstants.AchievementOption.less
...
const HowardClifford3 = new NPC(
    'Howard Clifford',
    ['UNLIMITED POWER! YOU\'LL NEVER STOP ME!'],
    {
        image: 'assets/images/npcs/Howard Clifford.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Detective Pikachu', 13),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                15,
                GameConstants.AchievementOption.less
...
const BabyAssistant = new AssistantNPC(
    'Elm\'s Assistant',
    [
    ...
    'baby',
    'assets/images/npcs/Scientist (male).png'
);
...
TownList['Goldenrod City'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Possessed Mewtwo'],
    ],
    {
        requirements: [
    ...
    ],
    {
        requirements: [
            new OneFromManyRequirement([
                ...
                new ClearDungeonRequirement(
                    1,
                    GameConstants.getDungeonIndex('Mt. Mortar')
                ),
            ]),
        ],
        npcs: [
...
TownList['Blackthorn City'] = new Town(
    ...
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Ice Path')
            ),
        ],
...
TownList['Indigo Plateau Johto'] = new Town(
    ...
    GameConstants.JohtoSubRegions.Johto,
    [
        TemporaryBattleList['Silver 7'],
        GymList['Elite Will'],
        GymList['Elite Koga'],
        GymList['Elite Bruno2'],
        GymList['Elite Karen'],
        GymList['Champion Lance'],
        pokeLeagueShop(),
    ],
    {
        requirements: [
...
TownList['Tin Tower'] = new DungeonTown(
    ...
    [
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Radio Tower')
        ),
    ]
);
...
const RoadsideStandShop = new Shop([ItemList['Probably Feebas']], 'Shady Deal');
...
const WindChimeShop = new Shop([ItemList['Probably Chimecho']], 'Shady Deal');
...
const BattleFrontierShop = new Shop([
    ...
    new PokeballItem(
        ...
        GameConstants.Currency.battlePoint,
        {
            multiplier: 1.35,
            multiplierDecrease: false,
            saveName: `${GameConstants.Pokeball[GameConstants.Pokeball.Masterball]}|${GameConstants.Currency[GameConstants.Currency.battlePoint]}`,
        },
        'Master Ball'
    ),
    new EnergyRestore(
        GameConstants.EnergyRestoreSize.SmallRestore,
        10,
        GameConstants.Currency.battlePoint,
        'Small Restore'
    ),
    new EnergyRestore(
        GameConstants.EnergyRestoreSize.MediumRestore,
        20,
        GameConstants.Currency.battlePoint,
        'Medium Restore'
    ),
    new EnergyRestore(
        GameConstants.EnergyRestoreSize.LargeRestore,
        40,
        GameConstants.Currency.battlePoint,
        'Large Restore'
    ),
...
const HoennBerryMaster = new BerryMasterShop(
    GameConstants.BerryTraderLocations['Mauville City'],
    [
        ItemList.Boost_Mulch,
        ItemList.Rich_Mulch,
        ItemList.Surprise_Mulch,
...
const HoennFluteMaster = new GemMasterShop(
    GameConstants.GemShops.HoennFluteMaster
);
const HoennStoneSalesman = new GemMasterShop(
    GameConstants.GemShops.HoennStoneSalesman,
    'Stone Salesman',
    [new TemporaryBattleRequirement('Hoenn Stone Salesman')],
    true
);
...
const SlateportHoennRoamerNPC = new RoamerNPC(
    'Reporter Gabby',
    [
    ...
    'assets/images/npcs/Reporter.png'
);

const SkepticalFisherman = new NPC(
    'Skeptical Fisherman',
    [
...
const FallarborProfessorCozmo = new NPC(
    'Prof. Cozmo',
    [
    ...
    {
        requirement: new QuestLineStartedRequirement(
            'The Delta Episode',
            GameConstants.AchievementOption.less
        ),
    }
...
const RoadsideStandShadySalesman = new NPC(
    'Shady Salesman',
    [
        'Have I got a deal just for you!',
...
const WindChimeShopShadySalesman = new NPC(
    'Shady Salesman',
    [
...
const Steven1 = new NPC(
    ...
    {
        requirement: new TemporaryBattleRequirement(
            'Kecleon 3',
            1,
            GameConstants.AchievementOption.less
        ),
...
const Wallace1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Weather Trio', 1),
            new QuestLineStepCompletedRequirement(
                'The Weather Trio',
                3,
                GameConstants.AchievementOption.less
...
const Wallace2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Wallace.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Weather Trio', 4),
            new QuestLineStepCompletedRequirement(
                'The Weather Trio',
                6,
                GameConstants.AchievementOption.less
...
const WeatherBattle1 = new NPC(
    'The Super-Ancient Pokémon Clash',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('The Weather Trio'),
            new QuestLineStepCompletedRequirement(
                'The Weather Trio',
                1,
                GameConstants.AchievementOption.less
...
const WeatherBattle2 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Weather Trio', 3),
            new QuestLineStepCompletedRequirement(
                'The Weather Trio',
                5,
                GameConstants.AchievementOption.less
...
const MillenniumFest = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Wish Maker'),
            new QuestLineStepCompletedRequirement(
                'Wish Maker',
                1,
                GameConstants.AchievementOption.less
...
const Butler1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Wish Maker', 1),
            new QuestLineStepCompletedRequirement(
                'Wish Maker',
                3,
                GameConstants.AchievementOption.less
...
const CocoonHatch = new NPC(
    'Examine the Crystalline Cocoon',
    ['<i>The cocoon shifts, shimmers, and hatches to reveal Jirachi!</i>'],
    {
        image: 'assets/images/npcs/other/Cocoon.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Wish Maker', 4),
            new QuestLineStepCompletedRequirement(
                'Wish Maker',
                6,
                GameConstants.AchievementOption.less
...
const Butler2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Butler.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('A Meta Discovery'),
            new QuestLineStepCompletedRequirement(
                'A Meta Discovery',
                1,
                GameConstants.AchievementOption.less
...
const Butler3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Butler.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Meta Discovery', 2),
            new QuestLineCompletedRequirement(
                'A Meta Discovery',
                GameConstants.AchievementOption.less
            ),
...
const CoolTrainerDillan = new NPC(
    'Cool Trainer Dillan',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement(
                'Egg Hunt',
                2,
                GameConstants.AchievementOption.more
            ),
            new OneFromManyRequirement([
                new QuestLineCompletedRequirement(
                    'Egg Hunt',
...
const SCEntrance = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Three Golems', 0),
            new QuestLineStepCompletedRequirement(
                'The Three Golems',
                1,
                GameConstants.AchievementOption.less
...
const MazeHintLeft = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Three Golems', 1),
            new QuestLineStepCompletedRequirement(
                'The Three Golems',
                3,
                GameConstants.AchievementOption.less
...
const SCMazeLeftWrong = new NPC(
    'Go Left',
    ['<i>You turn left, but it is a dead end.</i>'],
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Three Golems', 3),
            new QuestLineStepCompletedRequirement(
                'The Three Golems',
                6,
                GameConstants.AchievementOption.less
...
const MazeHintRight = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Three Golems', 5),
            new QuestLineStepCompletedRequirement(
                'The Three Golems',
                6,
                GameConstants.AchievementOption.less
...
const SCMazeRightWrong = new NPC(
    'Go Right',
...
const MazeHintStraight = new NPC(
    'Room Engraving',
    [
        '<i>These strange markings seem to spell something out. The nearby Braille Enthusiast may know more.</i>',
    ],
...
const SCMazeStraightWrong = new NPC(
    'Go Straight',
...
const BrailleEnthusiast1 = new NPC(
    'Braille Enthusiast',
    [
...
const BrailleEnthusiast2 = new NPC(
    'Braille Enthusiast',
    [
...
const BrailleEnthusiast3 = new NPC(
    'Braille Enthusiast',
    [
...
const Television1 = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('The Eon Duo'),
            new QuestLineStepCompletedRequirement(
                'The Eon Duo',
                1,
                GameConstants.AchievementOption.less
...
const Television2 = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Eon Duo', 0),
            new QuestLineStepCompletedRequirement(
                'The Eon Duo',
                2,
                GameConstants.AchievementOption.less
...
const TicketClaim = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Eon Duo', 1),
            new QuestLineStepCompletedRequirement(
                'The Eon Duo',
                3,
                GameConstants.AchievementOption.less
...
const SeaMauvilleRocket1 = new NPC(
    'Rocket Grunt',
    [
...
const SeaMauvilleRocket2 = new NPC(
    'Rocket Grunt',
    [
...
const SouthernIsland1 = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Eon Duo', 2),
            new QuestLineStepCompletedRequirement(
                'The Eon Duo',
                3,
                GameConstants.AchievementOption.less
...
const Cozmo1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('The Delta Episode'),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                1,
                GameConstants.AchievementOption.less
...
const Zinnia1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 0),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                2,
                GameConstants.AchievementOption.less
...
const DeltaMay1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 1),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                3,
                GameConstants.AchievementOption.less
...
const NewsBirch = new NPC(
    'Discuss the news with Professor Birch',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 2),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                4,
                GameConstants.AchievementOption.less
...
const DeltaMay2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/May.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 3),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                5,
                GameConstants.AchievementOption.less
...
const Zinnia2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Zinnia.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 7),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                9,
                GameConstants.AchievementOption.less
...
const Zinnia3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Zinnia.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 9),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                11,
                GameConstants.AchievementOption.less
...
const Cozmo2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Dr Cozmo.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 10),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                12,
                GameConstants.AchievementOption.less
...
const Zinnia4 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Zinnia.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 11),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                13,
                GameConstants.AchievementOption.less
...
const Cozmo3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Dr Cozmo.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 12),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                14,
                GameConstants.AchievementOption.less
...
const DraconidElder1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 14),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                16,
                GameConstants.AchievementOption.less
...
const DraconidElder2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Draconid Elder.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 16),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                18,
                GameConstants.AchievementOption.less
...
const Zinnia5 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Zinnia.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 19),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                21,
                GameConstants.AchievementOption.less
...
const Archie = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 21),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                23,
                GameConstants.AchievementOption.less
...
const Maxie = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 23),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                25,
                GameConstants.AchievementOption.less
...
const Wallace3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Wallace.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 24),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                26,
                GameConstants.AchievementOption.less
...
const Zinnia7 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Zinnia.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Delta Episode', 30),
            new QuestLineStepCompletedRequirement(
                'The Delta Episode',
                32,
                GameConstants.AchievementOption.less
...
const HoennStoneSalesman1 = new NPC(
    'Stone Salesman',
...
const HoennStoneSalesman2 = new NPC(
    'Stone Salesman',
    [
...
const MrStone1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Primal Reversion'),
            new QuestLineStepCompletedRequirement(
                'Primal Reversion',
                1,
                GameConstants.AchievementOption.less
...
const PrimalMural1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Primal Reversion', 1),
            new QuestLineStepCompletedRequirement(
                'Primal Reversion',
                3,
                GameConstants.AchievementOption.less
...
const PrimalSteven = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Steven.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Primal Reversion', 2),
            new QuestLineStepCompletedRequirement(
                'Primal Reversion',
                4,
                GameConstants.AchievementOption.less
...
const Stern1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            ...
            new QuestLineStepCompletedRequirement('Primal Reversion', 3),
            new QuestLineStepCompletedRequirement(
                'Primal Reversion',
                5,
                GameConstants.AchievementOption.less
...
const Stern2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Sailor.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Primal Reversion', 5),
            new QuestLineStepCompletedRequirement(
                'Primal Reversion',
                7,
                GameConstants.AchievementOption.less
...
const Stern3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Sailor.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Primal Reversion', 7),
            new QuestLineStepCompletedRequirement(
                'Primal Reversion',
                9,
                GameConstants.AchievementOption.less
...
const WeatherScan = new NPC(
    'Scan for unusual weather',
    [
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Primal Reversion', 11),
            new QuestLineStepCompletedRequirement(
                'Primal Reversion',
                13,
                GameConstants.AchievementOption.less
...
const PrimalArchie = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Aqua Leader.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Primal Reversion', 13),
            new QuestLineStepCompletedRequirement(
                'Primal Reversion',
                15,
                GameConstants.AchievementOption.less
...
const ZinniaOrigin = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            ...
            new QuestLineCompletedRequirement('Primal Reversion'),
        ]),
    }
);

const ExploreStand = new NPC(
    'Explore the Outskirt Stand',
    [
...
const Sack = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 2),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                4,
                GameConstants.AchievementOption.less
...
const EsCade1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 4),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                6,
                GameConstants.AchievementOption.less
...
const Rui1 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Rui.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 5),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                7,
                GameConstants.AchievementOption.less
...
const Duking1 = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 7),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                9,
                GameConstants.AchievementOption.less
...
const Doken1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 10),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                12,
                GameConstants.AchievementOption.less
...
const FreePlusle = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 12),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                14,
                GameConstants.AchievementOption.less
...
const Rui2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Rui.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 13),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                15,
                GameConstants.AchievementOption.less
...
const GrandpaEagun1 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Old Man.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 16),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                18,
                GameConstants.AchievementOption.less
...
const Rui3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Rui.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 18),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                20,
                GameConstants.AchievementOption.less
...
const SearchTheStudio = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 20),
            new QuestLineStepCompletedRequirement(
                'Shadows in the Desert',
                22,
                GameConstants.AchievementOption.less
...
const EviceEscape = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Shadows in the Desert', 25),
            new QuestLineCompletedRequirement(
                'Shadows in the Desert',
                GameConstants.AchievementOption.less
            ),
...
const OrreRoamerNPC = new RoamerNPC(
    ...
    'assets/images/npcs/Psychic (female).png'
);
const AgateAthlete = new NPC(
    'Jogger',
    [
...
const GateonSailor = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Sailor.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Gale of Darkness'),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                1,
                GameConstants.AchievementOption.less
...
const Chobin1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 3),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                5,
                GameConstants.AchievementOption.less
...
const Eagun2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Old Man.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 4),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                6,
                GameConstants.AchievementOption.less
...
const Lovrina = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 7),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                9,
                GameConstants.AchievementOption.less
...
const Exol = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 11),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                13,
                GameConstants.AchievementOption.less
...
const Snattle = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 14),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                16,
                GameConstants.AchievementOption.less
...
const Trest = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Office Worker (male).png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 15),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                17,
                GameConstants.AchievementOption.less
...
const Verich = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 16),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                18,
                GameConstants.AchievementOption.less
...
const Chobin2 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 18),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                20,
                GameConstants.AchievementOption.less
...
const SearchLibra = new NPC(
    'Search the S. S. Libra',
    [
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 20),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                22,
                GameConstants.AchievementOption.less
...
const ProfKrane = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Gale of Darkness', 25),
            new QuestLineStepCompletedRequirement(
                'Gale of Darkness',
                27,
                GameConstants.AchievementOption.less
...
const DrKaminko = new NPC('Dr. Kaminko', ['Leave me alone! I\'m WORKING!']);
...
const destinyGem = new NPC(
    'Green Pulsing Gemstone',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Destiny Deoxys', 0),
            new QuestLineStepCompletedRequirement(
                'Destiny Deoxys',
                2,
                GameConstants.AchievementOption.less
...
const destinyScientistChasm = new NPC(
    'Professor Lund',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Scientist (male).png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Destiny Deoxys', 2),
            new QuestLineStepCompletedRequirement(
                'Destiny Deoxys',
                4,
                GameConstants.AchievementOption.less
...
const destinyScientistBF = new NPC(
    'Professor Lund',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Scientist (male).png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Destiny Deoxys', 5),
            new QuestLineStepCompletedRequirement(
                'Destiny Deoxys',
                7,
                GameConstants.AchievementOption.less
...
const destinyDeoxysReunion = new PokemonGiftNPC(
    'Green and Purple Gem Deoxys',
    [
    ...
    'Deoxys (Green Core)',
    'assets/images/pokemon/386.04.png',
    {
        image: 'assets/images/npcs/other/Deoxys reunion.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Destiny Deoxys', 8),
            new ObtainedPokemonRequirement('Deoxys (Green Core)', true),
        ]),
    }
);

// For Leafeon and Glaceon. Show up in Hoenn too
const MossRock = new NPC(
    'Moss Rock',
...
TownList['Petalburg City'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Courtney 1'],
        TemporaryBattleList['Matt 1'],
    ],
    {
        requirements: [
...
TownList['Rustboro City'] = new Town(
    ...
    [
        RustboroCityShop,
        new GenericTraderShop('FossilDevonCorporation', 'Devon Corporation'),
        TemporaryBattleList['Mr. Stone'],
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Petalburg Woods')
            ),
        ],
    }
);
TownList['Dewford Town'] = new Town(
    ...
    [
        DewfordTownShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Dewford Town']),
    ],
    {
...
TownList['Slateport City'] = new Town(
    ...
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Granite Cave')
            ),
        ],
...
TownList['Sea Mauville'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Captain Stern'],
    ],
    {
        requirements: [
...
TownList['Verdanturf Town'] = new Town(
    ...
    {
        requirements: [
            new RouteKillRequirement(10, GameConstants.Region.hoenn, 117),
        ],
    }
);
...
TownList['Fallarbor Town'] = new Town(
    ...
    [
        ...
        HoennFluteMaster,
        HoennStoneSalesman,
        TemporaryBattleList['Hoenn Stone Salesman'],
    ],
    {
        requirements: [
...
TownList['Lavaridge Town'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Clown Jessie & James'],
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Jagged Pass')
            ),
        ],
...
TownList['Fortree City'] = new Town(
    ...
    [
        FortreeCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Fortree City']),
    ],
    {
...
TownList['Mossdeep Space Center'] = new Town(
    ...
    GameConstants.HoennSubRegions.Hoenn,
    [
        TemporaryBattleList['Aqua Grunt'],
        TemporaryBattleList['Magma Grunt'],
...
TownList['Pacifidlog Town'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Underground Fighting Ring'],
    ],
    {
        requirements: [
...
TownList['Sootopolis City'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Delta Wallace'],
    ],
    {
        requirements: [
...
TownList['Battle Frontier'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Destiny Deoxys Rayquaza'],
        TemporaryBattleList['Destiny Deoxys Army'],
        TemporaryBattleList['Destiny Rayquaza'],
        new GemMasterShop(
            GameConstants.GemShops.hoennBattleFrontierDeoxysDeal,
            'Deoxys Replica',
            [new QuestLineCompletedRequirement('Destiny Deoxys')],
            true
        ),
    ],
    {
...
TownList['Pokémon League Hoenn'] = new Town(
    ...
    GameConstants.HoennSubRegions.Hoenn,
    [
        GymList['Elite Sidney'],
        GymList['Elite Phoebe'],
        GymList['Elite Glacia'],
        GymList['Elite Drake'],
        GymList['Champion Wallace'],
        pokeLeagueShop(),
        TemporaryBattleList['Delta Steven'],
    ],
    {
        requirements: [
...
TownList['Southern Island'] = new Town(
    ...
    GameConstants.HoennSubRegions.Hoenn,
    [
        TemporaryBattleList.Latios,
        TemporaryBattleList.Latias,
        TemporaryBattleList['Matt 3'],
        TemporaryBattleList['Courtney 3'],
    ],
    {
        requirements: [
            new CustomRequirement(
                ko.pureComputed(
                    () => +App.game.keyItems.hasKeyItem(KeyItemType.Eon_ticket)
                ),
                1,
                'Obtain an Eon Ticket'
            ),
        ],
...
TownList['Pokémon HQ Lab'] = new Town(
    ...
    [
        new ShardTraderShop(
            GameConstants.ShardTraderLocations['Pokémon HQ Lab']
        ),
...
TownList['Orre Colosseum'] = new Town(
    ...
    GameConstants.HoennSubRegions.Orre,
    [
        GymList['Cipher Admin Lovrina'],
        GymList['Cipher Admin Snattle'],
        GymList['Cipher Admin Gorigan'],
        GymList['Cipher Admin Ardos'],
        GymList['Cipher Admin Eldes'],
    ],
    {
...
TownList['Meteor Falls'] = new DungeonTown(
    ...
    [
        TemporaryBattleList['Draconid Elder'],
        TemporaryBattleList['Mega Draconid Elder'],
    ],
    {
...
TownList['Mt. Chimney Crater'] = new DungeonTown(
    ...
    [
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Meteor Falls')
        ),
    ],
...
TownList['Jagged Pass'] = new DungeonTown(
    ...
    [
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Mt. Chimney Crater')
        ),
    ],
...
TownList['Aqua Hideout'] = new DungeonTown(
    ...
    [
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Magma Hideout')
        ),
    ],
...
TownList['Shoal Cave'] = new DungeonTown(
    ...
    [new RouteKillRequirement(10, GameConstants.Region.hoenn, 125)],
    [
        TemporaryBattleList['Shoal Fisherman'],
        TemporaryBattleList['Icy Boulder'],
    ],
    {
...
TownList['Cave of Origin'] = new DungeonTown(
    ...
    [
        ...
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Seafloor Cavern')
        ),
    ],
    [],
    {
...
TownList['Sky Pillar'] = new DungeonTown(
    ...
    [
        ...
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Cave of Origin')
        ),
    ],
...
const SinnohBerryMaster = new BerryMasterShop(
    GameConstants.BerryTraderLocations['Hearthome City'],
    [
        ItemList.Boost_Mulch,
        ItemList.Rich_Mulch,
        ItemList.Surprise_Mulch,
...
const SecretBerryMaster = new BerryMasterShop(
...
const TwinleafContestChampion = new NPC(
    'Contest Champion',
    [
...
const FloaromaFlowerGirl = new NPC(
    'Flower Girl',
    [
...
const EternaLassCaroline = new NPC(
    'Lass Caroline',
    [
...
const OreburghConstructionWorker = new NPC(
    'Construction Worker',
    [
...
const CanalaveSinnohMyth = new NPC(
    'Sinnoh\'s Myth',
    [
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Zero\'s Ambition', 0),
            new QuestLineStepCompletedRequirement(
                'Zero\'s Ambition',
                2,
                GameConstants.AchievementOption.less
...
const VerityMesprit = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Zero\'s Ambition', 2),
            new QuestLineStepCompletedRequirement(
                'Zero\'s Ambition',
                4,
                GameConstants.AchievementOption.less
...
const ValorAzelf = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Zero\'s Ambition', 4),
            new QuestLineStepCompletedRequirement(
                'Zero\'s Ambition',
                6,
                GameConstants.AchievementOption.less
...
const AcuityUxie = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Zero\'s Ambition', 6),
            new QuestLineStepCompletedRequirement(
                'Zero\'s Ambition',
                8,
                GameConstants.AchievementOption.less
...
const SunyshoreRibbonerJulia = new NPC(
    'Ribboner Julia',
    [
...
const FightAreaAceTrainer = new NPC(
    'Ace Trainer Quinn',
    [
...
const FightAreaZero1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Zero\'s Ambition'),
            new QuestLineStepCompletedRequirement(
                'Zero\'s Ambition',
                1,
                GameConstants.AchievementOption.less
...
const FightAreaZero2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Zero.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Zero\'s Ambition', 1),
            new QuestLineStepCompletedRequirement(
                'Zero\'s Ambition',
                2,
                GameConstants.AchievementOption.less
...
const SurvivalAreaSinnohRoamerNPC = new RoamerNPC(
    'Hiker Kevin',
    ...
    'assets/images/npcs/Hiker.png'
);

const SendoffSpringLakeTrio = new NPC(
    'Lake Trio',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Zero\'s Ambition', 9),
            new QuestLineStepCompletedRequirement(
                'Zero\'s Ambition',
                11,
                GameConstants.AchievementOption.less
...
const SendoffSpringZero1 = new NPC(
    'Zero',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Zero.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Zero\'s Ambition', 11),
            new QuestLineStepCompletedRequirement(
                'Zero\'s Ambition',
                12,
                GameConstants.AchievementOption.less
...
const SendoffSpringZero2 = new NPC(
    'Zero',
    [
...
const ProfRowan = new ProfNPC(
    ...
    'assets/images/npcs/Professor Rowan.png'
);

const LucyStevens1 = new NPC(
    'Lucy Stevens',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Detective Pikachu', 7),
            new QuestLineStepCompletedRequirement(
                'Detective Pikachu',
                9,
                GameConstants.AchievementOption.less
...
const ManaphyHastings1 = new NPC(
    'Professor Hastings',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Recover the Precious Egg!'),
            new QuestLineStepCompletedRequirement(
...
const ManaphyHastings2 = new NPC(
    'Professor Hastings',
    [
...
const ManaphyHastings3 = new NPC(
    'Professor Hastings',
    [
...
const ManaphyHastings4 = new NPC(
    'Professor Hastings',
    [
...
const ManaphyGoRockCommander = new NPC(
    'Go-Rock Commander',
    [
...
const GrotleAcornParty = new NPC(
    'Grotle and Friends',
...
const EvolutionAssistant = new AssistantNPC(
    'Prof. Rowan\'s Assistant',
    [
...
TownList['Sandgem Town'] = new Town(
    ...
    [
        SandgemTownShop,
        TemporaryBattleList['Manaphy Go-Rock Pincher'],
        new ShardTraderShop(
            GameConstants.ShardTraderLocations['Sandgem Town'],
            'Santa\'s Secret Daycare',
            true,
            'Plates'
        ),
    ],
...
TownList['Oreburgh City'] = new Town(
    ...
    [
        OreburghCityShop,
        new ShardTraderShop(
            GameConstants.ShardTraderLocations['Oreburgh City']
        ),
        new GenericTraderShop(
    ...
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Oreburgh Gate')
            ),
        ],
...
TownList['Eterna City'] = new Town(
    ...
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Eterna Forest')
            ),
        ],
...
TownList['Celestic Town'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Galactic Boss Cyrus'],
    ],
    {
...
TownList['Pal Park'] = new Town(
    ...
    [
        PalParkShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Pal Park']),
        TemporaryBattleList['Manaphy Egg Protectors'],
    ],
    {
        requirements: [
            new RouteKillRequirement(10, GameConstants.Region.sinnoh, 221),
        ],
...
TownList['Resort Area'] = new Town(
    ...
    [
        ResortAreaShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Resort Area']),
    ],
    {
        requirements: [
...
TownList['Pokémon League Sinnoh'] = new Town(
    ...
    [
        GymList['Elite Aaron'],
        GymList['Elite Bertha'],
        GymList['Elite Flint'],
        GymList['Elite Lucian'],
        GymList['Champion Cynthia'],
        pokeLeagueShop(),
    ],
    {
        requirements: [
...
TownList['Eterna Forest'] = new DungeonTown(
    ...
    [
        TemporaryBattleList['Manaphy Go-Rock MGrunt 1'],
        TemporaryBattleList['Manaphy Go-Rock MGrunt 2'],
        TemporaryBattleList['Manaphy Go-Rock MGrunt 3'],
        TemporaryBattleList['Manaphy Go-Rock MGrunt 4'],
        TemporaryBattleList['Manaphy Go-Rock FGrunt 1'],
        TemporaryBattleList['Manaphy Go-Rock FGrunt 2'],
    ],
    {
        npcs: [
            MossRock,
...
TownList['Lake Verity'] = new DungeonTown(
    ...
    [
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Lake Valor')
        ),
    ],
    [],
    {
...
TownList['Mt. Coronet North'] = new DungeonTown(
    ...
    [
        ...
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Lake Verity')
        ),
    ]
);
...
TownList['Team Galactic HQ'] = new DungeonTown(
    ...
    [
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Lake Acuity')
        ),
    ]
);
TownList['Spear Pillar'] = new DungeonTown(
    ...
    [
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Team Galactic HQ')
        ),
    ]
);
...
const AnvilleTownShop = new Shop([ItemList['Meloetta (Pirouette)']]);

//Unova Gem Master
const UnovaFluteMaster = new GemMasterShop(
    GameConstants.GemShops.UnovaFluteMaster
);

//Unova Berry Master
const DriftveilBerryMaster = new BerryMasterShop(
    GameConstants.BerryTraderLocations['Driftveil City'],
    [
        ItemList.Boost_Mulch,
        ItemList.Rich_Mulch,
        ItemList.Surprise_Mulch,
...
const CasteliaMusician = new NPC(
    'Musician',
    [
...
const RelicCastleRuinmaniac = new NPC(
    'Ruin Maniac',
    [
...
const PlasmaGrunt2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Team Plasma Grunt (male).png',
        requirement: new OneFromManyRequirement([
            new TemporaryBattleRequirement(
                'Team Plasma Grunt 4',
                1,
                GameConstants.AchievementOption.less
            ),
...
const DriftveilZinzolin = new NPC(
    'Zinzolin',
    [
        'YOU!',
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 6),
            new QuestLineStepCompletedRequirement(
...
const GiantChasmColress = new NPC(
    'Colress',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Giant Chasm')
            ),
...
const GiantChasmShadowTriad = new NPC(
    'Shadow Triad',
    [
...
const IcirrusFanClubChairman = new NPC(
    'Fan Club Chairman',
    [
...
const P2LaboratoryColress = new NPC(
    'Colress',
    [
...
const UnovaRoamerNPC = new RoamerNPC(
    'Professor Juniper\'s Aide',
    [
...
const DreamResearcher1 = new NPC(
    'Dream Researcher',
    [
...
const DreamResearcher2 = new NPC(
    'Dream Researcher',
    [
...
const OldManSwords = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Old Man.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Swords of Justice'),
            new QuestLineStepCompletedRequirement(
                'Swords of Justice',
                1,
                GameConstants.AchievementOption.less
...
// Genesect Quest Npcs
const InvestigateP2 = new NPC(
    'Investigate the P2 Laboratory',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('The Legend Awakened'),
            new QuestLineStepCompletedRequirement(
                'The Legend Awakened',
                1,
                GameConstants.AchievementOption.less
...
const AncientBugHunter1 = new NPC(
    'Ancient Bug Hunter',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Super Nerd.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Legend Awakened', 2),
            new QuestLineStepCompletedRequirement(
                'The Legend Awakened',
                4,
                GameConstants.AchievementOption.less
...
const AncientBugHunter2 = new NPC(
    'Ancient Bug Hunter',
    [
...
const AncientBugHunter3 = new NPC(
    'Ancient Bug Hunter',
    [
...
TownList['Nimbasa City'] = new Town(
    ...
    [
        NimbasaCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Nimbasa City']),
        TemporaryBattleList['Team Plasma Grunt 2'],
        TemporaryBattleList['Team Plasma Grunt 3'],
    ],
    {
        requirements: [
...
TownList['Mistralton City'] = new Town(
    ...
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Chargestone Cave')
            ),
...
TownList['Undella Town'] = new Town(
    ...
    [
        UndellaTownShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Undella Town']),
        UnovaFluteMaster,
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Reversal Mountain')
            ),
        ],
    }
);
TownList['Lacunosa Town'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Team Plasma Grunt 6'],
        TemporaryBattleList['Zinzolin 1'],
        TemporaryBattleList['Kyurem 1'],
    ],
    {
        requirements: [
...
TownList['Humilau City'] = new Town(
    ...
    [
        HumilauCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Humilau City']),
    ],
    {
        requirements: [
...
TownList['Icirrus City'] = new Town(
    ...
    [
        IcirrusCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Icirrus City']),
    ],
    {
        requirements: [
            new OneFromManyRequirement([
                ...
                new ClearDungeonRequirement(
                    1,
                    GameConstants.getDungeonIndex('Twist Mountain')
                ),
            ]),
        ],
...
TownList['Nacrene City'] = new Town(
    ...
    [
        NacreneCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Nacrene City']),
        new GenericTraderShop('FossilNacreneMuseum', 'Nacrene Museum'),
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Pinwheel Forest')
            ),
        ],
...
TownList['Nuvema Town'] = new Town(
    ...
    [
        NuvemaTownShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Nuvema Town']),
        TemporaryBattleList['Lab Ambush'],
    ],
    {
        requirements: [
...
TownList['Pokémon League Unova'] = new Town(
    ...
    GameConstants.UnovaSubRegions.Unova,
    [
        GymList['Elite Shauntal'],
        GymList['Elite Marshal'],
        GymList['Elite Grimsley'],
        GymList['Elite Caitlin'],
        GymList['Champion Iris'],
        pokeLeagueShop(),
    ],
    {
        requirements: [
            ...
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Victory Road Unova')
            ),
        ],
    }
);
...
TownList['Pledge Grove'] = new DungeonTown(
    ...
    [
        ...
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Moor of Icirrus')
        ),
    ]
);
...
TownList['Castelia Sewers'] = new DungeonTown(
    ...
    [new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 0)],
    [
        TemporaryBattleList['Red Genesect 1'],
        TemporaryBattleList['Red Genesect 2'],
    ],
    {
...
TownList['Giant Chasm'] = new DungeonTown(
    ...
    [
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Plasma Frigate')
        ),
        new QuestLineStepCompletedRequirement('Hollow Truth and Ideals', 15),
    ],
    [
        TemporaryBattleList['Ghetsis 1'],
        TemporaryBattleList['Ghetsis 2'],
        TemporaryBattleList['Kyurem 2'],
        TemporaryBattleList['Kyurem 3'],
        TemporaryBattleList['Destiny Deoxys Rayquaza'],
    ],
    {
        npcs: [
...
const DisguisedShop = new Shop(
    ...
    'Badly Disguised Shop',
    [new TemporaryBattleRequirement('Twerps')]
);
...
//Hoenn Flute Master
const FurfrouGemTrader = new GemMasterShop(
    GameConstants.GemShops.FurfrouGemTrader,
    'Furfrou Gem Trader'
);
const KalosStoneSalesman = new GemMasterShop(
    GameConstants.GemShops.KalosStoneSalesman,
    'Stone Emporium',
    [new TemporaryBattleRequirement('Kalos Stone Salesman')],
    true
);
...
const Lysandre1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('A Beautiful World'),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                1,
                GameConstants.AchievementOption.less
...
const Calem1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Beautiful World', 0),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                2,
                GameConstants.AchievementOption.less
...
const CyllageStoneCollector = new NPC(
    'Vivid Stone Collector',
    [
...
const TeamFlareGrunt1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Beautiful World', 6),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                8,
                GameConstants.AchievementOption.less
...
const Lysandre2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Team Flare Lysandre.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Beautiful World', 9),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                11,
                GameConstants.AchievementOption.less
...
const SantaluneSageChen = new NPC(
    'Sage Chen',
    [
...
const LaverreFurisodeGirlKatherine = new NPC(
...
const LaverreGengariteAster1 = new NPC(
    'Hex Maniac Aster',
    [
    ...
    ],
    {
        ...
        requirement: new OneFromManyRequirement([
            new StatisticRequirement(
                [
                    'pokemonEncountered',
                    PokemonHelper.getPokemonByName('Gastly').id,
                ],
                666,
                undefined,
                GameConstants.AchievementOption.less
            ...
            new StatisticRequirement(
                [
                    'pokemonEncountered',
                    PokemonHelper.getPokemonByName('Haunter').id,
                ],
                444,
                undefined,
                GameConstants.AchievementOption.less
...
const LaverreGengariteAster2 = new NPC(
    'Hex Maniac Aster',
    [
...
const LaverreMedichamite = new NPC(
    'Black Belt',
    [
...
const PokéBallFactoryDirector = new NPC(
    'Poké Ball Factory Director',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Gentleman (Gen 4).png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Beautiful World', 14),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                16,
                GameConstants.AchievementOption.less
...
const DendemilleDogLover = new NPC(
    'Dubious Dog-loving Duke',
    [
...
const DendemilleWolfLover = new NPC(
    'Worrisome Wolf-loving Woman',
    [
...
const ProfessorSycamore1 = new NPC(
    'Prof. Sycamore',
    [
...
const AnistarKalosRoamerNPC = new RoamerNPC(
    'Hex Maniac Melanie',
    ...
    'assets/images/npcs/Hex Maniac.png'
);

const KalosTVNews = new NPC(
    'Kalos TV News',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Team Flare Lysandre.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Beautiful World', 18),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                20,
                GameConstants.AchievementOption.less
...
const AZ1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Beautiful World', 21),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                23,
                GameConstants.AchievementOption.less
...
const BlueButton = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Beautiful World', 23),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                24,
                GameConstants.AchievementOption.less
...
const XerneasAZ = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/AZ.png',
        requirement: new MultiRequirement([
            new ObtainedPokemonRequirement('Xerneas'),
            new ObtainedPokemonRequirement('Xerneas (Active)', true),
        ]),
    }
);

const TeamFlareLysandre1 = new NPC(
    'Team Flare Lysandre',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Team Flare Lysandre.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Beautiful World', 29),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                31,
                GameConstants.AchievementOption.less
...
const TeamFlareBossLysandre1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('A Beautiful World', 31),
            new QuestLineStepCompletedRequirement(
                'A Beautiful World',
                33,
                GameConstants.AchievementOption.less
...
const EternalFloetteGift = new PokemonGiftNPC(
    'AZ',
    [
    ...
    'Floette (Eternal)',
    'assets/images/pokemon/670.05.png',
    {
        saveKey: 'eternalfloettegift',
        image: 'assets/images/npcs/AZ.png',
        requirement: new QuestLineCompletedRequirement('A Beautiful World'),
    }
);

const CouriwayOldGentlemanHarold = new NPC(
    'Old Gentleman Harold',
    [
...
const KiloudeConfusedHiker = new NPC(
    'Confused Hiker',
    [
...
const ProfSycamore = new ProfNPC(
    'Prof. Sycamore',
    GameConstants.Region.kalos,
    ...
    'assets/images/npcs/Sycamore.png'
);
...
const ExamineAegislash = new PokemonGiftNPC(
    'Millis and Argus Steels\' Aeglislash',
    ['<i>Aegislash wants to join you on your adventure.</i>'],
    'Aegislash (Blade)',
    'assets/images/pokemon/681.01.png',
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement(
                'Princess Diancie',
            ...
            new ObtainedPokemonRequirement('Aegislash (Blade)', true),
        ]),
    }
);

const ThanksDiancie = new NPC(
    'Princess Diancie',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Princess Diancie', 6),
            new QuestLineStepCompletedRequirement(
                'Princess Diancie',
                8,
                GameConstants.AchievementOption.less
...
const KalosStoneSalesman1 = new NPC(
    'Stone Salesman',
    ['I\'m hunting for rare stones! If I find any extras, I\'ll sell you some!'],
    {
        requirement: new TemporaryBattleRequirement(
...
const KalosStoneSalesman2 = new NPC(
    'Stone Salesman',
    [
...
const Baraz1 = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Clash of Ages', 0),
            new QuestLineStepCompletedRequirement(
                'Clash of Ages',
                2,
                GameConstants.AchievementOption.less
...
const Baraz2 = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Clash of Ages', 2),
            new QuestLineStepCompletedRequirement(
                'Clash of Ages',
                3,
                GameConstants.AchievementOption.less
...
const Baraz3 = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Clash of Ages', 4),
            new QuestLineStepCompletedRequirement(
                'Clash of Ages',
                6,
                GameConstants.AchievementOption.less
...
const Baraz4 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Clash of Ages', 6),
            new QuestLineStepCompletedRequirement(
                'Clash of Ages',
                8,
                GameConstants.AchievementOption.less
...
const VivillonPhotobook = new NPC(
    'Vivillon Photobook',
    [
...
const FriendlyAttendant = new NPC(
    'Friendly Attendant',
    [
...
const BugCatcherScizor = new NPC(
    'Bug Catcher Elliot',
    [
...
const AnomalyMewtwo2 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('An Unrivaled Power', 13),
            new QuestLineStepCompletedRequirement(
                'An Unrivaled Power',
                15,
                GameConstants.AchievementOption.less
...
const AnomalyMewtwo3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/pokemon/150.02.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('An Unrivaled Power', 15),
            new QuestLineStepCompletedRequirement(
                'An Unrivaled Power',
                17,
                GameConstants.AchievementOption.less
...
const AnomalyMewtwo4 = new NPC(
    ...
    ],
    {
        image: 'assets/images/pokemon/150.02.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('An Unrivaled Power', 17),
            new QuestLineCompletedRequirement(
                'An Unrivaled Power',
                GameConstants.AchievementOption.less
            ),
...
TownList['Lumiose City'] = new Town(
    ...
    GameConstants.KalosSubRegions.Kalos,
    [
        TemporaryBattleList['Sycamore 1'],
        DepartmentStoreShop,
        FriseurFurfrouShop,
        KalosStoneSalesman,
        TemporaryBattleList['Team Flare Lysandre 1'],
        TemporaryBattleList['Team Flare Xerosic'],
        TemporaryBattleList.AZ,
        TemporaryBattleList.Merilyn,
        TemporaryBattleList['Grand Duchess Diantha'],
        TemporaryBattleList['Kalos Stone Salesman'],
    ],
    {
        requirements: [
...
TownList['Parfum Palace'] = new Town(
    ...
    [
        new ShardTraderShop(
            GameConstants.ShardTraderLocations['Parfum Palace'],
            'Furfrou Shard Trader',
            true
        ),
        FurfrouGemTrader,
    ],
...
TownList['Ambrette Town'] = new Town(
    ...
    [
        ...
        new GenericTraderShop('FossilAmbretteFossilLab', 'Ambrette Fossil Lab'),
    ],
    {
        requirements: [
...
TownList['Cyllage City'] = new Town(
    ...
    [
        CyllageCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Cyllage City']),
        TemporaryBattleList['Marquis Grant'],
    ],
    {
        requirements: [
            new QuestLineStepCompletedRequirement('A Beautiful World', 5),
        ],
...
TownList['Shalour City'] = new Town(
    ...
    [
        ShalourCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Shalour City']),
        TemporaryBattleList.Korrina,
        TemporaryBattleList.Riot,
        TemporaryBattleList['Millis and Argus Steel'],
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Reflection Cave')
            ),
        ],
...
TownList['Laverre City'] = new Town(
    ...
    [
        LaverreCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Laverre City']),
        TemporaryBattleList['Hex Maniac Aster'],
    ],
    {
        requirements: [
...
TownList['Anistar City'] = new Town(
    ...
    [
        AnistarCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Anistar City']),
    ],
    {
        requirements: [
...
TownList['Couriway Town'] = new Town(
    ...
    GameConstants.KalosSubRegions.Kalos,
    [
        TemporaryBattleList['Sycamore 2'],
        CouriwayTownShop,
        new ShardTraderShop(
            GameConstants.ShardTraderLocations['Couriway Town']
        ),
        TemporaryBattleList['Team Flare Boss Lysandre 2'],
    ],
    {
        requirements: [
...
TownList['Pokémon League Kalos'] = new Town(
    ...
    [
        GymList['Elite Malva'],
        GymList['Elite Siebold'],
        GymList['Elite Wikstrom'],
        GymList['Elite Drasna'],
        GymList['Champion Diantha'],
        pokeLeagueShop(),
    ],
    {
        requirements: [
            ...
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Victory Road Kalos')
            ),
        ],
    }
);
...
TownList['Glittering Cave'] = new DungeonTown(
    ...
    [
        ...
        new QuestLineStepCompletedRequirement('A Beautiful World', 2),
    ],
...
TownList['Team Flare Secret HQ'] = new DungeonTown(
    ...
    [
        TemporaryBattleList.Xerneas,
        TemporaryBattleList.Yveltal,
        TemporaryBattleList['Team Flare Boss Lysandre 1'],
    ],
    {
...
const RoadsideMotelShop = new Shop([ItemList.Beastball], 'Looker’s Exchange', [
    new QuestLineStepCompletedRequirement('Ultra Beast Hunt', 1),
]);
...
const AetherParadiseShop = new Shop([ItemList.Upgrade, ItemList['Type: Null']]);
...
const ATreeMaybeShop = new Shop([ItemList.Power_Bracer, ItemList.Key_stone]);
...
// Magikarp Jump Shops
const MagikarpJumpGemTrade = new GemMasterShop(
    GameConstants.GemShops.MagikarpJumpGemTrader,
    'Trade',
    [new GymBadgeRequirement(BadgeEnums.Heal_League)]
);
const MagikarpJumpShadySalesMan = new Shop(
    [ItemList['Magikarp Blue Raindrops'], ItemList['Magikarp Saucy Violet']],
    'Shady Salesman',
    [new GymBadgeRequirement(BadgeEnums.Master_League)]
);

//Alola NPCs

const IkiOutskirtsMom = new NPC(
    'Scratch Cat Girl',
    [
...
const TrainerSchoolTeacher = new NPC(
    'Teacher Emily',
    [
...
const VerdantCavernIlima = new NPC(
    'Captain Ilima',
    [
...
const ProfBurnetAlola2 = new NPC(
    'Professor Burnet',
    [
...
const PikachuValleyPikachuGeneric = new NPC(
    'Pikachu',
    [
        'Pikachu!',
...
const PikachuValleyAlolaCap = new NPC(
    'Pikachu',
    [
        'Pi-Pikachu!',
...
const PikachuValleyPikachuWorldCap = new NPC(
    'Pikachu',
    [
        'Pii-kachu!',
...
const PaniolaTownActor = new NPC(
    'Actor Meredith',
    [
...
const RoyalAvenueSpectator = new NPC(
    'Spectator',
    [
...
const MalieKahuna = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Child of the Stars', 7),
            new OneFromManyRequirement([
                new QuestLineStepCompletedRequirement(
                    'Typing some Memories',
                    1,
...
const YungoosAetherHouse = new NPC('Yungoos', ['Grrrssssss'], {
...
const SeafolkCaptainMina = new NPC(
    'Captain Mina',
    [
...
const AetherParadiseAlolaRoamerNPC = new RoamerNPC(
    ...
    'assets/images/npcs/Assistant Branch Chief Wicke.png'
);

const ProfKukui = new ProfNPC(
    'Prof. Kukui',
    GameConstants.Region.alola,
...
const Lillie2 = new NPC(
    'Return Nebby to Lillie',
    [
...
const Lillie4 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Symbiotic Relations'),
            new QuestLineStepCompletedRequirement(
                'Symbiotic Relations',
                0,
                GameConstants.AchievementOption.less
...
const ProfBurnetAlola1 = new NPC(
    'Talk to Professor Burnet',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Lush Jungle')
            ),
...
const Lillie5 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Child of the Stars'),
            new QuestLineStepCompletedRequirement(
                'Child of the Stars',
                0,
                GameConstants.AchievementOption.less
...
const Lillie6 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Child of the Stars', 12),
            new QuestLineStepCompletedRequirement(
                'Child of the Stars',
                13,
                GameConstants.AchievementOption.less
...
const HapuHope = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Emissary of Light', 0),
            new QuestLineStepCompletedRequirement(
                'Emissary of Light',
                3,
                GameConstants.AchievementOption.less
...
const Lillie7 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Lillie (z powered).png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Emissary of Light', 7),
            new QuestLineCompletedRequirement(
                'Emissary of Light',
                GameConstants.AchievementOption.less
            ),
...
const LillieSun = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            ...
            new StatisticRequirement(
                ['npcTalkedTo', GameHelper.hash('SunFlute')],
                1,
                'Must have played the Sun Flute during Emissary of Light quest line'
            ),
        ]),
    }
);
const LillieMoon = new NPC(
    'Lillie',
    [
        'At first I\'d taken Nebby with me, but I didn\'t have the courage to protect it myself. But I\'m not that person anymore!',
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Eater of Light', 4),
            new StatisticRequirement(
                ['npcTalkedTo', GameHelper.hash('MoonFlute')],
                1,
                'Must have played the Moon Flute during Emissary of Light quest line'
            ),
        ]),
    }
);
// Optional Story NPCs
// Lillies
const LillieMahaloTrail1 = new NPC(
    'Mysterious Girl',
    ['H-help... Save Nebby!'],
    {
        image: 'assets/images/npcs/Lillie.png',
...
const LillieMahaloTrail2 = new NPC(
    'Lillie',
    [
...
const LillieMelemeleMeadow1 = new NPC(
    'Lillie',
    [
...
const LillieMelemeleMeadow2 = new NPC(
    'Lillie',
    [
...
const LillieRuinsOfLife = new NPC(
    'Lillie',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/specialNPCs/Lillie (nebby).png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Symbiotic Relations', 7),
            new QuestLineStepCompletedRequirement(
                'Symbiotic Relations',
                8,
                GameConstants.AchievementOption.less
...
const LillieAetherHouse = new NPC(
    'Lillie',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Child of the Stars', 5),
            new QuestLineStepCompletedRequirement(
                'Child of the Stars',
                6,
                GameConstants.AchievementOption.less
...
const LillieSeafolkVillage = new NPC(
    'Lillie',
    [
...
const LillieExeggutorIsland = new NPC(
    'Lillie',
    [
...
const HauAether = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Child of the Stars', 8),
            new QuestLineStepCompletedRequirement(
                'Child of the Stars',
                12,
                GameConstants.AchievementOption.less
...
const GladionAether = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Child of the Stars', 9),
            new QuestLineStepCompletedRequirement(
                'Child of the Stars',
                12,
                GameConstants.AchievementOption.less
...
const LillieAether = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Lillie.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Child of the Stars', 10),
            new QuestLineStepCompletedRequirement(
                'Child of the Stars',
                12,
                GameConstants.AchievementOption.less
...
const RotomDexPreChamp = new NPC(
    'Rotom Dex',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/specialNPCs/Rotom-Dex.png',
        requirement: new MultiRequirement([
            new QuestLineCompletedRequirement('Eater of Light'),
            new GymBadgeRequirement(
                BadgeEnums.Champion_Stamp,
                GameConstants.AchievementOption.less
            ),
...
//Silvally Types NPC
const SilvallyGladion1 = new NPC(
    'Gladion',
    [
...
const SilvallyGladion2 = new NPC(
    'Gladion',
    [
...
const SilvallyGladion2Hints = new NPC(
    'Ask Gladion for help',
    [
...
const SophoclesSilvally1 = new NPC(
    'Captain Sophocles',
    [
...
const VeteranSilvally1 = new NPC(
    'Veteran Aristo',
    [
...
const SilvallyGladion3 = new NPC(
    'Gladion',
    [
...
const SilvallyGladion3Hints = new NPC(
    'Ask Gladion for help',
    [
...
const PlumeriaSilvally = new NPC(
    'Plumeria',
    [
...
const SilvallyGladion4 = new NPC(
    'Gladion',
    [
...
//Ultra Beasts NPCs
const RoadsideMotelLooker1 = new NPC(
    'Looker',
    [
...
const RoadsideMotelAnabel1 = new NPC(
    'Anabel',
    [
...
const RoadsideMotelLooker2 = new NPC(
    'Looker',
    [
...
const RoadsideMotelAnabel2 = new NPC(
    'Anabel',
    [
...
const RoadsideMotelAnabel3 = new NPC(
    'Anabel',
    [
...
const RoadsideMotelMina = new NPC(
    'Captain Mina',
    [
...
const RoadsideMotelNanu1 = new NPC(
    'Kahuna Nanu',
    [
        '...',
...
const RoadsideMotelNanu2 = new NPC(
    'Kahuna Nanu',
    [
        '...',
...
const RoadsideMotelAnabel4 = new NPC(
    'Anabel',
    [
...
const RoadsideMotelAnabel5 = new NPC(
    'Anabel',
    [
...
const MayorKarp = new NPC(
    ...
    ],
    {
        ...
        requirement: new OneFromManyRequirement([
            new ObtainedPokemonRequirement('Magikarp'),
            new ObtainedPokemonRequirement('Magikarp (Feebas)'),
        ]),
    }
);

const MagikarpJumpRoamerNPC = new RoamerNPC(
    'Roddy Tackle',
    [
    ...
    'assets/images/npcs/Roddy Tackle.png',
    new OneFromManyRequirement([
        new ObtainedPokemonRequirement('Magikarp'),
        new ObtainedPokemonRequirement('Magikarp (Feebas)'),
    ])
);
const HoppyManOfMystery = new NPC(
    'Man of Mystery',
    [
...
const DrSplash1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Dr. Splash\'s Research Project'),
            new QuestLineStepCompletedRequirement(
...
const MagikarpEyeShadySalesman = new NPC(
    'Shady Salesman',
    [
...
const FishPolice = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Officer Jenny.png',
        requirement: new MultiRequirement([
            new ObtainedPokemonRequirement('Magikarp', true),
            new ObtainedPokemonRequirement('Magikarp (Feebas)', true),
        ]),
    }
);
...
TownList['Hau\'oli City'] = new Town(
    ...
    [
        HauoliCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Hau\'oli City']),
        TemporaryBattleList.Ilima,
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Trainers\' School')
            ),
        ],
        npcs: [NecrozmaLooker],
    }
...
TownList['Roadside Motel'] = new Town(
    ...
    GameConstants.AlolaSubRegions.MelemeleIsland,
    [
        TemporaryBattleList.Anabel,
        TemporaryBattleList['Captain Mina UB'],
        TemporaryBattleList['Kahuna Nanu UB'],
        RoadsideMotelShop,
    ],
    {
...
TownList['Heahea City'] = new Town(
    ...
    GameConstants.AlolaSubRegions.AkalaIsland,
    [
        TemporaryBattleList.Dexio,
        TemporaryBattleList.Sina,
        HeaheaCityShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Heahea City']),
        new DockTownContent(),
    ],
    {
...
TownList['Paniola Town'] = new Town(
    ...
    [
        PaniolaTownShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Paniola Town']),
    ],
    {
        requirements: [
...
TownList['Royal Avenue'] = new Town(
    ...
    GameConstants.AlolaSubRegions.AkalaIsland,
    [
        TemporaryBattleList['Battle Royal'],
        DepartmentStoreShop,
        TemporaryBattleList['Molayne Steel Memory'],
    ],
    {
...
TownList['Tapu Village'] = new Town(
    ...
    [
        TapuVillageShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Tapu Village']),
    ],
    {
        requirements: [
...
TownList['Seafolk Village'] = new Town(
    ...
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Aether Foundation')
            ),
        ],
        npcs: [
            SeafolkCaptain,
...
TownList['Exeggutor Island'] = new Town(
    ...
    [
        ...
        new MoveToTown('Exeggutor Island Hill', undefined, false),
    ],
    {
...
TownList['Altar of the Sunne and Moone'] = new Town(
    ...
    GameConstants.AlolaSubRegions.PoniIsland,
    [
        TemporaryBattleList.Lusamine,
        TemporaryBattleList.Necrozma,
        TemporaryBattleList['Ultra Megalopolis'],
        TemporaryBattleList.Lillie,
    ...
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Vast Poni Canyon')
            ),
        ],
        npcs: [
            SunFlute,
...
TownList['Pokémon League Alola'] = new Town(
    ...
    GameConstants.AlolaSubRegions.UlaulaIsland,
    [
        GymList['Elite Molayne'],
        GymList['Elite Olivia'],
        GymList['Elite Acerola'],
        GymList['Elite Kahili'],
        GymList['Champion Hau'],
        pokeLeagueShop(),
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Mount Lanakila')
            ),
        ],
...
TownList['A Tree Maybe'] = new Town(
    ...
    {
        requirements: [
            new RouteKillRequirement(10, GameConstants.Region.alola, 30),
        ],
...
TownList['Heavy League'] = new Town(
    ...
    GameConstants.AlolaSubRegions.MagikarpJump,
    [
        TemporaryBattleList['Magikarp Jump Karpella'],
        TemporaryBattleList['Magikarp Jump Karpen'],
    ],
    {
        requirements: [
...
TownList['Great League'] = new Town(
    ...
    GameConstants.AlolaSubRegions.MagikarpJump,
    [
        TemporaryBattleList['Magikarp Jump Tykarp'],
        TemporaryBattleList['Magikarp Jump Karpress'],
    ],
    {
        requirements: [
...
TownList['Fast League'] = new Town(
    ...
    GameConstants.AlolaSubRegions.MagikarpJump,
    [
        TemporaryBattleList['Magikarp Jump Karami'],
        TemporaryBattleList['Magikarp Jump Karson'],
    ],
    {
        requirements: [
...
TownList['Luxury League'] = new Town(
    ...
    GameConstants.AlolaSubRegions.MagikarpJump,
    [
        TemporaryBattleList['Magikarp Jump Karpress 2'],
        TemporaryBattleList['Magikarp Jump Karpen 2'],
        TemporaryBattleList['Magikarp Jump Karbuck'],
    ],
    {
        requirements: [
...
TownList['Heal League'] = new Town(
    ...
    GameConstants.AlolaSubRegions.MagikarpJump,
    [
        TemporaryBattleList['Magikarp Jump Skyhopper'],
        TemporaryBattleList['Magikarp Jump Karpen 3'],
        TemporaryBattleList['Magikarp Jump Karpella 2'],
    ],
    {
        requirements: [
...
TownList['Ultra League'] = new Town(
    ...
    GameConstants.AlolaSubRegions.MagikarpJump,
    [
        TemporaryBattleList['Magikarp Jump Karbuck 2'],
        TemporaryBattleList['Magikarp Jump Kareign'],
        TemporaryBattleList['Magikarp Jump Koylee 2'],
    ],
    {
        requirements: [
...
TownList['Elite Four League'] = new Town(
    ...
    [
        GymList['E4 League'],
        TemporaryBattleList['Magikarp Jump Karpress 3'],
        TemporaryBattleList['Magikarp Jump Karpen 4'],
        TemporaryBattleList['Magikarp Jump Karpella 3'],
    ],
    {
        requirements: [
...
TownList['Master League'] = new Town(
    ...
    GameConstants.AlolaSubRegions.MagikarpJump,
    [
        TemporaryBattleList['Magikarp Jump Skyhopper 2'],
        TemporaryBattleList['Magikarp Jump Tykarp 2'],
    ],
    {
        requirements: [
...
TownList['Melemele Meadow'] = new DungeonTown(
    ...
    [
        new MoveToTown(
            ...
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Melemele Meadow')
            ),
            false
        ),
    ],
...
TownList['Seaward Cave'] = new DungeonTown(
    ...
    [
        new MoveToTown('Melemele Meadow', undefined, false),
...
TownList['Lush Jungle'] = new DungeonTown(
    ...
    [
        LushJungleShop,
        TemporaryBattleList['Captain Mallow'],
        TemporaryBattleList['Captain Lana'],
    ],
...
TownList['Aether Foundation'] = new DungeonTown(
    ...
    [
        new GemMasterShop(
            GameConstants.GemShops.SilvallyTrader,
            'Memory Replicator',
            [new QuestLineStepCompletedRequirement('Typing some Memories', 3)],
            true
        ),
...
//Galar Shops
const PostwickShop = new Shop([ItemList.Pokeball]);
...
const GlimwoodTangleShop = new Shop(
    ...
    'Zarude Village',
    [new QuestLineCompletedRequirement('Secrets of the Jungle')]
);
...
const WedgehurstRailStaff = new NPC(
    'Rail Staff',
    [
...
const BattleCafeMaster = new NPC(
    'Battle Café Master',
    [
...
const HammerlockeHiker = new NPC(
    'Hiker Donald',
    [
...
const StowonSideSonia = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Darkest Day', 1),
            new QuestLineStepCompletedRequirement(
                'The Darkest Day',
                3,
                GameConstants.AchievementOption.less
...
const CirchesterGuitarist = new NPC(
    'Guitarist Justin',
    [
...
const RoseBroadcast = new NPC(
    'Broadcast of Chairman Rose',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Darkest Day', 10),
            new QuestLineStepCompletedRequirement(
                'The Darkest Day',
                12,
                GameConstants.AchievementOption.less
...
const WyndonHop = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Hop.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Darkest Day', 11),
            new QuestLineStepCompletedRequirement(
                'The Darkest Day',
                13,
                GameConstants.AchievementOption.less
...
const SlumberingHop1 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Hop.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Darkest Day', 13),
            new QuestLineStepCompletedRequirement(
                'The Darkest Day',
                15,
                GameConstants.AchievementOption.less
...
const EnergyPlantRose = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Macro Cosmos (rose).png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Darkest Day', 15),
            new QuestLineStepCompletedRequirement(
                'The Darkest Day',
                17,
                GameConstants.AchievementOption.less
...
const EternatusCatch = new PokemonGiftNPC(
    'Catch Eternatus',
    ['You caught Eternatus!'],
    'Eternatus',
    'assets/images/pokemon/890.png',
    {
        saveKey: 'eternatuscatch',
        requirement: new MultiRequirement([
            new TemporaryBattleRequirement('The Darkest Day'),
            new ObtainedPokemonRequirement('Eternatus', true),
        ]),
    }
);
...
const Leon = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Darkest Day', 18),
            new GymBadgeRequirement(
                BadgeEnums.Elite_GalarChampion,
                GameConstants.AchievementOption.less
            ),
...
const SordwardShielbert1 = new NPC(
    'Sordward & Shielbert',
    [
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Sword and Shield', 1),
            new QuestLineStepCompletedRequirement(
                'Sword and Shield',
                3,
                GameConstants.AchievementOption.less
...
const SordwardShielbert2 = new NPC(
    'Sordward & Shielbert',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Sordward & Shielbert.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Sword and Shield', 6),
            new QuestLineStepCompletedRequirement(
                'Sword and Shield',
                8,
                GameConstants.AchievementOption.less
...
const SordwardShielbert3 = new NPC(
    'Sordward & Shielbert',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Sordward & Shielbert.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Sword and Shield', 13),
            new QuestLineStepCompletedRequirement(
                'Sword and Shield',
                15,
                GameConstants.AchievementOption.less
...
const SordwardShielbert4 = new NPC(
    'Sordward & Shielbert',
    [
    ...
    ],
    {
        image: 'assets/images/npcs/Sordward & Shielbert.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Sword and Shield', 15),
            new QuestLineStepCompletedRequirement(
                'Sword and Shield',
                17,
                GameConstants.AchievementOption.less
...
const Piers = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Sword and Shield', 17),
            new QuestLineStepCompletedRequirement(
                'Sword and Shield',
                19,
                GameConstants.AchievementOption.less
...
const EnergyPlantHop = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Hop.png',
        requirement: new MultiRequirement([
            new QuestLineCompletedRequirement('Sword and Shield'),
        ]),
    }
);

const SouthGalarRoamerNPC = new RoamerNPC(
    'Professor Sonia',
    [
    ...
    'assets/images/npcs/Professor Sonia.png'
);

//Isle of Armor NPCs
const IsleofArmorRoamerNPC = new RoamerNPC(
    'Master Dojo Student',
    [
    ...
    'assets/images/npcs/Master Dojo.png'
);

const Mustard1 = new NPC(
    'Mustard',
    [
...
const Klara1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 5),
            new QuestLineStepCompletedRequirement(
                'The Dojo\'s Armor',
                7,
                GameConstants.AchievementOption.less
...
const Mustard5 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Mustard.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 7),
            new QuestLineStepCompletedRequirement(
                'The Dojo\'s Armor',
                10,
                GameConstants.AchievementOption.less
...
const Klara2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Klara.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 8),
            new QuestLineStepCompletedRequirement(
                'The Dojo\'s Armor',
                10,
                GameConstants.AchievementOption.less
...
const Mustard6 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Mustard.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 10),
            new QuestLineStepCompletedRequirement(
                'The Dojo\'s Armor',
                12,
                GameConstants.AchievementOption.less
...
const Mustard7 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Mustard.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 12),
            new QuestLineStepCompletedRequirement(
                'The Dojo\'s Armor',
                14,
                GameConstants.AchievementOption.less
...
const Mustard8 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Mustard.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 14),
            new QuestLineStepCompletedRequirement(
                'The Dojo\'s Armor',
                16,
                GameConstants.AchievementOption.less
...
const Mustard9 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Mustard.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 16),
            new QuestLineStepCompletedRequirement(
                'The Dojo\'s Armor',
                18,
                GameConstants.AchievementOption.less
...
const Mustard10 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Dojo\'s Armor', 18),
            new QuestLineCompletedRequirement(
                'The Dojo\'s Armor',
                GameConstants.AchievementOption.less
            ),
...
const JungleAsh1 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Ash Ketchum.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Secrets of the Jungle'),
            new QuestLineStepCompletedRequirement(
...
const JungleKoko1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Secrets of the Jungle', 0),
            new QuestLineStepCompletedRequirement(
                'Secrets of the Jungle',
                2,
                GameConstants.AchievementOption.less
...
const JungleKoko2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Koko.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Secrets of the Jungle', 2),
            new QuestLineStepCompletedRequirement(
                'Secrets of the Jungle',
                4,
                GameConstants.AchievementOption.less
...
const JungleKoko3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Koko.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Secrets of the Jungle', 4),
            new QuestLineStepCompletedRequirement(
                'Secrets of the Jungle',
                6,
                GameConstants.AchievementOption.less
...
const JungleKoko4 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Koko.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Secrets of the Jungle', 6),
            new QuestLineStepCompletedRequirement(
                'Secrets of the Jungle',
                9,
                GameConstants.AchievementOption.less
...
const JungleAsh2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Ash Ketchum.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Secrets of the Jungle', 7),
            new QuestLineStepCompletedRequirement(
                'Secrets of the Jungle',
                9,
                GameConstants.AchievementOption.less
...
const JungleKoko5 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Koko.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Secrets of the Jungle', 9),
            new QuestLineStepCompletedRequirement(
                'Secrets of the Jungle',
                11,
                GameConstants.AchievementOption.less
...
const JungleAsh3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Ash Ketchum.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Secrets of the Jungle', 11),
            new QuestLineStepCompletedRequirement(
                'Secrets of the Jungle',
                13,
                GameConstants.AchievementOption.less
...
const JungleKoko6 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Koko.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('Secrets of the Jungle', 13),
            new QuestLineCompletedRequirement(
                'Secrets of the Jungle',
                GameConstants.AchievementOption.less
            ),
...
const CrownShrineExplorer = new NPC(
    'Explorer',
    [
...
//Crown Tundra NPCs
const CrownTundraRoamerNPC = new RoamerNPC(
    'Freezington Mayor',
    [
...
const GalarFossilHiker = new NPC(
    'Spelunker',
    [
...
const CrownPeony1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('The Crown of Galar'),
            new QuestLineStepCompletedRequirement(
                'The Crown of Galar',
                1,
                GameConstants.AchievementOption.less
...
const Calyrex4 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/specialNPCs/Possessed Peony.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Crown of Galar', 7),
            new QuestLineStepCompletedRequirement(
                'The Crown of Galar',
                9,
                GameConstants.AchievementOption.less
...
const Calyrex5 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Crown of Galar', 9),
        ]),
    }
);
const CrownPeony2 = new NPC(
    'Peony',
    [
...
const BirdPeony1 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Peony.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('The Birds of the Dyna Tree'),
            new QuestLineStepCompletedRequirement(
...
const GolemPeony1 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Peony.png',
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('The Ancient Golems'),
            new QuestLineStepCompletedRequirement(
                'The Ancient Golems',
                1,
                GameConstants.AchievementOption.less
...
const GolemPeony2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Peony.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Ancient Golems', 1),
            new QuestLineStepCompletedRequirement(
                'The Ancient Golems',
                3,
                GameConstants.AchievementOption.less
...
const GolemPeony6 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Peony.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Ancient Golems', 9),
            new QuestLineCompletedRequirement(
                'The Ancient Golems',
                GameConstants.AchievementOption.less
            ),
...
const Peonia1 = new NPC(
    ...
    ],
    {
        ...
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('The Lair of Giants'),
            new QuestLineStepCompletedRequirement(
                'The Lair of Giants',
                1,
                GameConstants.AchievementOption.less
...
const Peonia2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Peonia.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Lair of Giants', 1),
            new QuestLineStepCompletedRequirement(
                'The Lair of Giants',
                32,
                GameConstants.AchievementOption.less
...
const Peonia3 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Peonia.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Lair of Giants', 32),
            new QuestLineStepCompletedRequirement(
                'The Lair of Giants',
                34,
                GameConstants.AchievementOption.less
...
const GigantamaxLeon1 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Leon.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Lair of Giants', 33),
            new QuestLineStepCompletedRequirement(
                'The Lair of Giants',
                35,
                GameConstants.AchievementOption.less
...
const GigantamaxLeon2 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Leon.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Lair of Giants', 35),
            new QuestLineStepCompletedRequirement(
                'The Lair of Giants',
                37,
                GameConstants.AchievementOption.less
...
const Peonia4 = new NPC(
    ...
    ],
    {
        image: 'assets/images/npcs/Peonia.png',
        requirement: new MultiRequirement([
            new QuestLineStepCompletedRequirement('The Lair of Giants', 36),
            new QuestLineCompletedRequirement(
                'The Lair of Giants',
                GameConstants.AchievementOption.less
            ),
...
const MaxLairScientist = new NPC(
    'Scientist',
    [
...
const ProfMagnolia = new ProfNPC(
    'Prof. Magnolia',
    GameConstants.Region.galar,
...
const magearnaGiftReq = new MultiRequirement([
    new CaughtUniqueShinyPokemonsByRegionRequirement(
        GameConstants.Region.kanto
    ),
    new CaughtUniqueShinyPokemonsByRegionRequirement(
        GameConstants.Region.johto
...
const MagearnaMysteryGift = new PokemonGiftNPC(
    'Mystery Gift',
    ['You have received a Mystery Gift for completing the National Shiny Dex!'],
    'Magearna (Original Color)',
    'assets/images/pokemon/801.01.png',
    {
        saveKey: 'magearnamysterygift',
        requirement: new CustomRequirement(
            ko.pureComputed(() => +magearnaGiftReq.isCompleted()),
            1,
            'Complete all regional Shiny Master achievements from Kanto through Galar.'
        ),
    }
);
...
TownList.Motostoke = new Town(
    ...
    GameConstants.GalarSubRegions.SouthGalar,
    [
        TemporaryBattleList['Marnie 1'],
        TemporaryBattleList['Rampaging Torkoal'],
        MotostokeShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations.Motostoke),
        new BattleCafe(),
    ],
    {
        requirements: [
...
TownList.Turffield = new Town(
    ...
    GameConstants.GalarSubRegions.SouthGalar,
    [
        TemporaryBattleList['Rampaging Tsareena'],
        TurffieldShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations.Turffield),
    ],
    {
        requirements: [
...
TownList.Hulbury = new Town(
    ...
    GameConstants.GalarSubRegions.SouthGalar,
    [
        TemporaryBattleList['Rampaging Gyarados'],
        HulburyShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations.Hulbury),
    ],
    {
...
TownList['Stow-on-Side'] = new Town(
    ...
    [
        TemporaryBattleList['Rampaging Conkeldurr'],
        TemporaryBattleList['Rampaging Dusknoir'],
        GymList['Stow-on-Side1'],
        GymList['Stow-on-Side2'],
        StowonSideShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Stow-on-Side']),
        new GenericTraderShop('FossilMasterGalarRoute6', 'Cara Liss'),
    ],
    {
        requirements: [
...
TownList.Ballonlea = new Town(
    ...
    GameConstants.GalarSubRegions.NorthGalar,
    [
        TemporaryBattleList['Gym Leader Bede'],
        BallonleaShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations.Ballonlea),
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Glimwood Tangle')
            ),
        ],
    }
);
...
TownList.Circhester = new Town(
    ...
    GameConstants.GalarSubRegions.NorthGalar,
    [
        TemporaryBattleList['Rampaging Gigalith'],
        TemporaryBattleList['Rampaging Froslass'],
        GymList.Circhester1,
        GymList.Circhester2,
        CirchesterShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations.Circhester),
    ],
    {
        requirements: [
...
TownList.Spikemuth = new Town(
    ...
    GameConstants.GalarSubRegions.NorthGalar,
    [
        TemporaryBattleList['Gym Leader Marnie'],
        SpikemuthShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations.Spikemuth),
        new DockTownContent(),
    ],
    {
...
TownList['Wyndon Stadium'] = new Town(
    ...
    GameConstants.GalarSubRegions.NorthGalar,
    [
        GymList['Elite Trainer Marnie'],
        GymList['Elite Gym Leader Bede'],
        GymList['Elite Trainer Hop'],
        GymList['Champion Leon'],
        pokeLeagueShop(),
    ],
    {
        requirements: [
...
TownList['Master Dojo'] = new Town(
    ...
    GameConstants.GalarSubRegions.IsleofArmor,
    [
        new BulletinBoard(GameConstants.BulletinBoards.Armor),
        TemporaryBattleList.Mustard,
        TemporaryBattleList.Kubfu,
        MasterDojoShop,
        new ShardTraderShop(GameConstants.ShardTraderLocations['Master Dojo']),
        new DockTownContent(),
    ],
    {
        requirements: [
...
TownList['Master Dojo Battle Court'] = new Town(
    ...
    GameConstants.GalarSubRegions.IsleofArmor,
    [
        GymList['Elite Gym Leader Klara'],
        GymList['Elite Gym Leader Avery'],
        GymList['Elite Dojo Matron Honey'],
        GymList['Elite Dojo Master Mustard'],
    ],
    {
...
TownList.Freezington = new Town(
    ...
    GameConstants.GalarSubRegions.CrownTundra,
    [
        new BulletinBoard(GameConstants.BulletinBoards.Crown),
        GymList['Elite Trainer Peony'],
        TemporaryBattleList.Calyrex,
        TemporaryBattleList.Glastrier,
...
TownList['Slumbering Weald Shrine'] = new DungeonTown(
    ...
    [
        TemporaryBattleList['Hop 8'],
        TemporaryBattleList['Sordward 1'],
        TemporaryBattleList['Shielbert 1'],
    ],
    {
...
TownList['Glimwood Tangle'] = new DungeonTown(
    ...
    [
        TemporaryBattleList['Zarude Tribe 1'],
        TemporaryBattleList['Zarude Tribe 2'],
        TemporaryBattleList['Zarude Tribe 3'],
        TemporaryBattleList['Zarude (Dada)'],
        TemporaryBattleList['Flowering Celebi'],
        GlimwoodTangleShop,
    ],
    {
        npcs: [
...
TownList['Energy Plant'] = new DungeonTown(
    ...
    [
        TemporaryBattleList.Eternatus,
        TemporaryBattleList['Sordward 2'],
        TemporaryBattleList['Shielbert 2'],
        TemporaryBattleList['Rampaging Zacian'],
        TemporaryBattleList['Rampaging Zamazenta'],
        TemporaryBattleList['The Darkest Day'],
        TemporaryBattleList['Eternamax Eternatus'],
    ],
    {
        npcs: [
            EnergyPlantRose,
...
const ForcesCogita1 = new NPC(
    ...
    {
        requirement: new MultiRequirement([
            new QuestLineStartedRequirement('Incarnate Forces of Hisui'),
            new QuestLineStepCompletedRequirement(
...
TownList['Jubilife Village'] = new Town(
    ...
    [
        JubilifeVillageShop,
        new ShardTraderShop(
            GameConstants.ShardTraderLocations['Jubilife Village']
        ),
        TemporaryBattleList['Volo 1'],
        TemporaryBattleList['Akari 1'],
        TemporaryBattleList['Akari 2'],
        TemporaryBattleList['Adaman 1'],
    ],
    {
        requirements: [new DevelopmentRequirement()],
    }
...
TownList['Grandtree Arena'] = new Town(
    ...
    GameConstants.HisuiSubRegions.Hisui,
    [
        TemporaryBattleList['Warden Lian'],
        TemporaryBattleList['Irida 1'],
        TemporaryBattleList['Lord of the Woods: Kleavor'],
    ],
    {
        requirements: [new DevelopmentRequirement()],
    }
...
TownList['Molten Arena'] = new Town(
    ...
    GameConstants.HisuiSubRegions.Hisui,
    [
        TemporaryBattleList.Clover,
        TemporaryBattleList['Coin 2'],
        TemporaryBattleList['Charm 1'],
        TemporaryBattleList['Lord of the Isles: Arcanine'],
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Firespit Island')
            ),
        ],
    }
);
...
TownList['Moonview Arena'] = new Town(
    ...
    [
        ...
        TemporaryBattleList['Lord of the Hollow: Electrode'],
    ],
    {
        requirements: [new DevelopmentRequirement()],
    }
...
TownList['Ancient Snowpoint Temple'] = new DungeonTown(
    ...
    [new DevelopmentRequirement()],
    [
        TemporaryBattleList['Warden Sabi'],
...
TownList['Seaside Hollow'] = new DungeonTown(
    ...
    GameConstants.Region.hisui,
    GameConstants.HisuiSubRegions.Hisui,
    [new DevelopmentRequirement(), new ObtainedPokemonRequirement('Overqwil')]
);
...
TownList['Temple of Sinnoh'] = new DungeonTown(
    ...
    [new DevelopmentRequirement()],
    [
        TemporaryBattleList['Dialga (Origin)'],
        TemporaryBattleList['Palkia (Origin)'],
        TemporaryBattleList['Volo 3'],
...
// Paldea NPCs
const PaldeaRoamerNPC = new RoamerNPC(
    'Student Emily',
    [
...
TownList['Pokémon League Paldea'] = new Town(
    ...
    [
        ...
        GymList['Elite Poppy'],
        GymList['Elite Larry'],
        GymList['Elite Hassel'],
        GymList['Top Champion Geeta'],
        pokeLeagueShop(),
    ],
    {
        requirements: [
...
TownList['Zero Lab'] = new Town(
    ...
    [
        GymList['AI Sada'],
        GymList['AI Turo'],
        TemporaryBattleList['Paradise Protection Protocol'],
    ],
    {
        requirements: [
            new ClearDungeonRequirement(
                1,
                GameConstants.getDungeonIndex('Area Zero Depths')
            ),
        ],
    }
);
...
TownList['Area Zero'] = new DungeonTown(
    ...
    [
        new ClearDungeonRequirement(
            1,
            GameConstants.getDungeonIndex('Inlet Grotto')
        ),
    ]
);
