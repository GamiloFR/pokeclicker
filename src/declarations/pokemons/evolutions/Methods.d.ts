...
/// <reference path="../PokemonNameType.d.ts"/>
 declare const TimeRestrictedLevelEvolution: (startHour: number, endHour: number, basePokemon: PokemonNameType, evolvedPokemon: PokemonNameType, level: number) => import("./Base").EvoData;
 declare const TimeRestrictedStoneEvolution: (startHour: number, endHour: number, basePokemon: PokemonNameType, evolvedPokemon: PokemonNameType, stone: StoneType) => import("./Base").EvoData;
 ...
 declare const MegaEvolution: (basePokemon: PokemonNameType, evolvedPokemon: PokemonNameType) => import("./Base").EvoData;
